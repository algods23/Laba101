(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function a(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(n){if(n.ep)return;n.ep=!0;const r=a(n);fetch(n.href,r)}})();var ce;(function(e){e.Unimplemented="UNIMPLEMENTED",e.Unavailable="UNAVAILABLE"})(ce||(ce={}));class De extends Error{constructor(t,a,s){super(t),this.message=t,this.code=a,this.data=s}}const qt=e=>{var t,a;return e?.androidBridge?"android":!((a=(t=e?.webkit)===null||t===void 0?void 0:t.messageHandlers)===null||a===void 0)&&a.bridge?"ios":"web"},Ft=e=>{const t=e.CapacitorCustomPlatform||null,a=e.Capacitor||{},s=a.Plugins=a.Plugins||{},n=()=>t!==null?t.name:qt(e),r=()=>n()!=="web",i=v=>{const f=c.get(v);return!!(f?.platforms.has(n())||d(v))},d=v=>{var f;return(f=a.PluginHeaders)===null||f===void 0?void 0:f.find(y=>y.name===v)},u=v=>e.console.error(v),c=new Map,o=(v,f={})=>{const y=c.get(v);if(y)return console.warn(`Capacitor plugin "${v}" already registered. Cannot register plugins twice.`),y.proxy;const N=n(),w=d(v);let g;const R=async()=>(!g&&N in f?g=typeof f[N]=="function"?g=await f[N]():g=f[N]:t!==null&&!g&&"web"in f&&(g=typeof f.web=="function"?g=await f.web():g=f.web),g),p=(x,I)=>{var k,U;if(w){const B=w?.methods.find(j=>I===j.name);if(B)return B.rtype==="promise"?j=>a.nativePromise(v,I.toString(),j):(j,ye)=>a.nativeCallback(v,I.toString(),j,ye);if(x)return(k=x[I])===null||k===void 0?void 0:k.bind(x)}else{if(x)return(U=x[I])===null||U===void 0?void 0:U.bind(x);throw new De(`"${v}" plugin is not implemented on ${N}`,ce.Unimplemented)}},E=x=>{let I;const k=(...U)=>{const B=R().then(j=>{const ye=p(j,x);if(ye){const h=ye(...U);return I=h?.remove,h}else throw new De(`"${v}.${x}()" is not implemented on ${N}`,ce.Unimplemented)});return x==="addListener"&&(B.remove=async()=>I()),B};return k.toString=()=>`${x.toString()}() { [capacitor code] }`,Object.defineProperty(k,"name",{value:x,writable:!1,configurable:!1}),k},b=E("addListener"),O=E("removeListener"),L=(x,I)=>{const k=b({eventName:x},I),U=async()=>{const j=await k;O({eventName:x,callbackId:j},I)},B=new Promise(j=>k.then(()=>j({remove:U})));return B.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await U()},B},P=new Proxy({},{get(x,I){switch(I){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return w?L:b;case"removeListener":return O;default:return E(I)}}});return s[v]=P,c.set(v,{name:v,proxy:P,platforms:new Set([...Object.keys(f),...w?[N]:[]])}),P};return a.convertFileSrc||(a.convertFileSrc=v=>v),a.getPlatform=n,a.handleError=u,a.isNativePlatform=r,a.isPluginAvailable=i,a.registerPlugin=o,a.Exception=De,a.DEBUG=!!a.DEBUG,a.isLoggingEnabled=!!a.isLoggingEnabled,a},kt=e=>e.Capacitor=Ft(e),$=kt(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),re=$.registerPlugin;class Ue{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(t,a){let s=!1;this.listeners[t]||(this.listeners[t]=[],s=!0),this.listeners[t].push(a);const r=this.windowListeners[t];r&&!r.registered&&this.addWindowListener(r),s&&this.sendRetainedArgumentsForEvent(t);const i=async()=>this.removeListener(t,a);return Promise.resolve({remove:i})}async removeAllListeners(){this.listeners={};for(const t in this.windowListeners)this.removeWindowListener(this.windowListeners[t]);this.windowListeners={}}notifyListeners(t,a,s){const n=this.listeners[t];if(!n){if(s){let r=this.retainedEventArguments[t];r||(r=[]),r.push(a),this.retainedEventArguments[t]=r}return}n.forEach(r=>r(a))}hasListeners(t){var a;return!!(!((a=this.listeners[t])===null||a===void 0)&&a.length)}registerWindowListener(t,a){this.windowListeners[a]={registered:!1,windowEventName:t,pluginEventName:a,handler:s=>{this.notifyListeners(a,s)}}}unimplemented(t="not implemented"){return new $.Exception(t,ce.Unimplemented)}unavailable(t="not available"){return new $.Exception(t,ce.Unavailable)}async removeListener(t,a){const s=this.listeners[t];if(!s)return;const n=s.indexOf(a);this.listeners[t].splice(n,1),this.listeners[t].length||this.removeWindowListener(this.windowListeners[t])}addWindowListener(t){window.addEventListener(t.windowEventName,t.handler),t.registered=!0}removeWindowListener(t){t&&(window.removeEventListener(t.windowEventName,t.handler),t.registered=!1)}sendRetainedArgumentsForEvent(t){const a=this.retainedEventArguments[t];a&&(delete this.retainedEventArguments[t],a.forEach(s=>{this.notifyListeners(t,s)}))}}const Ye=e=>encodeURIComponent(e).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),Je=e=>e.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class Mt extends Ue{async getCookies(){const t=document.cookie,a={};return t.split(";").forEach(s=>{if(s.length<=0)return;let[n,r]=s.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");n=Je(n).trim(),r=Je(r).trim(),a[n]=r}),a}async setCookie(t){try{const a=Ye(t.key),s=Ye(t.value),n=t.expires?`; expires=${t.expires.replace("expires=","")}`:"",r=(t.path||"/").replace("path=",""),i=t.url!=null&&t.url.length>0?`domain=${t.url}`:"";document.cookie=`${a}=${s||""}${n}; path=${r}; ${i};`}catch(a){return Promise.reject(a)}}async deleteCookie(t){try{document.cookie=`${t.key}=; Max-Age=0`}catch(a){return Promise.reject(a)}}async clearCookies(){try{const t=document.cookie.split(";")||[];for(const a of t)document.cookie=a.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(t){return Promise.reject(t)}}async clearAllCookies(){try{await this.clearCookies()}catch(t){return Promise.reject(t)}}}re("CapacitorCookies",{web:()=>new Mt});const Ut=async e=>new Promise((t,a)=>{const s=new FileReader;s.onload=()=>{const n=s.result;t(n.indexOf(",")>=0?n.split(",")[1]:n)},s.onerror=n=>a(n),s.readAsDataURL(e)}),Bt=(e={})=>{const t=Object.keys(e);return Object.keys(e).map(n=>n.toLocaleLowerCase()).reduce((n,r,i)=>(n[r]=e[t[i]],n),{})},_t=(e,t=!0)=>e?Object.entries(e).reduce((s,n)=>{const[r,i]=n;let d,u;return Array.isArray(i)?(u="",i.forEach(c=>{d=t?encodeURIComponent(c):c,u+=`${r}=${d}&`}),u.slice(0,-1)):(d=t?encodeURIComponent(i):i,u=`${r}=${d}`),`${s}&${u}`},"").substr(1):null,jt=(e,t={})=>{const a=Object.assign({method:e.method||"GET",headers:e.headers},t),n=Bt(e.headers)["content-type"]||"";if(typeof e.data=="string")a.body=e.data;else if(n.includes("application/x-www-form-urlencoded")){const r=new URLSearchParams;for(const[i,d]of Object.entries(e.data||{}))r.set(i,d);a.body=r.toString()}else if(n.includes("multipart/form-data")||e.data instanceof FormData){const r=new FormData;if(e.data instanceof FormData)e.data.forEach((d,u)=>{r.append(u,d)});else for(const d of Object.keys(e.data))r.append(d,e.data[d]);a.body=r;const i=new Headers(a.headers);i.delete("content-type"),a.headers=i}else(n.includes("application/json")||typeof e.data=="object")&&(a.body=JSON.stringify(e.data));return a};class Ht extends Ue{async request(t){const a=jt(t,t.webFetchExtra),s=_t(t.params,t.shouldEncodeUrlParams),n=s?`${t.url}?${s}`:t.url,r=await fetch(n,a),i=r.headers.get("content-type")||"";let{responseType:d="text"}=r.ok?t:{};i.includes("application/json")&&(d="json");let u,c;switch(d){case"arraybuffer":case"blob":c=await r.blob(),u=await Ut(c);break;case"json":u=await r.json();break;default:u=await r.text()}const o={};return r.headers.forEach((v,f)=>{o[f]=v}),{data:u,headers:o,status:r.status,url:r.url}}async get(t){return this.request(Object.assign(Object.assign({},t),{method:"GET"}))}async post(t){return this.request(Object.assign(Object.assign({},t),{method:"POST"}))}async put(t){return this.request(Object.assign(Object.assign({},t),{method:"PUT"}))}async patch(t){return this.request(Object.assign(Object.assign({},t),{method:"PATCH"}))}async delete(t){return this.request(Object.assign(Object.assign({},t),{method:"DELETE"}))}}re("CapacitorHttp",{web:()=>new Ht});var Qe;(function(e){e.Dark="DARK",e.Light="LIGHT",e.Default="DEFAULT"})(Qe||(Qe={}));var ze;(function(e){e.StatusBar="StatusBar",e.NavigationBar="NavigationBar"})(ze||(ze={}));class Wt extends Ue{async setStyle(){this.unavailable("not available for web")}async setAnimation(){this.unavailable("not available for web")}async show(){this.unavailable("not available for web")}async hide(){this.unavailable("not available for web")}}re("SystemBars",{web:()=>new Wt});const Xt="modulepreload",Kt=function(e){return"/"+e},Ze={},Be=function(t,a,s){let n=Promise.resolve();if(a&&a.length>0){let u=function(c){return Promise.all(c.map(o=>Promise.resolve(o).then(v=>({status:"fulfilled",value:v}),v=>({status:"rejected",reason:v}))))};document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),d=i?.nonce||i?.getAttribute("nonce");n=u(a.map(c=>{if(c=Kt(c),c in Ze)return;Ze[c]=!0;const o=c.endsWith(".css"),v=o?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${v}`))return;const f=document.createElement("link");if(f.rel=o?"stylesheet":Xt,o||(f.as="script"),f.crossOrigin="",f.href=c,d&&f.setAttribute("nonce",d),document.head.appendChild(f),o)return new Promise((y,N)=>{f.addEventListener("load",y),f.addEventListener("error",()=>N(new Error(`Unable to preload CSS for ${c}`)))})}))}function r(i){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=i,window.dispatchEvent(d),!d.defaultPrevented)throw i}return n.then(i=>{for(const d of i||[])d.status==="rejected"&&r(d.reason);return t().catch(r)})};function Gt(e){e.CapacitorUtils.Synapse=new Proxy({},{get(t,a){return new Proxy({},{get(s,n){return(r,i,d)=>{const u=e.Capacitor.Plugins[a];if(u===void 0){d(new Error(`Capacitor plugin ${a} not found`));return}if(typeof u[n]!="function"){d(new Error(`Method ${n} not found in Capacitor plugin ${a}`));return}(async()=>{try{const c=await u[n](r);i(c)}catch(c){d(c)}})()}}})}})}function Vt(e){e.CapacitorUtils.Synapse=new Proxy({},{get(t,a){return e.cordova.plugins[a]}})}function Yt(e=!1){typeof window>"u"||(window.CapacitorUtils=window.CapacitorUtils||{},window.Capacitor!==void 0&&!e?Gt(window):window.cordova!==void 0&&Vt(window))}var Ae;(function(e){e.Documents="DOCUMENTS",e.Data="DATA",e.Library="LIBRARY",e.Cache="CACHE",e.External="EXTERNAL",e.ExternalStorage="EXTERNAL_STORAGE",e.ExternalCache="EXTERNAL_CACHE",e.LibraryNoCloud="LIBRARY_NO_CLOUD",e.Temporary="TEMPORARY"})(Ae||(Ae={}));var qe;(function(e){e.UTF8="utf8",e.ASCII="ascii",e.UTF16="utf16"})(qe||(qe={}));const et=re("Filesystem",{web:()=>Be(()=>import("./web-BDuqzSqD.js"),[]).then(e=>new e.FilesystemWeb)});Yt();const Jt=re("Share",{web:()=>Be(()=>import("./web--JC3gNPW.js"),[]).then(e=>new e.ShareWeb)});class Qt{constructor(t){this.sqlite=t,this._connectionDict=new Map}async initWebStore(){try{return await this.sqlite.initWebStore(),Promise.resolve()}catch(t){return Promise.reject(t)}}async saveToStore(t){try{return await this.sqlite.saveToStore({database:t}),Promise.resolve()}catch(a){return Promise.reject(a)}}async saveToLocalDisk(t){try{return await this.sqlite.saveToLocalDisk({database:t}),Promise.resolve()}catch(a){return Promise.reject(a)}}async getFromLocalDiskToStore(t){const a=t??!0;try{return await this.sqlite.getFromLocalDiskToStore({overwrite:a}),Promise.resolve()}catch(s){return Promise.reject(s)}}async echo(t){try{const a=await this.sqlite.echo({value:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async isSecretStored(){try{const t=await this.sqlite.isSecretStored();return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async setEncryptionSecret(t){try{return await this.sqlite.setEncryptionSecret({passphrase:t}),Promise.resolve()}catch(a){return Promise.reject(a)}}async changeEncryptionSecret(t,a){try{return await this.sqlite.changeEncryptionSecret({passphrase:t,oldpassphrase:a}),Promise.resolve()}catch(s){return Promise.reject(s)}}async clearEncryptionSecret(){try{return await this.sqlite.clearEncryptionSecret(),Promise.resolve()}catch(t){return Promise.reject(t)}}async checkEncryptionSecret(t){try{const a=await this.sqlite.checkEncryptionSecret({passphrase:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async addUpgradeStatement(t,a){try{return t.endsWith(".db")&&(t=t.slice(0,-3)),await this.sqlite.addUpgradeStatement({database:t,upgrade:a}),Promise.resolve()}catch(s){return Promise.reject(s)}}async createConnection(t,a,s,n,r){try{t.endsWith(".db")&&(t=t.slice(0,-3)),await this.sqlite.createConnection({database:t,encrypted:a,mode:s,version:n,readonly:r});const i=new tt(t,r,this.sqlite),d=r?`RO_${t}`:`RW_${t}`;return this._connectionDict.set(d,i),Promise.resolve(i)}catch(i){return Promise.reject(i)}}async closeConnection(t,a){try{t.endsWith(".db")&&(t=t.slice(0,-3)),await this.sqlite.closeConnection({database:t,readonly:a});const s=a?`RO_${t}`:`RW_${t}`;return this._connectionDict.delete(s),Promise.resolve()}catch(s){return Promise.reject(s)}}async isConnection(t,a){const s={};t.endsWith(".db")&&(t=t.slice(0,-3));const n=a?`RO_${t}`:`RW_${t}`;return s.result=this._connectionDict.has(n),Promise.resolve(s)}async retrieveConnection(t,a){t.endsWith(".db")&&(t=t.slice(0,-3));const s=a?`RO_${t}`:`RW_${t}`;if(this._connectionDict.has(s)){const n=this._connectionDict.get(s);return typeof n<"u"?Promise.resolve(n):Promise.reject(`Connection ${t} is undefined`)}else return Promise.reject(`Connection ${t} does not exist`)}async getNCDatabasePath(t,a){try{const s=await this.sqlite.getNCDatabasePath({path:t,database:a});return Promise.resolve(s)}catch(s){return Promise.reject(s)}}async createNCConnection(t,a){try{await this.sqlite.createNCConnection({databasePath:t,version:a});const s=new tt(t,!0,this.sqlite),n=`RO_${t})`;return this._connectionDict.set(n,s),Promise.resolve(s)}catch(s){return Promise.reject(s)}}async closeNCConnection(t){try{await this.sqlite.closeNCConnection({databasePath:t});const a=`RO_${t})`;return this._connectionDict.delete(a),Promise.resolve()}catch(a){return Promise.reject(a)}}async isNCConnection(t){const a={},s=`RO_${t})`;return a.result=this._connectionDict.has(s),Promise.resolve(a)}async retrieveNCConnection(t){if(this._connectionDict.has(t)){const a=`RO_${t})`,s=this._connectionDict.get(a);return typeof s<"u"?Promise.resolve(s):Promise.reject(`Connection ${t} is undefined`)}else return Promise.reject(`Connection ${t} does not exist`)}async isNCDatabase(t){try{const a=await this.sqlite.isNCDatabase({databasePath:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async retrieveAllConnections(){return this._connectionDict}async closeAllConnections(){const t=new Map;try{for(const a of this._connectionDict.keys()){const s=a.substring(3),n=a.substring(0,3)==="RO_";await this.sqlite.closeConnection({database:s,readonly:n}),t.set(a,null)}for(const a of t.keys())this._connectionDict.delete(a);return Promise.resolve()}catch(a){return Promise.reject(a)}}async checkConnectionsConsistency(){try{const t=[...this._connectionDict.keys()],a=[],s=[];for(const r of t)a.push(r.substring(0,2)),s.push(r.substring(3));const n=await this.sqlite.checkConnectionsConsistency({dbNames:s,openModes:a});return n.result||(this._connectionDict=new Map),Promise.resolve(n)}catch(t){return this._connectionDict=new Map,Promise.reject(t)}}async importFromJson(t){try{const a=await this.sqlite.importFromJson({jsonstring:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async isJsonValid(t){try{const a=await this.sqlite.isJsonValid({jsonstring:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async copyFromAssets(t){const a=t??!0;try{return await this.sqlite.copyFromAssets({overwrite:a}),Promise.resolve()}catch(s){return Promise.reject(s)}}async getFromHTTPRequest(t,a){const s=a??!0;try{return await this.sqlite.getFromHTTPRequest({url:t,overwrite:s}),Promise.resolve()}catch(n){return Promise.reject(n)}}async isDatabaseEncrypted(t){t.endsWith(".db")&&(t=t.slice(0,-3));try{const a=await this.sqlite.isDatabaseEncrypted({database:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async isInConfigEncryption(){try{const t=await this.sqlite.isInConfigEncryption();return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isInConfigBiometricAuth(){try{const t=await this.sqlite.isInConfigBiometricAuth();return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isDatabase(t){t.endsWith(".db")&&(t=t.slice(0,-3));try{const a=await this.sqlite.isDatabase({database:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async getDatabaseList(){try{const a=(await this.sqlite.getDatabaseList()).values;a.sort();const s={values:a};return Promise.resolve(s)}catch(t){return Promise.reject(t)}}async getMigratableDbList(t){const a=t||"default";try{const s=await this.sqlite.getMigratableDbList({folderPath:a});return Promise.resolve(s)}catch(s){return Promise.reject(s)}}async addSQLiteSuffix(t,a){const s=t||"default",n=a||[];try{const r=await this.sqlite.addSQLiteSuffix({folderPath:s,dbNameList:n});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async deleteOldDatabases(t,a){const s=t||"default",n=a||[];try{const r=await this.sqlite.deleteOldDatabases({folderPath:s,dbNameList:n});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async moveDatabasesAndAddSuffix(t,a){const s=t||"default",n=a||[];return this.sqlite.moveDatabasesAndAddSuffix({folderPath:s,dbNameList:n})}}class tt{constructor(t,a,s){this.dbName=t,this.readonly=a,this.sqlite=s}getConnectionDBName(){return this.dbName}getConnectionReadOnly(){return this.readonly}async open(){try{return await this.sqlite.open({database:this.dbName,readonly:this.readonly}),Promise.resolve()}catch(t){return Promise.reject(t)}}async close(){try{return await this.sqlite.close({database:this.dbName,readonly:this.readonly}),Promise.resolve()}catch(t){return Promise.reject(t)}}async beginTransaction(){try{const t=await this.sqlite.beginTransaction({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async commitTransaction(){try{const t=await this.sqlite.commitTransaction({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async rollbackTransaction(){try{const t=await this.sqlite.rollbackTransaction({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isTransactionActive(){try{const t=await this.sqlite.isTransactionActive({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async loadExtension(t){try{return await this.sqlite.loadExtension({database:this.dbName,path:t,readonly:this.readonly}),Promise.resolve()}catch(a){return Promise.reject(a)}}async enableLoadExtension(t){try{return await this.sqlite.enableLoadExtension({database:this.dbName,toggle:t,readonly:this.readonly}),Promise.resolve()}catch(a){return Promise.reject(a)}}async getUrl(){try{const t=await this.sqlite.getUrl({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async getVersion(){try{const t=await this.sqlite.getVersion({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async getTableList(){try{const t=await this.sqlite.getTableList({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async execute(t,a=!0,s=!0){try{if(this.readonly)return Promise.reject("not allowed in read-only mode");{const n=await this.sqlite.execute({database:this.dbName,statements:t,transaction:a,readonly:!1,isSQL92:s});return Promise.resolve(n)}}catch(n){return Promise.reject(n)}}async query(t,a,s=!0){let n;try{return a&&a.length>0?n=await this.sqlite.query({database:this.dbName,statement:t,values:a,readonly:this.readonly,isSQL92:!0}):n=await this.sqlite.query({database:this.dbName,statement:t,values:[],readonly:this.readonly,isSQL92:s}),n=await this.reorderRows(n),Promise.resolve(n)}catch(r){return Promise.reject(r)}}async run(t,a,s=!0,n="no",r=!0){let i;try{return this.readonly?Promise.reject("not allowed in read-only mode"):(a&&a.length>0?i=await this.sqlite.run({database:this.dbName,statement:t,values:a,transaction:s,readonly:!1,returnMode:n,isSQL92:!0}):i=await this.sqlite.run({database:this.dbName,statement:t,values:[],transaction:s,readonly:!1,returnMode:n,isSQL92:r}),i.changes=await this.reorderRows(i.changes),Promise.resolve(i))}catch(d){return Promise.reject(d)}}async executeSet(t,a=!0,s="no",n=!0){let r;try{return this.readonly?Promise.reject("not allowed in read-only mode"):(r=await this.sqlite.executeSet({database:this.dbName,set:t,transaction:a,readonly:!1,returnMode:s,isSQL92:n}),r.changes=await this.reorderRows(r.changes),Promise.resolve(r))}catch(i){return Promise.reject(i)}}async isExists(){try{const t=await this.sqlite.isDBExists({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isTable(t){try{const a=await this.sqlite.isTableExists({database:this.dbName,table:t,readonly:this.readonly});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async isDBOpen(){try{const t=await this.sqlite.isDBOpen({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async delete(){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.deleteDatabase({database:this.dbName,readonly:!1}),Promise.resolve())}catch(t){return Promise.reject(t)}}async createSyncTable(){try{if(this.readonly)return Promise.reject("not allowed in read-only mode");{const t=await this.sqlite.createSyncTable({database:this.dbName,readonly:!1});return Promise.resolve(t)}}catch(t){return Promise.reject(t)}}async setSyncDate(t){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.setSyncDate({database:this.dbName,syncdate:t,readonly:!1}),Promise.resolve())}catch(a){return Promise.reject(a)}}async getSyncDate(){try{const t=await this.sqlite.getSyncDate({database:this.dbName,readonly:this.readonly});let a="";return t.syncDate>0&&(a=new Date(t.syncDate*1e3).toISOString()),Promise.resolve(a)}catch(t){return Promise.reject(t)}}async exportToJson(t,a=!1){try{const s=await this.sqlite.exportToJson({database:this.dbName,jsonexportmode:t,readonly:this.readonly,encrypted:a});return Promise.resolve(s)}catch(s){return Promise.reject(s)}}async deleteExportedRows(){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.deleteExportedRows({database:this.dbName,readonly:!1}),Promise.resolve())}catch(t){return Promise.reject(t)}}async executeTransaction(t,a=!0){let s=0,n=!1;if(this.readonly)return Promise.reject("not allowed in read-only mode");if(await this.sqlite.beginTransaction({database:this.dbName}),n=await this.sqlite.isTransactionActive({database:this.dbName}),!n)return Promise.reject("After Begin Transaction, no transaction active");try{for(const d of t){if(typeof d!="object"||!("statement"in d))throw new Error("Error a task.statement must be provided");if("values"in d&&d.values&&d.values.length>0){const u=d.statement.toUpperCase().includes("RETURNING")?"all":"no",c=await this.sqlite.run({database:this.dbName,statement:d.statement,values:d.values,transaction:!1,readonly:!1,returnMode:u,isSQL92:a});if(c.changes.changes<0)throw new Error("Error in transaction method run ");s+=c.changes.changes}else{const u=await this.sqlite.execute({database:this.dbName,statements:d.statement,transaction:!1,readonly:!1});if(u.changes.changes<0)throw new Error("Error in transaction method execute ");s+=u.changes.changes}}const r=await this.sqlite.commitTransaction({database:this.dbName});s+=r.changes.changes;const i={changes:{changes:s}};return Promise.resolve(i)}catch(r){const i=r.message?r.message:r;return await this.sqlite.rollbackTransaction({database:this.dbName}),Promise.reject(i)}}async reorderRows(t){const a=t;if(t?.values&&typeof t.values[0]=="object"&&Object.keys(t.values[0]).includes("ios_columns")){const s=t.values[0].ios_columns,n=[];for(let r=1;r<t.values.length;r++){const i=t.values[r],d={};for(const u of s)d[u]=i[u];n.push(d)}a.values=n}return Promise.resolve(a)}}const zt=re("CapacitorSQLite",{web:()=>Be(()=>import("./web-CWou6CBG.js"),[]).then(e=>new e.CapacitorSQLiteWeb),electron:()=>window.CapacitorCustomPlatform.plugins.CapacitorSQLite});function Zt(e){return e.replace(/^(add[- ]?on|additional)\s+/i,"").trim()}const ea="laba101_offline",Le="fresh_start_reset_v1",ta=new Qt(zt);let Ee=null;const G=[{id:1,name:"Laba101 Admin",email:"admin@laba101.test",password:"password",role:"admin",branch:"Main Store"},{id:2,name:"Gensan Branch Staff",email:"staff@laba101.gensan",password:"password",role:"staff",branch:"Gensan Branch"}],Ce=[],J=[V(1,"Drop-off","P185. Includes wash, dry, and fold.","Drop-Off","order",185,8,40,["Wash","Dry","Fold"],0,24),V(2,"Full Service","P200. Wash, Fabcon, detergent, dry, and fold.","Full Service","order",200,8,40,["Wash","Dry","Fold","Detergent","Fabcon"],0,24),V(3,"Self Service Wash","P60. Self-service wash (max 8kg per load).","Self Service","order",60,8,null,["Wash"],0,1),V(4,"Self Service Dry","P70. Self-service dry (40 mins).","Self Service","order",70,8,40,["Dry"],0,1),V(6,"Dry 10 mins","Additional drying time (10 mins).","Add-on","addon",30,8,10,["Dry"],0,1),V(7,"Dry 20 mins","Additional drying time (20 mins).","Add-on","addon",50,8,20,["Dry"],0,1),V(8,"Dry 40 mins","Additional drying time (40 mins).","Add-on","addon",70,8,40,["Dry"],0,1),V(9,"Additional Zonrox","Extra Zonrox bleach add-on per load.","Add-on","addon",25,0,null,["Zonrox"],0,0),V(10,"Additional Fabcon","Extra Fabcon fabric conditioner add-on per load.","Add-on","addon",25,0,null,["Fabcon"],0,0)],te=[{id:1,name:"Regular Clothes",maxKg:8,additionalFee:0,isActive:1},{id:2,name:"Comforter",maxKg:4,additionalFee:0,isActive:1},{id:3,name:"Thin Blankets",maxKg:6,additionalFee:0,isActive:1},{id:4,name:"Bedsheets",maxKg:6,additionalFee:0,isActive:1},{id:5,name:"Bath Towels",maxKg:6,additionalFee:0,isActive:1},{id:6,name:"Curtains",maxKg:6,additionalFee:0,isActive:1}];function at(e,t){const a=C(e,[]),s=new Map(a.map(r=>[r.id,r])),n=t.map(r=>{const i=s.get(r.id);return i?{...r,...i,isActive:i.isActive??r.isActive}:r});(a.length!==n.length||n.some((r,i)=>r.id!==a[i]?.id||JSON.stringify(r)!==JSON.stringify(a[i])))&&T(e,n)}async function aa(){at("services",J),at("item_categories",te)}async function Re(e){for(const t of J)((await e.query("SELECT id FROM laundry_services WHERE id = ?",[t.id])).values??[]).length>0?await e.run("UPDATE laundry_services SET name = ?, description = ?, category = ?, serviceType = ?, price = ?, maxKg = ?, dryingMinutes = ?, includes = ?, additionalCharge = ?, turnaroundHours = ?, isActive = COALESCE(isActive, ?) WHERE id = ?",[t.name,t.description,t.category,t.serviceType,t.price,t.maxKg,t.dryingMinutes,JSON.stringify(t.includes),t.additionalCharge,t.turnaroundHours,t.isActive,t.id]):await e.run("INSERT INTO laundry_services (id, name, description, category, serviceType, price, maxKg, dryingMinutes, includes, additionalCharge, turnaroundHours, isActive) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",[t.id,t.name,t.description,t.category,t.serviceType,t.price,t.maxKg,t.dryingMinutes,JSON.stringify(t.includes),t.additionalCharge,t.turnaroundHours,t.isActive]);for(const t of te)((await e.query("SELECT id FROM item_categories WHERE id = ?",[t.id])).values??[]).length>0?await e.run("UPDATE item_categories SET name = ?, maxKg = ?, additionalFee = ?, isActive = COALESCE(isActive, ?) WHERE id = ?",[t.name,t.maxKg,t.additionalFee,t.isActive,t.id]):await e.run("INSERT INTO item_categories (id, name, maxKg, additionalFee, isActive) VALUES (?, ?, ?, ?, ?)",[t.id,t.name,t.maxKg,t.additionalFee,t.isActive])}const ae=[],le=[],ne=[],de=[],ue=[],Q=[...[1,2,3,4].map(e=>({id:e,machineName:`Washer ${e}`,machineType:"washer",status:"available",branch:"Main Store"})),...[1,2,3,4].map(e=>({id:e+4,machineName:`Dryer ${e}`,machineType:"dryer",status:"available",branch:"Main Store"}))],me=[{key:"branch",value:"Main Store"},{key:"fold_rate",value:"5"},{key:"report_email",value:"admin@laba101.test"}];function V(e,t,a,s,n,r,i,d,u,c,o){return{id:e,name:t,description:a,category:s,serviceType:n,price:r,maxKg:i,dryingMinutes:d,includes:u,additionalCharge:c,turnaroundHours:o,isActive:1}}function H(e){return`laba101-mobile-${e}`}function C(e,t){const a=localStorage.getItem(H(e));if(!a)return structuredClone(t);try{return JSON.parse(a)}catch{return structuredClone(t)}}function T(e,t){localStorage.setItem(H(e),JSON.stringify(t))}function X(e){return e.reduce((t,a)=>Math.max(t,a.id),0)+1}function se(){return new Date().toISOString()}function Fe(e=new Date){const t=e.getFullYear(),a=String(e.getMonth()+1).padStart(2,"0"),s=String(e.getDate()).padStart(2,"0");return`${t}-${a}-${s}`}function sa(){return Fe().slice(2).replaceAll("-","")}function Y(e,t){if(!e)return t;try{return JSON.parse(e)}catch{return t}}async function D(){return Ee||(Ee=await ta.createConnection(ea,!1,"no-encryption",1,!1),await Ee.open()),Ee}async function M(e,t,a,s){((await e.query(`PRAGMA table_info(${t})`)).values??[]).some(i=>i.name===a)||await e.execute(`ALTER TABLE ${t} ADD COLUMN ${a} ${s}`)}function na(){const e=C("staff",G),t=new Map(e.map(s=>[s.id,s]));let a=!1;for(const s of G){const n=t.get(s.id);if(!n){t.set(s.id,{...s,isActive:1}),a=!0;continue}const r={...n,name:s.name,email:s.email,password:s.password,role:s.role,branch:s.branch,isActive:1};JSON.stringify(r)!==JSON.stringify(n)&&(t.set(s.id,r),a=!0)}a&&T("staff",Array.from(t.values()).sort((s,n)=>s.id-n.id))}async function ra(){localStorage.getItem(H(Le))||(T("staff",G),T("customers",[]),T("orders",[]),T("payments",[]),T("fold_logs",[]),T("expenses",[]),T("sales",[]),localStorage.getItem(H("services"))||T("services",J),localStorage.getItem(H("item_categories"))||T("item_categories",te),localStorage.getItem(H("machines"))||T("machines",Q),localStorage.getItem(H("subcleanings"))||T("subcleanings",[]),localStorage.getItem(H("settings"))||T("settings",me),localStorage.removeItem("laba101-mobile-session"),T(Le,!0))}async function pt(e){for(const t of G){if(((await e.query("SELECT id FROM staff WHERE id = ?",[t.id])).values??[]).length>0){await e.run("UPDATE staff SET name = ?, email = ?, password = ?, role = ?, branch = ?, isActive = 1 WHERE id = ?",[t.name,t.email,t.password,t.role,t.branch,t.id]);continue}await e.run("INSERT INTO staff (id, name, email, password, role, branch, isActive) VALUES (?, ?, ?, ?, ?, ?, ?)",[t.id,t.name,t.email,t.password,t.role,t.branch,1])}}async function ia(e){if(!(((await e.query("SELECT COUNT(*) as count FROM machines")).values?.[0]?.count??0)>0))for(const a of Q)await e.run("INSERT INTO machines (id, machineName, machineType, status, branch) VALUES (?, ?, ?, ?, ?)",[a.id,a.machineName,a.machineType,a.status,a.branch])}async function oa(e){for(const t of me)await e.run("INSERT OR IGNORE INTO settings (key, value) VALUES (?, ?)",[t.key,t.value])}async function ft(e){for(const t of J)((await e.query("SELECT id FROM laundry_services WHERE id = ?",[t.id])).values??[]).length>0||await e.run("INSERT INTO laundry_services (id, name, description, category, serviceType, price, maxKg, dryingMinutes, includes, additionalCharge, turnaroundHours, isActive) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",[t.id,t.name,t.description,t.category,t.serviceType,t.price,t.maxKg,t.dryingMinutes,JSON.stringify(t.includes),t.additionalCharge,t.turnaroundHours,t.isActive]);for(const t of te)((await e.query("SELECT id FROM item_categories WHERE id = ?",[t.id])).values??[]).length>0||await e.run("INSERT INTO item_categories (id, name, maxKg, additionalFee, isActive) VALUES (?, ?, ?, ?, ?)",[t.id,t.name,t.maxKg,t.additionalFee,t.isActive])}async function ca(e){((await e.query("SELECT value FROM settings WHERE key = ?",[Le])).values??[]).length>0||(await e.execute(`
  ...
  `}function Va(e=new Date){return{date:new Intl.DateTimeFormat("en-PH",{weekday:"long",month:"long",day:"numeric",year:"numeric"}).format(e),time:new Intl.DateTimeFormat("en-PH",{hour:"numeric",minute:"2-digit",second:"2-digit",hour12:!0}).format(e)}}function we(){const e=document.querySelector("[data-date-from]"),t=document.querySelector("[data-date-to]"),a=Array.from(document.querySelectorAll('input[name="reportType"]:checked')).map(s=>s.value).filter(s=>s==="sales"||s==="disbursement"||s==="fold_count"||s==="revolving_fund"||s==="summary");return{from:e?.value||"0000-01-01",to:t?.value||"9999-12-31",types:a.length?a:["summary"]}}function he(e,t){return e>=t.from&&e<=t.to}function Rt(e,t,a,s,n,r,i,d){const u=new Set(d.types),c=e.filter(h=>he(K(h.createdAt),d)),o=a.filter(h=>he(h.saleDate,d)),v=s.filter(h=>he(h.expenseDate,d)),f=Wa(c,r),y=new Map;t.filter(h=>he(K(h.receivedAt),d)).forEach(h=>{const q=y.get(h.orderId)??{cash:0,gcash:0};h.method==="gcash"?q.gcash+=h.amount:q.cash+=h.amount,y.set(h.orderId,q)});const N=c.reduce((h,q)=>{const _=y.get(q.id);if(_){const z=_.cash+_.gcash;if(z>q.totalAmount){const ie=q.totalAmount/z;return h+_.cash*ie}return h+_.cash}return h+q.paidAmount},0),w=o.reduce((h,q)=>h+q.cashAmount,0),g=o.reduce((h,q)=>h+q.gcashAmount,0),R=c.reduce((h,q)=>{const _=y.get(q.id);if(_){const z=_.cash+_.gcash;if(z>q.totalAmount){const ie=q.totalAmount/z;return h+_.gcash*ie}return h+_.gcash}return h+0},0),p=N+w,E=R+g,b=p+E,O=v.reduce((h,q)=>h+q.amount,0),L=O,P=b-L,x=()=>({orderCashTotal:N,orderGcashTotal:R,manualCashTotal:w,manualGcashTotal:g,totalCash:p,totalGcash:E,totalSales:b,transactions:c.map(h=>{const q=y.get(h.id)??{cash:h.paidAmount,gcash:0},_=q.cash+q.gcash;let z=q.cash,ie=q.gcash,Ge=_;if(_>h.totalAmount){const Ve=h.totalAmount/_;z=q.cash*Ve,ie=q.gcash*Ve,Ge=h.totalAmount}return{ticket:h.ticket,customer:h.customer,cash:z,gcash:ie,total:Ge}}),manualSales:o.map(h=>({cash:h.cashAmount,gcash:h.gcashAmount,total:h.totalAmount}))}),I=()=>({totalExpenses:O,totalDisbursement:L,rows:[["Date/Month","id#","Type","Name","Category","Description","Amount"],...v.map(h=>[Ct(h),h.number,ee(h),h.name,h.category??"",h.description??"",h.amount]),[],["Total Disbursement","","","","","",L]]}),k=()=>({rows:[["Staff","Fold Count"],...f.map(h=>[h.staffName,h.folds]),[],["Total Folds",f.reduce((h,q)=>h+q.folds,0)]]}),U=n.filter(h=>he(K(h.createdAt),d));return{selection:d,selectedTypes:u,salesRows:x,disbursementRows:I,foldCountRows:k,revolvingDailySummaryRows:()=>({rows:[["Date of Sales","Cash on Hand","Status","Date Update"],...o.map(h=>{const q=At(h.saleDate,e,s,h.cashAmount),_=h.status==="revolving"?"Revolving":h.status==="endorsed"?`Endorsed to ${h.endorsedTo??""}`:"Pending";return[h.saleDate,q,_,h.statusUpdatedAt?K(h.statusUpdatedAt):""]})]}),revolvingHistoryRows:()=>({rows:[["Date","Number","Name","Amount","Category","Description","Type"],...U.map(h=>[K(h.createdAt),h.revolvingNumber,h.name,h.type==="disbursement"?-h.amount:h.amount,h.category,h.description??"",h.type==="add"?"Add Revolving Fund":"Disbursement"])]}),summaryRows:()=>{const h=x(),q=I();return[["Summary",d.from,"to",d.to],[],["Total Cash:","Total GCash:","Total Sales:"],["","",""],[h.totalCash,h.totalGcash,h.totalSales],["","",""],["Total Disbursement:","Total Profit:","Cash on Hand:"],["","",""],[q.totalDisbursement,P,xe(h.totalCash,q.totalDisbursement)]]},profit:P}}function Ya(e,t){return`<button class="nav-link ${t?"is-active":""}" data-tab="${e}" type="button">
    <span class="nav-icon">${Ja(e)}</span>
    <span>${We[e]}</span>
  </button>`}function F(e,t){return`<div class="section-head"><div><h2>${m(e)}</h2><p class="meta">${m(t)}</p></div></div>`}function lt(){return We[l.tab]??"Dashboard"}function Pe(e){return(e?.name??"Laba101").trim().slice(0,1).toUpperCase()}function Ja(e){return{dashboard:"DB",pos:"POS",orders:"PO",archived:"AR",customers:"CU",pricing:"PS",disbursements:"DR",reports:"RP",inventory:"IN",maintenance:"MT",staff:"ST",revolving:"RV",settings:"SE"}[e]}async function xt(){const e=await pe(),t=await va(e),a=await gt(),s=await fa(),n=await je(),r=await ha(),i=await Et(),d=await fe(e),u=await wa(),c=await Aa(),o=await Ca(),v=await Pa(),f=await Nt(e),y=await Ua(e),N=await Fa(),w=await ma(),g=await ht("report_email");return{branch:e,staff:t,allStaff:a,customers:s,services:n,allServices:r,categories:i,orders:d,payments:u,foldLogs:c,expenses:o,sales:v,machines:f,subcleanings:y,revolvingHistory:N,foldRate:w,reportEmail:g??""}}async function S(){if(!l.currentUser){Qa(),hs();return}const e=await xt();e.orders.filter(u=>u.status!=="claimed").length,e.orders.filter(u=>u.status==="ready").length,e.orders.reduce((u,c)=>u+c.paidAmount,0);const t=W(),a=$t(e.payments,e.orders,u=>u.branch===e.branch&&K(u.receivedAt)===t),s=a.gcash+e.sales.filter(u=>u.saleDate===t).reduce((u,c)=>u+c.gcashAmount,0),n=a.cash+e.sales.filter(u=>u.saleDate===t).reduce((u,c)=>u+c.cashAmount,0),r=n+s,i=e.expenses.filter(u=>ee(u)==="daily"&&u.expenseDate===t).reduce((u,c)=>u+c.amount,0),d=xe(n,i);e.sales.reduce((u,c)=>u+c.totalAmount,0),e.expenses.reduce((u,c)=>u+c.amount,0),He.innerHTML=`
    <div class="app-frame">
      <header class="topbar">
      ...
      <aside class="sidebar ${l.sidebarOpen?"is-open":""}">
        ...
        <nav>${Dt().map(u=>Ya(u,l.tab===u)).join("")}</nav>
        ...
        <div class="sidebar-user">
          <span class="avatar">${Pe(l.currentUser)}</span>
          <div>
            <strong>${m(l.currentUser.name)}</strong>
      ...
      <main class="workspace">
        <header class="mobile-topbar">
          ...
          <button class="mobile-avatar" type="button">${Pe(l.currentUser)}</button>
        </header>

        ${l.tab==="dashboard"?Za({paidToday:r,cashPaidToday:n,gcashPaidToday:s,disbursementToday:i,cashOnHandToday:d,orders:e.orders,payments:e.payments,sales:e.sales}):""}
        ${l.tab==="pos"?es(e.orders,e.customers,e.services,e.categories,e.payments,e.branch):""}
        ${l.tab==="orders"?ts(e.orders,e.staff,e.services,e.payments):""}
        ${l.tab==="archived"?as(e.orders,e.staff,e.services,e.payments):""}
        ${l.tab==="customers"?cs(e.customers,e.orders):""}
        ${l.tab==="pricing"?ls(e.allServices,e.categories):""}
        ${l.tab==="disbursements"?ds(e.expenses,e.sales):""}
        ${l.tab==="reports"?us(e.orders,e.payments,e.sales,e.expenses,e.revolvingHistory,e.allStaff,e.foldRate):""}
        ${l.tab==="inventory"?ms(e.services,e.categories):""}
        ${l.tab==="maintenance"?vs(e.machines,e.subcleanings,e.branch):""}
        ${l.tab==="staff"?ps(e.allStaff,e.branch):""}
        ${l.tab==="revolving"?Rs(e.sales,e.revolvingHistory,e.orders,e.expenses):""}
        ${l.tab==="settings"?fs(e.branch,e.foldRate,e.reportEmail):""}
      </main>
    </div>
  `,ys(),bs(e),Es(e.allServices),Ss(e.expenses),ws(e.orders,e.payments,e.sales,e.expenses,e.revolvingHistory,e.foldRate),Ts(),Ns(),As(),Ls(e.allStaff),xs(),Cs(),gs()}function Dt(){if(l.currentUser?.role==="admin")return Object.keys(We).filter(t=>t!=="inventory");const e=["dashboard","pos","orders","archived","disbursements","reports","maintenance","revolving"];return Ka(l.currentUser)?["dashboard","disbursements","reports","maintenance","revolving"]:Ga(l.currentUser)?e.filter(t=>t!=="revolving"):e}function Qa(){He.innerHTML=`
      ...
      <article class="panel revenue-panel">
        ...
        <div class="stats compact dashboard-stats">
          <div class="stat paid-today-stat">
            ...
            <div class="value">${A(e.paidToday)}</div>
            <div class="stat-breakdown"><span>Cash ${A(e.cashPaidToday)}</span><span>GCash ${A(e.gcashPaidToday)}</span></div>
          </div>
          <div class="stat"><span class="card-label">Disbursement</span><div class="value">${A(e.disbursementToday)}</div></div>
          <div class="stat"><span class="card-label">Cash on Hand</span><div class="value">${A(e.cashOnHandToday)}</div></div>
        </div>
        <div class="chart-shell">
          <div class="mini-chart revenue-chart">
            ${s.map((i,d)=>{const u=Math.max(12,Math.round(i/n*r));return`<div class="chart-bar ${d===s.length-1?"is-today":""}"><span style="height:${u}px"></span><strong>${A(i)}</strong></div>`}).join("")}
          </div>
  ...
  `}function es(e,t,a,s,n,r){const i=a.filter(c=>c.serviceType==="order"&&c.isActive),d=a.filter(c=>c.serviceType==="addon"&&c.isActive),u=l.receiptOrderId?e.find(c=>c.id===l.receiptOrderId):null;return`
    <section class="grid content full">
        ...
        <form id="order-form" class="form">
          ...
          <fieldset class="check-grid">
            ...
            ${d.length?d.map(c=>`<div class="qty-card addon-quantity" data-qty-card="addonQty-${c.id}">
              <span><strong>${m(Z(c.name))}</strong><small>${A(c.price)} each</small></span>
              <div class="qty-control">
      ...
      ${u?Ke(u,n.filter(c=>c.orderId===u.id)):""}
    </section>
  `}function ts(e,t,a,s){const n=l.receiptOrderId?e.find(o=>o.id===l.receiptOrderId):null,r=e.filter(o=>o.status!=="claimed"),i=l.orderSearch.trim().toLowerCase(),d=l.orderDateFilter.trim(),u=l.orderPaymentFilter.trim().toLowerCase(),c=r.filter(o=>{const v=!i||[o.ticket,o.customer,o.phone,o.service,o.itemCategory,o.status].some(N=>String(N??"").toLowerCase().includes(i)),f=!d||K(o.createdAt)===d,y=!u||Xe(o)===u;return v&&f&&y});return`
    <section class="grid content full">
      <article class="panel span-2">
      ...
      ${l.paymentModalOrderId?ss(e.find(o=>o.id===l.paymentModalOrderId)):""}
    </section>
  `}function as(e,t,a,s){const n=e.filter(u=>u.status==="claimed"),r=l.archivedOrderSearch.trim().toLowerCase(),i=n.filter(u=>r?[u.ticket,u.customer,u.phone,u.service,u.itemCategory].some(c=>String(c??"").toLowerCase().includes(r)):!0),d=l.receiptOrderId?e.find(u=>u.id===l.receiptOrderId):null;return`
    <section class="grid content full">
      <article class="panel span-2">
  ...
  `}function Ot(e,t,a){const s=St(),n=e.workflowCompleted.includes("fold"),r=e.workflowCompleted.includes("claimed"),i=s.find(N=>!e.workflowCompleted.includes(N.key)),d=i?.key==="fold",u=Xe(e),c=e.extras.length?e.extras.map(N=>`${m(Z(N.name))} x${Number(N.quantity??1)}`).join(", "):"",o=l.currentUser?.role==="admin",v=e.status!=="claimed"&&e.paidAmount<=0,f=e.status!=="claimed"&&o&&e.paidAmount>0;let y=1;if(e.serviceLines){let N=0;e.serviceLines.forEach(w=>{const g=a.find(R=>R.id===w.id);g&&Array.isArray(g.includes)&&g.includes.includes("Fold")&&(N+=w.quantity)}),N>0&&(y=N)}return`
    <tr class="order-row-main">
      ...
      <td class="amount-cell"><strong>${A(e.totalAmount)}</strong><div class="small ${u==="paid"?"ok":u==="partial"?"warn":"meta"}">${m(u)} &middot; Bal: ${A(e.balance)}</div></td>
      <td>
      <div class="row-actions">
        ${n?r?"":`<form class="inline-form advance-form" data-order-id="${e.id}" data-action="claim" data-balance="${e.balance}">
          ...
          ${d?Array.from({length:y}).map((N,w)=>`<select name="assignedStaffId" required>
            <option value="">-- Staff ${y>1?`(Fold ${w+1})`:""}--</option>
      ...
      <td colspan="5">
        <div class="order-detail-row">
          ...
          <div class="workflow-progress order-workflow-progress">
            ${s.map(N=>`<span class="${e.workflowCompleted.includes(N.key)?"is-done":i?.key===N.key?"is-next":""}">${m(N.label)}</span>`).join("")}
          </div>
        </div>
      </td>
    </tr>
    ...
    <div class="modal-backdrop" role="presentation">
      <div class="receipt-modal" role="dialog" aria-modal="true" aria-labelledby="payment-title">
        ...
        <div class="receipt" style="border: 1px solid var(--line); border-style: solid; box-shadow: none;">
          ...
          <p>Please settle the remaining balance of <strong>${A(e.balance)}</strong> for ticket <strong>${m(e.ticket)}</strong> before claiming.</p>
      ...
      <div class="receipt-modal" role="dialog" aria-modal="true" aria-labelledby="receipt-title">
        ...
        <div class="receipt" id="receipt-print-area">
          ...
          <div class="summary-list receipt-lines">
            ...
            ${e.extras.length?`<div><span>Extra services</span><strong>${e.extras.map(i=>`${m(Z(i.name))} x${Number(i.quantity??1)} (${A(Number(i.total??i.price))})`).join(", ")}</strong></div>`:""}
            <div><span>Total</span><strong>${A(e.totalAmount)}</strong></div>
            <div><span>Tendered</span><strong>${A(a)}</strong></div>
            <div><span>Paid</span><strong>${A(e.paidAmount)}</strong></div>
            <div><span>Payment status</span><strong>${r}</strong></div>
            <div><span>Change</span><strong>${A(s)}</strong></div>
            <div><span>Balance</span><strong>${A(e.balance)}</strong></div>
          </div>
          <h3>Payments</h3>
          <div class="receipt-payments">
            ${t.map(i=>`<div><span>${m(i.method.toUpperCase())}</span><strong>${A(i.amount)}</strong>${i.reference?`<small>Ref ${m(i.reference)}</small>`:""}</div>`).join("")||'<p class="helper">No payments yet.</p>'}
          </div>
        </div>
      </div>
    </div>
  ...
  `}async function dt(){l.printerLoading=!0,l.printerError="",l.printerStatus="",await S();try{if(!(await ve.requestBluetoothPermissions()).granted)throw new Error("Bluetooth permission was not granted.");const t=await ve.listPairedPrinters();l.pairedPrinters=t.printers??[],l.selectedPrinterAddress=l.selectedPrinterAddress||t.savedAddress||l.pairedPrinters[0]?.address||"",l.printerStatus=l.pairedPrinters.length?"Select a printer, then connect.":"No paired printers found. Pair the printer in Android Bluetooth settings first."}catch(e){l.printerError=e instanceof Error?e.message:"Could not scan paired printers."}finally{l.printerLoading=!1,await S()}}async function rs(){if(!l.selectedPrinterAddress){l.printerError="Select a paired printer first.",await S();return}l.printerLoading=!0,l.printerError="",l.printerStatus="",await S();try{await ve.savePrinter({address:l.selectedPrinterAddress}),await ve.connect({address:l.selectedPrinterAddress}),l.printerStatus="Printer connected and saved."}catch(e){l.printerError=e instanceof Error?e.message:"Printer connection failed."}finally{l.printerLoading=!1,await S()}}function is(e){const t=(e.serviceLines?.length?e.serviceLines:[{id:e.serviceId,name:e.service,price:e.price,quantity:1,total:e.price}]).map(s=>({name:s.name,quantity:Number(s.quantity||1),price:Number(s.price||0)})),a=e.extras.map(s=>({name:Z(s.name),quantity:Number(s.quantity??1),price:Number(s.price||0)}));return[...t,...a]}async function os(e,t){const a=t.reduce((n,r)=>n+Number(r.amount),0),s=Math.max(0,Number((a-e.totalAmount).toFixed(2)));l.printerLoading=!0,l.printerError="",l.printerStatus="",await S();try{if(!l.selectedPrinterAddress){const n=await ve.getSavedPrinter();l.selectedPrinterAddress=n.address||""}await ve.printReceipt({address:l.selectedPrinterAddress||void 0,paperWidth:l.printerPaperWidth,storeName:"Laba101",receiptNumber:e.ticket,dateTime:oe(e.createdAt),customerName:e.customer,customerPhone:e.phone?.trim()||"No phone",items:is(e),totalAmount:e.totalAmount,paidAmount:e.paidAmount,changeAmount:s,balanceAmount:e.balance,staffName:l.currentUser?.name?.trim()||"Staff"}),l.printerStatus="Receipt sent to printer."}catch(n){l.printerPanelOpen=!0,l.printerError=n instanceof Error?n.message:"Bluetooth thermal print failed."}finally{l.printerLoading=!1,await S()}}function cs(e,t){const a=l.customerSearch.trim().toLowerCase(),s=e.filter(n=>a?n.name.toLowerCase().includes(a):!1);return`
    <section class="grid content full">
      <article class="panel">
      ...
      <article class="panel span-2">
        ...
        <div class="table-scroll">
          <div class="table data-table extra-services-table">
            ...
            ${s.map(n=>`<div class="table-row"><div><strong>${m(n.name)}</strong></div><div>${m(n.category)}</div><div>${A(n.price)}</div><div>${m(n.includes.join(", ")||"none")}</div><div>${n.isActive?"Active":"Inactive"}</div><div class="row-actions"><button class="secondary edit-service-btn" data-id="${n.id}">Edit</button>${n.isActive?`<button class="secondary deactivate-service-btn" data-id="${n.id}">Deactivate</button>`:`<button class="secondary activate-service-btn" data-id="${n.id}">Activate</button>`}</div></div>`).join("")||'<div class="helper">No extra services yet.</div>'}
          </div>
        </div>
      </article>
    </section>
  `}function ds(e,t){const a=W(),s=a.slice(0,7),n=l.currentUser?.role==="admin",r=Array.from(new Set([...Ha,...e.map(o=>o.category).filter(Boolean)])),i=e.filter(o=>ee(o)==="daily"&&o.expenseDate===a).reduce((o,v)=>o+v.amount,0),d=e.filter(o=>ee(o)==="monthly"&&o.expenseDate.startsWith(s)).reduce((o,v)=>o+v.amount,0),u=t.filter(o=>o.saleDate===a).reduce((o,v)=>o+v.totalAmount,0),c=t.filter(o=>o.saleDate.startsWith(s)).reduce((o,v)=>o+v.totalAmount,0);return`
    ...
    <section class="grid stats compact report-stats">
      <div class="panel stat"><div class="card-label">Daily disbursement</div><div class="value">${A(i)}</div></div>
      <div class="panel stat"><div class="card-label">Monthly disbursement</div><div class="value">${A(d)}</div></div>
      <div class="panel stat"><div class="card-label">Today sales input</div><div class="value">${A(u)}</div></div>
      <div class="panel stat"><div class="card-label">Month sales input</div><div class="value">${A(c)}</div></div>
    </section>
      ...
      <article class="panel">
        ...
        <div class="table-scroll daily-report-scroll">
          <div class="table wide-table daily-report-table">
            ...
            ${t.map(o=>`<div class="table-row"><div>${m(o.saleNumber)}</div><div>${m(o.saleDate)}</div><div>${A(o.cashAmount)}</div><div>${A(o.gcashAmount)}</div><div><strong>${A(o.totalAmount)}</strong></div><div class="row-actions"><button class="secondary edit-sale-btn" data-id="${o.id}" type="button">Edit</button>${n?`<button class="secondary delete-sale-btn" data-id="${o.id}" type="button">Delete</button>`:""}</div></div>`).join("")||'<div class="helper">No daily sales totals yet.</div>'}
          </div>
        </div>
      </article>
    </section>
    `}
  `}function us(e,t,a,s,n,r,i,d,u,c){const o=l.reportPreview?Rt(e,t,a,s,n,r,i,l.reportPreview):null;return`
    <section class="page-head">
      <div>
        ...
        ${o.selectedTypes.has("sales")?`
          <article>
            ...
            <div class="table wide-table report-preview-table sales-table">
              ...
              ${o.salesRows().transactions.map(v=>`<div class="table-row report-table-row"><div>${m(v.ticket)}</div><div>${m(v.customer)}</div><div>${A(v.cash)}</div><div>${A(v.gcash)}</div><div>${A(v.total)}</div></div>`).join("")}
            </div>
            <div class="sales-summary-section">
              ...
              <div class="table sales-summary-table">
                ...
                <div class="table-row"><div>Orders</div><div>${A(o.salesRows().orderCashTotal)}</div><div>${A(o.salesRows().orderGcashTotal)}</div><div>${A(o.salesRows().orderCashTotal+o.salesRows().orderGcashTotal)}</div></div>
                <div class="table-row"><div>Whole Sale Day</div><div>${A(o.salesRows().manualCashTotal)}</div><div>${A(o.salesRows().manualGcashTotal)}</div><div>${A(o.salesRows().manualCashTotal+o.salesRows().manualGcashTotal)}</div></div>
                <div class="table-row total-row"><div>Total</div><div>${A(o.salesRows().totalCash)}</div><div>${A(o.salesRows().totalGcash)}</div><div>${A(o.salesRows().totalSales)}</div></div>
              </div>
            </div>
          </article>`:""}
        ${o.selectedTypes.has("disbursement")?`
          <article>
            ...
            <div class="table wide-table report-preview-table report-disbursement-table">
              ...
              ${o.disbursementRows().rows.slice(1).filter(v=>v.length&&v[0]!=="Total Disbursement").map(v=>`<div class="table-row report-table-row"><div>${m(v[1]??"")}</div><div>${m(v[0]??"")}</div><div>${m(v[2]??"")}</div><div>${m(v[3]??"")}</div><div>${m(v[4]??"")}</div><div>${A(v[6])}</div></div>`).join("")}
            </div>
            <div class="disbursement-total">
              <strong>Total Disbursement: ${A(o.disbursementRows().totalDisbursement)}</strong>
            </div>
          </article>`:""}
        ${o.selectedTypes.has("fold_count")?`
          <article>
            ...
            <div class="table report-preview-table">
              ...
              ${o.foldCountRows().rows.slice(1).map(v=>`<div class="table-row">${v.map(f=>`<div>${m(f??"")}</div>`).join("")}</div>`).join("")}
            </div>
          </article>`:""}
        ...
        ${o.selectedTypes.has("summary")?`
          <article>
            ...
            <div class="summary-cards-grid summary-single-row">
              <div class="summary-card"><span class="card-label">Total Sales</span><div class="card-details"><span>Total Cash: ${A(o.salesRows().totalCash)}</span><span>Total GCash: ${A(o.salesRows().totalGcash)}</span></div><strong>${A(o.salesRows().totalSales)}</strong></div>
              <div class="summary-card"><span class="card-label">Total Disbursement</span><strong>${A(o.disbursementRows().totalDisbursement)}</strong></div>
              <div class="summary-card"><span class="card-label">Cash on Hand</span><strong>${A(xe(o.salesRows().totalCash,o.disbursementRows().totalDisbursement))}</strong></div>
            </div>
          </article>`:""}
      </section>
    `:""}
    ...
    <section class="grid content full">
      ...
      <article class="panel">
        ...
        <div class="table">
          ...
          ${e.map(a=>`<div class="table-row"><div><strong>${m(a.name)}</strong></div><div>${m(a.category)}</div><div>${A(a.price)}</div><div>${a.maxKg} kg</div><div>${a.isActive?"Active":"Inactive"}</div></div>`).join("")}
        </div>
      </article>
    </section>
  `}function vs(e,t,a){const s=e.filter(r=>r.status!=="under_cleaning"),n=e.filter(r=>r.status==="under_cleaning");return`
    <section class="page-head">
      ...
      <div class="segmented">
        <button class="${l.maintenanceTab==="cleaning"?"is-active":""}" data-maintenance-tab="cleaning" type="button">Subcleaning</button>
  ...
  `}function ys(){const e=()=>{localStorage.removeItem(ge),l.currentUser=null,l.tab="dashboard",l.receiptOrderId=0,l.sidebarOpen=!1,S()};document.querySelector("#logout-button")?.addEventListener("click",e),document.querySelector("#mobile-logout-button")?.addEventListener("click",e),document.querySelector("#mobile-menu-button")?.addEventListener("click",()=>{l.sidebarOpen=!0,S()}),document.querySelector("#sidebar-close-button")?.addEventListener("click",()=>{l.sidebarOpen=!1,S()}),document.querySelector("#sidebar-backdrop")?.addEventListener("click",()=>{l.sidebarOpen=!1,S()}),document.querySelectorAll("[data-tab]").forEach(t=>{t.addEventListener("click",()=>{l.tab=t.dataset.tab,l.receiptOrderId=0,l.sidebarOpen=!1,S()})}),document.querySelectorAll("[data-quick-tab]").forEach(t=>{t.addEventListener("click",()=>{l.tab=t.dataset.quickTab,S()})}),document.querySelectorAll("[data-receipt]").forEach(t=>{t.addEventListener("click",()=>{l.receiptOrderId=Number(t.dataset.receipt),l.printerPanelOpen=!1,l.printerError="",l.printerStatus="",S()})}),document.querySelector("[data-close-receipt]")?.addEventListener("click",()=>{l.receiptOrderId=0,S()}),document.querySelector("[data-open-printer-panel]")?.addEventListener("click",()=>{l.printerPanelOpen=!l.printerPanelOpen,l.printerPanelOpen&&l.pairedPrinters.length===0?dt():S()}),document.querySelector("[data-refresh-printers]")?.addEventListener("click",()=>{dt()}),document.querySelector("[data-printer-select]")?.addEventListener("change",t=>{l.selectedPrinterAddress=t.currentTarget.value,S()}),document.querySelector("[data-paper-width]")?.addEventListener("change",t=>{l.printerPaperWidth=Number(t.currentTarget.value)===80?80:58,S()}),document.querySelector("[data-connect-printer]")?.addEventListener("click",()=>{rs()}),document.querySelector("[data-thermal-print]")?.addEventListener("click",()=>{(async()=>{const t=await xt(),a=t.orders.find(n=>n.id===l.receiptOrderId);if(!a)throw new Error("Receipt order not found.");const s=t.payments.filter(n=>n.orderId===a.id);await os(a,s)})().catch(t=>{l.printerPanelOpen=!0,l.printerError=t instanceof Error?t.message:"Bluetooth thermal print failed.",S()})}),document.querySelectorAll("[data-report-tab]").forEach(t=>{t.addEventListener("click",()=>{l.dailyReportTab=t.dataset.reportTab,S()})}),document.querySelectorAll("[data-maintenance-tab]").forEach(t=>{t.addEventListener("click",()=>{l.maintenanceTab=t.dataset.maintenanceTab,S()})})}function hs(){za(),document.querySelector("#login-form")?.addEventListener("submit",async e=>{e.preventDefault();const t=new FormData(e.currentTarget),a=document.querySelector("#login-button");a&&(a.disabled=!0,a.textContent="Signing in...");try{const s=await bt(String(t.get("email")??""),String(t.get("password")??""));if(!s){l.loginError="Invalid email or password.",await S();return}l.currentUser=s,l.loginError="",await Te("branch",String(s.branch||"Main Store")),t.get("remember")?localStorage.setItem(ge,JSON.stringify({email:s.email,remembered:!0})):localStorage.removeItem(ge),Dt().includes(l.tab)||(l.tab="dashboard"),await S()}catch(s){alert("Login Error: "+String(s?.message||s)),a&&(a.disabled=!1,a.textContent="Sign in")}})}function gs(){Se&&window.clearInterval(Se);const e=document.querySelector("[data-navbar-time]"),t=document.querySelector("[data-navbar-date]");if(!e||!t){Se=void 0;return}const a=()=>{const s=Va();e.textContent=s.time,t.textContent=s.date};a(),Se=window.setInterval(a,1e3)}function ut(e,t){return e?t.find(a=>a.name.toLowerCase()===e.category.toLowerCase())??t.find(a=>a.name==="Regular Clothes")??t[0]??null:null}function Ie(e,t){return Math.max(1,Number(t.maxKg||e.maxKg||1))}function Pt(e,t){return Object.fromEntries(t.filter(a=>a.serviceType==="order").map(a=>[a.id,Number(e.querySelector(`input[name="serviceQty-${a.id}"]`)?.value??0)]).filter(([,a])=>Number(a)>0))}function mt(e,t){const a=Pt(e,t);return t.filter(s=>s.serviceType==="order"&&Number(a[s.id]??0)>0).map(s=>({...s,quantity:Number(a[s.id])}))}function It(e,t){return Object.fromEntries(t.filter(a=>a.serviceType==="addon").map(a=>[a.id,Number(e.querySelector(`input[name="addonQty-${a.id}"]`)?.value??0)]).filter(([,a])=>Number(a)>0))}function vt(e,t){const a=It(e,t);return t.filter(s=>s.serviceType==="addon"&&Number(a[s.id]??0)>0).map(s=>({...s,quantity:Number(a[s.id])}))}function bs(e){const t=document.querySelector("#order-form"),a=document.querySelector("#price-preview"),s=t?.querySelector('button[type="submit"]'),n=document.querySelector("#customer-name-input"),r=document.querySelector("#customer-id-input"),i=document.querySelector("#customer-phone-input"),d=document.querySelector("#customer-suggestions"),u=t?.querySelector("[data-order-error]"),c=t?.querySelector('select[name="paymentMethod"]'),o=t?.querySelector(".gcash-reference"),v=t?.querySelector('input[name="paymentReference"]');let f=!1,y;const N=p=>{if(!d||!n)return;const E=p.trim().toLowerCase();if(!E){d.hidden=!0;return}const b=e.customers.filter(P=>P.name.toLowerCase().includes(E)||(P.phone??"").includes(E)).slice(0,8),O=`<div class="ac-item ac-add" data-ac-new="true"><strong>+ Add new: "${m(p.trim())}"</strong></div>`,L=b.map(P=>`<div class="ac-item" data-ac-id="${P.id}" data-ac-name="${m(P.name)}" data-ac-phone="${m(P.phone??"")}"><strong>${m(P.name)}</strong>${P.phone?`<span>${m(P.phone)}</span>`:""}</div>`).join("");d.innerHTML=L+O,d.hidden=!1};n?.addEventListener("input",()=>{r&&(r.value=""),clearTimeout(y),y=window.setTimeout(()=>N(n.value),150)}),n?.addEventListener("focus",()=>{n.value.trim()&&N(n.value)}),d?.addEventListener("click",p=>{const E=p.target.closest(".ac-item");E&&(E.dataset.acNew==="true"?r&&(r.value=""):(n&&(n.value=E.dataset.acName??""),i&&(i.value=E.dataset.acPhone??""),r&&(r.value=E.dataset.acId??"")),d&&(d.hidden=!0))}),document.addEventListener("click",p=>{d&&!d.contains(p.target)&&p.target!==n&&(d.hidden=!0)});const w=()=>{const p=c?.value==="gcash";o&&(o.hidden=!p),v&&(v.required=p,p||(v.value=""))},g=(p,E)=>{if(!t)return;const b=t.querySelector(`input[name="${p}"]`);b&&(b.value=String(Math.max(0,Number(b.value||0)+E)),b.closest(".qty-card")?.classList.toggle("is-selected",Number(b.value)>0),b.dispatchEvent(new Event("input",{bubbles:!0})))};t?.querySelectorAll(".qty-control input").forEach(p=>{p.addEventListener("input",()=>{p.value=String(Math.max(0,Number(p.value||0))),p.closest(".qty-card")?.classList.toggle("is-selected",Number(p.value)>0)})}),t?.querySelectorAll("[data-qty-card]").forEach(p=>{p.addEventListener("click",E=>{const b=E.target;b.closest("input")||b.closest("button")||g(p.dataset.qtyCard??"",1)})}),t?.querySelectorAll("[data-qty-plus]").forEach(p=>{p.addEventListener("click",()=>g(p.dataset.qtyPlus??"",1))}),t?.querySelectorAll("[data-qty-minus]").forEach(p=>{p.addEventListener("click",()=>g(p.dataset.qtyMinus??"",-1))});const R=()=>{if(!t||!a)return;const p=mt(t,e.services),E=p[0],b=ut(E,e.categories),O=vt(t,e.services),L=p.length>0&&E&&b,P=O.length>0;if(!L&&!P){s&&(s.disabled=!0),u&&(u.hidden=!f,u.textContent=f?"Please select at least one service or extra service.":""),a.innerHTML='<div class="preview-total"><span>Total amount</span><strong>PHP 0.00</strong></div>';return}if(L){const x=Ne(p,b,Ie(E,b),O),I=x.serviceLines.map(U=>`${U.name} x${U.quantity}`),k=x.extras.map(U=>`${Z(U.name)} x${U.quantity}`);s&&(s.disabled=!1),u&&(u.hidden=!0,u.textContent=""),a.classList.remove("has-error"),a.innerHTML=`
        <div class="preview-line"><span>Services${I.length?` (${m(I.join(", "))})`:""}</span><strong>${A(x.price)}</strong></div>
        ${x.extraServiceAmount>0?`<div class="preview-line"><span>Extra services${k.length?` (${m(k.join(", "))})`:""}</span><strong>${A(x.extraServiceAmount)}</strong></div>`:""}
        <div class="preview-total"><span>Total amount</span><strong>${A(x.totalAmount)}</strong></div>
      `}else{const x=O.reduce((k,U)=>k+U.price*(U.quantity??1),0),I=O.map(k=>`${Z(k.name)} x${k.quantity??1}`);s&&(s.disabled=!1),u&&(u.hidden=!0,u.textContent=""),a.classList.remove("has-error"),a.innerHTML=`
        <div class="preview-line"><span>Extra services (${m(I.join(", "))})</span><strong>${A(x)}</strong></div>
        <div class="preview-total"><span>Total amount</span><strong>${A(x)}</strong></div>
      `}};c?.addEventListener("change",w),w(),t?.addEventListener("input",R),t?.addEventListener("change",R),R(),t?.addEventListener("submit",async p=>{p.preventDefault(),f=!0;const E=new FormData(t),b=mt(t,e.services),O=b[0],L=ut(O,e.categories),P=vt(t,e.services),x=b.length>0&&O&&L,I=P.length>0;if(!x&&!I){u&&(u.hidden=!1,u.textContent="Please select at least one service or extra service.");return}const k=b.map(B=>`${B.name} x${B.quantity}`).join(", "),U=x?Ne(b,L,Ie(O,L),P):Ne([],e.categories[0],1,P);if(confirm(`Save this order?

Services: ${k}
Total: ${A(U.totalAmount)}`))try{const B=await Ea({customerId:Number(E.get("customerId"))||void 0,customerName:String(E.get("customerName")??""),customerPhone:String(E.get("customerPhone")??"")||null,serviceQuantities:Pt(t,e.services),branch:e.branch,itemCategoryId:L?.id??e.categories[0].id,weightKg:O&&L?Ie(O,L):1,addonQuantities:It(t,e.services),paidAmount:Number(E.get("paidAmount")??0),paymentMethod:String(E.get("paymentMethod")??"cash"),paymentReference:String(E.get("paymentReference")??"")||null,notes:String(E.get("notes")??"")||null});l.receiptOrderId=B.id,await S()}catch(B){u&&(u.hidden=!1,u.textContent=B instanceof Error?B.message:"Order could not be saved.")}}),document.querySelectorAll(".advance-form").forEach(p=>{p.addEventListener("submit",async E=>{E.preventDefault();const b=Number(p.dataset.orderId),O=p.dataset.action==="claim",L=Number(p.dataset.balance||0);if(O&&L>0){l.paymentModalOrderId=b,await S();return}const x=new FormData(p).getAll("assignedStaffId").map(Number).filter(k=>k>0),I=x.length>0?x:null;await rt(b,I),await S()})}),document.querySelectorAll(".claim-payment-form").forEach(p=>{const E=p.querySelector('select[name="method"]'),b=p.querySelector('input[name="reference"]'),O=()=>{const L=E?.value==="gcash";b&&(b.closest("label").hidden=!L,b.required=L,L||(b.value=""))};E?.addEventListener("change",O),O(),p.addEventListener("submit",async L=>{L.preventDefault();const P=new FormData(p),x=Number(P.get("amount"));if(x<=0)return;const I=Number(p.dataset.orderId);await ke(I,{amount:x,method:String(P.get("method")),reference:String(P.get("reference")??"")||null}),await rt(I,null),l.paymentModalOrderId=0,await S()})}),document.querySelectorAll("[data-close-payment-modal]").forEach(p=>{p.addEventListener("click",async()=>{l.paymentModalOrderId=0,await S()})}),document.querySelectorAll(".payment-form").forEach(p=>{const E=p.querySelector('select[name="method"]'),b=p.querySelector('input[name="reference"]'),O=()=>{const L=E?.value==="gcash";b&&(b.hidden=!L,b.required=L,L||(b.value=""))};E?.addEventListener("change",O),O(),p.addEventListener("submit",async L=>{L.preventDefault();const P=new FormData(p),x=Number(P.get("amount")),I=String(P.get("method")),k=String(P.get("reference")??"")||null;confirm(`Confirm payment of ${A(x)} via ${I.toUpperCase()}?`)&&(await ke(Number(p.dataset.orderId),{amount:x,method:I,reference:k}),await S())})}),document.querySelectorAll("[data-cancel-order]").forEach(p=>{p.addEventListener("click",async()=>{const E=Number(p.dataset.cancelOrder);if(Number.isFinite(E)&&confirm("Cancel this order? (No payment will be refunded.)"))try{l.receiptOrderId===E&&(l.receiptOrderId=0),await Ta(E),await S()}catch(b){alert(b instanceof Error?b.message:"Cancel failed.")}})}),document.querySelectorAll("[data-delete-order]").forEach(p=>{p.addEventListener("click",async()=>{const E=Number(p.dataset.deleteOrder);if(Number.isFinite(E)&&confirm("Delete this paid order and update sales?"))try{l.receiptOrderId===E&&(l.receiptOrderId=0),await Na(E),await S()}catch(b){alert(b instanceof Error?b.message:"Delete failed.")}})})}function Es(e){document.querySelector("#service-form")?.addEventListener("submit",async t=>{t.preventDefault();const a=new FormData(t.currentTarget),s=a.get("id")?Number(a.get("id")):void 0;await nt({id:s,name:String(a.get("name")??""),description:String(a.get("description")??"")||null,category:String(a.get("category")??""),serviceType:String(a.get("serviceType")??"order"),price:Number(a.get("price")??0),maxKg:Number(a.get("maxKg")??0),dryingMinutes:Number(a.get("dryingMinutes"))||null,includes:a.getAll("includes").map(String).filter(Boolean),additionalCharge:0,turnaroundHours:Number(a.get("turnaroundHours")??24),isActive:1}),await S()}),document.querySelectorAll(".edit-service-btn").forEach(t=>{t.addEventListener("click",()=>{const a=Number(t.dataset.id),s=e.find(r=>r.id===a),n=document.querySelector("#service-form");s&&n&&(n.querySelector("[name=id]").value=String(s.id),n.querySelector("[name=name]").value=s.name,n.querySelector("[name=category]").value=s.category,n.querySelector("[name=serviceType]").value=s.serviceType,n.querySelector("[name=price]").value=String(s.price),n.querySelector("[name=maxKg]").value=String(s.maxKg),n.querySelector("[name=dryingMinutes]").value=s.dryingMinutes?String(s.dryingMinutes):"",n.querySelectorAll('input[name="includes"]').forEach(r=>{r.checked=s.includes.includes(r.value)}),n.querySelector("[name=turnaroundHours]").value=String(s.turnaroundHours),n.querySelector("[name=description]").value=s.description??"",window.scrollTo({top:0,behavior:"smooth"}))})}),document.querySelectorAll(".deactivate-service-btn, .activate-service-btn").forEach(t=>{t.addEventListener("click",async()=>{const a=Number(t.dataset.id),s=e.find(n=>n.id===a);if(s){const n=s.isActive?0:1;await nt({id:s.id,name:s.name,description:s.description,category:s.category,serviceType:s.serviceType,price:s.price,maxKg:s.maxKg,dryingMinutes:s.dryingMinutes,includes:s.includes,additionalCharge:s.additionalCharge,turnaroundHours:s.turnaroundHours,isActive:n}),await S()}})}),document.querySelector("#category-form")?.addEventListener("submit",async t=>{t.preventDefault();const a=new FormData(t.currentTarget);await ga({name:String(a.get("name")??""),maxKg:Number(a.get("maxKg")??0),additionalFee:Number(a.get("additionalFee")??0),isActive:1}),await S()})}function Ss(e){const t=document.querySelector("#expense-form"),a=t?.querySelector('input[name="disbursementType"]'),s=t?.querySelector(".expense-date-field"),n=t?.querySelector(".expense-month-field"),r=t?.querySelector('input[name="expenseDate"]'),i=t?.querySelector('input[name="expenseMonth"]'),d=u=>{!t||!a||!r||!i||(a.value=u,t.querySelectorAll("[data-expense-type]").forEach(c=>{c.classList.toggle("is-active",c.dataset.expenseType===u)}),s&&(s.hidden=u==="monthly"),n&&(n.hidden=u!=="monthly"),r.required=u==="daily",i.required=u==="monthly",u==="monthly"&&!i.value&&(i.value=Me()),u==="daily"&&!r.value&&(r.value=W()))};t?.querySelectorAll("[data-expense-type]").forEach(u=>{u.addEventListener("click",()=>d(u.dataset.expenseType==="monthly"?"monthly":"daily"))}),d("daily"),t?.addEventListener("submit",async u=>{u.preventDefault();const c=new FormData(u.currentTarget),o=Number(c.get("id")||0),v=String(c.get("disbursementType")??"daily")==="monthly"?"monthly":"daily",f=String(c.get("expenseMonth")??Me()),y={expenseDate:v==="monthly"?`${f}-01`:String(c.get("expenseDate")??""),disbursementType:v,name:String(c.get("name")??""),category:String(c.get("category")??""),description:String(c.get("description")??""),amount:Number(c.get("amount")??0)};o?await Da(o,y):await xa(y),await S()}),document.querySelectorAll(".edit-expense-btn").forEach(u=>{u.addEventListener("click",()=>{const c=e.find(v=>v.id===Number(u.dataset.id));if(!c||!t)return;t.querySelector("[name=id]").value=String(c.id),t.querySelector("[name=expenseDate]").value=c.expenseDate,t.querySelector("[name=expenseMonth]").value=Lt(c.expenseDate),d(ee(c)),t.querySelector("[name=amount]").value=String(c.amount),t.querySelector("[name=name]").value=c.name,t.querySelector("[name=category]").value=c.category,t.querySelector("[name=description]").value=c.description??"";const o=t.querySelector('button[type="submit"]');o&&(o.textContent="Update expense"),t.scrollIntoView({behavior:"smooth",block:"start"})})}),document.querySelectorAll(".delete-expense-btn").forEach(u=>{u.addEventListener("click",async()=>{if(l.currentUser?.role!=="admin")return;const c=Number(u.dataset.id);!Number.isFinite(c)||!confirm("Delete this disbursement?")||(await Oa(c),await S())})}),document.querySelector("#fold-form")?.addEventListener("submit",async u=>{u.preventDefault();const c=new FormData(u.currentTarget);await La({orderTicket:String(c.get("orderTicket")??""),staffName:String(c.get("staffName")??""),foldCount:Number(c.get("foldCount")??1),rate:Number(c.get("rate")??5)}),await S()})}function ws(e,t,a,s,n,r){document.querySelector("#generate-report")?.addEventListener("click",()=>{l.reportPreview=we(),S()});const i=document.querySelector("#sales-form");i?.addEventListener("submit",async w=>{w.preventDefault();const g=new FormData(w.currentTarget);await Ia({id:Number(g.get("id")||0)||void 0,saleDate:String(g.get("saleDate")??""),cashAmount:Number(g.get("cashAmount")??0),gcashAmount:Number(g.get("gcashAmount")??0),notes:String(g.get("notes")??"")}),await S()}),document.querySelectorAll(".edit-sale-btn").forEach(w=>{w.addEventListener("click",()=>{const g=a.find(p=>p.id===Number(w.dataset.id));if(!g||!i)return;i.querySelector("[name=id]").value=String(g.id),i.querySelector("[name=saleDate]").value=g.saleDate,i.querySelector("[name=cashAmount]").value=String(g.cashAmount),i.querySelector("[name=gcashAmount]").value=String(g.gcashAmount),i.querySelector("[name=notes]").value=g.notes??"";const R=i.querySelector('button[type="submit"]');R&&(R.textContent="Update daily sale"),i.scrollIntoView({behavior:"smooth",block:"start"})})}),document.querySelectorAll(".delete-sale-btn").forEach(w=>{w.addEventListener("click",async()=>{if(l.currentUser?.role!=="admin")return;const g=Number(w.dataset.id);!Number.isFinite(g)||!confirm("Delete this daily sale?")||(await qa(g),await S())})});const d=document.querySelector("[data-date-from]"),u=document.querySelector("[data-date-to]"),c=document.querySelector('[data-date-scope][value="custom"]');d&&c&&d.addEventListener("change",()=>c.checked=!0),u&&c&&u.addEventListener("change",()=>c.checked=!0),document.querySelectorAll("[data-date-scope]").forEach(w=>{w.addEventListener("change",()=>{if(!w.checked||!d||!u)return;const g=new Date,R=be(g),p=new Date(g);w.value==="week"&&p.setDate(g.getDate()-6),w.value==="month"&&p.setDate(1),w.value!=="custom"&&(d.value=w.value==="today"?R:be(p),u.value=R)})});const o=w=>{const g=E=>String(E??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&apos;"),R=E=>E==="Sales Report"?[110,125,150,215,95,95,105,105]:E==="Disbursement"?[115,115,90,150,150,220,105]:E==="Fold Count"?[220,125]:E==="Revolving Daily Summary"?[115,105,120,115]:E==="Revolving History"?[115,96,140,96,110,180,120]:[155,125,125,125,95,95,115,115];return`<?xml version="1.0"?>
...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 xmlns:html="http://www.w3.org/TR/REC-html40">
  ...
  ${w.map(E=>{const b=R(E.name).map(L=>`<Column ss:Width="${L}" ss:AutoFitWidth="0"/>`).join(""),O=E.rows.map(L=>{if(!L.length)return'<Row ss:Height="10" ss:StyleID="BorderRow"><Cell ss:StyleID="BorderCell"><Data ss:Type="String">&nbsp;</Data></Cell></Row>';const P=L[0]==="Type"||L[0]==="Summary"||L[0]==="Sales Summary"||L[0]==="Disbursement Summary"||L[0]==="Staff"||L[0]==="Date of Sales"||L[0]==="Date"||L[0]==="Date/Month",x=P?"HeaderRow":"BorderRow",I=P?"HeaderCell":"BorderCell",k=P?26:22,U=L.map(B=>`<Cell ss:StyleID="${I}"><Data ss:Type="${typeof B=="number"?"Number":"String"}">${g(B)}</Data></Cell>`).join("");return`<Row ss:Height="${k}" ss:StyleID="${x}">${U}</Row>`}).join("");return`
...
Your email app will open — please attach the file and send.`)}}}catch(R){alert("Failed: "+String(R))}finally{g&&(g.disabled=!1,g.textContent=w==="export"?"Export Excel":"Send to Email")}};document.querySelector("#export-report")?.addEventListener("click",async()=>{await N("export")}),document.querySelector("#email-report")?.addEventListener("click",async()=>{await N("email")})}function Ts(){document.querySelector("#order-queue-filters")?.addEventListener("submit",e=>{e.preventDefault();const t=new FormData(e.currentTarget);l.orderSearch=String(t.get("orderSearch")??"").trim(),l.orderDateFilter=String(t.get("orderDateFilter")??"").trim(),l.orderPaymentFilter=String(t.get("orderPaymentFilter")??"").trim(),S()}),document.querySelector("#order-queue-clear")?.addEventListener("click",()=>{l.orderSearch="",l.orderDateFilter="",l.orderPaymentFilter="",S()}),document.querySelector("#archived-order-filters")?.addEventListener("submit",e=>{e.preventDefault();const t=new FormData(e.currentTarget);l.archivedOrderSearch=String(t.get("archivedOrderSearch")??"").trim(),S()}),document.querySelector("#archived-order-clear")?.addEventListener("click",()=>{l.archivedOrderSearch="",S()})}function Ns(){document.querySelector("#customer-search-form")?.addEventListener("submit",e=>{e.preventDefault();const t=new FormData(e.currentTarget);l.customerSearch=String(t.get("customerSearch")??"").trim(),S()}),document.querySelector("#customer-search-clear")?.addEventListener("click",()=>{l.customerSearch="",S()})}function As(){document.querySelector("#machine-form")?.addEventListener("submit",async e=>{e.preventDefault();const t=new FormData(e.currentTarget);await ka({machineName:String(t.get("machineName")??""),machineType:String(t.get("machineType")),status:String(t.get("status")),branch:String(t.get("branch")??"")}),await S()}),document.querySelector("#subcleaning-form")?.addEventListener("submit",async e=>{e.preventDefault();const t=e.currentTarget.querySelector('button[type="submit"]');t&&(t.disabled=!0,t.textContent="Starting...");const a=new FormData(e.currentTarget),s=a.getAll("machineIds").map(Number);if(!s.length){alert("Please select at least one machine to clean."),t&&(t.disabled=!1,t.textContent="Start Cleaning");return}await Ba({date:String(a.get("date")??""),machineIds:s,cleaningStatus:String(a.get("cleaningStatus")??""),notes:String(a.get("notes")??""),branch:String(a.get("branch")??"")}),await S()}),document.querySelectorAll(".complete-cleaning-btn").forEach(e=>{e.addEventListener("click",async()=>{const t=Number(e.dataset.machineId),a=e.dataset.branch??"";e.disabled=!0,e.textContent="Completing...",await _a(t,a),await S()})}),document.querySelectorAll(".deactivate-machine-btn, .activate-machine-btn").forEach(e=>{e.addEventListener("click",async()=>{const t=Number(e.dataset.id),a=e.classList.contains("deactivate-machine-btn");await Ma(t,a?"inactive":"available"),await S()})})}function Ls(e){const t=document.querySelector("#add-staff-modal"),a=document.querySelector("#open-add-staff-modal"),s=document.querySelector("#close-add-staff-modal"),n=document.querySelector("#staff-form"),r=()=>{n?.reset(),n&&(n.querySelector("[name=id]").value="");const d=document.querySelector("#add-staff-title");d&&(d.textContent="Add staff member"),t?.removeAttribute("hidden")},i=()=>{t?.setAttribute("hidden",""),n?.reset()};a?.addEventListener("click",r),s?.addEventListener("click",i),t?.addEventListener("click",d=>{d.target===t&&i()}),document.querySelectorAll(".edit-staff-btn").forEach(d=>{d.addEventListener("click",()=>{const u=Number(d.dataset.id),c=e.find(o=>o.id===u);if(c&&n){n.querySelector("[name=id]").value=String(c.id),n.querySelector("[name=name]").value=c.name,n.querySelector("[name=email]").value=c.email,n.querySelector("[name=password]").value=c.password,n.querySelector("[name=role]").value=c.role,n.querySelector("[name=branch]").value=c.branch;const o=document.querySelector("#add-staff-title");o&&(o.textContent="Edit staff member"),t?.removeAttribute("hidden")}})}),document.querySelectorAll(".deactivate-staff-btn, .activate-staff-btn").forEach(d=>{d.addEventListener("click",async()=>{const u=Number(d.dataset.id),c=e.find(o=>o.id===u);c&&(await st(u,{isActive:c.isActive!==0?0:1}),await S())})}),n?.addEventListener("submit",async d=>{d.preventDefault();const u=document.querySelector("#staff-save-btn");u&&(u.disabled=!0,u.textContent="Saving...");const c=new FormData(n),o=c.get("id")?Number(c.get("id")):void 0,v=String(c.get("name")??"").trim(),f=String(c.get("email")??"").trim(),y=String(c.get("password")??"password")||"password",N=String(c.get("role")),w=String(c.get("branch")??"");if(!v||!f){alert("Name and email are required."),u&&(u.disabled=!1,u.textContent="Save staff member");return}try{o?await st(o,{name:v,email:f,password:y,role:N,branch:w}):await pa({name:v,email:f,password:y,role:N,branch:w}),i(),await S()}catch{alert("Failed to save staff. The email may already be in use."),u&&(u.disabled=!1,u.textContent="Save staff member")}})}function Cs(){document.querySelector("#settings-form")?.addEventListener("submit",async e=>{e.preventDefault();const t=new FormData(e.currentTarget);await Te("branch",String(t.get("branch")??"Main Store")),await Te("fold_rate",String(t.get("foldRate")??"5")),String(t.get("reportEmail")??"")&&await Te("report_email",String(t.get("reportEmail"))),alert("Settings saved successfully!")})}async function $s(){await ua();const e=localStorage.getItem(ge);if(e)try{const t=JSON.parse(e);if(t.email&&t.remembered){const a=await bt(t.email,"password")??null;l.currentUser=a}}catch{localStorage.removeItem(ge)}await S()}function Rs(e,t,a,s){const n=e.filter(y=>y.status==="revolving").reduce((y,N)=>y+N.cashAmount,0),r=t.filter(y=>y.type==="add").reduce((y,N)=>y+N.amount,0),i=t.filter(y=>y.type==="disbursement").reduce((y,N)=>y+N.amount,0),d=n+r-i,u=l.revolvingHistoryFrom||"0000-01-01",c=l.revolvingHistoryTo||"9999-12-31",o=t.filter(y=>{const N=K(y.createdAt);return N>=u&&N<=c}),v=e.map(y=>{const N=At(y.saleDate,a,s,y.cashAmount),w=y.status==="revolving"?'<span class="ok">Revolving</span>':y.status==="endorsed"?`<span class="warn">Endorsed to ${m(y.endorsedTo)}</span>`:'<span class="meta">Pending</span>',g=y.status!=="revolving"&&y.status!=="endorsed"?`<div class="row-actions">
        ...
        </div>`:"";return[`<strong>${m(oe(y.saleDate))}</strong>`,`<strong class="ok">${A(N)}</strong>`,w,y.statusUpdatedAt?m(oe(y.statusUpdatedAt)):"-",g]}),f=o.map(y=>[Xa(y.createdAt),`<strong>${m(y.revolvingNumber)}</strong>`,m(y.name),`<strong class="${y.type==="disbursement"?"warn":"ok"}">${y.type==="disbursement"?"-":"+"}${A(y.amount)}</strong>`,m(y.category),m(y.description||"-"),`<span class="${y.type==="add"?"ok":"warn"}">${y.type==="add"?"Add Revolving Fund":"Disbursement"}</span>`]);return`
    <section class="grid content full">
      ...
      <article class="panel">
        <div style="background-color: #061a42; color: white; padding: 24px; border-radius: 12px; margin-bottom: 24px;">
          ...
          <p style="font-size: 32px; font-weight: 800; margin: 0;">${A(d)}</p>
        </div>
      ...
      <article class="panel">
        ...
        ${$e(["Date","Disbursement #","Name","Amount","Category","Description","Type"],f,"data-table revolving-history-datatable")}
      </article>
  ...
  `}function xs(){document.querySelector("#revolving-history-filters")?.addEventListener("submit",async o=>{o.preventDefault();const v=new FormData(o.currentTarget);l.revolvingHistoryFrom=String(v.get("revolvingHistoryFrom")??"").trim(),l.revolvingHistoryTo=String(v.get("revolvingHistoryTo")??"").trim(),await S()}),document.querySelector("#revolving-history-clear")?.addEventListener("click",async()=>{l.revolvingHistoryFrom="",l.revolvingHistoryTo="",await S()}),document.querySelectorAll(".revolving-btn").forEach(o=>{o.addEventListener("click",async()=>{l.revolvingModalOpen=!0,l.revolvingSaleId=Number(o.dataset.id),await S()})});const e=document.getElementById("confirm-revolving-btn");e&&e.addEventListener("click",async()=>{await ot(l.revolvingSaleId,"revolving",null,new Date().toISOString()),l.revolvingModalOpen=!1,await S()});const t=document.getElementById("close-revolving-modal");t&&t.addEventListener("click",async()=>{l.revolvingModalOpen=!1,await S()}),document.querySelectorAll(".endorsed-btn").forEach(o=>{o.addEventListener("click",async()=>{l.endorseModalOpen=!0,l.endorseSaleId=Number(o.dataset.id),l.endorseSaleDate=o.dataset.date??"",await S()})});const a=document.getElementById("close-endorse-modal");a&&a.addEventListener("click",async()=>{l.endorseModalOpen=!1,await S()});const s=document.getElementById("endorse-form");s&&s.addEventListener("submit",async o=>{o.preventDefault();const v=new FormData(s),f=String(v.get("endorsedTo")??"").trim();f&&(await ot(l.endorseSaleId,"endorsed",f,new Date().toISOString()),l.endorseModalOpen=!1,await S())});const n=document.getElementById("add-revolving-fund-btn");n&&n.addEventListener("click",async()=>{l.addFundModalOpen=!0,await S()});const r=document.getElementById("close-add-fund-modal");r&&r.addEventListener("click",async()=>{l.addFundModalOpen=!1,await S()});const i=document.getElementById("add-fund-form");i&&i.addEventListener("submit",async o=>{o.preventDefault();const v=new FormData(i);await ct({name:String(v.get("name")??"").trim(),amount:Number(v.get("amount")??0),category:"Add Revolving Fund",description:null,type:"add",createdAt:new Date().toISOString()}),l.addFundModalOpen=!1,await S()});const d=document.getElementById("revolving-disbursement-btn");d&&d.addEventListener("click",async()=>{l.disbursementModalOpen=!0,await S()});const u=document.getElementById("close-disbursement-modal");u&&u.addEventListener("click",async()=>{l.disbursementModalOpen=!1,await S()});const c=document.getElementById("disbursement-form");c&&c.addEventListener("submit",async o=>{o.preventDefault();const v=new FormData(c);await ct({name:String(v.get("name")??"").trim(),amount:Number(v.get("amount")??0),category:String(v.get("category")??"").trim(),description:String(v.get("description")??"").trim(),type:"disbursement",expenseDate:W(),createdAt:new Date().toISOString()}),l.disbursementModalOpen=!1,await S()})}$s();export{qe as E,Ue as W,jt as b};
