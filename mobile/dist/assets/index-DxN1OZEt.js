(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))r(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const i of s.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&r(i)}).observe(document,{childList:!0,subtree:!0});function a(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(n){if(n.ep)return;n.ep=!0;const s=a(n);fetch(n.href,s)}})();var te;(function(e){e.Unimplemented="UNIMPLEMENTED",e.Unavailable="UNAVAILABLE"})(te||(te={}));class Ne extends Error{constructor(t,a,r){super(t),this.message=t,this.code=a,this.data=r}}const Nt=e=>{var t,a;return e?.androidBridge?"android":!((a=(t=e?.webkit)===null||t===void 0?void 0:t.messageHandlers)===null||a===void 0)&&a.bridge?"ios":"web"},At=e=>{const t=e.CapacitorCustomPlatform||null,a=e.Capacitor||{},r=a.Plugins=a.Plugins||{},n=()=>t!==null?t.name:Nt(e),s=()=>n()!=="web",i=u=>{const f=d.get(u);return!!(f?.platforms.has(n())||c(u))},c=u=>{var f;return(f=a.PluginHeaders)===null||f===void 0?void 0:f.find(v=>v.name===u)},l=u=>e.console.error(u),d=new Map,p=(u,f={})=>{const v=d.get(u);if(v)return console.warn(`Capacitor plugin "${u}" already registered. Cannot register plugins twice.`),v.proxy;const g=n(),y=c(u);let b;const T=async()=>(!b&&g in f?b=typeof f[g]=="function"?b=await f[g]():b=f[g]:t!==null&&!b&&"web"in f&&(b=typeof f.web=="function"?b=await f.web():b=f.web),b),w=(x,I)=>{var k,H;if(y){const h=y?.methods.find(O=>I===O.name);if(h)return h.rtype==="promise"?O=>a.nativePromise(u,I.toString(),O):(O,Z)=>a.nativeCallback(u,I.toString(),O,Z);if(x)return(k=x[I])===null||k===void 0?void 0:k.bind(x)}else{if(x)return(H=x[I])===null||H===void 0?void 0:H.bind(x);throw new Ne(`"${u}" plugin is not implemented on ${g}`,te.Unimplemented)}},N=x=>{let I;const k=(...H)=>{const h=T().then(O=>{const Z=w(O,x);if(Z){const de=Z(...H);return I=de?.remove,de}else throw new Ne(`"${u}.${x}()" is not implemented on ${g}`,te.Unimplemented)});return x==="addListener"&&(h.remove=async()=>I()),h};return k.toString=()=>`${x.toString()}() { [capacitor code] }`,Object.defineProperty(k,"name",{value:x,writable:!1,configurable:!1}),k},D=N("addListener"),M=N("removeListener"),q=(x,I)=>{const k=D({eventName:x},I),H=async()=>{const O=await k;M({eventName:x,callbackId:O},I)},h=new Promise(O=>k.then(()=>O({remove:H})));return h.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await H()},h},J=new Proxy({},{get(x,I){switch(I){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return y?q:D;case"removeListener":return M;default:return N(I)}}});return r[u]=J,d.set(u,{name:u,proxy:J,platforms:new Set([...Object.keys(f),...y?[g]:[]])}),J};return a.convertFileSrc||(a.convertFileSrc=u=>u),a.getPlatform=n,a.handleError=l,a.isNativePlatform=s,a.isPluginAvailable=i,a.registerPlugin=p,a.Exception=Ne,a.DEBUG=!!a.DEBUG,a.isLoggingEnabled=!!a.isLoggingEnabled,a},Lt=e=>e.Capacitor=At(e),A=Lt(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),z=A.registerPlugin;class Re{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(t,a){let r=!1;this.listeners[t]||(this.listeners[t]=[],r=!0),this.listeners[t].push(a);const s=this.windowListeners[t];s&&!s.registered&&this.addWindowListener(s),r&&this.sendRetainedArgumentsForEvent(t);const i=async()=>this.removeListener(t,a);return Promise.resolve({remove:i})}async removeAllListeners(){this.listeners={};for(const t in this.windowListeners)this.removeWindowListener(this.windowListeners[t]);this.windowListeners={}}notifyListeners(t,a,r){const n=this.listeners[t];if(!n){if(r){let s=this.retainedEventArguments[t];s||(s=[]),s.push(a),this.retainedEventArguments[t]=s}return}n.forEach(s=>s(a))}hasListeners(t){var a;return!!(!((a=this.listeners[t])===null||a===void 0)&&a.length)}registerWindowListener(t,a){this.windowListeners[a]={registered:!1,windowEventName:t,pluginEventName:a,handler:r=>{this.notifyListeners(a,r)}}}unimplemented(t="not implemented"){return new A.Exception(t,te.Unimplemented)}unavailable(t="not available"){return new A.Exception(t,te.Unavailable)}async removeListener(t,a){const r=this.listeners[t];if(!r)return;const n=r.indexOf(a);this.listeners[t].splice(n,1),this.listeners[t].length||this.removeWindowListener(this.windowListeners[t])}addWindowListener(t){window.addEventListener(t.windowEventName,t.handler),t.registered=!0}removeWindowListener(t){t&&(window.removeEventListener(t.windowEventName,t.handler),t.registered=!1)}sendRetainedArgumentsForEvent(t){const a=this.retainedEventArguments[t];a&&(delete this.retainedEventArguments[t],a.forEach(r=>{this.notifyListeners(t,r)}))}}const Ue=e=>encodeURIComponent(e).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),ke=e=>e.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class Ct extends Re{async getCookies(){const t=document.cookie,a={};return t.split(";").forEach(r=>{if(r.length<=0)return;let[n,s]=r.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");n=ke(n).trim(),s=ke(s).trim(),a[n]=s}),a}async setCookie(t){try{const a=Ue(t.key),r=Ue(t.value),n=t.expires?`; expires=${t.expires.replace("expires=","")}`:"",s=(t.path||"/").replace("path=",""),i=t.url!=null&&t.url.length>0?`domain=${t.url}`:"";document.cookie=`${a}=${r||""}${n}; path=${s}; ${i};`}catch(a){return Promise.reject(a)}}async deleteCookie(t){try{document.cookie=`${t.key}=; Max-Age=0`}catch(a){return Promise.reject(a)}}async clearCookies(){try{const t=document.cookie.split(";")||[];for(const a of t)document.cookie=a.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(t){return Promise.reject(t)}}async clearAllCookies(){try{await this.clearCookies()}catch(t){return Promise.reject(t)}}}z("CapacitorCookies",{web:()=>new Ct});const $t=async e=>new Promise((t,a)=>{const r=new FileReader;r.onload=()=>{const n=r.result;t(n.indexOf(",")>=0?n.split(",")[1]:n)},r.onerror=n=>a(n),r.readAsDataURL(e)}),Rt=(e={})=>{const t=Object.keys(e);return Object.keys(e).map(n=>n.toLocaleLowerCase()).reduce((n,s,i)=>(n[s]=e[t[i]],n),{})},Ot=(e,t=!0)=>e?Object.entries(e).reduce((r,n)=>{const[s,i]=n;let c,l;return Array.isArray(i)?(l="",i.forEach(d=>{c=t?encodeURIComponent(d):d,l+=`${s}=${c}&`}),l.slice(0,-1)):(c=t?encodeURIComponent(i):i,l=`${s}=${c}`),`${r}&${l}`},"").substr(1):null,Pt=(e,t={})=>{const a=Object.assign({method:e.method||"GET",headers:e.headers},t),n=Rt(e.headers)["content-type"]||"";if(typeof e.data=="string")a.body=e.data;else if(n.includes("application/x-www-form-urlencoded")){const s=new URLSearchParams;for(const[i,c]of Object.entries(e.data||{}))s.set(i,c);a.body=s.toString()}else if(n.includes("multipart/form-data")||e.data instanceof FormData){const s=new FormData;if(e.data instanceof FormData)e.data.forEach((c,l)=>{s.append(l,c)});else for(const c of Object.keys(e.data))s.append(c,e.data[c]);a.body=s;const i=new Headers(a.headers);i.delete("content-type"),a.headers=i}else(n.includes("application/json")||typeof e.data=="object")&&(a.body=JSON.stringify(e.data));return a};class xt extends Re{async request(t){const a=Pt(t,t.webFetchExtra),r=Ot(t.params,t.shouldEncodeUrlParams),n=r?`${t.url}?${r}`:t.url,s=await fetch(n,a),i=s.headers.get("content-type")||"";let{responseType:c="text"}=s.ok?t:{};i.includes("application/json")&&(c="json");let l,d;switch(c){case"arraybuffer":case"blob":d=await s.blob(),l=await $t(d);break;case"json":l=await s.json();break;default:l=await s.text()}const p={};return s.headers.forEach((u,f)=>{p[f]=u}),{data:l,headers:p,status:s.status,url:s.url}}async get(t){return this.request(Object.assign(Object.assign({},t),{method:"GET"}))}async post(t){return this.request(Object.assign(Object.assign({},t),{method:"POST"}))}async put(t){return this.request(Object.assign(Object.assign({},t),{method:"PUT"}))}async patch(t){return this.request(Object.assign(Object.assign({},t),{method:"PATCH"}))}async delete(t){return this.request(Object.assign(Object.assign({},t),{method:"DELETE"}))}}z("CapacitorHttp",{web:()=>new xt});var Me;(function(e){e.Dark="DARK",e.Light="LIGHT",e.Default="DEFAULT"})(Me||(Me={}));var Be;(function(e){e.StatusBar="StatusBar",e.NavigationBar="NavigationBar"})(Be||(Be={}));class Dt extends Re{async setStyle(){this.unavailable("not available for web")}async setAnimation(){this.unavailable("not available for web")}async show(){this.unavailable("not available for web")}async hide(){this.unavailable("not available for web")}}z("SystemBars",{web:()=>new Dt});const It="modulepreload",qt=function(e){return"/"+e},_e={},Oe=function(t,a,r){let n=Promise.resolve();if(a&&a.length>0){let l=function(d){return Promise.all(d.map(p=>Promise.resolve(p).then(u=>({status:"fulfilled",value:u}),u=>({status:"rejected",reason:u}))))};document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),c=i?.nonce||i?.getAttribute("nonce");n=l(a.map(d=>{if(d=qt(d),d in _e)return;_e[d]=!0;const p=d.endsWith(".css"),u=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${u}`))return;const f=document.createElement("link");if(f.rel=p?"stylesheet":It,p||(f.as="script"),f.crossOrigin="",f.href=d,c&&f.setAttribute("nonce",c),document.head.appendChild(f),p)return new Promise((v,g)=>{f.addEventListener("load",v),f.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${d}`)))})}))}function s(i){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=i,window.dispatchEvent(c),!c.defaultPrevented)throw i}return n.then(i=>{for(const c of i||[])c.status==="rejected"&&s(c.reason);return t().catch(s)})};function Ft(e){e.CapacitorUtils.Synapse=new Proxy({},{get(t,a){return new Proxy({},{get(r,n){return(s,i,c)=>{const l=e.Capacitor.Plugins[a];if(l===void 0){c(new Error(`Capacitor plugin ${a} not found`));return}if(typeof l[n]!="function"){c(new Error(`Method ${n} not found in Capacitor plugin ${a}`));return}(async()=>{try{const d=await l[n](s);i(d)}catch(d){c(d)}})()}}})}})}function Ut(e){e.CapacitorUtils.Synapse=new Proxy({},{get(t,a){return e.cordova.plugins[a]}})}function kt(e=!1){typeof window>"u"||(window.CapacitorUtils=window.CapacitorUtils||{},window.Capacitor!==void 0&&!e?Ft(window):window.cordova!==void 0&&Ut(window))}var ye;(function(e){e.Documents="DOCUMENTS",e.Data="DATA",e.Library="LIBRARY",e.Cache="CACHE",e.External="EXTERNAL",e.ExternalStorage="EXTERNAL_STORAGE",e.ExternalCache="EXTERNAL_CACHE",e.LibraryNoCloud="LIBRARY_NO_CLOUD",e.Temporary="TEMPORARY"})(ye||(ye={}));var Ce;(function(e){e.UTF8="utf8",e.ASCII="ascii",e.UTF16="utf16"})(Ce||(Ce={}));const je=z("Filesystem",{web:()=>Oe(()=>import("./web-BC0ONxvm.js"),[]).then(e=>new e.FilesystemWeb)});kt();const Mt=z("Share",{web:()=>Oe(()=>import("./web-CBhr-X8O.js"),[]).then(e=>new e.ShareWeb)});class Bt{constructor(t){this.sqlite=t,this._connectionDict=new Map}async initWebStore(){try{return await this.sqlite.initWebStore(),Promise.resolve()}catch(t){return Promise.reject(t)}}async saveToStore(t){try{return await this.sqlite.saveToStore({database:t}),Promise.resolve()}catch(a){return Promise.reject(a)}}async saveToLocalDisk(t){try{return await this.sqlite.saveToLocalDisk({database:t}),Promise.resolve()}catch(a){return Promise.reject(a)}}async getFromLocalDiskToStore(t){const a=t??!0;try{return await this.sqlite.getFromLocalDiskToStore({overwrite:a}),Promise.resolve()}catch(r){return Promise.reject(r)}}async echo(t){try{const a=await this.sqlite.echo({value:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async isSecretStored(){try{const t=await this.sqlite.isSecretStored();return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async setEncryptionSecret(t){try{return await this.sqlite.setEncryptionSecret({passphrase:t}),Promise.resolve()}catch(a){return Promise.reject(a)}}async changeEncryptionSecret(t,a){try{return await this.sqlite.changeEncryptionSecret({passphrase:t,oldpassphrase:a}),Promise.resolve()}catch(r){return Promise.reject(r)}}async clearEncryptionSecret(){try{return await this.sqlite.clearEncryptionSecret(),Promise.resolve()}catch(t){return Promise.reject(t)}}async checkEncryptionSecret(t){try{const a=await this.sqlite.checkEncryptionSecret({passphrase:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async addUpgradeStatement(t,a){try{return t.endsWith(".db")&&(t=t.slice(0,-3)),await this.sqlite.addUpgradeStatement({database:t,upgrade:a}),Promise.resolve()}catch(r){return Promise.reject(r)}}async createConnection(t,a,r,n,s){try{t.endsWith(".db")&&(t=t.slice(0,-3)),await this.sqlite.createConnection({database:t,encrypted:a,mode:r,version:n,readonly:s});const i=new He(t,s,this.sqlite),c=s?`RO_${t}`:`RW_${t}`;return this._connectionDict.set(c,i),Promise.resolve(i)}catch(i){return Promise.reject(i)}}async closeConnection(t,a){try{t.endsWith(".db")&&(t=t.slice(0,-3)),await this.sqlite.closeConnection({database:t,readonly:a});const r=a?`RO_${t}`:`RW_${t}`;return this._connectionDict.delete(r),Promise.resolve()}catch(r){return Promise.reject(r)}}async isConnection(t,a){const r={};t.endsWith(".db")&&(t=t.slice(0,-3));const n=a?`RO_${t}`:`RW_${t}`;return r.result=this._connectionDict.has(n),Promise.resolve(r)}async retrieveConnection(t,a){t.endsWith(".db")&&(t=t.slice(0,-3));const r=a?`RO_${t}`:`RW_${t}`;if(this._connectionDict.has(r)){const n=this._connectionDict.get(r);return typeof n<"u"?Promise.resolve(n):Promise.reject(`Connection ${t} is undefined`)}else return Promise.reject(`Connection ${t} does not exist`)}async getNCDatabasePath(t,a){try{const r=await this.sqlite.getNCDatabasePath({path:t,database:a});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async createNCConnection(t,a){try{await this.sqlite.createNCConnection({databasePath:t,version:a});const r=new He(t,!0,this.sqlite),n=`RO_${t})`;return this._connectionDict.set(n,r),Promise.resolve(r)}catch(r){return Promise.reject(r)}}async closeNCConnection(t){try{await this.sqlite.closeNCConnection({databasePath:t});const a=`RO_${t})`;return this._connectionDict.delete(a),Promise.resolve()}catch(a){return Promise.reject(a)}}async isNCConnection(t){const a={},r=`RO_${t})`;return a.result=this._connectionDict.has(r),Promise.resolve(a)}async retrieveNCConnection(t){if(this._connectionDict.has(t)){const a=`RO_${t})`,r=this._connectionDict.get(a);return typeof r<"u"?Promise.resolve(r):Promise.reject(`Connection ${t} is undefined`)}else return Promise.reject(`Connection ${t} does not exist`)}async isNCDatabase(t){try{const a=await this.sqlite.isNCDatabase({databasePath:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async retrieveAllConnections(){return this._connectionDict}async closeAllConnections(){const t=new Map;try{for(const a of this._connectionDict.keys()){const r=a.substring(3),n=a.substring(0,3)==="RO_";await this.sqlite.closeConnection({database:r,readonly:n}),t.set(a,null)}for(const a of t.keys())this._connectionDict.delete(a);return Promise.resolve()}catch(a){return Promise.reject(a)}}async checkConnectionsConsistency(){try{const t=[...this._connectionDict.keys()],a=[],r=[];for(const s of t)a.push(s.substring(0,2)),r.push(s.substring(3));const n=await this.sqlite.checkConnectionsConsistency({dbNames:r,openModes:a});return n.result||(this._connectionDict=new Map),Promise.resolve(n)}catch(t){return this._connectionDict=new Map,Promise.reject(t)}}async importFromJson(t){try{const a=await this.sqlite.importFromJson({jsonstring:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async isJsonValid(t){try{const a=await this.sqlite.isJsonValid({jsonstring:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async copyFromAssets(t){const a=t??!0;try{return await this.sqlite.copyFromAssets({overwrite:a}),Promise.resolve()}catch(r){return Promise.reject(r)}}async getFromHTTPRequest(t,a){const r=a??!0;try{return await this.sqlite.getFromHTTPRequest({url:t,overwrite:r}),Promise.resolve()}catch(n){return Promise.reject(n)}}async isDatabaseEncrypted(t){t.endsWith(".db")&&(t=t.slice(0,-3));try{const a=await this.sqlite.isDatabaseEncrypted({database:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async isInConfigEncryption(){try{const t=await this.sqlite.isInConfigEncryption();return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isInConfigBiometricAuth(){try{const t=await this.sqlite.isInConfigBiometricAuth();return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isDatabase(t){t.endsWith(".db")&&(t=t.slice(0,-3));try{const a=await this.sqlite.isDatabase({database:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async getDatabaseList(){try{const a=(await this.sqlite.getDatabaseList()).values;a.sort();const r={values:a};return Promise.resolve(r)}catch(t){return Promise.reject(t)}}async getMigratableDbList(t){const a=t||"default";try{const r=await this.sqlite.getMigratableDbList({folderPath:a});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async addSQLiteSuffix(t,a){const r=t||"default",n=a||[];try{const s=await this.sqlite.addSQLiteSuffix({folderPath:r,dbNameList:n});return Promise.resolve(s)}catch(s){return Promise.reject(s)}}async deleteOldDatabases(t,a){const r=t||"default",n=a||[];try{const s=await this.sqlite.deleteOldDatabases({folderPath:r,dbNameList:n});return Promise.resolve(s)}catch(s){return Promise.reject(s)}}async moveDatabasesAndAddSuffix(t,a){const r=t||"default",n=a||[];return this.sqlite.moveDatabasesAndAddSuffix({folderPath:r,dbNameList:n})}}class He{constructor(t,a,r){this.dbName=t,this.readonly=a,this.sqlite=r}getConnectionDBName(){return this.dbName}getConnectionReadOnly(){return this.readonly}async open(){try{return await this.sqlite.open({database:this.dbName,readonly:this.readonly}),Promise.resolve()}catch(t){return Promise.reject(t)}}async close(){try{return await this.sqlite.close({database:this.dbName,readonly:this.readonly}),Promise.resolve()}catch(t){return Promise.reject(t)}}async beginTransaction(){try{const t=await this.sqlite.beginTransaction({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async commitTransaction(){try{const t=await this.sqlite.commitTransaction({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async rollbackTransaction(){try{const t=await this.sqlite.rollbackTransaction({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isTransactionActive(){try{const t=await this.sqlite.isTransactionActive({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async loadExtension(t){try{return await this.sqlite.loadExtension({database:this.dbName,path:t,readonly:this.readonly}),Promise.resolve()}catch(a){return Promise.reject(a)}}async enableLoadExtension(t){try{return await this.sqlite.enableLoadExtension({database:this.dbName,toggle:t,readonly:this.readonly}),Promise.resolve()}catch(a){return Promise.reject(a)}}async getUrl(){try{const t=await this.sqlite.getUrl({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async getVersion(){try{const t=await this.sqlite.getVersion({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async getTableList(){try{const t=await this.sqlite.getTableList({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async execute(t,a=!0,r=!0){try{if(this.readonly)return Promise.reject("not allowed in read-only mode");{const n=await this.sqlite.execute({database:this.dbName,statements:t,transaction:a,readonly:!1,isSQL92:r});return Promise.resolve(n)}}catch(n){return Promise.reject(n)}}async query(t,a,r=!0){let n;try{return a&&a.length>0?n=await this.sqlite.query({database:this.dbName,statement:t,values:a,readonly:this.readonly,isSQL92:!0}):n=await this.sqlite.query({database:this.dbName,statement:t,values:[],readonly:this.readonly,isSQL92:r}),n=await this.reorderRows(n),Promise.resolve(n)}catch(s){return Promise.reject(s)}}async run(t,a,r=!0,n="no",s=!0){let i;try{return this.readonly?Promise.reject("not allowed in read-only mode"):(a&&a.length>0?i=await this.sqlite.run({database:this.dbName,statement:t,values:a,transaction:r,readonly:!1,returnMode:n,isSQL92:!0}):i=await this.sqlite.run({database:this.dbName,statement:t,values:[],transaction:r,readonly:!1,returnMode:n,isSQL92:s}),i.changes=await this.reorderRows(i.changes),Promise.resolve(i))}catch(c){return Promise.reject(c)}}async executeSet(t,a=!0,r="no",n=!0){let s;try{return this.readonly?Promise.reject("not allowed in read-only mode"):(s=await this.sqlite.executeSet({database:this.dbName,set:t,transaction:a,readonly:!1,returnMode:r,isSQL92:n}),s.changes=await this.reorderRows(s.changes),Promise.resolve(s))}catch(i){return Promise.reject(i)}}async isExists(){try{const t=await this.sqlite.isDBExists({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isTable(t){try{const a=await this.sqlite.isTableExists({database:this.dbName,table:t,readonly:this.readonly});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async isDBOpen(){try{const t=await this.sqlite.isDBOpen({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async delete(){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.deleteDatabase({database:this.dbName,readonly:!1}),Promise.resolve())}catch(t){return Promise.reject(t)}}async createSyncTable(){try{if(this.readonly)return Promise.reject("not allowed in read-only mode");{const t=await this.sqlite.createSyncTable({database:this.dbName,readonly:!1});return Promise.resolve(t)}}catch(t){return Promise.reject(t)}}async setSyncDate(t){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.setSyncDate({database:this.dbName,syncdate:t,readonly:!1}),Promise.resolve())}catch(a){return Promise.reject(a)}}async getSyncDate(){try{const t=await this.sqlite.getSyncDate({database:this.dbName,readonly:this.readonly});let a="";return t.syncDate>0&&(a=new Date(t.syncDate*1e3).toISOString()),Promise.resolve(a)}catch(t){return Promise.reject(t)}}async exportToJson(t,a=!1){try{const r=await this.sqlite.exportToJson({database:this.dbName,jsonexportmode:t,readonly:this.readonly,encrypted:a});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async deleteExportedRows(){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.deleteExportedRows({database:this.dbName,readonly:!1}),Promise.resolve())}catch(t){return Promise.reject(t)}}async executeTransaction(t,a=!0){let r=0,n=!1;if(this.readonly)return Promise.reject("not allowed in read-only mode");if(await this.sqlite.beginTransaction({database:this.dbName}),n=await this.sqlite.isTransactionActive({database:this.dbName}),!n)return Promise.reject("After Begin Transaction, no transaction active");try{for(const c of t){if(typeof c!="object"||!("statement"in c))throw new Error("Error a task.statement must be provided");if("values"in c&&c.values&&c.values.length>0){const l=c.statement.toUpperCase().includes("RETURNING")?"all":"no",d=await this.sqlite.run({database:this.dbName,statement:c.statement,values:c.values,transaction:!1,readonly:!1,returnMode:l,isSQL92:a});if(d.changes.changes<0)throw new Error("Error in transaction method run ");r+=d.changes.changes}else{const l=await this.sqlite.execute({database:this.dbName,statements:c.statement,transaction:!1,readonly:!1});if(l.changes.changes<0)throw new Error("Error in transaction method execute ");r+=l.changes.changes}}const s=await this.sqlite.commitTransaction({database:this.dbName});r+=s.changes.changes;const i={changes:{changes:r}};return Promise.resolve(i)}catch(s){const i=s.message?s.message:s;return await this.sqlite.rollbackTransaction({database:this.dbName}),Promise.reject(i)}}async reorderRows(t){const a=t;if(t?.values&&typeof t.values[0]=="object"&&Object.keys(t.values[0]).includes("ios_columns")){const r=t.values[0].ios_columns,n=[];for(let s=1;s<t.values.length;s++){const i=t.values[s],c={};for(const l of r)c[l]=i[l];n.push(c)}a.values=n}return Promise.resolve(a)}}const _t=z("CapacitorSQLite",{web:()=>Oe(()=>import("./web-DfhcyNWx.js"),[]).then(e=>new e.CapacitorSQLiteWeb),electron:()=>window.CapacitorCustomPlatform.plugins.CapacitorSQLite});function jt(e){return e.replace(/^(add[- ]?on|additional)\s+/i,"").trim()}const Ht="laba101_offline",he="fresh_start_reset_v1",Wt=new Bt(_t);let ue=null;const j=[{id:1,name:"Laba101 Admin",email:"admin@laba101.test",password:"password",role:"admin",branch:"Main Store"},{id:2,name:"Gensan Branch Staff",email:"staff@laba101.gensan",password:"password",role:"staff",branch:"Gensan Branch"}],ge=[],X=[W(1,"Drop-off","P185. Includes wash, dry, and fold.","Drop-Off","order",185,8,40,["Wash","Dry","Fold"],0,24),W(2,"Full Service","P200. Wash, Fabcon, detergent, dry, and fold.","Full Service","order",200,8,40,["Wash","Dry","Fold","Detergent","Fabcon"],0,24),W(3,"Self Service Wash","P60. Self-service wash (max 8kg per load).","Self Service","order",60,8,null,["Wash"],0,1),W(4,"Self Service Dry","P70. Self-service dry (40 mins).","Self Service","order",70,8,40,["Dry"],0,1),W(6,"Dry 10 mins","Additional drying time (10 mins).","Add-on","addon",30,8,10,["Dry"],0,1),W(7,"Dry 20 mins","Additional drying time (20 mins).","Add-on","addon",50,8,20,["Dry"],0,1),W(8,"Dry 40 mins","Additional drying time (40 mins).","Add-on","addon",70,8,40,["Dry"],0,1),W(9,"Additional Zonrox","Extra Zonrox bleach add-on per load.","Add-on","addon",25,0,null,["Zonrox"],0,0),W(10,"Additional Fabcon","Extra Fabcon fabric conditioner add-on per load.","Add-on","addon",25,0,null,["Fabcon"],0,0)],Y=[{id:1,name:"Regular Clothes",maxKg:8,additionalFee:0,isActive:1},{id:2,name:"Comforter",maxKg:4,additionalFee:0,isActive:1},{id:3,name:"Thin Blankets",maxKg:6,additionalFee:0,isActive:1},{id:4,name:"Bedsheets",maxKg:6,additionalFee:0,isActive:1},{id:5,name:"Bath Towels",maxKg:6,additionalFee:0,isActive:1},{id:6,name:"Curtains",maxKg:6,additionalFee:0,isActive:1}];function We(e,t){const a=L(e,[]),r=new Map(a.map(s=>[s.id,s])),n=t.map(s=>{const i=r.get(s.id);return i?{...s,...i,isActive:i.isActive??s.isActive}:s});(a.length!==n.length||n.some((s,i)=>s.id!==a[i]?.id||JSON.stringify(s)!==JSON.stringify(a[i])))&&E(e,n)}async function Xt(){We("services",X),We("item_categories",Y)}async function Ee(e){for(const t of X)((await e.query("SELECT id FROM laundry_services WHERE id = ?",[t.id])).values??[]).length>0?await e.run("UPDATE laundry_services SET name = ?, description = ?, category = ?, serviceType = ?, price = ?, maxKg = ?, dryingMinutes = ?, includes = ?, additionalCharge = ?, turnaroundHours = ?, isActive = COALESCE(isActive, ?) WHERE id = ?",[t.name,t.description,t.category,t.serviceType,t.price,t.maxKg,t.dryingMinutes,JSON.stringify(t.includes),t.additionalCharge,t.turnaroundHours,t.isActive,t.id]):await e.run("INSERT INTO laundry_services (id, name, description, category, serviceType, price, maxKg, dryingMinutes, includes, additionalCharge, turnaroundHours, isActive) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",[t.id,t.name,t.description,t.category,t.serviceType,t.price,t.maxKg,t.dryingMinutes,JSON.stringify(t.includes),t.additionalCharge,t.turnaroundHours,t.isActive]);for(const t of Y)((await e.query("SELECT id FROM item_categories WHERE id = ?",[t.id])).values??[]).length>0?await e.run("UPDATE item_categories SET name = ?, maxKg = ?, additionalFee = ?, isActive = COALESCE(isActive, ?) WHERE id = ?",[t.name,t.maxKg,t.additionalFee,t.isActive,t.id]):await e.run("INSERT INTO item_categories (id, name, maxKg, additionalFee, isActive) VALUES (?, ?, ?, ?, ?)",[t.id,t.name,t.maxKg,t.additionalFee,t.isActive])}const ae=[],be=[],ie=[],oe=[],re=[],K=[...[1,2,3,4].map(e=>({id:e,machineName:`Washer ${e}`,machineType:"washer",status:"available",branch:"Main Store"})),...[1,2,3,4].map(e=>({id:e+4,machineName:`Dryer ${e}`,machineType:"dryer",status:"available",branch:"Main Store"}))],ne=[{key:"branch",value:"Main Store"},{key:"fold_rate",value:"5"},{key:"report_email",value:"admin@laba101.test"}];function W(e,t,a,r,n,s,i,c,l,d,p){return{id:e,name:t,description:a,category:r,serviceType:n,price:s,maxKg:i,dryingMinutes:c,includes:l,additionalCharge:d,turnaroundHours:p,isActive:1}}function F(e){return`laba101-mobile-${e}`}function L(e,t){const a=localStorage.getItem(F(e));if(!a)return structuredClone(t);try{return JSON.parse(a)}catch{return structuredClone(t)}}function E(e,t){localStorage.setItem(F(e),JSON.stringify(t))}function U(e){return e.reduce((t,a)=>Math.max(t,a.id),0)+1}function Q(){return new Date().toISOString()}function $e(e=new Date){const t=e.getFullYear(),a=String(e.getMonth()+1).padStart(2,"0"),r=String(e.getDate()).padStart(2,"0");return`${t}-${a}-${r}`}function Kt(){return $e().slice(2).replaceAll("-","")}function G(e,t){if(!e)return t;try{return JSON.parse(e)}catch{return t}}async function C(){return ue||(ue=await Wt.createConnection(Ht,!1,"no-encryption",1,!1),await ue.open()),ue}async function P(e,t,a,r){((await e.query(`PRAGMA table_info(${t})`)).values??[]).some(i=>i.name===a)||await e.execute(`ALTER TABLE ${t} ADD COLUMN ${a} ${r}`)}function Gt(){const e=L("staff",j),t=new Map(e.map(r=>[r.id,r]));let a=!1;for(const r of j){const n=t.get(r.id);if(!n){t.set(r.id,{...r,isActive:1}),a=!0;continue}const s={...n,name:r.name,email:r.email,password:r.password,role:r.role,branch:r.branch,isActive:1};JSON.stringify(s)!==JSON.stringify(n)&&(t.set(r.id,s),a=!0)}a&&E("staff",Array.from(t.values()).sort((r,n)=>r.id-n.id))}async function Vt(){localStorage.getItem(F(he))||(E("staff",j),E("customers",[]),E("orders",[]),E("payments",[]),E("fold_logs",[]),E("expenses",[]),E("sales",[]),localStorage.getItem(F("services"))||E("services",X),localStorage.getItem(F("item_categories"))||E("item_categories",Y),localStorage.getItem(F("machines"))||E("machines",K),localStorage.getItem(F("subcleanings"))||E("subcleanings",[]),localStorage.getItem(F("settings"))||E("settings",ne),localStorage.removeItem("laba101-mobile-session"),E(he,!0))}async function rt(e){for(const t of j){if(((await e.query("SELECT id FROM staff WHERE id = ?",[t.id])).values??[]).length>0){await e.run("UPDATE staff SET name = ?, email = ?, password = ?, role = ?, branch = ?, isActive = 1 WHERE id = ?",[t.name,t.email,t.password,t.role,t.branch,t.id]);continue}await e.run("INSERT INTO staff (id, name, email, password, role, branch, isActive) VALUES (?, ?, ?, ?, ?, ?, ?)",[t.id,t.name,t.email,t.password,t.role,t.branch,1])}}async function Yt(e){if(!(((await e.query("SELECT COUNT(*) as count FROM machines")).values?.[0]?.count??0)>0))for(const a of K)await e.run("INSERT INTO machines (id, machineName, machineType, status, branch) VALUES (?, ?, ?, ?, ?)",[a.id,a.machineName,a.machineType,a.status,a.branch])}async function Qt(e){for(const t of ne)await e.run("INSERT OR IGNORE INTO settings (key, value) VALUES (?, ?)",[t.key,t.value])}async function nt(e){for(const t of X)((await e.query("SELECT id FROM laundry_services WHERE id = ?",[t.id])).values??[]).length>0||await e.run("INSERT INTO laundry_services (id, name, description, category, serviceType, price, maxKg, dryingMinutes, includes, additionalCharge, turnaroundHours, isActive) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",[t.id,t.name,t.description,t.category,t.serviceType,t.price,t.maxKg,t.dryingMinutes,JSON.stringify(t.includes),t.additionalCharge,t.turnaroundHours,t.isActive]);for(const t of Y)((await e.query("SELECT id FROM item_categories WHERE id = ?",[t.id])).values??[]).length>0||await e.run("INSERT INTO item_categories (id, name, maxKg, additionalFee, isActive) VALUES (?, ?, ?, ?, ?)",[t.id,t.name,t.maxKg,t.additionalFee,t.isActive])}async function Jt(e){((await e.query("SELECT value FROM settings WHERE key = ?",[he])).values??[]).length>0||(await e.execute(`
  ...
  `),await rt(e),await nt(e),await Yt(e),await Qt(e),await e.run("INSERT OR REPLACE INTO settings (key, value) VALUES (?, ?)",[he,Q()]),localStorage.removeItem("laba101-mobile-session"))}async function zt(){if(!A.isNativePlatform()){await Vt(),!localStorage.getItem(F("seeded_v4"))&&!localStorage.getItem(F("services"))&&!localStorage.getItem(F("staff"))&&(E("staff",j),E("customers",ge),E("services",X),E("item_categories",Y),E("orders",ae),E("payments",be),E("fold_logs",[]),E("expenses",ie),E("sales",oe),E("revolving_history",re),E("machines",K),E("subcleanings",[]),E("settings",ne),E("seeded_v4",!0)),await Xt(),Gt(),localStorage.getItem(F("seeded_v4"))||E("seeded_v4",!0);return}const e=await C();await e.execute(`
  ...
  `}function Pa(e=new Date){return{date:new Intl.DateTimeFormat("en-PH",{weekday:"long",month:"long",day:"numeric",year:"numeric"}).format(e),time:new Intl.DateTimeFormat("en-PH",{hour:"numeric",minute:"2-digit",second:"2-digit",hour12:!0}).format(e)}}function ve(){const e=document.querySelector("[data-date-from]"),t=document.querySelector("[data-date-to]"),a=Array.from(document.querySelectorAll('input[name="reportType"]:checked')).map(r=>r.value).filter(r=>r==="sales"||r==="disbursement"||r==="fold_count"||r==="revolving_fund"||r==="summary");return{from:e?.value||"0000-01-01",to:t?.value||"9999-12-31",types:a.length?a:["summary"]}}function pe(e,t){return e>=t.from&&e<=t.to}function gt(e,t,a,r,n,s){const i=new Set(s.types),c=e.filter(h=>pe(B(h.createdAt),s)),l=t.filter(h=>pe(h.saleDate,s)),d=a.filter(h=>pe(h.expenseDate,s)),p=$a(c),u=c.reduce((h,O)=>h+O.paidAmount,0),f=l.reduce((h,O)=>h+O.cashAmount,0),v=l.reduce((h,O)=>h+O.gcashAmount,0),g=0,y=u+f,b=g+v,T=y+b,w=d.reduce((h,O)=>h+O.amount,0),N=w,D=T-N,M=()=>({orderCashTotal:u,orderGcashTotal:g,manualCashTotal:f,manualGcashTotal:v,totalCash:y,totalGcash:b,totalSales:T,rows:[["Type","Date","Number","Name","Cash","GCash","Total","Balance"],...c.map(h=>["Order",B(h.createdAt),h.ticket,h.customer,h.paidAmount,0,h.paidAmount,h.balance]),...l.map(h=>["Manual Sale",h.saleDate,h.saleNumber,h.notes??"",h.cashAmount,h.gcashAmount,h.totalAmount,""]),[],["Sales Summary",s.from,"to",s.to,"","","",""],["Order Cash","","","","","",u,""],["Order GCash","","","","","",g,""],["Manual Cash","","","","","",f,""],["Manual GCash","","","","","",v,""],["Total Cash","","","","","",y,""],["Total GCash","","","","","",b,""],["Total Sales","","","","","",T,""]]}),q=()=>({totalExpenses:w,totalDisbursement:N,rows:[["Type","Date","Number","Name","Amount"],...d.map(h=>["Expense",h.expenseDate,h.number,h.name,h.amount]),[],["Disbursement Summary",s.from,"to",s.to,""],["Expenses","","","",w],["Total Disbursement","","","",N]]}),J=()=>({rows:[["Staff","Fold Count"],...p.map(h=>[h.staffName,h.folds]),[],["Total Folds",p.reduce((h,O)=>h+O.folds,0)]]}),x=r.filter(h=>pe(B(h.createdAt),s));return{selection:s,selectedTypes:i,salesRows:M,disbursementRows:q,foldCountRows:J,revolvingDailySummaryRows:()=>({rows:[["Date of Sales","Cash on Hand","Status","Date Update"],...l.map(h=>{const O=ht(h.saleDate,e,a,h.cashAmount),Z=h.status==="revolving"?"Revolving":h.status==="endorsed"?`Endorsed to ${h.endorsedTo??""}`:"Pending";return[h.saleDate,O,Z,h.statusUpdatedAt?B(h.statusUpdatedAt):""]})]}),revolvingHistoryRows:()=>({rows:[["Date","Number","Name","Amount","Category","Description","Type"],...x.map(h=>[B(h.createdAt),h.revolvingNumber,h.name,h.type==="disbursement"?-h.amount:h.amount,h.category,h.description??"",h.type==="add"?"Add Revolving Fund":"Disbursement"])]}),summaryRows:()=>{const h=M(),O=q();return[["Summary",s.from,"to",s.to,"","","",""],["Order Cash","","","","","",h.orderCashTotal,""],["Order GCash","","","","","",h.orderGcashTotal,""],["Manual Cash","","","","","",h.manualCashTotal,""],["Manual GCash","","","","","",h.manualGcashTotal,""],["Total Cash","","","","","",h.totalCash,""],["Total GCash","","","","","",h.totalGcash,""],["Total Sales","","","","","",h.totalSales,""],["Total Disbursement","","","","","",O.totalDisbursement,""],["Profit","","","","","",D,""],["Cash on Hand","","","","","",yt(h.totalCash,O.totalDisbursement),""]]},profit:D}}function xa(e,t){return`<button class="nav-link ${t?"is-active":""}" data-tab="${e}" type="button">
    <span class="nav-icon">${Da(e)}</span>
    <span>${Ie[e]}</span>
  </button>`}function R(e,t){return`<div class="section-head"><div><h2>${m(e)}</h2><p class="meta">${m(t)}</p></div></div>`}function Qe(){return Ie[o.tab]??"Dashboard"}function Le(e){return(e?.name??"Laba101").trim().slice(0,1).toUpperCase()}function Da(e){return{dashboard:"DB",pos:"POS",orders:"PO",archived:"AR",customers:"CU",pricing:"PS",disbursements:"DR",reports:"RP",inventory:"IN",maintenance:"MT",staff:"ST",revolving:"RV",settings:"SE"}[e]}async function bt(){const e=await we(),t=await aa(e),a=await ot(),r=await na(),n=await xe(),s=await ia(),i=await lt(),c=await Te(e),l=await ma(),d=await va(),p=await fa(),u=await ba(),f=await ft(e),v=await Na(e),g=await Ea(),y=await ta(),b=await it("report_email");return{branch:e,staff:t,allStaff:a,customers:r,services:n,allServices:s,categories:i,orders:c,payments:l,foldLogs:d,expenses:p,sales:u,machines:f,subcleanings:v,revolvingHistory:g,foldRate:y,reportEmail:b??""}}async function S(){if(!o.currentUser){Ia(),Za();return}const e=await bt();e.orders.filter(a=>a.status!=="claimed").length,e.orders.filter(a=>a.status==="ready").length,e.orders.reduce((a,r)=>a+r.paidAmount,0);const t=e.orders.filter(a=>B(a.createdAt)===_()).reduce((a,r)=>a+r.paidAmount,0);e.sales.reduce((a,r)=>a+r.totalAmount,0),e.expenses.reduce((a,r)=>a+r.amount,0),De.innerHTML=`
    <div class="app-frame">
      <header class="topbar">
      ...
      <aside class="sidebar ${o.sidebarOpen?"is-open":""}">
        ...
        <nav>${St().map(a=>xa(a,o.tab===a)).join("")}</nav>
      ...
      <main class="workspace">
        ...
        ${o.tab==="dashboard"?Fa({paidToday:t,orders:e.orders}):""}
        ${o.tab==="pos"?Ua(e.orders,e.customers,e.services,e.categories,e.payments,e.branch):""}
        ${o.tab==="orders"?ka(e.orders,e.staff,e.services,e.payments):""}
        ${o.tab==="archived"?Ma(e.orders,e.staff,e.services,e.payments):""}
  ...
  `,za(),tr(e),ar(e.allServices),rr(),nr(e.orders,e.sales,e.expenses,e.revolvingHistory,e.foldRate),sr(),ir(),or(),cr(e.allStaff),ur(),lr(),er()}function St(){return o.currentUser?.role==="admin"?Object.keys(Ie).filter(e=>e!=="inventory"):Oa(o.currentUser)?["disbursements","reports","maintenance","revolving"]:["pos","orders","archived","disbursements","reports","maintenance","revolving"]}function Ia(){De.innerHTML=`
  ...
  `}function qa(){document.querySelectorAll("[data-fill-email]").forEach(e=>{e.addEventListener("click",()=>{const t=document.querySelector('input[name="email"]'),a=document.querySelector('input[name="password"]');t&&(t.value=e.dataset.fillEmail??""),a&&(a.value=e.dataset.fillPassword??"")})})}function Fa(e){const t=new Date,a=Array.from({length:7},(i,c)=>{const l=new Date(t);return l.setDate(t.getDate()-(6-c)),new Intl.DateTimeFormat("en-PH",{month:"short",day:"numeric"}).format(l)}),r=Array.from({length:7},(i,c)=>{const l=new Date(t);l.setDate(t.getDate()-(6-c));const d=le(l);return e.orders.filter(p=>B(p.createdAt)===d).reduce((p,u)=>p+u.paidAmount,0)}),n=Math.max(1,...r),s=210;return`
  ...
  `}function Ua(e,t,a,r,n,s){const i=a.filter(u=>u.serviceType==="order"&&u.isActive),c=a.filter(u=>u.serviceType==="addon"&&u.isActive),l=o.receiptOrderId?e.find(u=>u.id===o.receiptOrderId):null,d=new Set(e.map(u=>u.customerId)),p=t.filter(u=>d.has(u.id));return`
        ...
        <form id="order-form" class="form">
          ...
          <fieldset class="check-grid">
            ...
            ${c.length?c.map(u=>`<div class="qty-card addon-quantity" data-qty-card="addonQty-${u.id}">
              <span><strong>${m(V(u.name))}</strong><small>${$(u.price)} each</small></span>
              <div class="qty-control">
                <button type="button" data-qty-minus="addonQty-${u.id}" aria-label="Decrease ${m(V(u.name))}">-</button>
                <input type="number" name="addonQty-${u.id}" min="0" step="1" value="0" inputmode="numeric" />
                <button type="button" data-qty-plus="addonQty-${u.id}" aria-label="Increase ${m(V(u.name))}">+</button>
              </div>
  ...
  `}function Ma(e,t,a,r){const n=e.filter(l=>l.status==="claimed"),s=o.archivedOrderSearch.trim().toLowerCase(),i=n.filter(l=>s?[l.ticket,l.customer,l.phone,l.service,l.itemCategory].some(d=>String(d??"").toLowerCase().includes(s)):!0),c=o.receiptOrderId?e.find(l=>l.id===o.receiptOrderId):null;return`
    <section class="grid content full">
      <article class="panel span-2">
  ...
  `}function Et(e,t,a){const r=ut(e,a),n=r.find(u=>!e.workflowCompleted.includes(u.key)),s=n?.key==="fold",i=n?.key==="extras"&&e.extras.length>0,c=qe(e),l=c.charAt(0).toUpperCase()+c.slice(1),d=c==="paid"?"ok":c==="partial"?"warn":"meta",p=e.extras.length?e.extras.map(u=>`${m(V(u.name))} x${Number(u.quantity??1)}`).join(", "):"";return`
    <tr>
      ...
      <div class="row-actions">
        ${n?`<form class="inline-form advance-form" data-order-id="${e.id}">
          ${i?`<div class="extra-confirmation">Confirm extra service: <strong>${e.extras.map(u=>`${m(V(u.name))} x${Number(u.quantity??1)}`).join(", ")}</strong></div>`:""}
      ...
      <div class="receipt-modal" role="dialog" aria-modal="true" aria-labelledby="receipt-title">
        ...
        <div class="receipt" id="receipt-print-area">
          ...
          <div class="summary-list receipt-lines">
            ...
            ${e.extras.length?`<div><span>Extra services</span><strong>${e.extras.map(i=>`${m(V(i.name))} x${Number(i.quantity??1)} (${$(Number(i.total??i.price))})`).join(", ")}</strong></div>`:""}
      ...
      <article class="panel">
        ...
        <form id="service-form" class="form">
          ...
          <fieldset class="check-grid">
            ...
            ${Ca.map(a=>`<label class="check"><input type="checkbox" name="includes" value="${a}" /> ${a}</label>`).join("")}
          </fieldset>
  ...
  `}function Ka(e,t){const a=_(),r=a.slice(0,7),n=e.filter(l=>l.expenseDate===a).reduce((l,d)=>l+d.amount,0),s=e.filter(l=>l.expenseDate.startsWith(r)).reduce((l,d)=>l+d.amount,0),i=t.filter(l=>l.saleDate===a).reduce((l,d)=>l+d.totalAmount,0),c=t.filter(l=>l.saleDate.startsWith(r)).reduce((l,d)=>l+d.totalAmount,0);return`
    ...
    `}
  `}function Ga(e,t,a,r,n,s,i,c){const l=o.reportPreview?gt(e,t,a,r,n,o.reportPreview):null;return`
    <section class="page-head">
      <div>
  ...
  `}function Ya(e,t,a){const r=e.filter(s=>s.status!=="under_cleaning"),n=e.filter(s=>s.status==="under_cleaning");return`
    <section class="page-head">
      <div>
    ...
    <section class="grid content full">
      ...
      <article class="panel span-2">
        ...
        <div class="table">
          ...
          ${e.map(s=>{const i=t.find(c=>c.machineIds.includes(s.id)&&c.date===_());return`<div class="table-row"><div><strong>${m(s.machineName)}</strong></div><div>${m(s.machineType)}</div><div>${i?m(i.cleaningStatus.replace("_"," ")):"Not Cleaned"}</div><div>${m(i?.notes??"-")}</div><div>${_()}</div></div>`}).join("")}
        </div>
      </article>
    </section>
    `:`
...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 xmlns:html="http://www.w3.org/TR/REC-html40">
  ...
  ${f.map(b=>{const T=g(b.name).map(N=>`<Column ss:Width="${N}" ss:AutoFitWidth="0"/>`).join(""),w=b.rows.map(N=>{if(!N.length)return'<Row ss:Height="10" ss:StyleID="BorderRow"><Cell ss:StyleID="BorderCell"><Data ss:Type="String">&nbsp;</Data></Cell></Row>';const D=N[0]==="Type"||N[0]==="Summary"||N[0]==="Sales Summary"||N[0]==="Disbursement Summary"||N[0]==="Staff"||N[0]==="Date of Sales"||N[0]==="Date",M=D?"HeaderRow":"BorderRow",q=D?"HeaderCell":"BorderCell",J=D?26:22,x=N.map(I=>`<Cell ss:StyleID="${q}"><Data ss:Type="${typeof I=="number"?"Number":"String"}">${v(I)}</Data></Cell>`).join("");return`<Row ss:Height="${J}" ss:StyleID="${M}">${x}</Row>`}).join("");return`
...
Your email app will open — please attach the file and send.`)}}}catch(g){alert("Failed: "+String(g))}finally{v&&(v.disabled=!1,v.textContent=f==="export"?"Export Excel":"Send to Email")}};document.querySelector("#export-report")?.addEventListener("click",async()=>{await u("export")}),document.querySelector("#email-report")?.addEventListener("click",async()=>{await u("email")})}function sr(){document.querySelector("#order-queue-filters")?.addEventListener("submit",e=>{e.preventDefault();const t=new FormData(e.currentTarget);o.orderSearch=String(t.get("orderSearch")??"").trim(),o.orderDateFilter=String(t.get("orderDateFilter")??"").trim(),o.orderPaymentFilter=String(t.get("orderPaymentFilter")??"").trim(),S()}),document.querySelector("#order-queue-clear")?.addEventListener("click",()=>{o.orderSearch="",o.orderDateFilter="",o.orderPaymentFilter="",S()}),document.querySelector("#archived-order-filters")?.addEventListener("submit",e=>{e.preventDefault();const t=new FormData(e.currentTarget);o.archivedOrderSearch=String(t.get("archivedOrderSearch")??"").trim(),S()}),document.querySelector("#archived-order-clear")?.addEventListener("click",()=>{o.archivedOrderSearch="",S()})}function ir(){document.querySelector("#customer-search-form")?.addEventListener("submit",e=>{e.preventDefault();const t=new FormData(e.currentTarget);o.customerSearch=String(t.get("customerSearch")??"").trim(),S()}),document.querySelector("#customer-search-clear")?.addEventListener("click",()=>{o.customerSearch="",S()})}function or(){document.querySelector("#machine-form")?.addEventListener("submit",async e=>{e.preventDefault();const t=new FormData(e.currentTarget);await wa({machineName:String(t.get("machineName")??""),machineType:String(t.get("machineType")),status:String(t.get("status")),branch:String(t.get("branch")??"")}),await S()}),document.querySelector("#subcleaning-form")?.addEventListener("submit",async e=>{e.preventDefault();const t=e.currentTarget.querySelector('button[type="submit"]');t&&(t.disabled=!0,t.textContent="Starting...");const a=new FormData(e.currentTarget),r=a.getAll("machineIds").map(Number);if(!r.length){alert("Please select at least one machine to clean."),t&&(t.disabled=!1,t.textContent="Start Cleaning");return}await Aa({date:String(a.get("date")??""),machineIds:r,cleaningStatus:String(a.get("cleaningStatus")??""),notes:String(a.get("notes")??""),branch:String(a.get("branch")??"")}),await S()}),document.querySelectorAll(".complete-cleaning-btn").forEach(e=>{e.addEventListener("click",async()=>{const t=Number(e.dataset.machineId),a=e.dataset.branch??"";e.disabled=!0,e.textContent="Completing...",await La(t,a),await S()})}),document.querySelectorAll(".deactivate-machine-btn, .activate-machine-btn").forEach(e=>{e.addEventListener("click",async()=>{const t=Number(e.dataset.id),a=e.classList.contains("deactivate-machine-btn");await Ta(t,a?"inactive":"available"),await S()})})}function cr(e){const t=document.querySelector("#add-staff-modal"),a=document.querySelector("#open-add-staff-modal"),r=document.querySelector("#close-add-staff-modal"),n=document.querySelector("#staff-form"),s=()=>{n?.reset(),n&&(n.querySelector("[name=id]").value="");const c=document.querySelector("#add-staff-title");c&&(c.textContent="Add staff member"),t?.removeAttribute("hidden")},i=()=>{t?.setAttribute("hidden",""),n?.reset()};a?.addEventListener("click",s),r?.addEventListener("click",i),t?.addEventListener("click",c=>{c.target===t&&i()}),document.querySelectorAll(".edit-staff-btn").forEach(c=>{c.addEventListener("click",()=>{const l=Number(c.dataset.id),d=e.find(p=>p.id===l);if(d&&n){n.querySelector("[name=id]").value=String(d.id),n.querySelector("[name=name]").value=d.name,n.querySelector("[name=email]").value=d.email,n.querySelector("[name=password]").value=d.password,n.querySelector("[name=role]").value=d.role,n.querySelector("[name=branch]").value=d.branch;const p=document.querySelector("#add-staff-title");p&&(p.textContent="Edit staff member"),t?.removeAttribute("hidden")}})}),document.querySelectorAll(".deactivate-staff-btn, .activate-staff-btn").forEach(c=>{c.addEventListener("click",async()=>{const l=Number(c.dataset.id),d=e.find(p=>p.id===l);d&&(await Xe(l,{isActive:d.isActive!==0?0:1}),await S())})}),n?.addEventListener("submit",async c=>{c.preventDefault();const l=document.querySelector("#staff-save-btn");l&&(l.disabled=!0,l.textContent="Saving...");const d=new FormData(n),p=d.get("id")?Number(d.get("id")):void 0,u=String(d.get("name")??"").trim(),f=String(d.get("email")??"").trim(),v=String(d.get("password")??"password")||"password",g=String(d.get("role")),y=String(d.get("branch")??"");if(!u||!f){alert("Name and email are required."),l&&(l.disabled=!1,l.textContent="Save staff member");return}try{p?await Xe(p,{name:u,email:f,password:v,role:g,branch:y}):await ra({name:u,email:f,password:v,role:g,branch:y}),i(),await S()}catch{alert("Failed to save staff. The email may already be in use."),l&&(l.disabled=!1,l.textContent="Save staff member")}})}function lr(){document.querySelector("#settings-form")?.addEventListener("submit",async e=>{e.preventDefault();const t=new FormData(e.currentTarget);await fe("branch",String(t.get("branch")??"Main Store")),await fe("fold_rate",String(t.get("foldRate")??"5")),String(t.get("reportEmail")??"")&&await fe("report_email",String(t.get("reportEmail"))),alert("Settings saved successfully!"),await S()})}await ea();const at=localStorage.getItem(ce);if(at)try{const e=JSON.parse(at);if(e.email&&e.remembered){const t=await ct(e.email,"password")??null;o.currentUser=t}}catch{localStorage.removeItem(ce)}function dr(e,t,a,r){const n=e.filter(v=>v.status==="revolving").reduce((v,g)=>v+g.cashAmount,0),s=t.filter(v=>v.type==="add").reduce((v,g)=>v+g.amount,0),i=t.filter(v=>v.type==="disbursement").reduce((v,g)=>v+g.amount,0),c=n+s-i,l=o.revolvingHistoryFrom||"0000-01-01",d=o.revolvingHistoryTo||"9999-12-31",p=t.filter(v=>{const g=B(v.createdAt);return g>=l&&g<=d}),u=e.map(v=>{const g=ht(v.saleDate,a,r,v.cashAmount),y=v.status==="revolving"?'<span class="ok">Revolving</span>':v.status==="endorsed"?`<span class="warn">Endorsed to ${m(v.endorsedTo)}</span>`:'<span class="meta">Pending</span>',b=v.status!=="revolving"&&v.status!=="endorsed"?`<div class="row-actions">
        ...
        </div>`:"";return[`<strong>${m(ee(v.saleDate))}</strong>`,`<strong class="ok">${$(g)}</strong>`,y,v.statusUpdatedAt?m(ee(v.statusUpdatedAt)):"-",b]}),f=p.map(v=>[Ra(v.createdAt),`<strong>${m(v.revolvingNumber)}</strong>`,m(v.name),`<strong class="${v.type==="disbursement"?"warn":"ok"}">${v.type==="disbursement"?"-":"+"}${$(v.amount)}</strong>`,m(v.category),m(v.description||"-"),`<span class="${v.type==="add"?"ok":"warn"}">${v.type==="add"?"Add Revolving Fund":"Disbursement"}</span>`]);return`
    <section class="grid content full">
