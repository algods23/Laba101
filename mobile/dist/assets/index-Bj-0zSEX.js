(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))r(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const i of s.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&r(i)}).observe(document,{childList:!0,subtree:!0});function a(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function r(n){if(n.ep)return;n.ep=!0;const s=a(n);fetch(n.href,s)}})();var te;(function(e){e.Unimplemented="UNIMPLEMENTED",e.Unavailable="UNAVAILABLE"})(te||(te={}));class Ne extends Error{constructor(t,a,r){super(t),this.message=t,this.code=a,this.data=r}}const Tt=e=>{var t,a;return e?.androidBridge?"android":!((a=(t=e?.webkit)===null||t===void 0?void 0:t.messageHandlers)===null||a===void 0)&&a.bridge?"ios":"web"},Nt=e=>{const t=e.CapacitorCustomPlatform||null,a=e.Capacitor||{},r=a.Plugins=a.Plugins||{},n=()=>t!==null?t.name:Tt(e),s=()=>n()!=="web",i=u=>{const f=d.get(u);return!!(f?.platforms.has(n())||c(u))},c=u=>{var f;return(f=a.PluginHeaders)===null||f===void 0?void 0:f.find(v=>v.name===u)},l=u=>e.console.error(u),d=new Map,p=(u,f={})=>{const v=d.get(u);if(v)return console.warn(`Capacitor plugin "${u}" already registered. Cannot register plugins twice.`),v.proxy;const g=n(),y=c(u);let b;const T=async()=>(!b&&g in f?b=typeof f[g]=="function"?b=await f[g]():b=f[g]:t!==null&&!b&&"web"in f&&(b=typeof f.web=="function"?b=await f.web():b=f.web),b),w=(D,I)=>{var U,W;if(y){const h=y?.methods.find(O=>I===O.name);if(h)return h.rtype==="promise"?O=>a.nativePromise(u,I.toString(),O):(O,Z)=>a.nativeCallback(u,I.toString(),O,Z);if(D)return(U=D[I])===null||U===void 0?void 0:U.bind(D)}else{if(D)return(W=D[I])===null||W===void 0?void 0:W.bind(D);throw new Ne(`"${u}" plugin is not implemented on ${g}`,te.Unimplemented)}},N=D=>{let I;const U=(...W)=>{const h=T().then(O=>{const Z=w(O,D);if(Z){const de=Z(...W);return I=de?.remove,de}else throw new Ne(`"${u}.${D}()" is not implemented on ${g}`,te.Unimplemented)});return D==="addListener"&&(h.remove=async()=>I()),h};return U.toString=()=>`${D.toString()}() { [capacitor code] }`,Object.defineProperty(U,"name",{value:D,writable:!1,configurable:!1}),U},x=N("addListener"),B=N("removeListener"),q=(D,I)=>{const U=x({eventName:D},I),W=async()=>{const O=await U;B({eventName:D,callbackId:O},I)},h=new Promise(O=>U.then(()=>O({remove:W})));return h.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await W()},h},Y=new Proxy({},{get(D,I){switch(I){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return y?q:x;case"removeListener":return B;default:return N(I)}}});return r[u]=Y,d.set(u,{name:u,proxy:Y,platforms:new Set([...Object.keys(f),...y?[g]:[]])}),Y};return a.convertFileSrc||(a.convertFileSrc=u=>u),a.getPlatform=n,a.handleError=l,a.isNativePlatform=s,a.isPluginAvailable=i,a.registerPlugin=p,a.Exception=Ne,a.DEBUG=!!a.DEBUG,a.isLoggingEnabled=!!a.isLoggingEnabled,a},At=e=>e.Capacitor=Nt(e),A=At(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),z=A.registerPlugin;class Re{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(t,a){let r=!1;this.listeners[t]||(this.listeners[t]=[],r=!0),this.listeners[t].push(a);const s=this.windowListeners[t];s&&!s.registered&&this.addWindowListener(s),r&&this.sendRetainedArgumentsForEvent(t);const i=async()=>this.removeListener(t,a);return Promise.resolve({remove:i})}async removeAllListeners(){this.listeners={};for(const t in this.windowListeners)this.removeWindowListener(this.windowListeners[t]);this.windowListeners={}}notifyListeners(t,a,r){const n=this.listeners[t];if(!n){if(r){let s=this.retainedEventArguments[t];s||(s=[]),s.push(a),this.retainedEventArguments[t]=s}return}n.forEach(s=>s(a))}hasListeners(t){var a;return!!(!((a=this.listeners[t])===null||a===void 0)&&a.length)}registerWindowListener(t,a){this.windowListeners[a]={registered:!1,windowEventName:t,pluginEventName:a,handler:r=>{this.notifyListeners(a,r)}}}unimplemented(t="not implemented"){return new A.Exception(t,te.Unimplemented)}unavailable(t="not available"){return new A.Exception(t,te.Unavailable)}async removeListener(t,a){const r=this.listeners[t];if(!r)return;const n=r.indexOf(a);this.listeners[t].splice(n,1),this.listeners[t].length||this.removeWindowListener(this.windowListeners[t])}addWindowListener(t){window.addEventListener(t.windowEventName,t.handler),t.registered=!0}removeWindowListener(t){t&&(window.removeEventListener(t.windowEventName,t.handler),t.registered=!1)}sendRetainedArgumentsForEvent(t){const a=this.retainedEventArguments[t];a&&(delete this.retainedEventArguments[t],a.forEach(r=>{this.notifyListeners(t,r)}))}}const ke=e=>encodeURIComponent(e).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),Ue=e=>e.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class Lt extends Re{async getCookies(){const t=document.cookie,a={};return t.split(";").forEach(r=>{if(r.length<=0)return;let[n,s]=r.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");n=Ue(n).trim(),s=Ue(s).trim(),a[n]=s}),a}async setCookie(t){try{const a=ke(t.key),r=ke(t.value),n=t.expires?`; expires=${t.expires.replace("expires=","")}`:"",s=(t.path||"/").replace("path=",""),i=t.url!=null&&t.url.length>0?`domain=${t.url}`:"";document.cookie=`${a}=${r||""}${n}; path=${s}; ${i};`}catch(a){return Promise.reject(a)}}async deleteCookie(t){try{document.cookie=`${t.key}=; Max-Age=0`}catch(a){return Promise.reject(a)}}async clearCookies(){try{const t=document.cookie.split(";")||[];for(const a of t)document.cookie=a.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(t){return Promise.reject(t)}}async clearAllCookies(){try{await this.clearCookies()}catch(t){return Promise.reject(t)}}}z("CapacitorCookies",{web:()=>new Lt});const Ct=async e=>new Promise((t,a)=>{const r=new FileReader;r.onload=()=>{const n=r.result;t(n.indexOf(",")>=0?n.split(",")[1]:n)},r.onerror=n=>a(n),r.readAsDataURL(e)}),$t=(e={})=>{const t=Object.keys(e);return Object.keys(e).map(n=>n.toLocaleLowerCase()).reduce((n,s,i)=>(n[s]=e[t[i]],n),{})},Rt=(e,t=!0)=>e?Object.entries(e).reduce((r,n)=>{const[s,i]=n;let c,l;return Array.isArray(i)?(l="",i.forEach(d=>{c=t?encodeURIComponent(d):d,l+=`${s}=${c}&`}),l.slice(0,-1)):(c=t?encodeURIComponent(i):i,l=`${s}=${c}`),`${r}&${l}`},"").substr(1):null,Ot=(e,t={})=>{const a=Object.assign({method:e.method||"GET",headers:e.headers},t),n=$t(e.headers)["content-type"]||"";if(typeof e.data=="string")a.body=e.data;else if(n.includes("application/x-www-form-urlencoded")){const s=new URLSearchParams;for(const[i,c]of Object.entries(e.data||{}))s.set(i,c);a.body=s.toString()}else if(n.includes("multipart/form-data")||e.data instanceof FormData){const s=new FormData;if(e.data instanceof FormData)e.data.forEach((c,l)=>{s.append(l,c)});else for(const c of Object.keys(e.data))s.append(c,e.data[c]);a.body=s;const i=new Headers(a.headers);i.delete("content-type"),a.headers=i}else(n.includes("application/json")||typeof e.data=="object")&&(a.body=JSON.stringify(e.data));return a};class Pt extends Re{async request(t){const a=Ot(t,t.webFetchExtra),r=Rt(t.params,t.shouldEncodeUrlParams),n=r?`${t.url}?${r}`:t.url,s=await fetch(n,a),i=s.headers.get("content-type")||"";let{responseType:c="text"}=s.ok?t:{};i.includes("application/json")&&(c="json");let l,d;switch(c){case"arraybuffer":case"blob":d=await s.blob(),l=await Ct(d);break;case"json":l=await s.json();break;default:l=await s.text()}const p={};return s.headers.forEach((u,f)=>{p[f]=u}),{data:l,headers:p,status:s.status,url:s.url}}async get(t){return this.request(Object.assign(Object.assign({},t),{method:"GET"}))}async post(t){return this.request(Object.assign(Object.assign({},t),{method:"POST"}))}async put(t){return this.request(Object.assign(Object.assign({},t),{method:"PUT"}))}async patch(t){return this.request(Object.assign(Object.assign({},t),{method:"PATCH"}))}async delete(t){return this.request(Object.assign(Object.assign({},t),{method:"DELETE"}))}}z("CapacitorHttp",{web:()=>new Pt});var Me;(function(e){e.Dark="DARK",e.Light="LIGHT",e.Default="DEFAULT"})(Me||(Me={}));var Be;(function(e){e.StatusBar="StatusBar",e.NavigationBar="NavigationBar"})(Be||(Be={}));class Dt extends Re{async setStyle(){this.unavailable("not available for web")}async setAnimation(){this.unavailable("not available for web")}async show(){this.unavailable("not available for web")}async hide(){this.unavailable("not available for web")}}z("SystemBars",{web:()=>new Dt});const xt="modulepreload",It=function(e){return"/"+e},_e={},Oe=function(t,a,r){let n=Promise.resolve();if(a&&a.length>0){let l=function(d){return Promise.all(d.map(p=>Promise.resolve(p).then(u=>({status:"fulfilled",value:u}),u=>({status:"rejected",reason:u}))))};document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),c=i?.nonce||i?.getAttribute("nonce");n=l(a.map(d=>{if(d=It(d),d in _e)return;_e[d]=!0;const p=d.endsWith(".css"),u=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${u}`))return;const f=document.createElement("link");if(f.rel=p?"stylesheet":xt,p||(f.as="script"),f.crossOrigin="",f.href=d,c&&f.setAttribute("nonce",c),document.head.appendChild(f),p)return new Promise((v,g)=>{f.addEventListener("load",v),f.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${d}`)))})}))}function s(i){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=i,window.dispatchEvent(c),!c.defaultPrevented)throw i}return n.then(i=>{for(const c of i||[])c.status==="rejected"&&s(c.reason);return t().catch(s)})};function qt(e){e.CapacitorUtils.Synapse=new Proxy({},{get(t,a){return new Proxy({},{get(r,n){return(s,i,c)=>{const l=e.Capacitor.Plugins[a];if(l===void 0){c(new Error(`Capacitor plugin ${a} not found`));return}if(typeof l[n]!="function"){c(new Error(`Method ${n} not found in Capacitor plugin ${a}`));return}(async()=>{try{const d=await l[n](s);i(d)}catch(d){c(d)}})()}}})}})}function Ft(e){e.CapacitorUtils.Synapse=new Proxy({},{get(t,a){return e.cordova.plugins[a]}})}function kt(e=!1){typeof window>"u"||(window.CapacitorUtils=window.CapacitorUtils||{},window.Capacitor!==void 0&&!e?qt(window):window.cordova!==void 0&&Ft(window))}var ye;(function(e){e.Documents="DOCUMENTS",e.Data="DATA",e.Library="LIBRARY",e.Cache="CACHE",e.External="EXTERNAL",e.ExternalStorage="EXTERNAL_STORAGE",e.ExternalCache="EXTERNAL_CACHE",e.LibraryNoCloud="LIBRARY_NO_CLOUD",e.Temporary="TEMPORARY"})(ye||(ye={}));var Ce;(function(e){e.UTF8="utf8",e.ASCII="ascii",e.UTF16="utf16"})(Ce||(Ce={}));const je=z("Filesystem",{web:()=>Oe(()=>import("./web-CMC50H_5.js"),[]).then(e=>new e.FilesystemWeb)});kt();const Ut=z("Share",{web:()=>Oe(()=>import("./web-BUNy4-Ze.js"),[]).then(e=>new e.ShareWeb)});class Mt{constructor(t){this.sqlite=t,this._connectionDict=new Map}async initWebStore(){try{return await this.sqlite.initWebStore(),Promise.resolve()}catch(t){return Promise.reject(t)}}async saveToStore(t){try{return await this.sqlite.saveToStore({database:t}),Promise.resolve()}catch(a){return Promise.reject(a)}}async saveToLocalDisk(t){try{return await this.sqlite.saveToLocalDisk({database:t}),Promise.resolve()}catch(a){return Promise.reject(a)}}async getFromLocalDiskToStore(t){const a=t??!0;try{return await this.sqlite.getFromLocalDiskToStore({overwrite:a}),Promise.resolve()}catch(r){return Promise.reject(r)}}async echo(t){try{const a=await this.sqlite.echo({value:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async isSecretStored(){try{const t=await this.sqlite.isSecretStored();return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async setEncryptionSecret(t){try{return await this.sqlite.setEncryptionSecret({passphrase:t}),Promise.resolve()}catch(a){return Promise.reject(a)}}async changeEncryptionSecret(t,a){try{return await this.sqlite.changeEncryptionSecret({passphrase:t,oldpassphrase:a}),Promise.resolve()}catch(r){return Promise.reject(r)}}async clearEncryptionSecret(){try{return await this.sqlite.clearEncryptionSecret(),Promise.resolve()}catch(t){return Promise.reject(t)}}async checkEncryptionSecret(t){try{const a=await this.sqlite.checkEncryptionSecret({passphrase:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async addUpgradeStatement(t,a){try{return t.endsWith(".db")&&(t=t.slice(0,-3)),await this.sqlite.addUpgradeStatement({database:t,upgrade:a}),Promise.resolve()}catch(r){return Promise.reject(r)}}async createConnection(t,a,r,n,s){try{t.endsWith(".db")&&(t=t.slice(0,-3)),await this.sqlite.createConnection({database:t,encrypted:a,mode:r,version:n,readonly:s});const i=new He(t,s,this.sqlite),c=s?`RO_${t}`:`RW_${t}`;return this._connectionDict.set(c,i),Promise.resolve(i)}catch(i){return Promise.reject(i)}}async closeConnection(t,a){try{t.endsWith(".db")&&(t=t.slice(0,-3)),await this.sqlite.closeConnection({database:t,readonly:a});const r=a?`RO_${t}`:`RW_${t}`;return this._connectionDict.delete(r),Promise.resolve()}catch(r){return Promise.reject(r)}}async isConnection(t,a){const r={};t.endsWith(".db")&&(t=t.slice(0,-3));const n=a?`RO_${t}`:`RW_${t}`;return r.result=this._connectionDict.has(n),Promise.resolve(r)}async retrieveConnection(t,a){t.endsWith(".db")&&(t=t.slice(0,-3));const r=a?`RO_${t}`:`RW_${t}`;if(this._connectionDict.has(r)){const n=this._connectionDict.get(r);return typeof n<"u"?Promise.resolve(n):Promise.reject(`Connection ${t} is undefined`)}else return Promise.reject(`Connection ${t} does not exist`)}async getNCDatabasePath(t,a){try{const r=await this.sqlite.getNCDatabasePath({path:t,database:a});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async createNCConnection(t,a){try{await this.sqlite.createNCConnection({databasePath:t,version:a});const r=new He(t,!0,this.sqlite),n=`RO_${t})`;return this._connectionDict.set(n,r),Promise.resolve(r)}catch(r){return Promise.reject(r)}}async closeNCConnection(t){try{await this.sqlite.closeNCConnection({databasePath:t});const a=`RO_${t})`;return this._connectionDict.delete(a),Promise.resolve()}catch(a){return Promise.reject(a)}}async isNCConnection(t){const a={},r=`RO_${t})`;return a.result=this._connectionDict.has(r),Promise.resolve(a)}async retrieveNCConnection(t){if(this._connectionDict.has(t)){const a=`RO_${t})`,r=this._connectionDict.get(a);return typeof r<"u"?Promise.resolve(r):Promise.reject(`Connection ${t} is undefined`)}else return Promise.reject(`Connection ${t} does not exist`)}async isNCDatabase(t){try{const a=await this.sqlite.isNCDatabase({databasePath:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async retrieveAllConnections(){return this._connectionDict}async closeAllConnections(){const t=new Map;try{for(const a of this._connectionDict.keys()){const r=a.substring(3),n=a.substring(0,3)==="RO_";await this.sqlite.closeConnection({database:r,readonly:n}),t.set(a,null)}for(const a of t.keys())this._connectionDict.delete(a);return Promise.resolve()}catch(a){return Promise.reject(a)}}async checkConnectionsConsistency(){try{const t=[...this._connectionDict.keys()],a=[],r=[];for(const s of t)a.push(s.substring(0,2)),r.push(s.substring(3));const n=await this.sqlite.checkConnectionsConsistency({dbNames:r,openModes:a});return n.result||(this._connectionDict=new Map),Promise.resolve(n)}catch(t){return this._connectionDict=new Map,Promise.reject(t)}}async importFromJson(t){try{const a=await this.sqlite.importFromJson({jsonstring:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async isJsonValid(t){try{const a=await this.sqlite.isJsonValid({jsonstring:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async copyFromAssets(t){const a=t??!0;try{return await this.sqlite.copyFromAssets({overwrite:a}),Promise.resolve()}catch(r){return Promise.reject(r)}}async getFromHTTPRequest(t,a){const r=a??!0;try{return await this.sqlite.getFromHTTPRequest({url:t,overwrite:r}),Promise.resolve()}catch(n){return Promise.reject(n)}}async isDatabaseEncrypted(t){t.endsWith(".db")&&(t=t.slice(0,-3));try{const a=await this.sqlite.isDatabaseEncrypted({database:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async isInConfigEncryption(){try{const t=await this.sqlite.isInConfigEncryption();return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isInConfigBiometricAuth(){try{const t=await this.sqlite.isInConfigBiometricAuth();return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isDatabase(t){t.endsWith(".db")&&(t=t.slice(0,-3));try{const a=await this.sqlite.isDatabase({database:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async getDatabaseList(){try{const a=(await this.sqlite.getDatabaseList()).values;a.sort();const r={values:a};return Promise.resolve(r)}catch(t){return Promise.reject(t)}}async getMigratableDbList(t){const a=t||"default";try{const r=await this.sqlite.getMigratableDbList({folderPath:a});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async addSQLiteSuffix(t,a){const r=t||"default",n=a||[];try{const s=await this.sqlite.addSQLiteSuffix({folderPath:r,dbNameList:n});return Promise.resolve(s)}catch(s){return Promise.reject(s)}}async deleteOldDatabases(t,a){const r=t||"default",n=a||[];try{const s=await this.sqlite.deleteOldDatabases({folderPath:r,dbNameList:n});return Promise.resolve(s)}catch(s){return Promise.reject(s)}}async moveDatabasesAndAddSuffix(t,a){const r=t||"default",n=a||[];return this.sqlite.moveDatabasesAndAddSuffix({folderPath:r,dbNameList:n})}}class He{constructor(t,a,r){this.dbName=t,this.readonly=a,this.sqlite=r}getConnectionDBName(){return this.dbName}getConnectionReadOnly(){return this.readonly}async open(){try{return await this.sqlite.open({database:this.dbName,readonly:this.readonly}),Promise.resolve()}catch(t){return Promise.reject(t)}}async close(){try{return await this.sqlite.close({database:this.dbName,readonly:this.readonly}),Promise.resolve()}catch(t){return Promise.reject(t)}}async beginTransaction(){try{const t=await this.sqlite.beginTransaction({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async commitTransaction(){try{const t=await this.sqlite.commitTransaction({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async rollbackTransaction(){try{const t=await this.sqlite.rollbackTransaction({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isTransactionActive(){try{const t=await this.sqlite.isTransactionActive({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async loadExtension(t){try{return await this.sqlite.loadExtension({database:this.dbName,path:t,readonly:this.readonly}),Promise.resolve()}catch(a){return Promise.reject(a)}}async enableLoadExtension(t){try{return await this.sqlite.enableLoadExtension({database:this.dbName,toggle:t,readonly:this.readonly}),Promise.resolve()}catch(a){return Promise.reject(a)}}async getUrl(){try{const t=await this.sqlite.getUrl({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async getVersion(){try{const t=await this.sqlite.getVersion({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async getTableList(){try{const t=await this.sqlite.getTableList({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async execute(t,a=!0,r=!0){try{if(this.readonly)return Promise.reject("not allowed in read-only mode");{const n=await this.sqlite.execute({database:this.dbName,statements:t,transaction:a,readonly:!1,isSQL92:r});return Promise.resolve(n)}}catch(n){return Promise.reject(n)}}async query(t,a,r=!0){let n;try{return a&&a.length>0?n=await this.sqlite.query({database:this.dbName,statement:t,values:a,readonly:this.readonly,isSQL92:!0}):n=await this.sqlite.query({database:this.dbName,statement:t,values:[],readonly:this.readonly,isSQL92:r}),n=await this.reorderRows(n),Promise.resolve(n)}catch(s){return Promise.reject(s)}}async run(t,a,r=!0,n="no",s=!0){let i;try{return this.readonly?Promise.reject("not allowed in read-only mode"):(a&&a.length>0?i=await this.sqlite.run({database:this.dbName,statement:t,values:a,transaction:r,readonly:!1,returnMode:n,isSQL92:!0}):i=await this.sqlite.run({database:this.dbName,statement:t,values:[],transaction:r,readonly:!1,returnMode:n,isSQL92:s}),i.changes=await this.reorderRows(i.changes),Promise.resolve(i))}catch(c){return Promise.reject(c)}}async executeSet(t,a=!0,r="no",n=!0){let s;try{return this.readonly?Promise.reject("not allowed in read-only mode"):(s=await this.sqlite.executeSet({database:this.dbName,set:t,transaction:a,readonly:!1,returnMode:r,isSQL92:n}),s.changes=await this.reorderRows(s.changes),Promise.resolve(s))}catch(i){return Promise.reject(i)}}async isExists(){try{const t=await this.sqlite.isDBExists({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isTable(t){try{const a=await this.sqlite.isTableExists({database:this.dbName,table:t,readonly:this.readonly});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async isDBOpen(){try{const t=await this.sqlite.isDBOpen({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async delete(){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.deleteDatabase({database:this.dbName,readonly:!1}),Promise.resolve())}catch(t){return Promise.reject(t)}}async createSyncTable(){try{if(this.readonly)return Promise.reject("not allowed in read-only mode");{const t=await this.sqlite.createSyncTable({database:this.dbName,readonly:!1});return Promise.resolve(t)}}catch(t){return Promise.reject(t)}}async setSyncDate(t){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.setSyncDate({database:this.dbName,syncdate:t,readonly:!1}),Promise.resolve())}catch(a){return Promise.reject(a)}}async getSyncDate(){try{const t=await this.sqlite.getSyncDate({database:this.dbName,readonly:this.readonly});let a="";return t.syncDate>0&&(a=new Date(t.syncDate*1e3).toISOString()),Promise.resolve(a)}catch(t){return Promise.reject(t)}}async exportToJson(t,a=!1){try{const r=await this.sqlite.exportToJson({database:this.dbName,jsonexportmode:t,readonly:this.readonly,encrypted:a});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async deleteExportedRows(){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.deleteExportedRows({database:this.dbName,readonly:!1}),Promise.resolve())}catch(t){return Promise.reject(t)}}async executeTransaction(t,a=!0){let r=0,n=!1;if(this.readonly)return Promise.reject("not allowed in read-only mode");if(await this.sqlite.beginTransaction({database:this.dbName}),n=await this.sqlite.isTransactionActive({database:this.dbName}),!n)return Promise.reject("After Begin Transaction, no transaction active");try{for(const c of t){if(typeof c!="object"||!("statement"in c))throw new Error("Error a task.statement must be provided");if("values"in c&&c.values&&c.values.length>0){const l=c.statement.toUpperCase().includes("RETURNING")?"all":"no",d=await this.sqlite.run({database:this.dbName,statement:c.statement,values:c.values,transaction:!1,readonly:!1,returnMode:l,isSQL92:a});if(d.changes.changes<0)throw new Error("Error in transaction method run ");r+=d.changes.changes}else{const l=await this.sqlite.execute({database:this.dbName,statements:c.statement,transaction:!1,readonly:!1});if(l.changes.changes<0)throw new Error("Error in transaction method execute ");r+=l.changes.changes}}const s=await this.sqlite.commitTransaction({database:this.dbName});r+=s.changes.changes;const i={changes:{changes:r}};return Promise.resolve(i)}catch(s){const i=s.message?s.message:s;return await this.sqlite.rollbackTransaction({database:this.dbName}),Promise.reject(i)}}async reorderRows(t){const a=t;if(t?.values&&typeof t.values[0]=="object"&&Object.keys(t.values[0]).includes("ios_columns")){const r=t.values[0].ios_columns,n=[];for(let s=1;s<t.values.length;s++){const i=t.values[s],c={};for(const l of r)c[l]=i[l];n.push(c)}a.values=n}return Promise.resolve(a)}}const Bt=z("CapacitorSQLite",{web:()=>Oe(()=>import("./web-DVbH7eBX.js"),[]).then(e=>new e.CapacitorSQLiteWeb),electron:()=>window.CapacitorCustomPlatform.plugins.CapacitorSQLite});function _t(e){return e.replace(/^(add[- ]?on|additional)\s+/i,"").trim()}const jt="laba101_offline",he="fresh_start_reset_v1",Ht=new Mt(Bt);let ue=null;const H=[{id:1,name:"Laba101 Admin",email:"admin@laba101.test",password:"password",role:"admin",branch:"Main Store"},{id:2,name:"Gensan Staff",email:"staff@laba101.gensan",password:"password",role:"staff",branch:"Gensan Branch"}],ge=[],V=[M(1,"Drop-off","Wash, dry and fold.","Drop-Off","order",185,8,40,["Wash","Dry","Fold"],0,24),M(2,"Full Service","Wash, dry, fold, detergent and Fabcon.","Full Service","order",200,8,40,["Wash","Dry","Fold","Detergent","Fabcon"],0,24),M(3,"Self Service Wash","Max of 8kg per load.","Self Service","order",60,8,null,["Wash"],0,1),M(4,"Self Service Dry","Regular time: 40 mins drying time.","Self Service","order",70,8,40,["Dry"],0,1),M(5,"Dry Only","Standard drying rate.","Dry Only","order",70,8,40,["Dry"],0,1),M(6,"Additional Dry 10 mins","Additional drying time.","Add-on","addon",30,8,10,["Dry"],0,1),M(7,"Additional Dry 20 mins","Additional drying time.","Add-on","addon",50,8,20,["Dry"],0,1),M(8,"Additional Dry 40 mins","Additional drying time.","Add-on","addon",70,8,40,["Dry"],0,1),M(9,"Additional Zonrox","Extra Zonrox bleach add-on per load.","Add-on","addon",25,0,null,["Zonrox"],0,0),M(10,"Additional Fabcon","Extra Fabcon fabric conditioner add-on per load.","Add-on","addon",25,0,null,["Fabcon"],0,0),M(11,"Comforter / Bulky Load","Comforter 4kg max per load. Thin blankets, bedsheets, bath towels, pillow cases and curtains: 6kg max per load.","Comforter","order",200,8,40,["Wash","Dry","Fold"],0,24)],Q=[{id:1,name:"Regular Clothes",maxKg:8,additionalFee:0,isActive:1},{id:2,name:"Comforter",maxKg:4,additionalFee:0,isActive:1},{id:3,name:"Thin Blankets",maxKg:6,additionalFee:0,isActive:1},{id:4,name:"Bedsheets",maxKg:6,additionalFee:0,isActive:1},{id:5,name:"Bath Towels",maxKg:6,additionalFee:0,isActive:1},{id:6,name:"Curtains",maxKg:6,additionalFee:0,isActive:1}];function We(e,t){const a=L(e,[]),r=new Map(a.map(s=>[s.id,s])),n=t.map(s=>{const i=r.get(s.id);return i?{...s,...i,isActive:i.isActive??s.isActive}:s});(a.length!==n.length||n.some((s,i)=>s.id!==a[i]?.id||JSON.stringify(s)!==JSON.stringify(a[i])))&&E(e,n)}async function Wt(){We("services",V),We("item_categories",Q)}async function Ee(e){for(const t of V)((await e.query("SELECT id FROM laundry_services WHERE id = ?",[t.id])).values??[]).length>0?await e.run("UPDATE laundry_services SET name = ?, description = ?, category = ?, serviceType = ?, price = ?, maxKg = ?, dryingMinutes = ?, includes = ?, additionalCharge = ?, turnaroundHours = ?, isActive = COALESCE(isActive, ?) WHERE id = ?",[t.name,t.description,t.category,t.serviceType,t.price,t.maxKg,t.dryingMinutes,JSON.stringify(t.includes),t.additionalCharge,t.turnaroundHours,t.isActive,t.id]):await e.run("INSERT INTO laundry_services (id, name, description, category, serviceType, price, maxKg, dryingMinutes, includes, additionalCharge, turnaroundHours, isActive) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",[t.id,t.name,t.description,t.category,t.serviceType,t.price,t.maxKg,t.dryingMinutes,JSON.stringify(t.includes),t.additionalCharge,t.turnaroundHours,t.isActive]);for(const t of Q)((await e.query("SELECT id FROM item_categories WHERE id = ?",[t.id])).values??[]).length>0?await e.run("UPDATE item_categories SET name = ?, maxKg = ?, additionalFee = ?, isActive = COALESCE(isActive, ?) WHERE id = ?",[t.name,t.maxKg,t.additionalFee,t.isActive,t.id]):await e.run("INSERT INTO item_categories (id, name, maxKg, additionalFee, isActive) VALUES (?, ?, ?, ?, ?)",[t.id,t.name,t.maxKg,t.additionalFee,t.isActive])}const ae=[],be=[],ie=[],oe=[],re=[],X=[...[1,2,3,4].map(e=>({id:e,machineName:`Washer ${e}`,machineType:"washer",status:"available",branch:"Main Store"})),...[1,2,3,4].map(e=>({id:e+4,machineName:`Dryer ${e}`,machineType:"dryer",status:"available",branch:"Main Store"}))],ne=[{key:"branch",value:"Main Store"},{key:"fold_rate",value:"5"},{key:"report_email",value:"admin@laba101.test"}];function M(e,t,a,r,n,s,i,c,l,d,p){return{id:e,name:t,description:a,category:r,serviceType:n,price:s,maxKg:i,dryingMinutes:c,includes:l,additionalCharge:d,turnaroundHours:p,isActive:1}}function F(e){return`laba101-mobile-${e}`}function L(e,t){const a=localStorage.getItem(F(e));if(!a)return structuredClone(t);try{return JSON.parse(a)}catch{return structuredClone(t)}}function E(e,t){localStorage.setItem(F(e),JSON.stringify(t))}function k(e){return e.reduce((t,a)=>Math.max(t,a.id),0)+1}function J(){return new Date().toISOString()}function $e(e=new Date){const t=e.getFullYear(),a=String(e.getMonth()+1).padStart(2,"0"),r=String(e.getDate()).padStart(2,"0");return`${t}-${a}-${r}`}function Xt(){return $e().slice(2).replaceAll("-","")}function K(e,t){if(!e)return t;try{return JSON.parse(e)}catch{return t}}async function C(){return ue||(ue=await Ht.createConnection(jt,!1,"no-encryption",1,!1),await ue.open()),ue}async function P(e,t,a,r){((await e.query(`PRAGMA table_info(${t})`)).values??[]).some(i=>i.name===a)||await e.execute(`ALTER TABLE ${t} ADD COLUMN ${a} ${r}`)}function Kt(){const e=L("staff",H),t=new Map(e.map(r=>[r.id,r]));let a=!1;for(const r of H){const n=t.get(r.id);if(!n){t.set(r.id,{...r,isActive:1}),a=!0;continue}const s={...n,name:r.name,email:r.email,password:r.password,role:r.role,branch:r.branch,isActive:1};JSON.stringify(s)!==JSON.stringify(n)&&(t.set(r.id,s),a=!0)}a&&E("staff",Array.from(t.values()).sort((r,n)=>r.id-n.id))}async function Gt(){localStorage.getItem(F(he))||(E("staff",H),E("customers",[]),E("orders",[]),E("payments",[]),E("fold_logs",[]),E("expenses",[]),E("sales",[]),localStorage.getItem(F("services"))||E("services",V),localStorage.getItem(F("item_categories"))||E("item_categories",Q),localStorage.getItem(F("machines"))||E("machines",X),localStorage.getItem(F("subcleanings"))||E("subcleanings",[]),localStorage.getItem(F("settings"))||E("settings",ne),localStorage.removeItem("laba101-mobile-session"),E(he,!0))}async function rt(e){for(const t of H){if(((await e.query("SELECT id FROM staff WHERE id = ?",[t.id])).values??[]).length>0){await e.run("UPDATE staff SET name = ?, email = ?, password = ?, role = ?, branch = ?, isActive = 1 WHERE id = ?",[t.name,t.email,t.password,t.role,t.branch,t.id]);continue}await e.run("INSERT INTO staff (id, name, email, password, role, branch, isActive) VALUES (?, ?, ?, ?, ?, ?, ?)",[t.id,t.name,t.email,t.password,t.role,t.branch,1])}}async function Vt(e){if(!(((await e.query("SELECT COUNT(*) as count FROM machines")).values?.[0]?.count??0)>0))for(const a of X)await e.run("INSERT INTO machines (id, machineName, machineType, status, branch) VALUES (?, ?, ?, ?, ?)",[a.id,a.machineName,a.machineType,a.status,a.branch])}async function Yt(e){for(const t of ne)await e.run("INSERT OR IGNORE INTO settings (key, value) VALUES (?, ?)",[t.key,t.value])}async function Qt(e){((await e.query("SELECT value FROM settings WHERE key = ?",[he])).values??[]).length>0||(await e.execute(`
  ...
  `),await rt(e),await Vt(e),await Yt(e),await e.run("INSERT OR REPLACE INTO settings (key, value) VALUES (?, ?)",[he,J()]),localStorage.removeItem("laba101-mobile-session"))}async function Jt(){if(!A.isNativePlatform()){await Gt(),!localStorage.getItem(F("seeded_v4"))&&!localStorage.getItem(F("services"))&&!localStorage.getItem(F("staff"))&&(E("staff",H),E("customers",ge),E("services",V),E("item_categories",Q),E("orders",ae),E("payments",be),E("fold_logs",[]),E("expenses",ie),E("sales",oe),E("revolving_history",re),E("machines",X),E("subcleanings",[]),E("settings",ne),E("seeded_v4",!0)),await Wt(),Kt(),localStorage.getItem(F("seeded_v4"))||E("seeded_v4",!0);return}const e=await C();if(await e.execute(`
  ...
  `),await P(e,"staff","email","TEXT"),await P(e,"staff","password","TEXT"),await P(e,"staff","role","TEXT"),await P(e,"staff","isActive","INTEGER NOT NULL DEFAULT 1"),await e.run('UPDATE staff SET password = ? WHERE password IS NULL OR password = ""',["password"]),await e.run('UPDATE staff SET role = ? WHERE role IS NULL OR role = ""',["staff"]),await P(e,"orders","customerId","INTEGER NOT NULL DEFAULT 0"),await P(e,"orders","phone","TEXT"),await P(e,"orders","serviceId","INTEGER NOT NULL DEFAULT 0"),await P(e,"orders","serviceLines","TEXT"),await P(e,"orders","itemCategoryId","INTEGER NOT NULL DEFAULT 0"),await P(e,"orders","itemCategory",'TEXT NOT NULL DEFAULT "Regular Clothes"'),await P(e,"orders","workflowCompleted","TEXT"),await P(e,"orders","weightKg","REAL NOT NULL DEFAULT 0"),await P(e,"orders","price","REAL NOT NULL DEFAULT 0"),await P(e,"orders","additionalCharge","REAL NOT NULL DEFAULT 0"),await P(e,"orders","extraServiceAmount","REAL NOT NULL DEFAULT 0"),await P(e,"orders","totalAmount","REAL NOT NULL DEFAULT 0"),await P(e,"orders","paidAmount","REAL NOT NULL DEFAULT 0"),await P(e,"orders","extras","TEXT"),await P(e,"orders","notes","TEXT"),await P(e,"orders","dueAt","TEXT"),await P(e,"orders","createdAt",'TEXT NOT NULL DEFAULT ""'),await P(e,"daily_sales","saleNumber","TEXT"),await P(e,"daily_sales","status","TEXT"),await P(e,"daily_sales","endorsedTo","TEXT"),await P(e,"daily_sales","statusUpdatedAt","TEXT"),((await e.query("SELECT COUNT(*) as count FROM staff")).values?.[0]?.count??0)===0){for(const a of H)await e.run("INSERT INTO staff (id, name, email, password, role, branch, isActive) VALUES (?, ?, ?, ?, ?, ?, ?)",[a.id,a.name,a.email,a.password,a.role,a.branch,1]);for(const a of ge)await e.run("INSERT INTO customers (id, name, phone, address) VALUES (?, ?, ?, ?)",[a.id,a.name,a.phone,a.address]);for(const a of V)await e.run("INSERT INTO laundry_services (id, name, description, category, serviceType, price, maxKg, dryingMinutes, includes, additionalCharge, turnaroundHours, isActive) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",[a.id,a.name,a.description,a.category,a.serviceType,a.price,a.maxKg,a.dryingMinutes,JSON.stringify(a.includes),a.additionalCharge,a.turnaroundHours,a.isActive]);for(const a of Q)await e.run("INSERT INTO item_categories (id, name, maxKg, additionalFee, isActive) VALUES (?, ?, ?, ?, ?)",[a.id,a.name,a.maxKg,a.additionalFee,a.isActive]);for(const a of ae)await nt(e,a);for(const a of be)await e.run("INSERT INTO payments (id, orderId, amount, method, reference, receivedAt, branch) VALUES (?, ?, ?, ?, ?, ?, ?)",[a.id,a.orderId,a.amount,a.method,a.reference,a.receivedAt,a.branch]);for(const a of ie)await e.run("INSERT INTO disbursement_expenses (id, expenseDate, number, name, category, description, amount) VALUES (?, ?, ?, ?, ?, ?, ?)",[a.id,a.expenseDate,a.number,a.name,a.category,a.description,a.amount]);for(const a of oe)await e.run("INSERT INTO daily_sales (id, saleDate, saleNumber, cashAmount, gcashAmount, totalAmount, notes) VALUES (?, ?, ?, ?, ?, ?, ?)",[a.id,a.saleDate,a.saleNumber,a.cashAmount,a.gcashAmount,a.totalAmount,a.notes]);for(const a of re)await e.run("INSERT INTO revolving_history (id, revolvingNumber, name, amount, category, description, type, createdAt) VALUES (?, ?, ?, ?, ?, ?, ?, ?)",[a.id,a.revolvingNumber,a.name,a.amount,a.category,a.description,a.type,a.createdAt]);for(const a of X)await e.run("INSERT INTO machines (id, machineName, machineType, status, branch) VALUES (?, ?, ?, ?, ?)",[a.id,a.machineName,a.machineType,a.status,a.branch]);for(const a of ne)await e.run("INSERT INTO settings (key, value) VALUES (?, ?)",[a.key,a.value])}await Ee(e),await rt(e),await Qt(e)}async function nt(e,t){await e.run("INSERT INTO orders (id, ticket, customerId, customer, phone, serviceId, service, serviceLines, itemCategoryId, itemCategory, branch, status, workflowCompleted, weightKg, price, additionalCharge, extraServiceAmount, totalAmount, paidAmount, extras, notes, foldedBy, dueAt, createdAt) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",[t.id,t.ticket,t.customerId,t.customer,t.phone,t.serviceId,t.service,JSON.stringify(t.serviceLines??[]),t.itemCategoryId,t.itemCategory,t.branch,t.status,JSON.stringify(t.workflowCompleted),t.weightKg,t.price,t.additionalCharge,t.extraServiceAmount,t.totalAmount,t.paidAmount,JSON.stringify(t.extras),t.notes,t.foldedBy,t.dueAt,t.createdAt])}function zt(e){const t=Number(e.paidAmount??0),a=Number(e.totalAmount??0),r=Number(e.foldedBy),n=K(e.serviceLines,[]),s=Number(e.serviceId),i=String(e.service),c=Number(e.price);return{id:Number(e.id),ticket:String(e.ticket),customerId:Number(e.customerId),customer:String(e.customer),phone:e.phone?String(e.phone):null,serviceId:s,service:i,serviceLines:n.length?n:[{id:s,name:i,price:c,quantity:1,total:c}],itemCategoryId:Number(e.itemCategoryId),itemCategory:String(e.itemCategory),branch:String(e.branch),status:String(e.status),workflowCompleted:K(e.workflowCompleted,[]),weightKg:Number(e.weightKg),price:c,additionalCharge:Number(e.additionalCharge),extraServiceAmount:Number(e.extraServiceAmount),totalAmount:a,paidAmount:t,balance:Number((a-t).toFixed(2)),extras:K(e.extras,[]),notes:e.notes?String(e.notes):null,foldedBy:Number.isFinite(r)&&r>0?r:null,foldedByName:e.foldedByName?String(e.foldedByName):null,dueAt:String(e.dueAt),createdAt:String(e.createdAt)}}async function Zt(){await Jt()}async function we(){return(await Pe()).find(t=>t.key==="branch")?.value??"Main Store"}async function ea(){const e=await Pe();return Number(e.find(t=>t.key==="fold_rate")?.value??"5")}async function st(e){return(await Pe()).find(a=>a.key===e)?.value}async function Pe(){return A.isNativePlatform()?(await(await C()).query("SELECT key, value FROM settings ORDER BY key")).values??[]:L("settings",ne)}async function fe(e,t){if(!A.isNativePlatform()){const r=L("settings",ne).filter(n=>n.key!==e);r.push({key:e,value:t}),E("settings",r);return}await(await C()).run("REPLACE INTO settings (key, value) VALUES (?, ?)",[e,t])}async function ta(e){return A.isNativePlatform()?(await(await C()).query('SELECT id, name, COALESCE(email, "") as email, COALESCE(password, "password") as password, COALESCE(role, "staff") as role, branch, COALESCE(isActive, 1) as isActive FROM staff WHERE branch = ? ORDER BY name ASC',[e])).values??[]:L("staff",H).filter(r=>r.branch===e)}async function it(){return A.isNativePlatform()?(await(await C()).query('SELECT id, name, COALESCE(email, "") as email, COALESCE(password, "password") as password, COALESCE(role, "staff") as role, branch, COALESCE(isActive, 1) as isActive FROM staff ORDER BY name ASC')).values??[]:L("staff",H)}async function ot(e,t){const a=e.trim().toLowerCase();return(await it()).find(n=>n.email.toLowerCase()===a&&n.password===t&&n.isActive!==0)??null}async function aa(e){if(!A.isNativePlatform()){const a=L("staff",H);a.unshift({id:k(a),...e,isActive:1}),E("staff",a);return}await(await C()).run("INSERT INTO staff (name, email, password, role, branch, isActive) VALUES (?, ?, ?, ?, ?, ?)",[e.name,e.email,e.password,e.role,e.branch,1])}async function Xe(e,t){if(!A.isNativePlatform()){const s=L("staff",H),i=s.find(c=>c.id===e);i&&(Object.assign(i,t),E("staff",s));return}const a=await C(),r=[],n=[];for(const[s,i]of Object.entries(t))s!=="id"&&(r.push(`${s} = ?`),n.push(i));r.length&&(n.push(e),await a.run(`UPDATE staff SET ${r.join(", ")} WHERE id = ?`,n))}async function ra(){return A.isNativePlatform()?(await(await C()).query("SELECT id, name, phone, address FROM customers ORDER BY name ASC")).values??[]:L("customers",ge).sort((a,r)=>a.name.localeCompare(r.name))}async function na(e){if(!A.isNativePlatform()){const n=L("customers",ge),s=e.id?n.find(c=>c.id===e.id):n.find(c=>c.name.toLowerCase()===e.name.toLowerCase()&&(e.phone?c.phone===e.phone:!0));if(s)return s.name=e.name,s.phone=e.phone??s.phone,s.address=e.address??s.address,E("customers",n),s;const i={id:k(n),name:e.name,phone:e.phone??null,address:e.address??null};return n.push(i),E("customers",n),i}const t=await C();if(e.id)return await t.run("UPDATE customers SET name = ?, phone = ?, address = ? WHERE id = ?",[e.name,e.phone??null,e.address??null,e.id]),{id:e.id,name:e.name,phone:e.phone??null,address:e.address??null};const a=await t.query("SELECT COALESCE(MAX(id), 0) + 1 as id FROM customers"),r=Number((a.values?.[0]).id);return await t.run("INSERT INTO customers (id, name, phone, address) VALUES (?, ?, ?, ?)",[r,e.name,e.phone??null,e.address??null]),{id:r,name:e.name,phone:e.phone??null,address:e.address??null}}async function De(e){if(!A.isNativePlatform())return L("services",V).filter(r=>!0);const t=await C(),a=await t.query("SELECT id, name, description, category, serviceType, price, maxKg, dryingMinutes, includes, additionalCharge, turnaroundHours, isActive FROM laundry_services  ORDER BY name ASC",[]);return(a.values??[]).length===0?(await Ee(t),((await t.query("SELECT id, name, description, category, serviceType, price, maxKg, dryingMinutes, includes, additionalCharge, turnaroundHours, isActive FROM laundry_services  ORDER BY name ASC",[])).values??[]).map(n=>({...n,includes:K(n.includes,[])}))):(a.values??[]).map(r=>({...r,includes:K(r.includes,[])}))}async function sa(){if(!A.isNativePlatform())return L("services",V);const e=await C(),t=await e.query("SELECT id, name, description, category, serviceType, price, maxKg, dryingMinutes, includes, additionalCharge, turnaroundHours, isActive FROM laundry_services ORDER BY name ASC");return(t.values??[]).length===0?(await Ee(e),((await e.query("SELECT id, name, description, category, serviceType, price, maxKg, dryingMinutes, includes, additionalCharge, turnaroundHours, isActive FROM laundry_services ORDER BY name ASC")).values??[]).map(r=>({...r,includes:K(r.includes,[])}))):(t.values??[]).map(a=>({...a,includes:K(a.includes,[])}))}async function Ke(e){if(!A.isNativePlatform()){const a=L("services",V),r=e.id?a.find(n=>n.id===e.id):null;r?Object.assign(r,e):a.unshift({...e,id:k(a)}),E("services",a);return}const t=await C();e.id?await t.run("UPDATE laundry_services SET name = ?, description = ?, category = ?, serviceType = ?, price = ?, maxKg = ?, dryingMinutes = ?, includes = ?, additionalCharge = ?, turnaroundHours = ?, isActive = ? WHERE id = ?",[e.name,e.description,e.category,e.serviceType,e.price,e.maxKg,e.dryingMinutes,JSON.stringify(e.includes),e.additionalCharge,e.turnaroundHours,e.isActive,e.id]):await t.run("INSERT INTO laundry_services (name, description, category, serviceType, price, maxKg, dryingMinutes, includes, additionalCharge, turnaroundHours, isActive) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",[e.name,e.description,e.category,e.serviceType,e.price,e.maxKg,e.dryingMinutes,JSON.stringify(e.includes),e.additionalCharge,e.turnaroundHours,e.isActive])}async function ct(){if(!A.isNativePlatform())return L("item_categories",Q).filter(a=>a.isActive);const e=await C(),t=await e.query("SELECT id, name, maxKg, additionalFee, isActive FROM item_categories WHERE isActive = 1 ORDER BY name ASC");return(t.values??[]).length===0?(await Ee(e),(await e.query("SELECT id, name, maxKg, additionalFee, isActive FROM item_categories WHERE isActive = 1 ORDER BY name ASC")).values??[]):t.values??[]}async function ia(e){if(!A.isNativePlatform()){const a=L("item_categories",Q),r=e.id?a.find(n=>n.id===e.id):null;r?Object.assign(r,e):a.unshift({...e,id:k(a)}),E("item_categories",a);return}const t=await C();e.id?await t.run("UPDATE item_categories SET name = ?, maxKg = ?, additionalFee = ?, isActive = ? WHERE id = ?",[e.name,e.maxKg,e.additionalFee,e.isActive,e.id]):await t.run("INSERT INTO item_categories (name, maxKg, additionalFee, isActive) VALUES (?, ?, ?, ?)",[e.name,e.maxKg,e.additionalFee,e.isActive])}function lt(e,t,a,r){const n=(Array.isArray(e)?e:[e]).map(f=>{const v=Math.max(0,Number(f.quantity??1)),g=Number(f.price);return{id:f.id,name:f.name,price:g,quantity:v,total:Number((g*v).toFixed(2))}}).filter(f=>f.quantity>0),s=Number(t.maxKg),i=0,c=0,l=r.map(f=>{const v=Math.max(0,Number(f.quantity??1)),g=Number(f.price);return{id:f.id,name:_t(f.name),price:g,quantity:v,total:Number((g*v).toFixed(2))}}).filter(f=>f.quantity>0),d=n.reduce((f,v)=>f+v.total,0),p=l.reduce((f,v)=>f+v.total,0),u=Number((d+c+p).toFixed(2));return{price:Number(d.toFixed(2)),additionalCharge:Number(c.toFixed(2)),extraServiceAmount:Number(p.toFixed(2)),totalAmount:u,allowedKg:s,extraKg:Number(i.toFixed(2)),warning:null,serviceLines:n,extras:l}}function dt(e,t){const a=e.serviceLines?.length?e.serviceLines.map(i=>i.id):[e.serviceId],r=t.filter(i=>a.includes(i.id)),n=Array.from(new Set(r.flatMap(i=>i.includes??[]))),s=[{key:"received",label:"Received"}];return n.includes("Wash")&&s.push({key:"wash",label:"Wash"}),e.extras.length&&s.push({key:"extras",label:"Extra services"}),(n.includes("Dry")||r.some(i=>(i.dryingMinutes??0)>0))&&s.push({key:"dry",label:"Dry"}),n.includes("Fold")&&s.push({key:"fold",label:"Fold"}),s.push({key:"ready",label:"Ready"},{key:"claimed",label:"Claimed"}),s}function oa(e){return e.includes("claimed")?"claimed":e.includes("ready")?"ready":e.includes("dry")?"drying":e.includes("extras")||e.includes("wash")?"washing":"received"}async function Te(e){return A.isNativePlatform()?((await(await C()).query("SELECT o.*, s.name as foldedByName FROM orders o LEFT JOIN staff s ON s.id = o.foldedBy WHERE o.branch = ? ORDER BY o.id DESC",[e])).values??[]).map(r=>zt(r)):L("orders",ae).filter(r=>r.branch===e).map(r=>({...r,serviceLines:r.serviceLines??[{id:r.serviceId,name:r.service,price:Number(r.price),quantity:1,total:Number(r.price)}],balance:Number((r.totalAmount-r.paidAmount).toFixed(2))}))}async function ca(e){const[t,a]=await Promise.all([De(),ct()]),r=e.serviceQuantities??(e.serviceId?{[e.serviceId]:1}:{}),n=t.filter(w=>w.serviceType==="order"&&Number(r[w.id]??0)>0).map(w=>({...w,quantity:Number(r[w.id]??0)})),s=n[0],i=a.find(w=>w.id===e.itemCategoryId)??a.find(w=>w.name.toLowerCase()===(s?.category??"").toLowerCase())??a.find(w=>w.name==="Regular Clothes")??a[0];if(!n.length||!s||!i)throw new Error("Please select at least one service.");const c=e.addonQuantities??Object.fromEntries((e.addonIds??[]).map(w=>[w,1])),l=t.filter(w=>w.serviceType==="addon"&&Number(c[w.id]??0)>0).map(w=>({...w,quantity:Number(c[w.id]??0)})),d=e.weightKg??Math.max(1,Number(i.maxKg||s.maxKg||1)),p=lt(n,i,d,l),u=await na({id:e.customerId||void 0,name:e.customerName,phone:e.customerPhone??null}),f=Math.max(0,e.paidAmount),v=Math.min(p.totalAmount,f),g={ticket:await la(),customerId:u.id,customer:u.name,phone:u.phone,serviceId:s.id,service:p.serviceLines.map(w=>`${w.name} x${w.quantity}`).join(", "),serviceLines:p.serviceLines,itemCategoryId:i.id,itemCategory:i.name,branch:e.branch,status:"received",workflowCompleted:["received"],weightKg:d,price:p.price,additionalCharge:p.additionalCharge,extraServiceAmount:p.extraServiceAmount,totalAmount:p.totalAmount,paidAmount:v,balance:Number((p.totalAmount-v).toFixed(2)),extras:p.extras,notes:e.notes||null,foldedBy:null,foldedByName:null,dueAt:new Date(Date.now()+Math.max(...n.map(w=>w.turnaroundHours))*60*60*1e3).toISOString(),createdAt:J()};if(!A.isNativePlatform()){const w=L("orders",ae),N={...g,id:k(w)};return w.unshift(N),E("orders",w),f>0&&await ut(N.id,{amount:f,method:e.paymentMethod,reference:e.paymentReference??null}),N}const y=await C(),b=await y.query("SELECT COALESCE(MAX(id), 0) + 1 as id FROM orders"),T={...g,id:Number((b.values?.[0]).id)};return await nt(y,T),f>0&&await y.run("INSERT INTO payments (orderId, amount, method, reference, receivedAt, branch) VALUES (?, ?, ?, ?, ?, ?)",[T.id,f,e.paymentMethod,e.paymentReference??null,J(),e.branch]),T}async function la(){const e=`LB${Xt()}`,t=await we(),r=(await Te(t)).filter(s=>s.ticket.startsWith(e)).sort((s,i)=>i.ticket.localeCompare(s.ticket))[0],n=r?Number(r.ticket.slice(-3))+1:1;return`${e}-${String(n).padStart(3,"0")}`}async function da(e,t){const a=await we(),[r,n]=await Promise.all([Te(a),De()]),s=r.find(d=>d.id===e);if(!s)return;const c=dt(s,n).map(d=>d.key).find(d=>!s.workflowCompleted.includes(d));if(!c)return;if(s.workflowCompleted=[...s.workflowCompleted,c],s.status=oa(s.workflowCompleted),c==="fold"&&t&&(s.foldedBy=t),!A.isNativePlatform()){const d=L("orders",ae),p=d.find(u=>u.id===s.id);p&&Object.assign(p,s),E("orders",d);return}await(await C()).run("UPDATE orders SET workflowCompleted = ?, status = ?, foldedBy = ? WHERE id = ?",[JSON.stringify(s.workflowCompleted),s.status,s.foldedBy,s.id])}async function ut(e,t){const a=await we();if(!(await Te(a)).find(c=>c.id===e))return;const s=Math.max(0,t.amount);if(s<=0)return;if(!A.isNativePlatform()){const c=L("payments",be);c.unshift({id:k(c),orderId:e,amount:s,method:t.method,reference:t.reference??null,receivedAt:J(),branch:a}),E("payments",c);const l=L("orders",ae),d=l.find(p=>p.id===e);d&&(d.paidAmount=Math.min(d.totalAmount,Number((d.paidAmount+s).toFixed(2)))),E("orders",l);return}const i=await C();await i.run("INSERT INTO payments (orderId, amount, method, reference, receivedAt, branch) VALUES (?, ?, ?, ?, ?, ?)",[e,s,t.method,t.reference??null,J(),a]),await i.run("UPDATE orders SET paidAmount = MIN(totalAmount, paidAmount + ?) WHERE id = ?",[s,e])}async function ua(e){return A.isNativePlatform()?(await(await C()).query("SELECT id, orderId, amount, method, reference, receivedAt, branch FROM payments  ORDER BY receivedAt DESC",[])).values??[]:L("payments",be).filter(r=>!0)}async function ma(){return A.isNativePlatform()?(await(await C()).query("SELECT id, orderTicket, staffName, foldCount, rate, total, createdAt FROM fold_logs ORDER BY id DESC")).values??[]:L("fold_logs",[])}async function va(e){const t=Number((e.foldCount*e.rate).toFixed(2));if(!A.isNativePlatform()){const r=L("fold_logs",[]);r.unshift({id:Date.now(),...e,total:t,createdAt:J()}),E("fold_logs",r);return}await(await C()).run("INSERT INTO fold_logs (orderTicket, staffName, foldCount, rate, total, createdAt) VALUES (?, ?, ?, ?, ?, ?)",[e.orderTicket,e.staffName,e.foldCount,e.rate,t,J()])}async function pa(){return A.isNativePlatform()?(await(await C()).query("SELECT id, expenseDate, number, name, category, description, amount FROM disbursement_expenses ORDER BY expenseDate DESC, id DESC")).values??[]:L("expenses",ie)}function Ae(e){const t=/^DISB-(\d+)$/i.exec(String(e??"").trim());return t?Number(t[1]):0}function Ge(e){const t=/^REV-(\d+)$/i.exec(String(e??"").trim());return t?Number(t[1]):0}async function fa(){let e=0;if(!A.isNativePlatform()){const n=L("expenses",ie),s=L("revolving_history",re);for(const i of n)e=Math.max(e,Ae(i.number));for(const i of s)i.type==="disbursement"&&(e=Math.max(e,Ae(i.revolvingNumber)));return e}const t=await C(),a=await t.query("SELECT number FROM disbursement_expenses"),r=await t.query("SELECT revolvingNumber as number FROM revolving_history WHERE type = 'disbursement'");for(const n of[...a.values??[],...r.values??[]])e=Math.max(e,Ae(String(n.number)));return e}async function mt(){const e=await fa()+1;return`DISB-${String(e).padStart(2,"0")}`}async function ya(){let e=0;if(!A.isNativePlatform()){const r=L("revolving_history",re);for(const n of r)n.type==="add"&&(e=Math.max(e,Ge(n.revolvingNumber)));return`REV-${String(e+1).padStart(2,"0")}`}const a=await(await C()).query("SELECT revolvingNumber FROM revolving_history WHERE type = 'add'");for(const r of a.values??[])e=Math.max(e,Ge(String(r.revolvingNumber)));return`REV-${String(e+1).padStart(2,"0")}`}async function vt(e){if(!A.isNativePlatform()){const a=L("expenses",ie),r=k(a);a.unshift({id:r,expenseDate:e.expenseDate,number:e.number,name:e.name,category:e.category,description:e.description||null,amount:e.amount}),E("expenses",a);return}await(await C()).run("INSERT INTO disbursement_expenses (expenseDate, number, name, category, description, amount) VALUES (?, ?, ?, ?, ?, ?)",[e.expenseDate,e.number,e.name,e.category,e.description||null,e.amount])}async function ha(e){const t=await mt();await vt({expenseDate:e.expenseDate,number:t,name:e.name,category:e.category,description:e.description,amount:e.amount})}async function ga(){return A.isNativePlatform()?(await(await C()).query('SELECT id, saleDate, COALESCE(saleNumber, "") as saleNumber, cashAmount, gcashAmount, totalAmount, notes, status, endorsedTo, statusUpdatedAt FROM daily_sales ORDER BY saleDate DESC, id DESC')).values??[]:L("sales",oe)}async function ba(e){const t=Number((e.cashAmount+e.gcashAmount).toFixed(2));if(!A.isNativePlatform()){const s=L("sales",oe),i=s.find(c=>c.saleDate===e.saleDate);if(i)Object.assign(i,{cashAmount:e.cashAmount,gcashAmount:e.gcashAmount,totalAmount:t,notes:e.notes||null});else{const c=k(s);s.unshift({id:c,saleDate:e.saleDate,saleNumber:`SALE-${String(c).padStart(2,"0")}`,cashAmount:e.cashAmount,gcashAmount:e.gcashAmount,totalAmount:t,notes:e.notes||null})}E("sales",s);return}const a=await C(),n=(await a.query("SELECT id, saleNumber FROM daily_sales WHERE saleDate = ?",[e.saleDate])).values?.[0];if(n)await a.run("UPDATE daily_sales SET cashAmount = ?, gcashAmount = ?, totalAmount = ?, notes = ? WHERE id = ?",[e.cashAmount,e.gcashAmount,t,e.notes||null,n.id]);else{const s=await a.query("SELECT COALESCE(MAX(id), 0) + 1 as id FROM daily_sales"),i=Number((s.values?.[0]).id);await a.run("INSERT INTO daily_sales (saleDate, saleNumber, cashAmount, gcashAmount, totalAmount, notes) VALUES (?, ?, ?, ?, ?, ?)",[e.saleDate,`SALE-${String(i).padStart(2,"0")}`,e.cashAmount,e.gcashAmount,t,e.notes||null])}}async function Ve(e,t,a=null,r){if(!A.isNativePlatform()){const s=L("sales",oe),i=s.find(c=>c.id===e);i&&(i.status=t,i.endorsedTo=a,i.statusUpdatedAt=r,E("sales",s));return}await(await C()).run("UPDATE daily_sales SET status = ?, endorsedTo = ?, statusUpdatedAt = ? WHERE id = ?",[t,a,r,e])}async function Sa(){return A.isNativePlatform()?(await(await C()).query("SELECT id, revolvingNumber, name, amount, category, description, type, createdAt FROM revolving_history ORDER BY createdAt DESC, id DESC")).values??[]:L("revolving_history",re).sort((a,r)=>r.createdAt.localeCompare(a.createdAt))}async function Ye(e){const t=e.type==="disbursement"?await mt():await ya();if(e.type==="disbursement"){const r=e.expenseDate??e.createdAt.slice(0,10);await vt({expenseDate:r,number:t,name:e.name,category:e.category,description:e.description??"",amount:e.amount})}if(!A.isNativePlatform()){const r=L("revolving_history",re),n=k(r);r.unshift({id:n,revolvingNumber:t,...e}),E("revolving_history",r);return}await(await C()).run("INSERT INTO revolving_history (revolvingNumber, name, amount, category, description, type, createdAt) VALUES (?, ?, ?, ?, ?, ?, ?)",[t,e.name,e.amount,e.category,e.description||null,e.type,e.createdAt])}async function pt(e){return A.isNativePlatform()?(await(await C()).query("SELECT id, machineName, machineType, status, branch FROM machines WHERE branch = ? ORDER BY machineType, machineName",[e])).values??[]:L("machines",X).filter(r=>r.branch===e)}async function Ea(e){if(!A.isNativePlatform()){const a=L("machines",X);a.unshift({id:k(a),...e}),E("machines",a);return}await(await C()).run("INSERT INTO machines (machineName, machineType, status, branch) VALUES (?, ?, ?, ?)",[e.machineName,e.machineType,e.status,e.branch])}async function wa(e,t){if(!A.isNativePlatform()){const r=L("machines",X),n=r.find(s=>s.id===e);n&&(n.status=t,E("machines",r));return}await(await C()).run("UPDATE machines SET status = ? WHERE id = ?",[t,e])}async function Ta(e){return A.isNativePlatform()?((await(await C()).query("SELECT id, date, machineIds, machineNames, cleaningStatus, notes, branch FROM subcleanings WHERE branch = ? ORDER BY date DESC, id DESC",[e])).values??[]).map(r=>({...r,machineIds:K(r.machineIds,[])})):L("subcleanings",[]).filter(r=>r.branch===e)}async function Na(e){const a=(await pt(e.branch)).filter(s=>e.machineIds.includes(s.id)).map(s=>s.machineName).join(", ");if(!A.isNativePlatform()){const s=L("subcleanings",[]);s.unshift({id:k(s),date:e.date,machineIds:e.machineIds,machineNames:a,cleaningStatus:e.cleaningStatus,notes:e.notes||null,branch:e.branch}),E("subcleanings",s);const i=L("machines",X);i.forEach(c=>{e.machineIds.includes(c.id)&&(c.status=e.cleaningStatus==="completed"?"available":"under_cleaning")}),E("machines",i);return}const r=await C();await r.run("INSERT INTO subcleanings (date, machineIds, machineNames, cleaningStatus, notes, branch) VALUES (?, ?, ?, ?, ?, ?)",[e.date,JSON.stringify(e.machineIds),a,e.cleaningStatus,e.notes||null,e.branch]);const n=e.cleaningStatus==="completed"?"available":"under_cleaning";for(const s of e.machineIds)await r.run("UPDATE machines SET status = ? WHERE id = ?",[n,s])}async function Aa(e,t){if(!A.isNativePlatform()){const i=L("machines",X),c=i.find(p=>p.id===e);c&&(c.status="available"),E("machines",i);const l=L("subcleanings",[]),d=$e();l.unshift({id:k(l),date:d,machineIds:[e],machineNames:c?.machineName??"",cleaningStatus:"completed",notes:null,branch:t}),E("subcleanings",l);return}const a=await C(),n=(await a.query("SELECT machineName FROM machines WHERE id = ?",[e])).values?.[0]?.machineName??"";await a.run("UPDATE machines SET status = ? WHERE id = ?",["available",e]);const s=$e();await a.run("INSERT INTO subcleanings (date, machineIds, machineNames, cleaningStatus, notes, branch) VALUES (?, ?, ?, ?, ?, ?)",[s,JSON.stringify([e]),n,"completed",null,t])}const xe=document.querySelector("#app");if(!xe)throw new Error("App root not found");let me;const se=z("BluetoothThermalPrinter"),Ie={dashboard:"Dashboard",pos:"POS",orders:"Orders",archived:"Archived Order",customers:"Customers",pricing:"Pricing Services",disbursements:"Daily Report",reports:"Reports",inventory:"Inventory",maintenance:"Maintenance",staff:"Staff",revolving:"Revolving Fund",settings:"Settings"},o={tab:"dashboard",receiptOrderId:0,currentUser:null,loginError:"",sidebarOpen:!1,dailyReportTab:"expenses",maintenanceTab:"cleaning",customerSearch:"",orderSearch:"",orderDateFilter:"",orderPaymentFilter:"",printerPanelOpen:!1,printerLoading:!1,printerError:"",printerStatus:"",printerPaperWidth:58,pairedPrinters:[],selectedPrinterAddress:"",archivedOrderSearch:"",reportPreview:null,endorseModalOpen:!1,endorseSaleId:0,endorseSaleDate:"",revolvingModalOpen:!1,revolvingSaleId:0,addFundModalOpen:!1,disbursementModalOpen:!1,revolvingHistoryFrom:"",revolvingHistoryTo:""},La=["Wash","Dry","Fold","Detergent","Fabcon","Zonrox"],ce="laba101-mobile-session";function $(e){return new Intl.NumberFormat("en-PH",{style:"currency",currency:"PHP"}).format(e||0)}function m(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function G(e){return e.replace(/^(add[- ]?on|additional)\s+/i,"").trim()}function ft(e,t){return Number((e-t).toFixed(2))}function yt(e,t,a,r=0){const n=t.filter(i=>_(i.createdAt)===e).reduce((i,c)=>i+c.paidAmount,0),s=a.filter(i=>i.expenseDate===e).reduce((i,c)=>i+c.amount,0);return ft(n+r,s)}function Ca(e){const t=new Map;return e.filter(a=>a.workflowCompleted.includes("fold")&&a.foldedByName).forEach(a=>{const r=a.foldedByName,n=t.get(r)??{staffName:r,folds:0};n.folds+=1,t.set(r,n)}),Array.from(t.values())}function le(e=new Date){const t=e.getFullYear(),a=String(e.getMonth()+1).padStart(2,"0"),r=String(e.getDate()).padStart(2,"0");return`${t}-${a}-${r}`}function j(){return le()}function _(e){return le(new Date(e))}function qe(e){return e.paidAmount<=0?"unpaid":e.balance>0?"partial":"paid"}function ee(e){return new Intl.DateTimeFormat("en-PH",{dateStyle:"medium",timeStyle:"short"}).format(new Date(e))}function $a(e){const t=new Date(e),a=new Intl.DateTimeFormat("en-PH",{month:"short",day:"numeric",year:"numeric"}).format(t),r=new Intl.DateTimeFormat("en-PH",{hour:"numeric",minute:"2-digit",hour12:!0}).format(t);return`<div class="datetime-stack"><strong>${m(a)}</strong><span class="meta">${m(r)}</span></div>`}function Ra(e){return e?.role==="staff"&&e.branch==="Gensan Branch"}function Se(e,t,a="data-table"){return`
  ...
  `}function Oa(e=new Date){return{date:new Intl.DateTimeFormat("en-PH",{weekday:"long",month:"long",day:"numeric",year:"numeric"}).format(e),time:new Intl.DateTimeFormat("en-PH",{hour:"numeric",minute:"2-digit",second:"2-digit",hour12:!0}).format(e)}}function ve(){const e=document.querySelector("[data-date-from]"),t=document.querySelector("[data-date-to]"),a=Array.from(document.querySelectorAll('input[name="reportType"]:checked')).map(r=>r.value).filter(r=>r==="sales"||r==="disbursement"||r==="fold_count"||r==="revolving_fund"||r==="summary");return{from:e?.value||"0000-01-01",to:t?.value||"9999-12-31",types:a.length?a:["summary"]}}function pe(e,t){return e>=t.from&&e<=t.to}function ht(e,t,a,r,n,s){const i=new Set(s.types),c=e.filter(h=>pe(_(h.createdAt),s)),l=t.filter(h=>pe(h.saleDate,s)),d=a.filter(h=>pe(h.expenseDate,s)),p=Ca(c),u=c.reduce((h,O)=>h+O.paidAmount,0),f=l.reduce((h,O)=>h+O.cashAmount,0),v=l.reduce((h,O)=>h+O.gcashAmount,0),g=0,y=u+f,b=g+v,T=y+b,w=d.reduce((h,O)=>h+O.amount,0),N=w,x=T-N,B=()=>({orderCashTotal:u,orderGcashTotal:g,manualCashTotal:f,manualGcashTotal:v,totalCash:y,totalGcash:b,totalSales:T,rows:[["Type","Date","Number","Name","Cash","GCash","Total","Balance"],...c.map(h=>["Order",_(h.createdAt),h.ticket,h.customer,h.paidAmount,0,h.paidAmount,h.balance]),...l.map(h=>["Manual Sale",h.saleDate,h.saleNumber,h.notes??"",h.cashAmount,h.gcashAmount,h.totalAmount,""]),[],["Sales Summary",s.from,"to",s.to,"","","",""],["Order Cash","","","","","",u,""],["Order GCash","","","","","",g,""],["Manual Cash","","","","","",f,""],["Manual GCash","","","","","",v,""],["Total Cash","","","","","",y,""],["Total GCash","","","","","",b,""],["Total Sales","","","","","",T,""]]}),q=()=>({totalExpenses:w,totalDisbursement:N,rows:[["Type","Date","Number","Name","Amount"],...d.map(h=>["Expense",h.expenseDate,h.number,h.name,h.amount]),[],["Disbursement Summary",s.from,"to",s.to,""],["Expenses","","","",w],["Total Disbursement","","","",N]]}),Y=()=>({rows:[["Staff","Fold Count"],...p.map(h=>[h.staffName,h.folds]),[],["Total Folds",p.reduce((h,O)=>h+O.folds,0)]]}),D=r.filter(h=>pe(_(h.createdAt),s));return{selection:s,selectedTypes:i,salesRows:B,disbursementRows:q,foldCountRows:Y,revolvingDailySummaryRows:()=>({rows:[["Date of Sales","Cash on Hand","Status","Date Update"],...l.map(h=>{const O=yt(h.saleDate,e,a,h.cashAmount),Z=h.status==="revolving"?"Revolving":h.status==="endorsed"?`Endorsed to ${h.endorsedTo??""}`:"Pending";return[h.saleDate,O,Z,h.statusUpdatedAt?_(h.statusUpdatedAt):""]})]}),revolvingHistoryRows:()=>({rows:[["Date","Number","Name","Amount","Category","Description","Type"],...D.map(h=>[_(h.createdAt),h.revolvingNumber,h.name,h.type==="disbursement"?-h.amount:h.amount,h.category,h.description??"",h.type==="add"?"Add Revolving Fund":"Disbursement"])]}),summaryRows:()=>{const h=B(),O=q();return[["Summary",s.from,"to",s.to,"","","",""],["Order Cash","","","","","",h.orderCashTotal,""],["Order GCash","","","","","",h.orderGcashTotal,""],["Manual Cash","","","","","",h.manualCashTotal,""],["Manual GCash","","","","","",h.manualGcashTotal,""],["Total Cash","","","","","",h.totalCash,""],["Total GCash","","","","","",h.totalGcash,""],["Total Sales","","","","","",h.totalSales,""],["Total Disbursement","","","","","",O.totalDisbursement,""],["Profit","","","","","",x,""],["Cash on Hand","","","","","",ft(h.totalCash,O.totalDisbursement),""]]},profit:x}}function Pa(e,t){return`<button class="nav-link ${t?"is-active":""}" data-tab="${e}" type="button">
    <span class="nav-icon">${Da(e)}</span>
    <span>${Ie[e]}</span>
  </button>`}function R(e,t){return`<div class="section-head"><div><h2>${m(e)}</h2><p class="meta">${m(t)}</p></div></div>`}function Qe(){return Ie[o.tab]??"Dashboard"}function Le(e){return(e?.name??"Laba101").trim().slice(0,1).toUpperCase()}function Da(e){return{dashboard:"DB",pos:"POS",orders:"PO",archived:"AR",customers:"CU",pricing:"PS",disbursements:"DR",reports:"RP",inventory:"IN",maintenance:"MT",staff:"ST",revolving:"RV",settings:"SE"}[e]}async function gt(){const e=await we(),t=await ta(e),a=await it(),r=await ra(),n=await De(),s=await sa(),i=await ct(),c=await Te(e),l=await ua(),d=await ma(),p=await pa(),u=await ga(),f=await pt(e),v=await Ta(e),g=await Sa(),y=await ea(),b=await st("report_email");return{branch:e,staff:t,allStaff:a,customers:r,services:n,allServices:s,categories:i,orders:c,payments:l,foldLogs:d,expenses:p,sales:u,machines:f,subcleanings:v,revolvingHistory:g,foldRate:y,reportEmail:b??""}}async function S(){if(!o.currentUser){xa(),za();return}const e=await gt();e.orders.filter(a=>a.status!=="claimed").length,e.orders.filter(a=>a.status==="ready").length,e.orders.reduce((a,r)=>a+r.paidAmount,0);const t=e.orders.filter(a=>_(a.createdAt)===j()).reduce((a,r)=>a+r.paidAmount,0);e.sales.reduce((a,r)=>a+r.totalAmount,0),e.expenses.reduce((a,r)=>a+r.amount,0),xe.innerHTML=`
    <div class="app-frame">
      <header class="topbar">
      ...
      <aside class="sidebar ${o.sidebarOpen?"is-open":""}">
        ...
        <nav>${bt().map(a=>Pa(a,o.tab===a)).join("")}</nav>
      ...
      <main class="workspace">
        ...
        ${o.tab==="customers"?Ha(e.customers,e.orders):""}
        ${o.tab==="pricing"?Wa(e.allServices,e.categories):""}
        ${o.tab==="disbursements"?Xa(e.expenses,e.sales):""}
        ${o.tab==="reports"?Ka(e.orders,e.sales,e.expenses,e.revolvingHistory,e.foldRate):""}
        ${o.tab==="inventory"?Ga(e.services,e.categories):""}
        ${o.tab==="maintenance"?Va(e.machines,e.subcleanings,e.branch):""}
        ${o.tab==="staff"?Ya(e.allStaff,e.branch):""}
        ${o.tab==="revolving"?lr(e.sales,e.revolvingHistory,e.orders,e.expenses):""}
        ${o.tab==="settings"?Qa(e.branch,e.foldRate,e.reportEmail):""}
      </main>
    </div>
  `,Ja(),er(e),tr(e.allServices),ar(),rr(e.orders,e.sales,e.expenses,e.revolvingHistory,e.foldRate),nr(),sr(),ir(),or(e.allStaff),dr(),cr(),Za()}function bt(){return o.currentUser?.role==="admin"?Object.keys(Ie).filter(e=>e!=="inventory"):Ra(o.currentUser)?["disbursements","reports","maintenance","revolving"]:["pos","orders","archived","disbursements","reports","maintenance","revolving"]}function xa(){xe.innerHTML=`
  ...
  `}function Ia(){document.querySelectorAll("[data-fill-email]").forEach(e=>{e.addEventListener("click",()=>{const t=document.querySelector('input[name="email"]'),a=document.querySelector('input[name="password"]');t&&(t.value=e.dataset.fillEmail??""),a&&(a.value=e.dataset.fillPassword??"")})})}function qa(e){const t=new Date,a=Array.from({length:7},(i,c)=>{const l=new Date(t);return l.setDate(t.getDate()-(6-c)),new Intl.DateTimeFormat("en-PH",{month:"short",day:"numeric"}).format(l)}),r=Array.from({length:7},(i,c)=>{const l=new Date(t);l.setDate(t.getDate()-(6-c));const d=le(l);return e.orders.filter(p=>_(p.createdAt)===d).reduce((p,u)=>p+u.paidAmount,0)}),n=Math.max(1,...r),s=210;return`
  ...
  `}function Fa(e,t,a,r,n,s){const i=a.filter(u=>u.serviceType==="order"&&u.isActive),c=a.filter(u=>u.serviceType==="addon"&&u.isActive),l=o.receiptOrderId?e.find(u=>u.id===o.receiptOrderId):null,d=new Set(e.map(u=>u.customerId)),p=t.filter(u=>d.has(u.id));return`
    <section class="grid content full">
      <article class="panel span-2">
        ${R("New POS order","Tap a service, add extra quantities, and confirm the total")}
        <form id="order-form" class="form">
          <div class="form-row">
            <label>Existing customer (${m(s)})
  ...
  `}function ka(e,t,a,r){const n=o.receiptOrderId?e.find(p=>p.id===o.receiptOrderId):null,s=e.filter(p=>p.status!=="claimed"),i=o.orderSearch.trim().toLowerCase(),c=o.orderDateFilter.trim(),l=o.orderPaymentFilter.trim().toLowerCase(),d=s.filter(p=>{const u=!i||[p.ticket,p.customer,p.phone,p.service,p.itemCategory,p.status].some(g=>String(g??"").toLowerCase().includes(i)),f=!c||_(p.createdAt)===c,v=!l||qe(p)===l;return u&&f&&v});return`
    <section class="grid content full">
      <article class="panel span-2">
        ...
        <div class="table-scroll">
          <table class="data-table orders-data-table">
            ...
            <tbody>
              ${d.map(p=>St(p,t,a)).join("")||'<tr><td colspan="7" class="table-empty">No matching active orders.</td></tr>'}
            </tbody>
          </table>
        </div>
      </article>
  ...
  `}function Ua(e,t,a,r){const n=e.filter(l=>l.status==="claimed"),s=o.archivedOrderSearch.trim().toLowerCase(),i=n.filter(l=>s?[l.ticket,l.customer,l.phone,l.service,l.itemCategory].some(d=>String(d??"").toLowerCase().includes(s)):!0),c=o.receiptOrderId?e.find(l=>l.id===o.receiptOrderId):null;return`
    <section class="grid content full">
      <article class="panel span-2">
        ...
        <div class="table-scroll">
          <table class="data-table orders-data-table archived-orders-table">
            <thead><tr><th>Ticket</th><th>Customer</th><th>Service</th><th>Total</th><th>Payment</th><th>Status</th><th>Actions</th></tr></thead>
            <tbody>
              ${i.map(l=>St(l,t,a)).join("")||'<tr><td colspan="7" class="table-empty">No archived orders found.</td></tr>'}
            </tbody>
          </table>
        </div>
      </article>
  ...
  `}function St(e,t,a){const r=dt(e,a),n=r.find(u=>!e.workflowCompleted.includes(u.key)),s=n?.key==="fold",i=n?.key==="extras"&&e.extras.length>0,c=qe(e),l=c.charAt(0).toUpperCase()+c.slice(1),d=c==="paid"?"ok":c==="partial"?"warn":"meta",p=e.extras.length?e.extras.map(u=>`${m(G(u.name))} x${Number(u.quantity??1)}`).join(", "):"";return`
    <tr>
      ...
      <td>
        ...
        <div class="workflow-progress">
          ${r.map(u=>`<span class="${e.workflowCompleted.includes(u.key)?"is-done":n?.key===u.key?"is-next":""}">${m(u.label)}</span>`).join("")}
        </div>
      </td>
      <td>
      <div class="row-actions">
        ${n?`<form class="inline-form advance-form" data-order-id="${e.id}">
          ...
          <button class="secondary" type="submit">Next: ${m(n.label)}</button>
        </form>`:""}
        ${e.balance>0?`
  ...
  `}async function Je(){o.printerLoading=!0,o.printerError="",o.printerStatus="",await S();try{if(!(await se.requestBluetoothPermissions()).granted)throw new Error("Bluetooth permission was not granted.");const t=await se.listPairedPrinters();o.pairedPrinters=t.printers??[],o.selectedPrinterAddress=o.selectedPrinterAddress||t.savedAddress||o.pairedPrinters[0]?.address||"",o.printerStatus=o.pairedPrinters.length?"Select a printer, then connect.":"No paired printers found. Pair the printer in Android Bluetooth settings first."}catch(e){o.printerError=e instanceof Error?e.message:"Could not scan paired printers."}finally{o.printerLoading=!1,await S()}}async function Ba(){if(!o.selectedPrinterAddress){o.printerError="Select a paired printer first.",await S();return}o.printerLoading=!0,o.printerError="",o.printerStatus="",await S();try{await se.savePrinter({address:o.selectedPrinterAddress}),await se.connect({address:o.selectedPrinterAddress}),o.printerStatus="Printer connected and saved."}catch(e){o.printerError=e instanceof Error?e.message:"Printer connection failed."}finally{o.printerLoading=!1,await S()}}function _a(e){const t=(e.serviceLines?.length?e.serviceLines:[{id:e.serviceId,name:e.service,price:e.price,quantity:1,total:e.price}]).map(r=>({name:r.name,quantity:Number(r.quantity||1),price:Number(r.price||0)})),a=e.extras.map(r=>({name:G(r.name),quantity:Number(r.quantity??1),price:Number(r.price||0)}));return[...t,...a]}async function ja(e,t){const a=t.reduce((n,s)=>n+Number(s.amount),0),r=Math.max(0,Number((a-e.totalAmount).toFixed(2)));o.printerLoading=!0,o.printerError="",o.printerStatus="",await S();try{if(!o.selectedPrinterAddress){const n=await se.getSavedPrinter();o.selectedPrinterAddress=n.address||""}await se.printReceipt({address:o.selectedPrinterAddress||void 0,paperWidth:o.printerPaperWidth,storeName:"Laba101",receiptNumber:e.ticket,dateTime:ee(e.createdAt),customerName:e.customer,customerPhone:e.phone?.trim()||"No phone",items:_a(e),totalAmount:e.totalAmount,paidAmount:e.paidAmount,changeAmount:r,balanceAmount:e.balance,staffName:o.currentUser?.name?.trim()||"Staff"}),o.printerStatus="Receipt sent to printer."}catch(n){o.printerPanelOpen=!0,o.printerError=n instanceof Error?n.message:"Bluetooth thermal print failed."}finally{o.printerLoading=!1,await S()}}function Ha(e,t){const a=o.customerSearch.trim().toLowerCase(),r=e.filter(n=>a?n.name.toLowerCase().includes(a):!1);return`
    <section class="grid content full">
      <article class="panel">
  ...
  `}function Xa(e,t){const a=j(),r=a.slice(0,7),n=e.filter(l=>l.expenseDate===a).reduce((l,d)=>l+d.amount,0),s=e.filter(l=>l.expenseDate.startsWith(r)).reduce((l,d)=>l+d.amount,0),i=t.filter(l=>l.saleDate===a).reduce((l,d)=>l+d.totalAmount,0),c=t.filter(l=>l.saleDate.startsWith(r)).reduce((l,d)=>l+d.totalAmount,0);return`
    ...
    `}
  `}function Ka(e,t,a,r,n,s,i,c){const l=o.reportPreview?ht(e,t,a,r,n,o.reportPreview):null;return`
    <section class="page-head">
      <div>
      ...
      <section class="panel report-preview">
        ...
        ${l.selectedTypes.has("revolving_fund")?`
          <article>
            ...
            ${Se(["Date of Sales","Cash on Hand","Status","Date Update"],l.revolvingDailySummaryRows().rows.slice(1).map(d=>[m(String(d[0]??"")),m(String(d[1]??"")),m(String(d[2]??"")),m(String(d[3]??""))]),"data-table revolving-report-table")}
          </article>
          <article>
            ${R("Revolving Fund — Table History",`${l.selection.from} to ${l.selection.to}`)}
            ${Se(["Date","Number","Name","Amount","Category","Description","Type"],l.revolvingHistoryRows().rows.slice(1).map(d=>[m(String(d[0]??"")),m(String(d[1]??"")),m(String(d[2]??"")),m(String(d[3]??"")),m(String(d[4]??"")),m(String(d[5]??"")),m(String(d[6]??""))]),"data-table revolving-report-table")}
          </article>`:""}
  ...
  `}function Va(e,t,a){const r=e.filter(s=>s.status!=="under_cleaning"),n=e.filter(s=>s.status==="under_cleaning");return`
    <section class="page-head">
      <div>
    ...
    <section class="grid content full">
      <article class="panel">
        ...
        <form id="subcleaning-form" class="form">
          ...
          <fieldset class="machine-list">
            ${r.map(s=>`<label class="machine-card"><input type="checkbox" name="machineIds" value="${s.id}" /><span><strong>${m(s.machineName)}</strong><small>${m(s.machineType)}</small></span><em></em></label>`).join("")||'<p class="helper">All machines are currently being cleaned.</p>'}
          </fieldset>
        ...
        <div class="machine-stack">
          ${n.length?n.map(s=>`
            <div class="machine-status">
              <span><strong>${m(s.machineName)}</strong><small>${m(s.machineType)}</small></span>
              <b>In progress</b>
              <button class="secondary complete-cleaning-btn" type="button" data-machine-id="${s.id}" data-branch="${m(a)}">Mark Complete</button>
      ...
      <article class="panel span-2">
        ...
        <div class="table">
          ...
          ${e.map(s=>{const i=t.find(c=>c.machineIds.includes(s.id)&&c.date===j());return`<div class="table-row"><div><strong>${m(s.machineName)}</strong></div><div>${m(s.machineType)}</div><div>${i?m(i.cleaningStatus.replace("_"," ")):"Not Cleaned"}</div><div>${m(i?.notes??"-")}</div><div>${j()}</div></div>`}).join("")}
        </div>
      </article>
    </section>
    `:`
    <section class="grid content full">
      ...
      <article class="panel">
        ...
        <div class="table">
          ...
          ${e.map(s=>`<div class="table-row"><div><strong>${m(s.machineName)}</strong></div><div>${m(s.machineType)}</div><div>${m(s.status.replace("_"," "))}</div><div>${m(s.branch)}</div>
          <div class="row-actions">
  ...
  `}function Ja(){const e=()=>{localStorage.removeItem(ce),o.currentUser=null,o.tab="dashboard",o.receiptOrderId=0,o.sidebarOpen=!1,S()};document.querySelector("#logout-button")?.addEventListener("click",e),document.querySelector("#mobile-logout-button")?.addEventListener("click",e),document.querySelector("#mobile-menu-button")?.addEventListener("click",()=>{o.sidebarOpen=!0,S()}),document.querySelector("#sidebar-close-button")?.addEventListener("click",()=>{o.sidebarOpen=!1,S()}),document.querySelector("#sidebar-backdrop")?.addEventListener("click",()=>{o.sidebarOpen=!1,S()}),document.querySelectorAll("[data-tab]").forEach(t=>{t.addEventListener("click",()=>{o.tab=t.dataset.tab,o.receiptOrderId=0,o.sidebarOpen=!1,S()})}),document.querySelectorAll("[data-quick-tab]").forEach(t=>{t.addEventListener("click",()=>{o.tab=t.dataset.quickTab,S()})}),document.querySelectorAll("[data-receipt]").forEach(t=>{t.addEventListener("click",()=>{o.receiptOrderId=Number(t.dataset.receipt),o.printerPanelOpen=!1,o.printerError="",o.printerStatus="",S()})}),document.querySelector("[data-close-receipt]")?.addEventListener("click",()=>{o.receiptOrderId=0,S()}),document.querySelector("[data-open-printer-panel]")?.addEventListener("click",()=>{o.printerPanelOpen=!o.printerPanelOpen,o.printerPanelOpen&&o.pairedPrinters.length===0?Je():S()}),document.querySelector("[data-refresh-printers]")?.addEventListener("click",()=>{Je()}),document.querySelector("[data-printer-select]")?.addEventListener("change",t=>{o.selectedPrinterAddress=t.currentTarget.value,S()}),document.querySelector("[data-paper-width]")?.addEventListener("change",t=>{o.printerPaperWidth=Number(t.currentTarget.value)===80?80:58,S()}),document.querySelector("[data-connect-printer]")?.addEventListener("click",()=>{Ba()}),document.querySelector("[data-thermal-print]")?.addEventListener("click",()=>{(async()=>{const t=await gt(),a=t.orders.find(n=>n.id===o.receiptOrderId);if(!a)throw new Error("Receipt order not found.");const r=t.payments.filter(n=>n.orderId===a.id);await ja(a,r)})().catch(t=>{o.printerPanelOpen=!0,o.printerError=t instanceof Error?t.message:"Bluetooth thermal print failed.",S()})}),document.querySelectorAll("[data-report-tab]").forEach(t=>{t.addEventListener("click",()=>{o.dailyReportTab=t.dataset.reportTab,S()})}),document.querySelectorAll("[data-maintenance-tab]").forEach(t=>{t.addEventListener("click",()=>{o.maintenanceTab=t.dataset.maintenanceTab,S()})})}function za(){Ia(),document.querySelector("#login-form")?.addEventListener("submit",async e=>{e.preventDefault();const t=new FormData(e.currentTarget),a=document.querySelector("#login-button");a&&(a.disabled=!0,a.textContent="Signing in...");try{const r=await ot(String(t.get("email")??""),String(t.get("password")??""));if(!r){o.loginError="Invalid email or password.",await S();return}o.currentUser=r,o.loginError="",await fe("branch",String(r.branch||"Main Store")),t.get("remember")?localStorage.setItem(ce,JSON.stringify({email:r.email,remembered:!0})):localStorage.removeItem(ce),bt().includes(o.tab)||(o.tab="dashboard"),await S()}catch(r){alert("Login Error: "+String(r?.message||r)),a&&(a.disabled=!1,a.textContent="Sign in")}})}function Za(){me&&window.clearInterval(me);const e=document.querySelector("[data-navbar-time]"),t=document.querySelector("[data-navbar-date]");if(!e||!t){me=void 0;return}const a=()=>{const r=Oa();e.textContent=r.time,t.textContent=r.date};a(),me=window.setInterval(a,1e3)}function ze(e,t){return e?t.find(a=>a.name.toLowerCase()===e.category.toLowerCase())??t.find(a=>a.name==="Regular Clothes")??t[0]??null:null}function Ze(e,t){return Math.max(1,Number(t.maxKg||e.maxKg||1))}function Et(e,t){return Object.fromEntries(t.filter(a=>a.serviceType==="order").map(a=>[a.id,Number(e.querySelector(`input[name="serviceQty-${a.id}"]`)?.value??0)]).filter(([,a])=>Number(a)>0))}function et(e,t){const a=Et(e,t);return t.filter(r=>r.serviceType==="order"&&Number(a[r.id]??0)>0).map(r=>({...r,quantity:Number(a[r.id])}))}function wt(e,t){return Object.fromEntries(t.filter(a=>a.serviceType==="addon").map(a=>[a.id,Number(e.querySelector(`input[name="addonQty-${a.id}"]`)?.value??0)]).filter(([,a])=>Number(a)>0))}function tt(e,t){const a=wt(e,t);return t.filter(r=>r.serviceType==="addon"&&Number(a[r.id]??0)>0).map(r=>({...r,quantity:Number(a[r.id])}))}function er(e){const t=document.querySelector("#order-form"),a=document.querySelector("#price-preview"),r=t?.querySelector('button[type="submit"]'),n=t?.querySelector('select[name="customerId"]'),s=t?.querySelector('input[name="customerName"]'),i=t?.querySelector('input[name="customerPhone"]'),c=t?.querySelector("[data-order-error]"),l=t?.querySelector('select[name="paymentMethod"]'),d=t?.querySelector(".gcash-reference"),p=t?.querySelector('input[name="paymentReference"]'),u=()=>{if(!n||!s||!i)return;const y=n.selectedOptions[0];s.value=y?.dataset.name??"",i.value=y?.dataset.phone??""},f=()=>{const y=l?.value==="gcash";d&&(d.hidden=!y),p&&(p.required=y,y||(p.value=""))},v=(y,b)=>{if(!t)return;const T=t.querySelector(`input[name="${y}"]`);T&&(T.value=String(Math.max(0,Number(T.value||0)+b)),T.closest(".qty-card")?.classList.toggle("is-selected",Number(T.value)>0),T.dispatchEvent(new Event("input",{bubbles:!0})))};t?.querySelectorAll(".qty-control input").forEach(y=>{y.addEventListener("input",()=>{y.value=String(Math.max(0,Number(y.value||0))),y.closest(".qty-card")?.classList.toggle("is-selected",Number(y.value)>0)})}),t?.querySelectorAll("[data-qty-card]").forEach(y=>{y.addEventListener("click",b=>{const T=b.target;T.closest("input")||T.closest("button")||v(y.dataset.qtyCard??"",1)})}),t?.querySelectorAll("[data-qty-plus]").forEach(y=>{y.addEventListener("click",()=>v(y.dataset.qtyPlus??"",1))}),t?.querySelectorAll("[data-qty-minus]").forEach(y=>{y.addEventListener("click",()=>v(y.dataset.qtyMinus??"",-1))});const g=()=>{if(!t||!a)return;const y=et(t,e.services),b=y[0],T=ze(b,e.categories),w=tt(t,e.services);if(!y.length||!b||!T){r&&(r.disabled=!0),c&&(c.hidden=!1,c.textContent="Please select at least one service quantity."),a.innerHTML='<div class="preview-total"><span>Total amount</span><strong>PHP 0.00</strong></div>';return}const N=lt(y,T,Ze(b,T),w),x=N.serviceLines.map(q=>`${q.name} x${q.quantity}`),B=N.extras.map(q=>`${G(q.name)} x${q.quantity}`);r&&(r.disabled=!1),c&&(c.hidden=!0,c.textContent=""),a.classList.remove("has-error"),a.innerHTML=`
    ...
    `};n?.addEventListener("change",u),l?.addEventListener("change",f),f(),t?.addEventListener("input",g),t?.addEventListener("change",g),g(),t?.addEventListener("submit",async y=>{y.preventDefault();const b=new FormData(t),T=et(t,e.services),w=T[0],N=ze(w,e.categories);if(tt(t,e.services),!T.length){c&&(c.hidden=!1,c.textContent="Please select at least one service quantity.");return}try{await ca({customerId:Number(b.get("customerId"))||void 0,customerName:String(b.get("customerName")??""),customerPhone:String(b.get("customerPhone")??"")||null,serviceQuantities:Et(t,e.services),branch:e.branch,itemCategoryId:N?.id,weightKg:w&&N?Ze(w,N):void 0,addonQuantities:wt(t,e.services),paidAmount:Number(b.get("paidAmount")??0),paymentMethod:String(b.get("paymentMethod")??"cash"),paymentReference:String(b.get("paymentReference")??"")||null,notes:String(b.get("notes")??"")||null}),await S()}catch(x){c&&(c.hidden=!1,c.textContent=x instanceof Error?x.message:"Order could not be saved.")}}),document.querySelectorAll(".advance-form").forEach(y=>{y.addEventListener("submit",async b=>{b.preventDefault();const T=new FormData(y);await da(Number(y.dataset.orderId),Number(T.get("assignedStaffId"))||null),await S()})}),document.querySelectorAll(".payment-form").forEach(y=>{const b=y.querySelector('select[name="method"]'),T=y.querySelector('input[name="reference"]'),w=()=>{const N=b?.value==="gcash";T&&(T.hidden=!N,T.required=N,N||(T.value=""))};b?.addEventListener("change",w),w(),y.addEventListener("submit",async N=>{N.preventDefault();const x=new FormData(y);await ut(Number(y.dataset.orderId),{amount:Number(x.get("amount")),method:String(x.get("method")),reference:String(x.get("reference")??"")||null}),await S()})})}function tr(e){document.querySelector("#service-form")?.addEventListener("submit",async t=>{t.preventDefault();const a=new FormData(t.currentTarget),r=a.get("id")?Number(a.get("id")):void 0;await Ke({id:r,name:String(a.get("name")??""),description:String(a.get("description")??"")||null,category:String(a.get("category")??""),serviceType:String(a.get("serviceType")??"order"),price:Number(a.get("price")??0),maxKg:Number(a.get("maxKg")??0),dryingMinutes:Number(a.get("dryingMinutes"))||null,includes:a.getAll("includes").map(String).filter(Boolean),additionalCharge:0,turnaroundHours:Number(a.get("turnaroundHours")??24),isActive:1}),await S()}),document.querySelectorAll(".edit-service-btn").forEach(t=>{t.addEventListener("click",()=>{const a=Number(t.dataset.id),r=e.find(s=>s.id===a),n=document.querySelector("#service-form");r&&n&&(n.querySelector("[name=id]").value=String(r.id),n.querySelector("[name=name]").value=r.name,n.querySelector("[name=category]").value=r.category,n.querySelector("[name=serviceType]").value=r.serviceType,n.querySelector("[name=price]").value=String(r.price),n.querySelector("[name=maxKg]").value=String(r.maxKg),n.querySelector("[name=dryingMinutes]").value=r.dryingMinutes?String(r.dryingMinutes):"",n.querySelectorAll('input[name="includes"]').forEach(s=>{s.checked=r.includes.includes(s.value)}),n.querySelector("[name=turnaroundHours]").value=String(r.turnaroundHours),n.querySelector("[name=description]").value=r.description??"",window.scrollTo({top:0,behavior:"smooth"}))})}),document.querySelectorAll(".deactivate-service-btn, .activate-service-btn").forEach(t=>{t.addEventListener("click",async()=>{const a=Number(t.dataset.id),r=e.find(n=>n.id===a);if(r){const n=r.isActive?0:1;await Ke({id:r.id,name:r.name,description:r.description,category:r.category,serviceType:r.serviceType,price:r.price,maxKg:r.maxKg,dryingMinutes:r.dryingMinutes,includes:r.includes,additionalCharge:r.additionalCharge,turnaroundHours:r.turnaroundHours,isActive:n}),await S()}})}),document.querySelector("#category-form")?.addEventListener("submit",async t=>{t.preventDefault();const a=new FormData(t.currentTarget);await ia({name:String(a.get("name")??""),maxKg:Number(a.get("maxKg")??0),additionalFee:Number(a.get("additionalFee")??0),isActive:1}),await S()})}function ar(){document.querySelector("#expense-form")?.addEventListener("submit",async e=>{e.preventDefault();const t=new FormData(e.currentTarget);await ha({expenseDate:String(t.get("expenseDate")??""),name:String(t.get("name")??""),category:String(t.get("category")??""),description:String(t.get("description")??""),amount:Number(t.get("amount")??0)}),await S()}),document.querySelector("#fold-form")?.addEventListener("submit",async e=>{e.preventDefault();const t=new FormData(e.currentTarget);await va({orderTicket:String(t.get("orderTicket")??""),staffName:String(t.get("staffName")??""),foldCount:Number(t.get("foldCount")??1),rate:Number(t.get("rate")??5)}),await S()})}function rr(e,t,a,r,n){document.querySelector("#generate-report")?.addEventListener("click",()=>{o.reportPreview=ve(),S()}),document.querySelector("#sales-form")?.addEventListener("submit",async f=>{f.preventDefault();const v=new FormData(f.currentTarget);await ba({saleDate:String(v.get("saleDate")??""),cashAmount:Number(v.get("cashAmount")??0),gcashAmount:Number(v.get("gcashAmount")??0),notes:String(v.get("notes")??"")}),await S()});const s=document.querySelector("[data-date-from]"),i=document.querySelector("[data-date-to]");document.querySelectorAll("[data-date-scope]").forEach(f=>{f.addEventListener("change",()=>{if(!f.checked||!s||!i)return;const v=new Date,g=le(v),y=new Date(v);f.value==="week"&&y.setDate(v.getDate()-6),f.value==="month"&&y.setDate(1),f.value!=="custom"&&(s.value=f.value==="today"?g:le(y),i.value=g)})});const c=f=>{const v=b=>String(b??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&apos;"),g=b=>b==="Sales Report"?[110,125,150,215,95,95,105,105]:b==="Disbursement"?[110,115,150,220,105]:b==="Fold Count"?[220,125]:b==="Revolving Daily Summary"?[115,105,120,115]:b==="Revolving History"?[115,96,140,96,110,180,120]:[155,125,125,125,95,95,115,115];return`<?xml version="1.0"?>
...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 xmlns:html="http://www.w3.org/TR/REC-html40">
  ...
  ${f.map(b=>{const T=g(b.name).map(N=>`<Column ss:Width="${N}" ss:AutoFitWidth="0"/>`).join(""),w=b.rows.map(N=>{if(!N.length)return'<Row ss:Height="10" ss:StyleID="BorderRow"><Cell ss:StyleID="BorderCell"><Data ss:Type="String">&nbsp;</Data></Cell></Row>';const x=N[0]==="Type"||N[0]==="Summary"||N[0]==="Sales Summary"||N[0]==="Disbursement Summary"||N[0]==="Staff"||N[0]==="Date of Sales"||N[0]==="Date",B=x?"HeaderRow":"BorderRow",q=x?"HeaderCell":"BorderCell",Y=x?26:22,D=N.map(I=>`<Cell ss:StyleID="${q}"><Data ss:Type="${typeof I=="number"?"Number":"String"}">${v(I)}</Data></Cell>`).join("");return`<Row ss:Height="${Y}" ss:StyleID="${B}">${D}</Row>`}).join("");return`
...
</Workbook>`},l=()=>{const f=ve(),v=ht(e,t,a,r,n,f),g=[];v.selectedTypes.has("sales")&&g.push({name:"Sales Report",rows:v.salesRows().rows}),v.selectedTypes.has("disbursement")&&g.push({name:"Disbursement",rows:v.disbursementRows().rows}),v.selectedTypes.has("fold_count")&&g.push({name:"Fold Count",rows:v.foldCountRows().rows}),v.selectedTypes.has("revolving_fund")&&(g.push({name:"Revolving Daily Summary",rows:v.revolvingDailySummaryRows().rows}),g.push({name:"Revolving History",rows:v.revolvingHistoryRows().rows})),v.selectedTypes.has("summary")&&g.push({name:"Summary",rows:v.summaryRows()});const y=c(g.length?g:[{name:"Summary",rows:v.summaryRows()}]),b=`laba101-report-${f.from}-to-${f.to}.xls`;return new File([y],b,{type:"application/vnd.ms-excel"})},d=async()=>{const f=l();if(!A.isNativePlatform())return{fileName:f.name,uri:""};const v=await f.text(),g=f.name;await je.writeFile({path:g,data:v,directory:ye.External,encoding:Ce.UTF8});const{uri:y}=await je.getUri({path:g,directory:ye.External});return{fileName:f.name,uri:y}},p=()=>{const f=l(),v=ve(),g=`laba101-report-${v.from}-to-${v.to}.xls`,y=f,b=URL.createObjectURL(y),T=document.createElement("a");return T.href=b,T.download=g,document.body.appendChild(T),T.click(),setTimeout(()=>{T.remove(),URL.revokeObjectURL(b)},1e3),g},u=async f=>{const v=document.querySelector(f==="export"?"#export-report":"#email-report");v&&(v.disabled=!0,v.textContent=f==="export"?"Exporting...":"Sending...");try{if(f==="export")if(A.isNativePlatform()){const g=await d();alert(`Report exported as "${g.fileName}".`)}else{const g=p();alert(`Report saved: ${g}`)}else{const g=await st("report_email")||"";if(!g){alert("Please configure a report email in Settings first.");return}const y=ve(),b=`Laba101 report ${y.from} to ${y.to}`;if(A.isNativePlatform()){const T=await d();try{await Ut.share({title:b,text:`Please find the attached Laba101 report file: ${T.fileName}`,files:[T.uri],dialogTitle:"Send report via email"}),alert(`Report saved and shared as "${T.fileName}".`)}catch(w){const N=String(w).toLowerCase();if(N.includes("share canceled")||N.includes("canceled"))alert(`Report saved as "${T.fileName}".`);else throw w}}else{const T=p(),w=`Hi,
...
Your email app will open — please attach the file and send.`)}}}catch(g){alert("Failed: "+String(g))}finally{v&&(v.disabled=!1,v.textContent=f==="export"?"Export Excel":"Send to Email")}};document.querySelector("#export-report")?.addEventListener("click",async()=>{await u("export")}),document.querySelector("#email-report")?.addEventListener("click",async()=>{await u("email")})}function nr(){document.querySelector("#order-queue-filters")?.addEventListener("submit",e=>{e.preventDefault();const t=new FormData(e.currentTarget);o.orderSearch=String(t.get("orderSearch")??"").trim(),o.orderDateFilter=String(t.get("orderDateFilter")??"").trim(),o.orderPaymentFilter=String(t.get("orderPaymentFilter")??"").trim(),S()}),document.querySelector("#order-queue-clear")?.addEventListener("click",()=>{o.orderSearch="",o.orderDateFilter="",o.orderPaymentFilter="",S()}),document.querySelector("#archived-order-filters")?.addEventListener("submit",e=>{e.preventDefault();const t=new FormData(e.currentTarget);o.archivedOrderSearch=String(t.get("archivedOrderSearch")??"").trim(),S()}),document.querySelector("#archived-order-clear")?.addEventListener("click",()=>{o.archivedOrderSearch="",S()})}function sr(){document.querySelector("#customer-search-form")?.addEventListener("submit",e=>{e.preventDefault();const t=new FormData(e.currentTarget);o.customerSearch=String(t.get("customerSearch")??"").trim(),S()}),document.querySelector("#customer-search-clear")?.addEventListener("click",()=>{o.customerSearch="",S()})}function ir(){document.querySelector("#machine-form")?.addEventListener("submit",async e=>{e.preventDefault();const t=new FormData(e.currentTarget);await Ea({machineName:String(t.get("machineName")??""),machineType:String(t.get("machineType")),status:String(t.get("status")),branch:String(t.get("branch")??"")}),await S()}),document.querySelector("#subcleaning-form")?.addEventListener("submit",async e=>{e.preventDefault();const t=e.currentTarget.querySelector('button[type="submit"]');t&&(t.disabled=!0,t.textContent="Starting...");const a=new FormData(e.currentTarget),r=a.getAll("machineIds").map(Number);if(!r.length){alert("Please select at least one machine to clean."),t&&(t.disabled=!1,t.textContent="Start Cleaning");return}await Na({date:String(a.get("date")??""),machineIds:r,cleaningStatus:String(a.get("cleaningStatus")??""),notes:String(a.get("notes")??""),branch:String(a.get("branch")??"")}),await S()}),document.querySelectorAll(".complete-cleaning-btn").forEach(e=>{e.addEventListener("click",async()=>{const t=Number(e.dataset.machineId),a=e.dataset.branch??"";e.disabled=!0,e.textContent="Completing...",await Aa(t,a),await S()})}),document.querySelectorAll(".deactivate-machine-btn, .activate-machine-btn").forEach(e=>{e.addEventListener("click",async()=>{const t=Number(e.dataset.id),a=e.classList.contains("deactivate-machine-btn");await wa(t,a?"inactive":"available"),await S()})})}function or(e){const t=document.querySelector("#add-staff-modal"),a=document.querySelector("#open-add-staff-modal"),r=document.querySelector("#close-add-staff-modal"),n=document.querySelector("#staff-form"),s=()=>{n?.reset(),n&&(n.querySelector("[name=id]").value="");const c=document.querySelector("#add-staff-title");c&&(c.textContent="Add staff member"),t?.removeAttribute("hidden")},i=()=>{t?.setAttribute("hidden",""),n?.reset()};a?.addEventListener("click",s),r?.addEventListener("click",i),t?.addEventListener("click",c=>{c.target===t&&i()}),document.querySelectorAll(".edit-staff-btn").forEach(c=>{c.addEventListener("click",()=>{const l=Number(c.dataset.id),d=e.find(p=>p.id===l);if(d&&n){n.querySelector("[name=id]").value=String(d.id),n.querySelector("[name=name]").value=d.name,n.querySelector("[name=email]").value=d.email,n.querySelector("[name=password]").value=d.password,n.querySelector("[name=role]").value=d.role,n.querySelector("[name=branch]").value=d.branch;const p=document.querySelector("#add-staff-title");p&&(p.textContent="Edit staff member"),t?.removeAttribute("hidden")}})}),document.querySelectorAll(".deactivate-staff-btn, .activate-staff-btn").forEach(c=>{c.addEventListener("click",async()=>{const l=Number(c.dataset.id),d=e.find(p=>p.id===l);d&&(await Xe(l,{isActive:d.isActive!==0?0:1}),await S())})}),n?.addEventListener("submit",async c=>{c.preventDefault();const l=document.querySelector("#staff-save-btn");l&&(l.disabled=!0,l.textContent="Saving...");const d=new FormData(n),p=d.get("id")?Number(d.get("id")):void 0,u=String(d.get("name")??"").trim(),f=String(d.get("email")??"").trim(),v=String(d.get("password")??"password")||"password",g=String(d.get("role")),y=String(d.get("branch")??"");if(!u||!f){alert("Name and email are required."),l&&(l.disabled=!1,l.textContent="Save staff member");return}try{p?await Xe(p,{name:u,email:f,password:v,role:g,branch:y}):await aa({name:u,email:f,password:v,role:g,branch:y}),i(),await S()}catch{alert("Failed to save staff. The email may already be in use."),l&&(l.disabled=!1,l.textContent="Save staff member")}})}function cr(){document.querySelector("#settings-form")?.addEventListener("submit",async e=>{e.preventDefault();const t=new FormData(e.currentTarget);await fe("branch",String(t.get("branch")??"Main Store")),await fe("fold_rate",String(t.get("foldRate")??"5")),String(t.get("reportEmail")??"")&&await fe("report_email",String(t.get("reportEmail"))),alert("Settings saved successfully!"),await S()})}await Zt();const at=localStorage.getItem(ce);if(at)try{const e=JSON.parse(at);if(e.email&&e.remembered){const t=await ot(e.email,"password")??null;o.currentUser=t}}catch{localStorage.removeItem(ce)}function lr(e,t,a,r){const n=e.filter(v=>v.status==="revolving").reduce((v,g)=>v+g.cashAmount,0),s=t.filter(v=>v.type==="add").reduce((v,g)=>v+g.amount,0),i=t.filter(v=>v.type==="disbursement").reduce((v,g)=>v+g.amount,0),c=n+s-i,l=o.revolvingHistoryFrom||"0000-01-01",d=o.revolvingHistoryTo||"9999-12-31",p=t.filter(v=>{const g=_(v.createdAt);return g>=l&&g<=d}),u=e.map(v=>{const g=yt(v.saleDate,a,r,v.cashAmount),y=v.status==="revolving"?'<span class="ok">Revolving</span>':v.status==="endorsed"?`<span class="warn">Endorsed to ${m(v.endorsedTo)}</span>`:'<span class="meta">Pending</span>',b=v.status!=="revolving"&&v.status!=="endorsed"?`<div class="row-actions">
    ...
    <section class="grid content full">
      ...
      <article class="panel">
        ...
        ${Se(["Date of Sales","Cash on Hand","Status","Date Update","Action"],u,"data-table revolving-summary-datatable")}
      </article>
