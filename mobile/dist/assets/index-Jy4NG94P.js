(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const i of n.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function a(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(r){if(r.ep)return;r.ep=!0;const n=a(r);fetch(r.href,n)}})();var oe;(function(e){e.Unimplemented="UNIMPLEMENTED",e.Unavailable="UNAVAILABLE"})(oe||(oe={}));class $e extends Error{constructor(t,a,s){super(t),this.message=t,this.code=a,this.data=s}}const Dt=e=>{var t,a;return e?.androidBridge?"android":!((a=(t=e?.webkit)===null||t===void 0?void 0:t.messageHandlers)===null||a===void 0)&&a.bridge?"ios":"web"},Ot=e=>{const t=e.CapacitorCustomPlatform||null,a=e.Capacitor||{},s=a.Plugins=a.Plugins||{},r=()=>t!==null?t.name:Dt(e),n=()=>r()!=="web",i=m=>{const p=o.get(m);return!!(p?.platforms.has(r())||l(m))},l=m=>{var p;return(p=a.PluginHeaders)===null||p===void 0?void 0:p.find(b=>b.name===m)},d=m=>e.console.error(m),o=new Map,u=(m,p={})=>{const b=o.get(m);if(b)return console.warn(`Capacitor plugin "${m}" already registered. Cannot register plugins twice.`),b.proxy;const g=r(),E=l(m);let f;const N=async()=>(!f&&g in p?f=typeof p[g]=="function"?f=await p[g]():f=p[g]:t!==null&&!f&&"web"in p&&(f=typeof p.web=="function"?f=await p.web():f=p.web),f),y=(P,F)=>{var M,_;if(E){const G=E?.methods.find(B=>F===B.name);if(G)return G.rtype==="promise"?B=>a.nativePromise(m,F.toString(),B):(B,h)=>a.nativeCallback(m,F.toString(),B,h);if(P)return(M=P[F])===null||M===void 0?void 0:M.bind(P)}else{if(P)return(_=P[F])===null||_===void 0?void 0:_.bind(P);throw new $e(`"${m}" plugin is not implemented on ${g}`,oe.Unimplemented)}},A=P=>{let F;const M=(..._)=>{const G=N().then(B=>{const h=y(B,P);if(h){const D=h(..._);return F=D?.remove,D}else throw new $e(`"${m}.${P}()" is not implemented on ${g}`,oe.Unimplemented)});return P==="addListener"&&(G.remove=async()=>F()),G};return M.toString=()=>`${P.toString()}() { [capacitor code] }`,Object.defineProperty(M,"name",{value:P,writable:!1,configurable:!1}),M},O=A("addListener"),R=A("removeListener"),U=(P,F)=>{const M=O({eventName:P},F),_=async()=>{const B=await M;R({eventName:P,callbackId:B},F)},G=new Promise(B=>M.then(()=>B({remove:_})));return G.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await _()},G},q=new Proxy({},{get(P,F){switch(F){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return E?U:O;case"removeListener":return R;default:return A(F)}}});return s[m]=q,o.set(m,{name:m,proxy:q,platforms:new Set([...Object.keys(p),...E?[g]:[]])}),q};return a.convertFileSrc||(a.convertFileSrc=m=>m),a.getPlatform=r,a.handleError=d,a.isNativePlatform=n,a.isPluginAvailable=i,a.registerPlugin=u,a.Exception=$e,a.DEBUG=!!a.DEBUG,a.isLoggingEnabled=!!a.isLoggingEnabled,a},Pt=e=>e.Capacitor=Ot(e),C=Pt(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),re=C.registerPlugin;class qe{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(t,a){let s=!1;this.listeners[t]||(this.listeners[t]=[],s=!0),this.listeners[t].push(a);const n=this.windowListeners[t];n&&!n.registered&&this.addWindowListener(n),s&&this.sendRetainedArgumentsForEvent(t);const i=async()=>this.removeListener(t,a);return Promise.resolve({remove:i})}async removeAllListeners(){this.listeners={};for(const t in this.windowListeners)this.removeWindowListener(this.windowListeners[t]);this.windowListeners={}}notifyListeners(t,a,s){const r=this.listeners[t];if(!r){if(s){let n=this.retainedEventArguments[t];n||(n=[]),n.push(a),this.retainedEventArguments[t]=n}return}r.forEach(n=>n(a))}hasListeners(t){var a;return!!(!((a=this.listeners[t])===null||a===void 0)&&a.length)}registerWindowListener(t,a){this.windowListeners[a]={registered:!1,windowEventName:t,pluginEventName:a,handler:s=>{this.notifyListeners(a,s)}}}unimplemented(t="not implemented"){return new C.Exception(t,oe.Unimplemented)}unavailable(t="not available"){return new C.Exception(t,oe.Unavailable)}async removeListener(t,a){const s=this.listeners[t];if(!s)return;const r=s.indexOf(a);this.listeners[t].splice(r,1),this.listeners[t].length||this.removeWindowListener(this.windowListeners[t])}addWindowListener(t){window.addEventListener(t.windowEventName,t.handler),t.registered=!0}removeWindowListener(t){t&&(window.removeEventListener(t.windowEventName,t.handler),t.registered=!1)}sendRetainedArgumentsForEvent(t){const a=this.retainedEventArguments[t];a&&(delete this.retainedEventArguments[t],a.forEach(s=>{this.notifyListeners(t,s)}))}}const Xe=e=>encodeURIComponent(e).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),Ke=e=>e.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class xt extends qe{async getCookies(){const t=document.cookie,a={};return t.split(";").forEach(s=>{if(s.length<=0)return;let[r,n]=s.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");r=Ke(r).trim(),n=Ke(n).trim(),a[r]=n}),a}async setCookie(t){try{const a=Xe(t.key),s=Xe(t.value),r=t.expires?`; expires=${t.expires.replace("expires=","")}`:"",n=(t.path||"/").replace("path=",""),i=t.url!=null&&t.url.length>0?`domain=${t.url}`:"";document.cookie=`${a}=${s||""}${r}; path=${n}; ${i};`}catch(a){return Promise.reject(a)}}async deleteCookie(t){try{document.cookie=`${t.key}=; Max-Age=0`}catch(a){return Promise.reject(a)}}async clearCookies(){try{const t=document.cookie.split(";")||[];for(const a of t)document.cookie=a.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(t){return Promise.reject(t)}}async clearAllCookies(){try{await this.clearCookies()}catch(t){return Promise.reject(t)}}}re("CapacitorCookies",{web:()=>new xt});const It=async e=>new Promise((t,a)=>{const s=new FileReader;s.onload=()=>{const r=s.result;t(r.indexOf(",")>=0?r.split(",")[1]:r)},s.onerror=r=>a(r),s.readAsDataURL(e)}),qt=(e={})=>{const t=Object.keys(e);return Object.keys(e).map(r=>r.toLocaleLowerCase()).reduce((r,n,i)=>(r[n]=e[t[i]],r),{})},Ft=(e,t=!0)=>e?Object.entries(e).reduce((s,r)=>{const[n,i]=r;let l,d;return Array.isArray(i)?(d="",i.forEach(o=>{l=t?encodeURIComponent(o):o,d+=`${n}=${l}&`}),d.slice(0,-1)):(l=t?encodeURIComponent(i):i,d=`${n}=${l}`),`${s}&${d}`},"").substr(1):null,kt=(e,t={})=>{const a=Object.assign({method:e.method||"GET",headers:e.headers},t),r=qt(e.headers)["content-type"]||"";if(typeof e.data=="string")a.body=e.data;else if(r.includes("application/x-www-form-urlencoded")){const n=new URLSearchParams;for(const[i,l]of Object.entries(e.data||{}))n.set(i,l);a.body=n.toString()}else if(r.includes("multipart/form-data")||e.data instanceof FormData){const n=new FormData;if(e.data instanceof FormData)e.data.forEach((l,d)=>{n.append(d,l)});else for(const l of Object.keys(e.data))n.append(l,e.data[l]);a.body=n;const i=new Headers(a.headers);i.delete("content-type"),a.headers=i}else(r.includes("application/json")||typeof e.data=="object")&&(a.body=JSON.stringify(e.data));return a};class Ut extends qe{async request(t){const a=kt(t,t.webFetchExtra),s=Ft(t.params,t.shouldEncodeUrlParams),r=s?`${t.url}?${s}`:t.url,n=await fetch(r,a),i=n.headers.get("content-type")||"";let{responseType:l="text"}=n.ok?t:{};i.includes("application/json")&&(l="json");let d,o;switch(l){case"arraybuffer":case"blob":o=await n.blob(),d=await It(o);break;case"json":d=await n.json();break;default:d=await n.text()}const u={};return n.headers.forEach((m,p)=>{u[p]=m}),{data:d,headers:u,status:n.status,url:n.url}}async get(t){return this.request(Object.assign(Object.assign({},t),{method:"GET"}))}async post(t){return this.request(Object.assign(Object.assign({},t),{method:"POST"}))}async put(t){return this.request(Object.assign(Object.assign({},t),{method:"PUT"}))}async patch(t){return this.request(Object.assign(Object.assign({},t),{method:"PATCH"}))}async delete(t){return this.request(Object.assign(Object.assign({},t),{method:"DELETE"}))}}re("CapacitorHttp",{web:()=>new Ut});var Ge;(function(e){e.Dark="DARK",e.Light="LIGHT",e.Default="DEFAULT"})(Ge||(Ge={}));var Ve;(function(e){e.StatusBar="StatusBar",e.NavigationBar="NavigationBar"})(Ve||(Ve={}));class Mt extends qe{async setStyle(){this.unavailable("not available for web")}async setAnimation(){this.unavailable("not available for web")}async show(){this.unavailable("not available for web")}async hide(){this.unavailable("not available for web")}}re("SystemBars",{web:()=>new Mt});const _t="modulepreload",Bt=function(e){return"/"+e},Ye={},Fe=function(t,a,s){let r=Promise.resolve();if(a&&a.length>0){let d=function(o){return Promise.all(o.map(u=>Promise.resolve(u).then(m=>({status:"fulfilled",value:m}),m=>({status:"rejected",reason:m}))))};document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),l=i?.nonce||i?.getAttribute("nonce");r=d(a.map(o=>{if(o=Bt(o),o in Ye)return;Ye[o]=!0;const u=o.endsWith(".css"),m=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${o}"]${m}`))return;const p=document.createElement("link");if(p.rel=u?"stylesheet":_t,u||(p.as="script"),p.crossOrigin="",p.href=o,l&&p.setAttribute("nonce",l),document.head.appendChild(p),u)return new Promise((b,g)=>{p.addEventListener("load",b),p.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${o}`)))})}))}function n(i){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=i,window.dispatchEvent(l),!l.defaultPrevented)throw i}return r.then(i=>{for(const l of i||[])l.status==="rejected"&&n(l.reason);return t().catch(n)})};function jt(e){e.CapacitorUtils.Synapse=new Proxy({},{get(t,a){return new Proxy({},{get(s,r){return(n,i,l)=>{const d=e.Capacitor.Plugins[a];if(d===void 0){l(new Error(`Capacitor plugin ${a} not found`));return}if(typeof d[r]!="function"){l(new Error(`Method ${r} not found in Capacitor plugin ${a}`));return}(async()=>{try{const o=await d[r](n);i(o)}catch(o){l(o)}})()}}})}})}function Ht(e){e.CapacitorUtils.Synapse=new Proxy({},{get(t,a){return e.cordova.plugins[a]}})}function Wt(e=!1){typeof window>"u"||(window.CapacitorUtils=window.CapacitorUtils||{},window.Capacitor!==void 0&&!e?jt(window):window.cordova!==void 0&&Ht(window))}var we;(function(e){e.Documents="DOCUMENTS",e.Data="DATA",e.Library="LIBRARY",e.Cache="CACHE",e.External="EXTERNAL",e.ExternalStorage="EXTERNAL_STORAGE",e.ExternalCache="EXTERNAL_CACHE",e.LibraryNoCloud="LIBRARY_NO_CLOUD",e.Temporary="TEMPORARY"})(we||(we={}));var Pe;(function(e){e.UTF8="utf8",e.ASCII="ascii",e.UTF16="utf16"})(Pe||(Pe={}));const Qe=re("Filesystem",{web:()=>Fe(()=>import("./web-BHsEhhTz.js"),[]).then(e=>new e.FilesystemWeb)});Wt();const Xt=re("Share",{web:()=>Fe(()=>import("./web-CLE41rxb.js"),[]).then(e=>new e.ShareWeb)});class Kt{constructor(t){this.sqlite=t,this._connectionDict=new Map}async initWebStore(){try{return await this.sqlite.initWebStore(),Promise.resolve()}catch(t){return Promise.reject(t)}}async saveToStore(t){try{return await this.sqlite.saveToStore({database:t}),Promise.resolve()}catch(a){return Promise.reject(a)}}async saveToLocalDisk(t){try{return await this.sqlite.saveToLocalDisk({database:t}),Promise.resolve()}catch(a){return Promise.reject(a)}}async getFromLocalDiskToStore(t){const a=t??!0;try{return await this.sqlite.getFromLocalDiskToStore({overwrite:a}),Promise.resolve()}catch(s){return Promise.reject(s)}}async echo(t){try{const a=await this.sqlite.echo({value:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async isSecretStored(){try{const t=await this.sqlite.isSecretStored();return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async setEncryptionSecret(t){try{return await this.sqlite.setEncryptionSecret({passphrase:t}),Promise.resolve()}catch(a){return Promise.reject(a)}}async changeEncryptionSecret(t,a){try{return await this.sqlite.changeEncryptionSecret({passphrase:t,oldpassphrase:a}),Promise.resolve()}catch(s){return Promise.reject(s)}}async clearEncryptionSecret(){try{return await this.sqlite.clearEncryptionSecret(),Promise.resolve()}catch(t){return Promise.reject(t)}}async checkEncryptionSecret(t){try{const a=await this.sqlite.checkEncryptionSecret({passphrase:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async addUpgradeStatement(t,a){try{return t.endsWith(".db")&&(t=t.slice(0,-3)),await this.sqlite.addUpgradeStatement({database:t,upgrade:a}),Promise.resolve()}catch(s){return Promise.reject(s)}}async createConnection(t,a,s,r,n){try{t.endsWith(".db")&&(t=t.slice(0,-3)),await this.sqlite.createConnection({database:t,encrypted:a,mode:s,version:r,readonly:n});const i=new Je(t,n,this.sqlite),l=n?`RO_${t}`:`RW_${t}`;return this._connectionDict.set(l,i),Promise.resolve(i)}catch(i){return Promise.reject(i)}}async closeConnection(t,a){try{t.endsWith(".db")&&(t=t.slice(0,-3)),await this.sqlite.closeConnection({database:t,readonly:a});const s=a?`RO_${t}`:`RW_${t}`;return this._connectionDict.delete(s),Promise.resolve()}catch(s){return Promise.reject(s)}}async isConnection(t,a){const s={};t.endsWith(".db")&&(t=t.slice(0,-3));const r=a?`RO_${t}`:`RW_${t}`;return s.result=this._connectionDict.has(r),Promise.resolve(s)}async retrieveConnection(t,a){t.endsWith(".db")&&(t=t.slice(0,-3));const s=a?`RO_${t}`:`RW_${t}`;if(this._connectionDict.has(s)){const r=this._connectionDict.get(s);return typeof r<"u"?Promise.resolve(r):Promise.reject(`Connection ${t} is undefined`)}else return Promise.reject(`Connection ${t} does not exist`)}async getNCDatabasePath(t,a){try{const s=await this.sqlite.getNCDatabasePath({path:t,database:a});return Promise.resolve(s)}catch(s){return Promise.reject(s)}}async createNCConnection(t,a){try{await this.sqlite.createNCConnection({databasePath:t,version:a});const s=new Je(t,!0,this.sqlite),r=`RO_${t})`;return this._connectionDict.set(r,s),Promise.resolve(s)}catch(s){return Promise.reject(s)}}async closeNCConnection(t){try{await this.sqlite.closeNCConnection({databasePath:t});const a=`RO_${t})`;return this._connectionDict.delete(a),Promise.resolve()}catch(a){return Promise.reject(a)}}async isNCConnection(t){const a={},s=`RO_${t})`;return a.result=this._connectionDict.has(s),Promise.resolve(a)}async retrieveNCConnection(t){if(this._connectionDict.has(t)){const a=`RO_${t})`,s=this._connectionDict.get(a);return typeof s<"u"?Promise.resolve(s):Promise.reject(`Connection ${t} is undefined`)}else return Promise.reject(`Connection ${t} does not exist`)}async isNCDatabase(t){try{const a=await this.sqlite.isNCDatabase({databasePath:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async retrieveAllConnections(){return this._connectionDict}async closeAllConnections(){const t=new Map;try{for(const a of this._connectionDict.keys()){const s=a.substring(3),r=a.substring(0,3)==="RO_";await this.sqlite.closeConnection({database:s,readonly:r}),t.set(a,null)}for(const a of t.keys())this._connectionDict.delete(a);return Promise.resolve()}catch(a){return Promise.reject(a)}}async checkConnectionsConsistency(){try{const t=[...this._connectionDict.keys()],a=[],s=[];for(const n of t)a.push(n.substring(0,2)),s.push(n.substring(3));const r=await this.sqlite.checkConnectionsConsistency({dbNames:s,openModes:a});return r.result||(this._connectionDict=new Map),Promise.resolve(r)}catch(t){return this._connectionDict=new Map,Promise.reject(t)}}async importFromJson(t){try{const a=await this.sqlite.importFromJson({jsonstring:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async isJsonValid(t){try{const a=await this.sqlite.isJsonValid({jsonstring:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async copyFromAssets(t){const a=t??!0;try{return await this.sqlite.copyFromAssets({overwrite:a}),Promise.resolve()}catch(s){return Promise.reject(s)}}async getFromHTTPRequest(t,a){const s=a??!0;try{return await this.sqlite.getFromHTTPRequest({url:t,overwrite:s}),Promise.resolve()}catch(r){return Promise.reject(r)}}async isDatabaseEncrypted(t){t.endsWith(".db")&&(t=t.slice(0,-3));try{const a=await this.sqlite.isDatabaseEncrypted({database:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async isInConfigEncryption(){try{const t=await this.sqlite.isInConfigEncryption();return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isInConfigBiometricAuth(){try{const t=await this.sqlite.isInConfigBiometricAuth();return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isDatabase(t){t.endsWith(".db")&&(t=t.slice(0,-3));try{const a=await this.sqlite.isDatabase({database:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async getDatabaseList(){try{const a=(await this.sqlite.getDatabaseList()).values;a.sort();const s={values:a};return Promise.resolve(s)}catch(t){return Promise.reject(t)}}async getMigratableDbList(t){const a=t||"default";try{const s=await this.sqlite.getMigratableDbList({folderPath:a});return Promise.resolve(s)}catch(s){return Promise.reject(s)}}async addSQLiteSuffix(t,a){const s=t||"default",r=a||[];try{const n=await this.sqlite.addSQLiteSuffix({folderPath:s,dbNameList:r});return Promise.resolve(n)}catch(n){return Promise.reject(n)}}async deleteOldDatabases(t,a){const s=t||"default",r=a||[];try{const n=await this.sqlite.deleteOldDatabases({folderPath:s,dbNameList:r});return Promise.resolve(n)}catch(n){return Promise.reject(n)}}async moveDatabasesAndAddSuffix(t,a){const s=t||"default",r=a||[];return this.sqlite.moveDatabasesAndAddSuffix({folderPath:s,dbNameList:r})}}class Je{constructor(t,a,s){this.dbName=t,this.readonly=a,this.sqlite=s}getConnectionDBName(){return this.dbName}getConnectionReadOnly(){return this.readonly}async open(){try{return await this.sqlite.open({database:this.dbName,readonly:this.readonly}),Promise.resolve()}catch(t){return Promise.reject(t)}}async close(){try{return await this.sqlite.close({database:this.dbName,readonly:this.readonly}),Promise.resolve()}catch(t){return Promise.reject(t)}}async beginTransaction(){try{const t=await this.sqlite.beginTransaction({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async commitTransaction(){try{const t=await this.sqlite.commitTransaction({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async rollbackTransaction(){try{const t=await this.sqlite.rollbackTransaction({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isTransactionActive(){try{const t=await this.sqlite.isTransactionActive({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async loadExtension(t){try{return await this.sqlite.loadExtension({database:this.dbName,path:t,readonly:this.readonly}),Promise.resolve()}catch(a){return Promise.reject(a)}}async enableLoadExtension(t){try{return await this.sqlite.enableLoadExtension({database:this.dbName,toggle:t,readonly:this.readonly}),Promise.resolve()}catch(a){return Promise.reject(a)}}async getUrl(){try{const t=await this.sqlite.getUrl({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async getVersion(){try{const t=await this.sqlite.getVersion({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async getTableList(){try{const t=await this.sqlite.getTableList({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async execute(t,a=!0,s=!0){try{if(this.readonly)return Promise.reject("not allowed in read-only mode");{const r=await this.sqlite.execute({database:this.dbName,statements:t,transaction:a,readonly:!1,isSQL92:s});return Promise.resolve(r)}}catch(r){return Promise.reject(r)}}async query(t,a,s=!0){let r;try{return a&&a.length>0?r=await this.sqlite.query({database:this.dbName,statement:t,values:a,readonly:this.readonly,isSQL92:!0}):r=await this.sqlite.query({database:this.dbName,statement:t,values:[],readonly:this.readonly,isSQL92:s}),r=await this.reorderRows(r),Promise.resolve(r)}catch(n){return Promise.reject(n)}}async run(t,a,s=!0,r="no",n=!0){let i;try{return this.readonly?Promise.reject("not allowed in read-only mode"):(a&&a.length>0?i=await this.sqlite.run({database:this.dbName,statement:t,values:a,transaction:s,readonly:!1,returnMode:r,isSQL92:!0}):i=await this.sqlite.run({database:this.dbName,statement:t,values:[],transaction:s,readonly:!1,returnMode:r,isSQL92:n}),i.changes=await this.reorderRows(i.changes),Promise.resolve(i))}catch(l){return Promise.reject(l)}}async executeSet(t,a=!0,s="no",r=!0){let n;try{return this.readonly?Promise.reject("not allowed in read-only mode"):(n=await this.sqlite.executeSet({database:this.dbName,set:t,transaction:a,readonly:!1,returnMode:s,isSQL92:r}),n.changes=await this.reorderRows(n.changes),Promise.resolve(n))}catch(i){return Promise.reject(i)}}async isExists(){try{const t=await this.sqlite.isDBExists({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isTable(t){try{const a=await this.sqlite.isTableExists({database:this.dbName,table:t,readonly:this.readonly});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async isDBOpen(){try{const t=await this.sqlite.isDBOpen({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async delete(){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.deleteDatabase({database:this.dbName,readonly:!1}),Promise.resolve())}catch(t){return Promise.reject(t)}}async createSyncTable(){try{if(this.readonly)return Promise.reject("not allowed in read-only mode");{const t=await this.sqlite.createSyncTable({database:this.dbName,readonly:!1});return Promise.resolve(t)}}catch(t){return Promise.reject(t)}}async setSyncDate(t){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.setSyncDate({database:this.dbName,syncdate:t,readonly:!1}),Promise.resolve())}catch(a){return Promise.reject(a)}}async getSyncDate(){try{const t=await this.sqlite.getSyncDate({database:this.dbName,readonly:this.readonly});let a="";return t.syncDate>0&&(a=new Date(t.syncDate*1e3).toISOString()),Promise.resolve(a)}catch(t){return Promise.reject(t)}}async exportToJson(t,a=!1){try{const s=await this.sqlite.exportToJson({database:this.dbName,jsonexportmode:t,readonly:this.readonly,encrypted:a});return Promise.resolve(s)}catch(s){return Promise.reject(s)}}async deleteExportedRows(){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.deleteExportedRows({database:this.dbName,readonly:!1}),Promise.resolve())}catch(t){return Promise.reject(t)}}async executeTransaction(t,a=!0){let s=0,r=!1;if(this.readonly)return Promise.reject("not allowed in read-only mode");if(await this.sqlite.beginTransaction({database:this.dbName}),r=await this.sqlite.isTransactionActive({database:this.dbName}),!r)return Promise.reject("After Begin Transaction, no transaction active");try{for(const l of t){if(typeof l!="object"||!("statement"in l))throw new Error("Error a task.statement must be provided");if("values"in l&&l.values&&l.values.length>0){const d=l.statement.toUpperCase().includes("RETURNING")?"all":"no",o=await this.sqlite.run({database:this.dbName,statement:l.statement,values:l.values,transaction:!1,readonly:!1,returnMode:d,isSQL92:a});if(o.changes.changes<0)throw new Error("Error in transaction method run ");s+=o.changes.changes}else{const d=await this.sqlite.execute({database:this.dbName,statements:l.statement,transaction:!1,readonly:!1});if(d.changes.changes<0)throw new Error("Error in transaction method execute ");s+=d.changes.changes}}const n=await this.sqlite.commitTransaction({database:this.dbName});s+=n.changes.changes;const i={changes:{changes:s}};return Promise.resolve(i)}catch(n){const i=n.message?n.message:n;return await this.sqlite.rollbackTransaction({database:this.dbName}),Promise.reject(i)}}async reorderRows(t){const a=t;if(t?.values&&typeof t.values[0]=="object"&&Object.keys(t.values[0]).includes("ios_columns")){const s=t.values[0].ios_columns,r=[];for(let n=1;n<t.values.length;n++){const i=t.values[n],l={};for(const d of s)l[d]=i[d];r.push(l)}a.values=r}return Promise.resolve(a)}}const Gt=re("CapacitorSQLite",{web:()=>Fe(()=>import("./web-By93s8ao.js"),[]).then(e=>new e.CapacitorSQLiteWeb),electron:()=>window.CapacitorCustomPlatform.plugins.CapacitorSQLite});function Vt(e){return e.replace(/^(add[- ]?on|additional)\s+/i,"").trim()}const Yt="laba101_offline",Te="fresh_start_reset_v1",Qt=new Kt(Gt);let ge=null;const K=[{id:1,name:"Laba101 Admin",email:"admin@laba101.test",password:"password",role:"admin",branch:"Main Store"},{id:2,name:"Gensan Branch Staff",email:"staff@laba101.gensan",password:"password",role:"staff",branch:"Gensan Branch"}],Ne=[],Y=[V(1,"Drop-off","P185. Includes wash, dry, and fold.","Drop-Off","order",185,8,40,["Wash","Dry","Fold"],0,24),V(2,"Full Service","P200. Wash, Fabcon, detergent, dry, and fold.","Full Service","order",200,8,40,["Wash","Dry","Fold","Detergent","Fabcon"],0,24),V(3,"Self Service Wash","P60. Self-service wash (max 8kg per load).","Self Service","order",60,8,null,["Wash"],0,1),V(4,"Self Service Dry","P70. Self-service dry (40 mins).","Self Service","order",70,8,40,["Dry"],0,1),V(6,"Dry 10 mins","Additional drying time (10 mins).","Add-on","addon",30,8,10,["Dry"],0,1),V(7,"Dry 20 mins","Additional drying time (20 mins).","Add-on","addon",50,8,20,["Dry"],0,1),V(8,"Dry 40 mins","Additional drying time (40 mins).","Add-on","addon",70,8,40,["Dry"],0,1),V(9,"Additional Zonrox","Extra Zonrox bleach add-on per load.","Add-on","addon",25,0,null,["Zonrox"],0,0),V(10,"Additional Fabcon","Extra Fabcon fabric conditioner add-on per load.","Add-on","addon",25,0,null,["Fabcon"],0,0)],ee=[{id:1,name:"Regular Clothes",maxKg:8,additionalFee:0,isActive:1},{id:2,name:"Comforter",maxKg:4,additionalFee:0,isActive:1},{id:3,name:"Thin Blankets",maxKg:6,additionalFee:0,isActive:1},{id:4,name:"Bedsheets",maxKg:6,additionalFee:0,isActive:1},{id:5,name:"Bath Towels",maxKg:6,additionalFee:0,isActive:1},{id:6,name:"Curtains",maxKg:6,additionalFee:0,isActive:1}];function ze(e,t){const a=L(e,[]),s=new Map(a.map(n=>[n.id,n])),r=t.map(n=>{const i=s.get(n.id);return i?{...n,...i,isActive:i.isActive??n.isActive}:n});(a.length!==r.length||r.some((n,i)=>n.id!==a[i]?.id||JSON.stringify(n)!==JSON.stringify(a[i])))&&w(e,r)}async function Jt(){ze("services",Y),ze("item_categories",ee)}async function Le(e){for(const t of Y)((await e.query("SELECT id FROM laundry_services WHERE id = ?",[t.id])).values??[]).length>0?await e.run("UPDATE laundry_services SET name = ?, description = ?, category = ?, serviceType = ?, price = ?, maxKg = ?, dryingMinutes = ?, includes = ?, additionalCharge = ?, turnaroundHours = ?, isActive = COALESCE(isActive, ?) WHERE id = ?",[t.name,t.description,t.category,t.serviceType,t.price,t.maxKg,t.dryingMinutes,JSON.stringify(t.includes),t.additionalCharge,t.turnaroundHours,t.isActive,t.id]):await e.run("INSERT INTO laundry_services (id, name, description, category, serviceType, price, maxKg, dryingMinutes, includes, additionalCharge, turnaroundHours, isActive) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",[t.id,t.name,t.description,t.category,t.serviceType,t.price,t.maxKg,t.dryingMinutes,JSON.stringify(t.includes),t.additionalCharge,t.turnaroundHours,t.isActive]);for(const t of ee)((await e.query("SELECT id FROM item_categories WHERE id = ?",[t.id])).values??[]).length>0?await e.run("UPDATE item_categories SET name = ?, maxKg = ?, additionalFee = ?, isActive = COALESCE(isActive, ?) WHERE id = ?",[t.name,t.maxKg,t.additionalFee,t.isActive,t.id]):await e.run("INSERT INTO item_categories (id, name, maxKg, additionalFee, isActive) VALUES (?, ?, ?, ?, ?)",[t.id,t.name,t.maxKg,t.additionalFee,t.isActive])}const te=[],ce=[],se=[],le=[],de=[],Q=[...[1,2,3,4].map(e=>({id:e,machineName:`Washer ${e}`,machineType:"washer",status:"available",branch:"Main Store"})),...[1,2,3,4].map(e=>({id:e+4,machineName:`Dryer ${e}`,machineType:"dryer",status:"available",branch:"Main Store"}))],ue=[{key:"branch",value:"Main Store"},{key:"fold_rate",value:"5"},{key:"report_email",value:"admin@laba101.test"}];function V(e,t,a,s,r,n,i,l,d,o,u){return{id:e,name:t,description:a,category:s,serviceType:r,price:n,maxKg:i,dryingMinutes:l,includes:d,additionalCharge:o,turnaroundHours:u,isActive:1}}function j(e){return`laba101-mobile-${e}`}function L(e,t){const a=localStorage.getItem(j(e));if(!a)return structuredClone(t);try{return JSON.parse(a)}catch{return structuredClone(t)}}function w(e,t){localStorage.setItem(j(e),JSON.stringify(t))}function H(e){return e.reduce((t,a)=>Math.max(t,a.id),0)+1}function ae(){return new Date().toISOString()}function xe(e=new Date){const t=e.getFullYear(),a=String(e.getMonth()+1).padStart(2,"0"),s=String(e.getDate()).padStart(2,"0");return`${t}-${a}-${s}`}function zt(){return xe().slice(2).replaceAll("-","")}function z(e,t){if(!e)return t;try{return JSON.parse(e)}catch{return t}}async function $(){return ge||(ge=await Qt.createConnection(Yt,!1,"no-encryption",1,!1),await ge.open()),ge}async function I(e,t,a,s){((await e.query(`PRAGMA table_info(${t})`)).values??[]).some(i=>i.name===a)||await e.execute(`ALTER TABLE ${t} ADD COLUMN ${a} ${s}`)}function Zt(){const e=L("staff",K),t=new Map(e.map(s=>[s.id,s]));let a=!1;for(const s of K){const r=t.get(s.id);if(!r){t.set(s.id,{...s,isActive:1}),a=!0;continue}const n={...r,name:s.name,email:s.email,password:s.password,role:s.role,branch:s.branch,isActive:1};JSON.stringify(n)!==JSON.stringify(r)&&(t.set(s.id,n),a=!0)}a&&w("staff",Array.from(t.values()).sort((s,r)=>s.id-r.id))}async function ea(){localStorage.getItem(j(Te))||(w("staff",K),w("customers",[]),w("orders",[]),w("payments",[]),w("fold_logs",[]),w("expenses",[]),w("sales",[]),localStorage.getItem(j("services"))||w("services",Y),localStorage.getItem(j("item_categories"))||w("item_categories",ee),localStorage.getItem(j("machines"))||w("machines",Q),localStorage.getItem(j("subcleanings"))||w("subcleanings",[]),localStorage.getItem(j("settings"))||w("settings",ue),localStorage.removeItem("laba101-mobile-session"),w(Te,!0))}async function dt(e){for(const t of K){if(((await e.query("SELECT id FROM staff WHERE id = ?",[t.id])).values??[]).length>0){await e.run("UPDATE staff SET name = ?, email = ?, password = ?, role = ?, branch = ?, isActive = 1 WHERE id = ?",[t.name,t.email,t.password,t.role,t.branch,t.id]);continue}await e.run("INSERT INTO staff (id, name, email, password, role, branch, isActive) VALUES (?, ?, ?, ?, ?, ?, ?)",[t.id,t.name,t.email,t.password,t.role,t.branch,1])}}async function ta(e){if(!(((await e.query("SELECT COUNT(*) as count FROM machines")).values?.[0]?.count??0)>0))for(const a of Q)await e.run("INSERT INTO machines (id, machineName, machineType, status, branch) VALUES (?, ?, ?, ?, ?)",[a.id,a.machineName,a.machineType,a.status,a.branch])}async function aa(e){for(const t of ue)await e.run("INSERT OR IGNORE INTO settings (key, value) VALUES (?, ?)",[t.key,t.value])}async function ut(e){for(const t of Y)((await e.query("SELECT id FROM laundry_services WHERE id = ?",[t.id])).values??[]).length>0||await e.run("INSERT INTO laundry_services (id, name, description, category, serviceType, price, maxKg, dryingMinutes, includes, additionalCharge, turnaroundHours, isActive) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",[t.id,t.name,t.description,t.category,t.serviceType,t.price,t.maxKg,t.dryingMinutes,JSON.stringify(t.includes),t.additionalCharge,t.turnaroundHours,t.isActive]);for(const t of ee)((await e.query("SELECT id FROM item_categories WHERE id = ?",[t.id])).values??[]).length>0||await e.run("INSERT INTO item_categories (id, name, maxKg, additionalFee, isActive) VALUES (?, ?, ?, ?, ?)",[t.id,t.name,t.maxKg,t.additionalFee,t.isActive])}async function sa(e){((await e.query("SELECT value FROM settings WHERE key = ?",[Te])).values??[]).length>0||(await e.execute(`
  ...
  `),await dt(e),await ut(e),await ta(e),await aa(e),await e.run("INSERT OR REPLACE INTO settings (key, value) VALUES (?, ?)",[Te,ae()]),localStorage.removeItem("laba101-mobile-session"))}async function ra(){if(!C.isNativePlatform()){await ea(),!localStorage.getItem(j("seeded_v4"))&&!localStorage.getItem(j("services"))&&!localStorage.getItem(j("staff"))&&(w("staff",K),w("customers",Ne),w("services",Y),w("item_categories",ee),w("orders",te),w("payments",ce),w("fold_logs",[]),w("expenses",se),w("sales",le),w("revolving_history",de),w("machines",Q),w("subcleanings",[]),w("settings",ue),w("seeded_v4",!0)),await Jt(),Zt(),localStorage.getItem(j("seeded_v4"))||w("seeded_v4",!0);return}const e=await $();await e.execute(`
  ...
  `}function Ha(e=new Date){return{date:new Intl.DateTimeFormat("en-PH",{weekday:"long",month:"long",day:"numeric",year:"numeric"}).format(e),time:new Intl.DateTimeFormat("en-PH",{hour:"numeric",minute:"2-digit",second:"2-digit",hour12:!0}).format(e)}}function Ee(){const e=document.querySelector("[data-date-from]"),t=document.querySelector("[data-date-to]"),a=Array.from(document.querySelectorAll('input[name="reportType"]:checked')).map(s=>s.value).filter(s=>s==="sales"||s==="disbursement"||s==="fold_count"||s==="revolving_fund"||s==="summary");return{from:e?.value||"0000-01-01",to:t?.value||"9999-12-31",types:a.length?a:["summary"]}}function fe(e,t){return e>=t.from&&e<=t.to}function Nt(e,t,a,s,r,n,i){const l=new Set(i.types),d=e.filter(h=>fe(W(h.createdAt),i)),o=a.filter(h=>fe(h.saleDate,i)),u=s.filter(h=>fe(h.expenseDate,i)),m=Ma(d),p=new Map;t.filter(h=>fe(W(h.receivedAt),i)).forEach(h=>{const D=p.get(h.orderId)??{cash:0,gcash:0};h.method==="gcash"?D.gcash+=h.amount:D.cash+=h.amount,p.set(h.orderId,D)});const b=d.reduce((h,D)=>{const k=p.get(D.id);if(k){const J=k.cash+k.gcash;if(J>D.totalAmount){const ne=D.totalAmount/J;return h+k.cash*ne}return h+k.cash}return h+D.paidAmount},0),g=o.reduce((h,D)=>h+D.cashAmount,0),E=o.reduce((h,D)=>h+D.gcashAmount,0),f=d.reduce((h,D)=>{const k=p.get(D.id);if(k){const J=k.cash+k.gcash;if(J>D.totalAmount){const ne=D.totalAmount/J;return h+k.gcash*ne}return h+k.gcash}return h+0},0),N=b+g,y=f+E,A=N+y,O=u.reduce((h,D)=>h+D.amount,0),R=O,U=A-R,q=()=>({orderCashTotal:b,orderGcashTotal:f,manualCashTotal:g,manualGcashTotal:E,totalCash:N,totalGcash:y,totalSales:A,transactions:d.map(h=>{const D=p.get(h.id)??{cash:h.paidAmount,gcash:0},k=D.cash+D.gcash;let J=D.cash,ne=D.gcash,He=k;if(k>h.totalAmount){const We=h.totalAmount/k;J=D.cash*We,ne=D.gcash*We,He=h.totalAmount}return{ticket:h.ticket,customer:h.customer,cash:J,gcash:ne,total:He}}),manualSales:o.map(h=>({cash:h.cashAmount,gcash:h.gcashAmount,total:h.totalAmount}))}),P=()=>({totalExpenses:O,totalDisbursement:R,rows:[["Date","id#","Name","Category","Description","Amount"],...u.map(h=>[h.expenseDate,h.number,h.name,h.category??"",h.description??"",h.amount]),[],["Total Disbursement","","","","",R]]}),F=()=>({rows:[["Staff","Fold Count"],...m.map(h=>[h.staffName,h.folds]),[],["Total Folds",m.reduce((h,D)=>h+D.folds,0)]]}),M=r.filter(h=>fe(W(h.createdAt),i));return{selection:i,selectedTypes:l,salesRows:q,disbursementRows:P,foldCountRows:F,revolvingDailySummaryRows:()=>({rows:[["Date of Sales","Cash on Hand","Status","Date Update"],...o.map(h=>{const D=wt(h.saleDate,e,s,h.cashAmount),k=h.status==="revolving"?"Revolving":h.status==="endorsed"?`Endorsed to ${h.endorsedTo??""}`:"Pending";return[h.saleDate,D,k,h.statusUpdatedAt?W(h.statusUpdatedAt):""]})]}),revolvingHistoryRows:()=>({rows:[["Date","Number","Name","Amount","Category","Description","Type"],...M.map(h=>[W(h.createdAt),h.revolvingNumber,h.name,h.type==="disbursement"?-h.amount:h.amount,h.category,h.description??"",h.type==="add"?"Add Revolving Fund":"Disbursement"])]}),summaryRows:()=>{const h=q(),D=P();return[["Summary",i.from,"to",i.to],[],["Total Cash:","Total GCash:","Total Sales:"],["","",""],[h.totalCash,h.totalGcash,h.totalSales],["","",""],["Total Disbursement:","Total Profit:","Cash on Hand:"],["","",""],[D.totalDisbursement,U,Ce(h.totalCash,D.totalDisbursement)]]},profit:U}}function Wa(e,t){return`<button class="nav-link ${t?"is-active":""}" data-tab="${e}" type="button">
    <span class="nav-icon">${Xa(e)}</span>
    <span>${_e[e]}</span>
  </button>`}function x(e,t){return`<div class="section-head"><div><h2>${v(e)}</h2><p class="meta">${v(t)}</p></div></div>`}function rt(){return _e[c.tab]??"Dashboard"}function De(e){return(e?.name??"Laba101").trim().slice(0,1).toUpperCase()}function Xa(e){return{dashboard:"DB",pos:"POS",orders:"PO",archived:"AR",customers:"CU",pricing:"PS",disbursements:"DR",reports:"RP",inventory:"IN",maintenance:"MT",staff:"ST",revolving:"RV",settings:"SE"}[e]}async function At(){const e=await ve(),t=await ca(e),a=await pt(),s=await da(),r=await Ue(),n=await ma(),i=await yt(),l=await pe(e),d=await ga(),o=await Sa(),u=await Ta(),m=await Ra(),p=await St(e),b=await qa(e),g=await Pa(),E=await oa(),f=await vt("report_email");return{branch:e,staff:t,allStaff:a,customers:s,services:r,allServices:n,categories:i,orders:l,payments:d,foldLogs:o,expenses:u,sales:m,machines:p,subcleanings:b,revolvingHistory:g,foldRate:E,reportEmail:f??""}}async function S(){if(!c.currentUser){Ka(),us();return}const e=await At();e.orders.filter(d=>d.status!=="claimed").length,e.orders.filter(d=>d.status==="ready").length,e.orders.reduce((d,o)=>d+o.paidAmount,0);const t=X(),a=Tt(e.payments,e.orders,d=>d.branch===e.branch&&W(d.receivedAt)===t),s=a.gcash+e.sales.filter(d=>d.saleDate===t).reduce((d,o)=>d+o.gcashAmount,0),r=a.cash+e.sales.filter(d=>d.saleDate===t).reduce((d,o)=>d+o.cashAmount,0),n=r+s,i=e.expenses.filter(d=>d.expenseDate===t).reduce((d,o)=>d+o.amount,0),l=Ce(r,i);e.sales.reduce((d,o)=>d+o.totalAmount,0),e.expenses.reduce((d,o)=>d+o.amount,0),Me.innerHTML=`
    <div class="app-frame">
      <header class="topbar">
      ...
      <aside class="sidebar ${c.sidebarOpen?"is-open":""}">
        ...
        <nav>${Lt().map(d=>Wa(d,c.tab===d)).join("")}</nav>
      ...
      <main class="workspace">
        ...
        ${c.tab==="dashboard"?Va({paidToday:n,cashPaidToday:r,gcashPaidToday:s,disbursementToday:i,cashOnHandToday:l,orders:e.orders,payments:e.payments,sales:e.sales}):""}
        ${c.tab==="pos"?Ya(e.orders,e.customers,e.services,e.categories,e.payments,e.branch):""}
        ${c.tab==="orders"?Qa(e.orders,e.staff,e.services,e.payments):""}
        ${c.tab==="archived"?Ja(e.orders,e.staff,e.services,e.payments):""}
        ${c.tab==="customers"?as(e.customers,e.orders):""}
        ${c.tab==="pricing"?ss(e.allServices,e.categories):""}
        ${c.tab==="disbursements"?rs(e.expenses,e.sales):""}
        ${c.tab==="reports"?ns(e.orders,e.payments,e.sales,e.expenses,e.revolvingHistory,e.foldRate):""}
        ${c.tab==="inventory"?is(e.services,e.categories):""}
        ${c.tab==="maintenance"?os(e.machines,e.subcleanings,e.branch):""}
        ${c.tab==="staff"?cs(e.allStaff,e.branch):""}
        ${c.tab==="revolving"?ws(e.sales,e.revolvingHistory,e.orders,e.expenses):""}
        ${c.tab==="settings"?ls(e.branch,e.foldRate,e.reportEmail):""}
      </main>
    </div>
  `,ds(),vs(e),ps(e.allServices),fs(e.expenses),ys(e.orders,e.payments,e.sales,e.expenses,e.revolvingHistory,e.foldRate),hs(),gs(),bs(),Es(e.allStaff),Ts(),Ss(),ms()}function Lt(){if(c.currentUser?.role==="admin")return Object.keys(_e).filter(t=>t!=="inventory");const e=["dashboard","pos","orders","archived","disbursements","reports","maintenance","revolving"];return Ba(c.currentUser)?["dashboard","disbursements","reports","maintenance","revolving"]:ja(c.currentUser)?e.filter(t=>t!=="revolving"):e}function Ka(){Me.innerHTML=`
  ...
  `}function Ga(){document.querySelectorAll("[data-fill-email]").forEach(e=>{e.addEventListener("click",()=>{const t=document.querySelector('input[name="email"]'),a=document.querySelector('input[name="password"]');t&&(t.value=e.dataset.fillEmail??""),a&&(a.value=e.dataset.fillPassword??"")})})}function Va(e){const t=new Date,a=Array.from({length:7},(i,l)=>{const d=new Date(t);return d.setDate(t.getDate()-(6-l)),new Intl.DateTimeFormat("en-PH",{month:"short",day:"numeric"}).format(d)}),s=Array.from({length:7},(i,l)=>{const d=new Date(t);d.setDate(t.getDate()-(6-l));const o=he(d),u=Tt(e.payments,e.orders,p=>W(p.receivedAt)===o).total,m=e.sales.filter(p=>p.saleDate===o).reduce((p,b)=>p+b.totalAmount,0);return u+m}),r=Math.max(1,...s),n=210;return`
      ...
      <article class="panel revenue-panel">
        ...
        <div class="chart-shell">
          <div class="mini-chart revenue-chart">
            ${s.map((i,l)=>{const d=Math.max(12,Math.round(i/r*n));return`<div class="chart-bar ${l===s.length-1?"is-today":""}"><span style="height:${d}px"></span><strong>${T(i)}</strong></div>`}).join("")}
          </div>
  ...
  `}function Ya(e,t,a,s,r,n){const i=a.filter(m=>m.serviceType==="order"&&m.isActive),l=a.filter(m=>m.serviceType==="addon"&&m.isActive),d=c.receiptOrderId?e.find(m=>m.id===c.receiptOrderId):null,o=new Set(e.map(m=>m.customerId)),u=t.filter(m=>o.has(m.id));return`
    <section class="grid content full">
          ...
          <div class="form-row">
            <label>Existing customer (${v(n)})
              <select name="customerId">
                ...
                ${u.map(m=>`<option value="${m.id}" data-name="${v(m.name)}" data-phone="${v(m.phone??"")}">${v(m.name)} ${m.phone?`- ${v(m.phone)}`:""}</option>`).join("")}
              </select>
            </label>
      ...
      ${d?je(d,r.filter(m=>m.orderId===d.id)):""}
    </section>
  `}function Qa(e,t,a,s){const r=c.receiptOrderId?e.find(u=>u.id===c.receiptOrderId):null,n=e.filter(u=>u.status!=="claimed"),i=c.orderSearch.trim().toLowerCase(),l=c.orderDateFilter.trim(),d=c.orderPaymentFilter.trim().toLowerCase(),o=n.filter(u=>{const m=!i||[u.ticket,u.customer,u.phone,u.service,u.itemCategory,u.status].some(g=>String(g??"").toLowerCase().includes(i)),p=!l||W(u.createdAt)===l,b=!d||Be(u)===d;return m&&p&&b});return`
    <section class="grid content full">
      <article class="panel span-2">
        ...
        <div class="summary-list queue-summary">
          ...
          <div><span>Claimed archived</span><strong>${e.filter(u=>u.status==="claimed").length}</strong></div>
        </div>
        <table class="data-table orders-data-table">
          ...
          <tbody>
            ${o.map(u=>Ct(u,t,a)).join("")||'<tr><td colspan="5" class="table-empty">No matching active orders.</td></tr>'}
          </tbody>
        </table>
      </article>
      ${r?je(r,s.filter(u=>u.orderId===r.id)):""}
    </section>
  `}function Ja(e,t,a,s){const r=e.filter(d=>d.status==="claimed"),n=c.archivedOrderSearch.trim().toLowerCase(),i=r.filter(d=>n?[d.ticket,d.customer,d.phone,d.service,d.itemCategory].some(o=>String(o??"").toLowerCase().includes(n)):!0),l=c.receiptOrderId?e.find(d=>d.id===c.receiptOrderId):null;return`
    <section class="grid content full">
      <article class="panel span-2">
        ...
        <table class="data-table orders-data-table archived-orders-table">
          ...
          <tbody>
            ${i.map(d=>Ct(d,t,a)).join("")||'<tr><td colspan="5" class="table-empty">No archived orders found.</td></tr>'}
          </tbody>
        </table>
      </article>
      ${l?je(l,s.filter(d=>d.orderId===l.id)):""}
    </section>
  `}function Ct(e,t,a){const s=ht(e,a),r=s.find(p=>!e.workflowCompleted.includes(p.key)),n=r?.key==="fold",i=r?.key==="extras"&&e.extras.length>0,l=Be(e),d=e.extras.length?e.extras.map(p=>`${v(Z(p.name))} x${Number(p.quantity??1)}`).join(", "):"",o=c.currentUser?.role==="admin",u=e.status!=="claimed"&&e.paidAmount<=0,m=e.status!=="claimed"&&o&&e.paidAmount>0;return`
      ...
      <td colspan="5">
        <div class="order-detail-row">
          ...
          <div class="workflow-progress order-workflow-progress">
            ${s.map(p=>`<span class="${e.workflowCompleted.includes(p.key)?"is-done":r?.key===p.key?"is-next":""}">${v(p.label)}</span>`).join("")}
          </div>
        </div>
      </td>
    </tr>
  `}function je(e,t){const a=t.reduce((i,l)=>i+Number(l.amount),0),s=Math.max(0,Number((a-e.totalAmount).toFixed(2))),r=Be(e),n=r.charAt(0).toUpperCase()+r.slice(1);return`
  ...
  `}function ss(e,t){const a=e.filter(r=>r.serviceType==="order"),s=e.filter(r=>r.serviceType==="addon");return`
    <section class="grid content full">
      <article class="panel">
        ...
        <form id="service-form" class="form">
          ...
          <fieldset class="check-grid">
            ...
            ${Ua.map(r=>`<label class="check"><input type="checkbox" name="includes" value="${r}" /> ${r}</label>`).join("")}
          </fieldset>
      ...
      <article class="panel span-2">
        ...
        <div class="table-scroll">
          <div class="table data-table extra-services-table">
            ...
            ${s.map(r=>`<div class="table-row"><div><strong>${v(r.name)}</strong></div><div>${v(r.category)}</div><div>${T(r.price)}</div><div>${v(r.includes.join(", ")||"none")}</div><div>${r.isActive?"Active":"Inactive"}</div><div class="row-actions"><button class="secondary edit-service-btn" data-id="${r.id}">Edit</button>${r.isActive?`<button class="secondary deactivate-service-btn" data-id="${r.id}">Deactivate</button>`:`<button class="secondary activate-service-btn" data-id="${r.id}">Activate</button>`}</div></div>`).join("")||'<div class="helper">No extra services yet.</div>'}
          </div>
        </div>
      </article>
    </section>
  `}function rs(e,t){const a=X(),s=a.slice(0,7),r=c.currentUser?.role==="admin",n=e.filter(o=>o.expenseDate===a).reduce((o,u)=>o+u.amount,0),i=e.filter(o=>o.expenseDate.startsWith(s)).reduce((o,u)=>o+u.amount,0),l=t.filter(o=>o.saleDate===a).reduce((o,u)=>o+u.totalAmount,0),d=t.filter(o=>o.saleDate.startsWith(s)).reduce((o,u)=>o+u.totalAmount,0);return`
    ...
    <section class="grid stats compact report-stats">
      <div class="panel stat"><div class="card-label">Daily disbursement</div><div class="value">${T(n)}</div></div>
      <div class="panel stat"><div class="card-label">Monthly disbursement</div><div class="value">${T(i)}</div></div>
      <div class="panel stat"><div class="card-label">Today sales input</div><div class="value">${T(l)}</div></div>
      ...
      <article class="panel">
        ...
        <div class="table-scroll daily-report-scroll">
          <div class="table daily-report-table">
            ...
            ${e.map(o=>`<div class="table-row"><div>${v(o.expenseDate)}</div><div>${v(o.number)}</div><div>${v(o.name)}</div><div>${v(o.category)}</div><div>${T(o.amount)}</div><div class="row-actions"><button class="secondary edit-expense-btn" data-id="${o.id}" type="button">Edit</button>${r?`<button class="secondary delete-expense-btn" data-id="${o.id}" type="button">Delete</button>`:""}</div></div>`).join("")||'<div class="helper">No expenses yet.</div>'}
          </div>
        </div>
      </article>
    </section>
      ...
      <article class="panel">
        ...
        <div class="table-scroll daily-report-scroll">
          <div class="table wide-table daily-report-table">
            ...
            ${t.map(o=>`<div class="table-row"><div>${v(o.saleNumber)}</div><div>${v(o.saleDate)}</div><div>${T(o.cashAmount)}</div><div>${T(o.gcashAmount)}</div><div><strong>${T(o.totalAmount)}</strong></div><div class="row-actions"><button class="secondary edit-sale-btn" data-id="${o.id}" type="button">Edit</button>${r?`<button class="secondary delete-sale-btn" data-id="${o.id}" type="button">Delete</button>`:""}</div></div>`).join("")||'<div class="helper">No daily sales totals yet.</div>'}
          </div>
        </div>
      </article>
    </section>
    `}
  `}function ns(e,t,a,s,r,n,i,l,d){const o=c.reportPreview?Nt(e,t,a,s,r,n,c.reportPreview):null;return`
    <section class="page-head">
      <div>
        ...
        ${o.selectedTypes.has("sales")?`
          <article>
            ...
            <div class="table wide-table report-preview-table sales-table">
              ...
              ${o.salesRows().transactions.map(u=>`<div class="table-row report-table-row"><div>${v(u.ticket)}</div><div>${v(u.customer)}</div><div>${T(u.cash)}</div><div>${T(u.gcash)}</div><div>${T(u.total)}</div></div>`).join("")}
            </div>
        ...
        ${o.selectedTypes.has("disbursement")?`
          <article>
            ...
            <div class="table wide-table report-preview-table report-disbursement-table">
              ...
              ${o.disbursementRows().rows.slice(1).filter(u=>u.length&&u[0]!=="Total Disbursement").map(u=>`<div class="table-row report-table-row"><div>${v(u[1]??"")}</div><div>${v(u[0]??"")}</div><div>${v(u[2]??"")}</div><div>${v(u[3]??"")}</div><div>${T(u[5])}</div></div>`).join("")}
            </div>
        ...
        ${o.selectedTypes.has("fold_count")?`
          <article>
            ...
            <div class="table report-preview-table">
              ...
              ${o.foldCountRows().rows.slice(1).map(u=>`<div class="table-row">${u.map(m=>`<div>${v(m??"")}</div>`).join("")}</div>`).join("")}
            </div>
          </article>`:""}
        ${o.selectedTypes.has("revolving_fund")?`
          <article>
            ${x("Revolving Fund — Daily Summary",`${o.selection.from} to ${o.selection.to}`)}
            ${Ae(["Date of Sales","Cash on Hand","Status","Date Update"],o.revolvingDailySummaryRows().rows.slice(1).map(u=>[v(String(u[0]??"")),v(String(u[1]??"")),v(String(u[2]??"")),v(String(u[3]??""))]),"data-table revolving-report-table")}
          </article>
          <article>
            ${x("Revolving Fund — Table History",`${o.selection.from} to ${o.selection.to}`)}
            ${Ae(["Date","Number","Name","Amount","Category","Description","Type"],o.revolvingHistoryRows().rows.slice(1).map(u=>[v(String(u[0]??"")),v(String(u[1]??"")),v(String(u[2]??"")),v(String(u[3]??"")),v(String(u[4]??"")),v(String(u[5]??"")),v(String(u[6]??""))]),"data-table revolving-report-table")}
          </article>`:""}
        ${o.selectedTypes.has("summary")?`
          <article>
            ...
            <div class="summary-cards-grid summary-single-row">
              ...
              <div class="summary-card"><span class="card-label">Cash on Hand</span><strong>${T(Ce(o.salesRows().totalCash,o.disbursementRows().totalDisbursement))}</strong></div>
            </div>
          </article>`:""}
      </section>
    `:""}
  ...
  `}function os(e,t,a){const s=e.filter(n=>n.status!=="under_cleaning"),r=e.filter(n=>n.status==="under_cleaning");return`
    <section class="page-head">
      <div>
    ...
    <section class="grid content full">
      ...
      <article class="panel span-2">
        ...
        <div class="table">
          ...
          ${e.map(n=>{const i=t.find(l=>l.machineIds.includes(n.id)&&l.date===X());return`<div class="table-row"><div><strong>${v(n.machineName)}</strong></div><div>${v(n.machineType)}</div><div>${i?v(i.cleaningStatus.replace("_"," ")):"Not Cleaned"}</div><div>${v(i?.notes??"-")}</div><div>${X()}</div></div>`}).join("")}
        </div>
      </article>
    </section>
    `:`
  ...
  `}function ds(){const e=()=>{localStorage.removeItem(ye),c.currentUser=null,c.tab="dashboard",c.receiptOrderId=0,c.sidebarOpen=!1,S()};document.querySelector("#logout-button")?.addEventListener("click",e),document.querySelector("#mobile-logout-button")?.addEventListener("click",e),document.querySelector("#mobile-menu-button")?.addEventListener("click",()=>{c.sidebarOpen=!0,S()}),document.querySelector("#sidebar-close-button")?.addEventListener("click",()=>{c.sidebarOpen=!1,S()}),document.querySelector("#sidebar-backdrop")?.addEventListener("click",()=>{c.sidebarOpen=!1,S()}),document.querySelectorAll("[data-tab]").forEach(t=>{t.addEventListener("click",()=>{c.tab=t.dataset.tab,c.receiptOrderId=0,c.sidebarOpen=!1,S()})}),document.querySelectorAll("[data-quick-tab]").forEach(t=>{t.addEventListener("click",()=>{c.tab=t.dataset.quickTab,S()})}),document.querySelectorAll("[data-receipt]").forEach(t=>{t.addEventListener("click",()=>{c.receiptOrderId=Number(t.dataset.receipt),c.printerPanelOpen=!1,c.printerError="",c.printerStatus="",S()})}),document.querySelector("[data-close-receipt]")?.addEventListener("click",()=>{c.receiptOrderId=0,S()}),document.querySelector("[data-open-printer-panel]")?.addEventListener("click",()=>{c.printerPanelOpen=!c.printerPanelOpen,c.printerPanelOpen&&c.pairedPrinters.length===0?nt():S()}),document.querySelector("[data-refresh-printers]")?.addEventListener("click",()=>{nt()}),document.querySelector("[data-printer-select]")?.addEventListener("change",t=>{c.selectedPrinterAddress=t.currentTarget.value,S()}),document.querySelector("[data-paper-width]")?.addEventListener("change",t=>{c.printerPaperWidth=Number(t.currentTarget.value)===80?80:58,S()}),document.querySelector("[data-connect-printer]")?.addEventListener("click",()=>{Za()}),document.querySelector("[data-thermal-print]")?.addEventListener("click",()=>{(async()=>{const t=await At(),a=t.orders.find(r=>r.id===c.receiptOrderId);if(!a)throw new Error("Receipt order not found.");const s=t.payments.filter(r=>r.orderId===a.id);await ts(a,s)})().catch(t=>{c.printerPanelOpen=!0,c.printerError=t instanceof Error?t.message:"Bluetooth thermal print failed.",S()})}),document.querySelectorAll("[data-report-tab]").forEach(t=>{t.addEventListener("click",()=>{c.dailyReportTab=t.dataset.reportTab,S()})}),document.querySelectorAll("[data-maintenance-tab]").forEach(t=>{t.addEventListener("click",()=>{c.maintenanceTab=t.dataset.maintenanceTab,S()})})}function us(){Ga(),document.querySelector("#login-form")?.addEventListener("submit",async e=>{e.preventDefault();const t=new FormData(e.currentTarget),a=document.querySelector("#login-button");a&&(a.disabled=!0,a.textContent="Signing in...");try{const s=await ft(String(t.get("email")??""),String(t.get("password")??""));if(!s){c.loginError="Invalid email or password.",await S();return}c.currentUser=s,c.loginError="",await Se("branch",String(s.branch||"Main Store")),t.get("remember")?localStorage.setItem(ye,JSON.stringify({email:s.email,remembered:!0})):localStorage.removeItem(ye),Lt().includes(c.tab)||(c.tab="dashboard"),await S()}catch(s){alert("Login Error: "+String(s?.message||s)),a&&(a.disabled=!1,a.textContent="Sign in")}})}function ms(){be&&window.clearInterval(be);const e=document.querySelector("[data-navbar-time]"),t=document.querySelector("[data-navbar-date]");if(!e||!t){be=void 0;return}const a=()=>{const s=Ha();e.textContent=s.time,t.textContent=s.date};a(),be=window.setInterval(a,1e3)}function it(e,t){return e?t.find(a=>a.name.toLowerCase()===e.category.toLowerCase())??t.find(a=>a.name==="Regular Clothes")??t[0]??null:null}function Oe(e,t){return Math.max(1,Number(t.maxKg||e.maxKg||1))}function $t(e,t){return Object.fromEntries(t.filter(a=>a.serviceType==="order").map(a=>[a.id,Number(e.querySelector(`input[name="serviceQty-${a.id}"]`)?.value??0)]).filter(([,a])=>Number(a)>0))}function ot(e,t){const a=$t(e,t);return t.filter(s=>s.serviceType==="order"&&Number(a[s.id]??0)>0).map(s=>({...s,quantity:Number(a[s.id])}))}function Rt(e,t){return Object.fromEntries(t.filter(a=>a.serviceType==="addon").map(a=>[a.id,Number(e.querySelector(`input[name="addonQty-${a.id}"]`)?.value??0)]).filter(([,a])=>Number(a)>0))}function ct(e,t){const a=Rt(e,t);return t.filter(s=>s.serviceType==="addon"&&Number(a[s.id]??0)>0).map(s=>({...s,quantity:Number(a[s.id])}))}function vs(e){const t=document.querySelector("#order-form"),a=document.querySelector("#price-preview"),s=t?.querySelector('button[type="submit"]'),r=t?.querySelector('select[name="customerId"]'),n=t?.querySelector('input[name="customerName"]'),i=t?.querySelector('input[name="customerPhone"]'),l=t?.querySelector("[data-order-error]"),d=t?.querySelector('select[name="paymentMethod"]'),o=t?.querySelector(".gcash-reference"),u=t?.querySelector('input[name="paymentReference"]');let m=!1;const p=()=>{if(!r||!n||!i)return;const f=r.selectedOptions[0];n.value=f?.dataset.name??"",i.value=f?.dataset.phone??""},b=()=>{const f=d?.value==="gcash";o&&(o.hidden=!f),u&&(u.required=f,f||(u.value=""))},g=(f,N)=>{if(!t)return;const y=t.querySelector(`input[name="${f}"]`);y&&(y.value=String(Math.max(0,Number(y.value||0)+N)),y.closest(".qty-card")?.classList.toggle("is-selected",Number(y.value)>0),y.dispatchEvent(new Event("input",{bubbles:!0})))};t?.querySelectorAll(".qty-control input").forEach(f=>{f.addEventListener("input",()=>{f.value=String(Math.max(0,Number(f.value||0))),f.closest(".qty-card")?.classList.toggle("is-selected",Number(f.value)>0)})}),t?.querySelectorAll("[data-qty-card]").forEach(f=>{f.addEventListener("click",N=>{const y=N.target;y.closest("input")||y.closest("button")||g(f.dataset.qtyCard??"",1)})}),t?.querySelectorAll("[data-qty-plus]").forEach(f=>{f.addEventListener("click",()=>g(f.dataset.qtyPlus??"",1))}),t?.querySelectorAll("[data-qty-minus]").forEach(f=>{f.addEventListener("click",()=>g(f.dataset.qtyMinus??"",-1))});const E=()=>{if(!t||!a)return;const f=ot(t,e.services),N=f[0],y=it(N,e.categories),A=ct(t,e.services);if(!f.length||!N||!y){s&&(s.disabled=!0),l&&(l.hidden=!m,l.textContent=m?"Please select at least one service quantity.":""),a.innerHTML='<div class="preview-total"><span>Total amount</span><strong>PHP 0.00</strong></div>';return}const O=Ie(f,y,Oe(N,y),A),R=O.serviceLines.map(q=>`${q.name} x${q.quantity}`),U=O.extras.map(q=>`${Z(q.name)} x${q.quantity}`);s&&(s.disabled=!1),l&&(l.hidden=!0,l.textContent=""),a.classList.remove("has-error"),a.innerHTML=`
    ...
    `};r?.addEventListener("change",p),d?.addEventListener("change",b),b(),t?.addEventListener("input",E),t?.addEventListener("change",E),E(),t?.addEventListener("submit",async f=>{f.preventDefault(),m=!0;const N=new FormData(t),y=ot(t,e.services),A=y[0],O=it(A,e.categories),R=ct(t,e.services);if(!y.length||!A||!O){l&&(l.hidden=!1,l.textContent="Please select at least one service quantity.");return}const U=y.map(P=>`${P.name} x${P.quantity}`).join(", "),q=Ie(y,O,Oe(A,O),R);if(confirm(`Save this order?

Services: ${U}
Total: ${T(q.totalAmount)}`))try{const P=await fa({customerId:Number(N.get("customerId"))||void 0,customerName:String(N.get("customerName")??""),customerPhone:String(N.get("customerPhone")??"")||null,serviceQuantities:$t(t,e.services),branch:e.branch,itemCategoryId:O?.id,weightKg:A&&O?Oe(A,O):void 0,addonQuantities:Rt(t,e.services),paidAmount:Number(N.get("paidAmount")??0),paymentMethod:String(N.get("paymentMethod")??"cash"),paymentReference:String(N.get("paymentReference")??"")||null,notes:String(N.get("notes")??"")||null});c.receiptOrderId=P.id,await S()}catch(P){l&&(l.hidden=!1,l.textContent=P instanceof Error?P.message:"Order could not be saved.")}}),document.querySelectorAll(".advance-form").forEach(f=>{f.addEventListener("submit",async N=>{N.preventDefault();const y=new FormData(f);await ha(Number(f.dataset.orderId),Number(y.get("assignedStaffId"))||null),await S()})}),document.querySelectorAll(".payment-form").forEach(f=>{const N=f.querySelector('select[name="method"]'),y=f.querySelector('input[name="reference"]'),A=()=>{const O=N?.value==="gcash";y&&(y.hidden=!O,y.required=O,O||(y.value=""))};N?.addEventListener("change",A),A(),f.addEventListener("submit",async O=>{O.preventDefault();const R=new FormData(f),U=Number(R.get("amount")),q=String(R.get("method")),P=String(R.get("reference")??"")||null;confirm(`Confirm payment of ${T(U)} via ${q.toUpperCase()}?`)&&(await gt(Number(f.dataset.orderId),{amount:U,method:q,reference:P}),await S())})}),document.querySelectorAll("[data-cancel-order]").forEach(f=>{f.addEventListener("click",async()=>{const N=Number(f.dataset.cancelOrder);if(Number.isFinite(N)&&confirm("Cancel this order? (No payment will be refunded.)"))try{c.receiptOrderId===N&&(c.receiptOrderId=0),await ba(N),await S()}catch(y){alert(y instanceof Error?y.message:"Cancel failed.")}})}),document.querySelectorAll("[data-delete-order]").forEach(f=>{f.addEventListener("click",async()=>{const N=Number(f.dataset.deleteOrder);if(Number.isFinite(N)&&confirm("Delete this paid order and update sales?"))try{c.receiptOrderId===N&&(c.receiptOrderId=0),await Ea(N),await S()}catch(y){alert(y instanceof Error?y.message:"Delete failed.")}})})}function ps(e){document.querySelector("#service-form")?.addEventListener("submit",async t=>{t.preventDefault();const a=new FormData(t.currentTarget),s=a.get("id")?Number(a.get("id")):void 0;await et({id:s,name:String(a.get("name")??""),description:String(a.get("description")??"")||null,category:String(a.get("category")??""),serviceType:String(a.get("serviceType")??"order"),price:Number(a.get("price")??0),maxKg:Number(a.get("maxKg")??0),dryingMinutes:Number(a.get("dryingMinutes"))||null,includes:a.getAll("includes").map(String).filter(Boolean),additionalCharge:0,turnaroundHours:Number(a.get("turnaroundHours")??24),isActive:1}),await S()}),document.querySelectorAll(".edit-service-btn").forEach(t=>{t.addEventListener("click",()=>{const a=Number(t.dataset.id),s=e.find(n=>n.id===a),r=document.querySelector("#service-form");s&&r&&(r.querySelector("[name=id]").value=String(s.id),r.querySelector("[name=name]").value=s.name,r.querySelector("[name=category]").value=s.category,r.querySelector("[name=serviceType]").value=s.serviceType,r.querySelector("[name=price]").value=String(s.price),r.querySelector("[name=maxKg]").value=String(s.maxKg),r.querySelector("[name=dryingMinutes]").value=s.dryingMinutes?String(s.dryingMinutes):"",r.querySelectorAll('input[name="includes"]').forEach(n=>{n.checked=s.includes.includes(n.value)}),r.querySelector("[name=turnaroundHours]").value=String(s.turnaroundHours),r.querySelector("[name=description]").value=s.description??"",window.scrollTo({top:0,behavior:"smooth"}))})}),document.querySelectorAll(".deactivate-service-btn, .activate-service-btn").forEach(t=>{t.addEventListener("click",async()=>{const a=Number(t.dataset.id),s=e.find(r=>r.id===a);if(s){const r=s.isActive?0:1;await et({id:s.id,name:s.name,description:s.description,category:s.category,serviceType:s.serviceType,price:s.price,maxKg:s.maxKg,dryingMinutes:s.dryingMinutes,includes:s.includes,additionalCharge:s.additionalCharge,turnaroundHours:s.turnaroundHours,isActive:r}),await S()}})}),document.querySelector("#category-form")?.addEventListener("submit",async t=>{t.preventDefault();const a=new FormData(t.currentTarget);await va({name:String(a.get("name")??""),maxKg:Number(a.get("maxKg")??0),additionalFee:Number(a.get("additionalFee")??0),isActive:1}),await S()})}function fs(e){const t=document.querySelector("#expense-form");t?.addEventListener("submit",async a=>{a.preventDefault();const s=new FormData(a.currentTarget),r=Number(s.get("id")||0),n={expenseDate:String(s.get("expenseDate")??""),name:String(s.get("name")??""),category:String(s.get("category")??""),description:String(s.get("description")??""),amount:Number(s.get("amount")??0)};r?await Ca(r,n):await La(n),await S()}),document.querySelectorAll(".edit-expense-btn").forEach(a=>{a.addEventListener("click",()=>{const s=e.find(n=>n.id===Number(a.dataset.id));if(!s||!t)return;t.querySelector("[name=id]").value=String(s.id),t.querySelector("[name=expenseDate]").value=s.expenseDate,t.querySelector("[name=amount]").value=String(s.amount),t.querySelector("[name=name]").value=s.name,t.querySelector("[name=category]").value=s.category,t.querySelector("[name=description]").value=s.description??"";const r=t.querySelector('button[type="submit"]');r&&(r.textContent="Update expense"),t.scrollIntoView({behavior:"smooth",block:"start"})})}),document.querySelectorAll(".delete-expense-btn").forEach(a=>{a.addEventListener("click",async()=>{if(c.currentUser?.role!=="admin")return;const s=Number(a.dataset.id);!Number.isFinite(s)||!confirm("Delete this disbursement?")||(await $a(s),await S())})}),document.querySelector("#fold-form")?.addEventListener("submit",async a=>{a.preventDefault();const s=new FormData(a.currentTarget);await wa({orderTicket:String(s.get("orderTicket")??""),staffName:String(s.get("staffName")??""),foldCount:Number(s.get("foldCount")??1),rate:Number(s.get("rate")??5)}),await S()})}function ys(e,t,a,s,r,n){document.querySelector("#generate-report")?.addEventListener("click",()=>{c.reportPreview=Ee(),S()});const i=document.querySelector("#sales-form");i?.addEventListener("submit",async g=>{g.preventDefault();const E=new FormData(g.currentTarget);await Da({id:Number(E.get("id")||0)||void 0,saleDate:String(E.get("saleDate")??""),cashAmount:Number(E.get("cashAmount")??0),gcashAmount:Number(E.get("gcashAmount")??0),notes:String(E.get("notes")??"")}),await S()}),document.querySelectorAll(".edit-sale-btn").forEach(g=>{g.addEventListener("click",()=>{const E=a.find(N=>N.id===Number(g.dataset.id));if(!E||!i)return;i.querySelector("[name=id]").value=String(E.id),i.querySelector("[name=saleDate]").value=E.saleDate,i.querySelector("[name=cashAmount]").value=String(E.cashAmount),i.querySelector("[name=gcashAmount]").value=String(E.gcashAmount),i.querySelector("[name=notes]").value=E.notes??"";const f=i.querySelector('button[type="submit"]');f&&(f.textContent="Update daily sale"),i.scrollIntoView({behavior:"smooth",block:"start"})})}),document.querySelectorAll(".delete-sale-btn").forEach(g=>{g.addEventListener("click",async()=>{if(c.currentUser?.role!=="admin")return;const E=Number(g.dataset.id);!Number.isFinite(E)||!confirm("Delete this daily sale?")||(await Oa(E),await S())})});const l=document.querySelector("[data-date-from]"),d=document.querySelector("[data-date-to]");document.querySelectorAll("[data-date-scope]").forEach(g=>{g.addEventListener("change",()=>{if(!g.checked||!l||!d)return;const E=new Date,f=he(E),N=new Date(E);g.value==="week"&&N.setDate(E.getDate()-6),g.value==="month"&&N.setDate(1),g.value!=="custom"&&(l.value=g.value==="today"?f:he(N),d.value=f)})});const o=g=>{const E=y=>String(y??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&apos;"),f=y=>y==="Sales Report"?[110,125,150,215,95,95,105,105]:y==="Disbursement"?[110,115,150,220,105]:y==="Fold Count"?[220,125]:y==="Revolving Daily Summary"?[115,105,120,115]:y==="Revolving History"?[115,96,140,96,110,180,120]:[155,125,125,125,95,95,115,115];return`<?xml version="1.0"?>
...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 xmlns:html="http://www.w3.org/TR/REC-html40">
  ...
  ${g.map(y=>{const A=f(y.name).map(R=>`<Column ss:Width="${R}" ss:AutoFitWidth="0"/>`).join(""),O=y.rows.map(R=>{if(!R.length)return'<Row ss:Height="10" ss:StyleID="BorderRow"><Cell ss:StyleID="BorderCell"><Data ss:Type="String">&nbsp;</Data></Cell></Row>';const U=R[0]==="Type"||R[0]==="Summary"||R[0]==="Sales Summary"||R[0]==="Disbursement Summary"||R[0]==="Staff"||R[0]==="Date of Sales"||R[0]==="Date",q=U?"HeaderRow":"BorderRow",P=U?"HeaderCell":"BorderCell",F=U?26:22,M=R.map(_=>`<Cell ss:StyleID="${P}"><Data ss:Type="${typeof _=="number"?"Number":"String"}">${E(_)}</Data></Cell>`).join("");return`<Row ss:Height="${F}" ss:StyleID="${q}">${M}</Row>`}).join("");return`
        <Worksheet ss:Name="${E(y.name)}">
          <Table>
            ${A}
            ${O}
          </Table>
        </Worksheet>`}).join("")}
</Workbook>`},u=()=>{const g=Ee(),E=Nt(e,t,a,s,r,n,g),f=[];if(E.selectedTypes.has("sales")){const A=E.salesRows(),O=[["Ticket","Customer","Cash","GCash","Total Payment"],...A.transactions.map(R=>[R.ticket,R.customer,R.cash,R.gcash,R.total]),[],["Cash from Orders","GCash from Orders","Sales from Orders"],[A.orderCashTotal,A.orderGcashTotal,A.orderCashTotal+A.orderGcashTotal],[],["Cash Whole Sale","GCash Whole Sale","Whole Sale of Day"],[A.manualCashTotal,A.manualGcashTotal,A.manualCashTotal+A.manualGcashTotal],[],["Total Cash","Total GCash","Total Sales"],[A.totalCash,A.totalGcash,A.totalSales]];f.push({name:"Sales Report",rows:O})}E.selectedTypes.has("disbursement")&&f.push({name:"Disbursement",rows:E.disbursementRows().rows}),E.selectedTypes.has("fold_count")&&f.push({name:"Fold Count",rows:E.foldCountRows().rows}),E.selectedTypes.has("revolving_fund")&&(f.push({name:"Revolving Daily Summary",rows:E.revolvingDailySummaryRows().rows}),f.push({name:"Revolving History",rows:E.revolvingHistoryRows().rows})),E.selectedTypes.has("summary")&&f.push({name:"Summary",rows:E.summaryRows()});const N=o(f.length?f:[{name:"Summary",rows:E.summaryRows()}]),y=`laba101-report-${g.from}-to-${g.to}.xls`;return new File([N],y,{type:"application/vnd.ms-excel"})},m=async()=>{const g=u();if(!C.isNativePlatform())return{fileName:g.name,uri:""};const E=await g.text(),f=g.name;await Qe.writeFile({path:f,data:E,directory:we.External,encoding:Pe.UTF8});const{uri:N}=await Qe.getUri({path:f,directory:we.External});return{fileName:g.name,uri:N}},p=()=>{const g=u(),E=Ee(),f=`laba101-report-${E.from}-to-${E.to}.xls`,N=g,y=URL.createObjectURL(N),A=document.createElement("a");return A.href=y,A.download=f,document.body.appendChild(A),A.click(),setTimeout(()=>{A.remove(),URL.revokeObjectURL(y)},1e3),f},b=async g=>{const E=document.querySelector(g==="export"?"#export-report":"#email-report");E&&(E.disabled=!0,E.textContent=g==="export"?"Exporting...":"Sending...");try{if(g==="export")if(C.isNativePlatform()){const f=await m();alert(`Report exported as "${f.fileName}".`)}else{const f=p();alert(`Report saved: ${f}`)}else{const f=await vt("report_email")||"";if(!f){alert("Please configure a report email in Settings first.");return}const N=Ee(),y=`Laba101 report ${N.from} to ${N.to}`;if(C.isNativePlatform()){const A=await m();try{await Xt.share({title:y,text:`Please find the attached Laba101 report file: ${A.fileName}`,files:[A.uri],dialogTitle:"Send report via email"}),alert(`Report saved and shared as "${A.fileName}".`)}catch(O){const R=String(O).toLowerCase();if(R.includes("share canceled")||R.includes("canceled"))alert(`Report saved as "${A.fileName}".`);else throw O}}else{const A=p(),O=`Hi,

Please find the attached Laba101 report file: ${A}

Date range: ${N.from} to ${N.to}`,R=`mailto:${f}?subject=${encodeURIComponent(y)}&body=${encodeURIComponent(O)}`;setTimeout(()=>{window.location.href=R},800),alert(`Report downloaded as "${A}".
Your email app will open — please attach the file and send.`)}}}catch(f){alert("Failed: "+String(f))}finally{E&&(E.disabled=!1,E.textContent=g==="export"?"Export Excel":"Send to Email")}};document.querySelector("#export-report")?.addEventListener("click",async()=>{await b("export")}),document.querySelector("#email-report")?.addEventListener("click",async()=>{await b("email")})}function hs(){document.querySelector("#order-queue-filters")?.addEventListener("submit",e=>{e.preventDefault();const t=new FormData(e.currentTarget);c.orderSearch=String(t.get("orderSearch")??"").trim(),c.orderDateFilter=String(t.get("orderDateFilter")??"").trim(),c.orderPaymentFilter=String(t.get("orderPaymentFilter")??"").trim(),S()}),document.querySelector("#order-queue-clear")?.addEventListener("click",()=>{c.orderSearch="",c.orderDateFilter="",c.orderPaymentFilter="",S()}),document.querySelector("#archived-order-filters")?.addEventListener("submit",e=>{e.preventDefault();const t=new FormData(e.currentTarget);c.archivedOrderSearch=String(t.get("archivedOrderSearch")??"").trim(),S()}),document.querySelector("#archived-order-clear")?.addEventListener("click",()=>{c.archivedOrderSearch="",S()})}function gs(){document.querySelector("#customer-search-form")?.addEventListener("submit",e=>{e.preventDefault();const t=new FormData(e.currentTarget);c.customerSearch=String(t.get("customerSearch")??"").trim(),S()}),document.querySelector("#customer-search-clear")?.addEventListener("click",()=>{c.customerSearch="",S()})}function bs(){document.querySelector("#machine-form")?.addEventListener("submit",async e=>{e.preventDefault();const t=new FormData(e.currentTarget);await xa({machineName:String(t.get("machineName")??""),machineType:String(t.get("machineType")),status:String(t.get("status")),branch:String(t.get("branch")??"")}),await S()}),document.querySelector("#subcleaning-form")?.addEventListener("submit",async e=>{e.preventDefault();const t=e.currentTarget.querySelector('button[type="submit"]');t&&(t.disabled=!0,t.textContent="Starting...");const a=new FormData(e.currentTarget),s=a.getAll("machineIds").map(Number);if(!s.length){alert("Please select at least one machine to clean."),t&&(t.disabled=!1,t.textContent="Start Cleaning");return}await Fa({date:String(a.get("date")??""),machineIds:s,cleaningStatus:String(a.get("cleaningStatus")??""),notes:String(a.get("notes")??""),branch:String(a.get("branch")??"")}),await S()}),document.querySelectorAll(".complete-cleaning-btn").forEach(e=>{e.addEventListener("click",async()=>{const t=Number(e.dataset.machineId),a=e.dataset.branch??"";e.disabled=!0,e.textContent="Completing...",await ka(t,a),await S()})}),document.querySelectorAll(".deactivate-machine-btn, .activate-machine-btn").forEach(e=>{e.addEventListener("click",async()=>{const t=Number(e.dataset.id),a=e.classList.contains("deactivate-machine-btn");await Ia(t,a?"inactive":"available"),await S()})})}function Es(e){const t=document.querySelector("#add-staff-modal"),a=document.querySelector("#open-add-staff-modal"),s=document.querySelector("#close-add-staff-modal"),r=document.querySelector("#staff-form"),n=()=>{r?.reset(),r&&(r.querySelector("[name=id]").value="");const l=document.querySelector("#add-staff-title");l&&(l.textContent="Add staff member"),t?.removeAttribute("hidden")},i=()=>{t?.setAttribute("hidden",""),r?.reset()};a?.addEventListener("click",n),s?.addEventListener("click",i),t?.addEventListener("click",l=>{l.target===t&&i()}),document.querySelectorAll(".edit-staff-btn").forEach(l=>{l.addEventListener("click",()=>{const d=Number(l.dataset.id),o=e.find(u=>u.id===d);if(o&&r){r.querySelector("[name=id]").value=String(o.id),r.querySelector("[name=name]").value=o.name,r.querySelector("[name=email]").value=o.email,r.querySelector("[name=password]").value=o.password,r.querySelector("[name=role]").value=o.role,r.querySelector("[name=branch]").value=o.branch;const u=document.querySelector("#add-staff-title");u&&(u.textContent="Edit staff member"),t?.removeAttribute("hidden")}})}),document.querySelectorAll(".deactivate-staff-btn, .activate-staff-btn").forEach(l=>{l.addEventListener("click",async()=>{const d=Number(l.dataset.id),o=e.find(u=>u.id===d);o&&(await Ze(d,{isActive:o.isActive!==0?0:1}),await S())})}),r?.addEventListener("submit",async l=>{l.preventDefault();const d=document.querySelector("#staff-save-btn");d&&(d.disabled=!0,d.textContent="Saving...");const o=new FormData(r),u=o.get("id")?Number(o.get("id")):void 0,m=String(o.get("name")??"").trim(),p=String(o.get("email")??"").trim(),b=String(o.get("password")??"password")||"password",g=String(o.get("role")),E=String(o.get("branch")??"");if(!m||!p){alert("Name and email are required."),d&&(d.disabled=!1,d.textContent="Save staff member");return}try{u?await Ze(u,{name:m,email:p,password:b,role:g,branch:E}):await la({name:m,email:p,password:b,role:g,branch:E}),i(),await S()}catch{alert("Failed to save staff. The email may already be in use."),d&&(d.disabled=!1,d.textContent="Save staff member")}})}function Ss(){document.querySelector("#settings-form")?.addEventListener("submit",async e=>{e.preventDefault();const t=new FormData(e.currentTarget);await Se("branch",String(t.get("branch")??"Main Store")),await Se("fold_rate",String(t.get("foldRate")??"5")),String(t.get("reportEmail")??"")&&await Se("report_email",String(t.get("reportEmail"))),alert("Settings saved successfully!"),await S()})}await ia();const lt=localStorage.getItem(ye);if(lt)try{const e=JSON.parse(lt);if(e.email&&e.remembered){const t=await ft(e.email,"password")??null;c.currentUser=t}}catch{localStorage.removeItem(ye)}function ws(e,t,a,s){const r=e.filter(b=>b.status==="revolving").reduce((b,g)=>b+g.cashAmount,0),n=t.filter(b=>b.type==="add").reduce((b,g)=>b+g.amount,0),i=t.filter(b=>b.type==="disbursement").reduce((b,g)=>b+g.amount,0),l=r+n-i,d=c.revolvingHistoryFrom||"0000-01-01",o=c.revolvingHistoryTo||"9999-12-31",u=t.filter(b=>{const g=W(b.createdAt);return g>=d&&g<=o}),m=e.map(b=>{const g=wt(b.saleDate,a,s,b.cashAmount),E=b.status==="revolving"?'<span class="ok">Revolving</span>':b.status==="endorsed"?`<span class="warn">Endorsed to ${v(b.endorsedTo)}</span>`:'<span class="meta">Pending</span>',f=b.status!=="revolving"&&b.status!=="endorsed"?`<div class="row-actions">
          <button class="primary revolving-btn" data-id="${b.id}">Revolving</button>
          <button class="secondary endorsed-btn" data-id="${b.id}" data-date="${ie(b.saleDate)}">Endorsed</button>
        </div>`:"";return[`<strong>${v(ie(b.saleDate))}</strong>`,`<strong class="ok">${T(g)}</strong>`,E,b.statusUpdatedAt?v(ie(b.statusUpdatedAt)):"-",f]}),p=u.map(b=>[_a(b.createdAt),`<strong>${v(b.revolvingNumber)}</strong>`,v(b.name),`<strong class="${b.type==="disbursement"?"warn":"ok"}">${b.type==="disbursement"?"-":"+"}${T(b.amount)}</strong>`,v(b.category),v(b.description||"-"),`<span class="${b.type==="add"?"ok":"warn"}">${b.type==="add"?"Add Revolving Fund":"Disbursement"}</span>`]);return`
    <section class="grid content full">
      ...
      <article class="panel">
        ...
        ${Ae(["Date","Disbursement #","Name","Amount","Category","Description","Type"],p,"data-table revolving-history-datatable")}
      </article>
  ...
  `}function Ts(){document.querySelector("#revolving-history-filters")?.addEventListener("submit",async u=>{u.preventDefault();const m=new FormData(u.currentTarget);c.revolvingHistoryFrom=String(m.get("revolvingHistoryFrom")??"").trim(),c.revolvingHistoryTo=String(m.get("revolvingHistoryTo")??"").trim(),await S()}),document.querySelector("#revolving-history-clear")?.addEventListener("click",async()=>{c.revolvingHistoryFrom="",c.revolvingHistoryTo="",await S()}),document.querySelectorAll(".revolving-btn").forEach(u=>{u.addEventListener("click",async()=>{c.revolvingModalOpen=!0,c.revolvingSaleId=Number(u.dataset.id),await S()})});const e=document.getElementById("confirm-revolving-btn");e&&e.addEventListener("click",async()=>{await at(c.revolvingSaleId,"revolving",null,new Date().toISOString()),c.revolvingModalOpen=!1,await S()});const t=document.getElementById("close-revolving-modal");t&&t.addEventListener("click",async()=>{c.revolvingModalOpen=!1,await S()}),document.querySelectorAll(".endorsed-btn").forEach(u=>{u.addEventListener("click",async()=>{c.endorseModalOpen=!0,c.endorseSaleId=Number(u.dataset.id),c.endorseSaleDate=u.dataset.date??"",await S()})});const a=document.getElementById("close-endorse-modal");a&&a.addEventListener("click",async()=>{c.endorseModalOpen=!1,await S()});const s=document.getElementById("endorse-form");s&&s.addEventListener("submit",async u=>{u.preventDefault();const m=new FormData(s),p=String(m.get("endorsedTo")??"").trim();p&&(await at(c.endorseSaleId,"endorsed",p,new Date().toISOString()),c.endorseModalOpen=!1,await S())});const r=document.getElementById("add-revolving-fund-btn");r&&r.addEventListener("click",async()=>{c.addFundModalOpen=!0,await S()});const n=document.getElementById("close-add-fund-modal");n&&n.addEventListener("click",async()=>{c.addFundModalOpen=!1,await S()});const i=document.getElementById("add-fund-form");i&&i.addEventListener("submit",async u=>{u.preventDefault();const m=new FormData(i);await st({name:String(m.get("name")??"").trim(),amount:Number(m.get("amount")??0),category:"Add Revolving Fund",description:null,type:"add",createdAt:new Date().toISOString()}),c.addFundModalOpen=!1,await S()});const l=document.getElementById("revolving-disbursement-btn");l&&l.addEventListener("click",async()=>{c.disbursementModalOpen=!0,await S()});const d=document.getElementById("close-disbursement-modal");d&&d.addEventListener("click",async()=>{c.disbursementModalOpen=!1,await S()});const o=document.getElementById("disbursement-form");o&&o.addEventListener("submit",async u=>{u.preventDefault();const m=new FormData(o);await st({name:String(m.get("name")??"").trim(),amount:Number(m.get("amount")??0),category:String(m.get("category")??"").trim(),description:String(m.get("description")??"").trim(),type:"disbursement",expenseDate:X(),createdAt:new Date().toISOString()}),c.disbursementModalOpen=!1,await S()})}await S();export{Pe as E,qe as W,kt as b};
