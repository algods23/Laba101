(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const o of n.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function a(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(r){if(r.ep)return;r.ep=!0;const n=a(r);fetch(r.href,n)}})();var J;(function(e){e.Unimplemented="UNIMPLEMENTED",e.Unavailable="UNAVAILABLE"})(J||(J={}));class be extends Error{constructor(t,a,s){super(t),this.message=t,this.code=a,this.data=s}}const tt=e=>{var t,a;return e?.androidBridge?"android":!((a=(t=e?.webkit)===null||t===void 0?void 0:t.messageHandlers)===null||a===void 0)&&a.bridge?"ios":"web"},at=e=>{const t=e.CapacitorCustomPlatform||null,a=e.Capacitor||{},s=a.Plugins=a.Plugins||{},r=()=>t!==null?t.name:tt(e),n=()=>r()!=="web",o=m=>{const v=l.get(m);return!!(v?.platforms.has(r())||i(m))},i=m=>{var v;return(v=a.PluginHeaders)===null||v===void 0?void 0:v.find(y=>y.name===m)},c=m=>e.console.error(m),l=new Map,g=(m,v={})=>{const y=l.get(m);if(y)return console.warn(`Capacitor plugin "${m}" already registered. Cannot register plugins twice.`),y.proxy;const b=r(),p=i(m);let d;const C=async()=>(!d&&b in v?d=typeof v[b]=="function"?d=await v[b]():d=v[b]:t!==null&&!d&&"web"in v&&(d=typeof v.web=="function"?d=await v.web():d=v.web),d),N=(h,O)=>{var M,_;if(p){const W=p?.methods.find(F=>O===F.name);if(W)return W.rtype==="promise"?F=>a.nativePromise(m,O.toString(),F):(F,se)=>a.nativeCallback(m,O.toString(),F,se);if(h)return(M=h[O])===null||M===void 0?void 0:M.bind(h)}else{if(h)return(_=h[O])===null||_===void 0?void 0:_.bind(h);throw new be(`"${m}" plugin is not implemented on ${b}`,J.Unimplemented)}},L=h=>{let O;const M=(..._)=>{const W=C().then(F=>{const se=N(F,h);if(se){const re=se(..._);return O=re?.remove,re}else throw new be(`"${m}.${h}()" is not implemented on ${b}`,J.Unimplemented)});return h==="addListener"&&(W.remove=async()=>O()),W};return M.toString=()=>`${h.toString()}() { [capacitor code] }`,Object.defineProperty(M,"name",{value:h,writable:!1,configurable:!1}),M},R=L("addListener"),q=L("removeListener"),P=(h,O)=>{const M=R({eventName:h},O),_=async()=>{const F=await M;q({eventName:h,callbackId:F},O)},W=new Promise(F=>M.then(()=>F({remove:_})));return W.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await _()},W},V=new Proxy({},{get(h,O){switch(O){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return p?P:R;case"removeListener":return q;default:return L(O)}}});return s[m]=V,l.set(m,{name:m,proxy:V,platforms:new Set([...Object.keys(v),...p?[b]:[]])}),V};return a.convertFileSrc||(a.convertFileSrc=m=>m),a.getPlatform=r,a.handleError=c,a.isNativePlatform=n,a.isPluginAvailable=o,a.registerPlugin=g,a.Exception=be,a.DEBUG=!!a.DEBUG,a.isLoggingEnabled=!!a.isLoggingEnabled,a},st=e=>e.Capacitor=at(e),w=st(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),Z=w.registerPlugin;class Ae{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(t,a){let s=!1;this.listeners[t]||(this.listeners[t]=[],s=!0),this.listeners[t].push(a);const n=this.windowListeners[t];n&&!n.registered&&this.addWindowListener(n),s&&this.sendRetainedArgumentsForEvent(t);const o=async()=>this.removeListener(t,a);return Promise.resolve({remove:o})}async removeAllListeners(){this.listeners={};for(const t in this.windowListeners)this.removeWindowListener(this.windowListeners[t]);this.windowListeners={}}notifyListeners(t,a,s){const r=this.listeners[t];if(!r){if(s){let n=this.retainedEventArguments[t];n||(n=[]),n.push(a),this.retainedEventArguments[t]=n}return}r.forEach(n=>n(a))}hasListeners(t){var a;return!!(!((a=this.listeners[t])===null||a===void 0)&&a.length)}registerWindowListener(t,a){this.windowListeners[a]={registered:!1,windowEventName:t,pluginEventName:a,handler:s=>{this.notifyListeners(a,s)}}}unimplemented(t="not implemented"){return new w.Exception(t,J.Unimplemented)}unavailable(t="not available"){return new w.Exception(t,J.Unavailable)}async removeListener(t,a){const s=this.listeners[t];if(!s)return;const r=s.indexOf(a);this.listeners[t].splice(r,1),this.listeners[t].length||this.removeWindowListener(this.windowListeners[t])}addWindowListener(t){window.addEventListener(t.windowEventName,t.handler),t.registered=!0}removeWindowListener(t){t&&(window.removeEventListener(t.windowEventName,t.handler),t.registered=!1)}sendRetainedArgumentsForEvent(t){const a=this.retainedEventArguments[t];a&&(delete this.retainedEventArguments[t],a.forEach(s=>{this.notifyListeners(t,s)}))}}const De=e=>encodeURIComponent(e).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),xe=e=>e.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class rt extends Ae{async getCookies(){const t=document.cookie,a={};return t.split(";").forEach(s=>{if(s.length<=0)return;let[r,n]=s.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");r=xe(r).trim(),n=xe(n).trim(),a[r]=n}),a}async setCookie(t){try{const a=De(t.key),s=De(t.value),r=t.expires?`; expires=${t.expires.replace("expires=","")}`:"",n=(t.path||"/").replace("path=",""),o=t.url!=null&&t.url.length>0?`domain=${t.url}`:"";document.cookie=`${a}=${s||""}${r}; path=${n}; ${o};`}catch(a){return Promise.reject(a)}}async deleteCookie(t){try{document.cookie=`${t.key}=; Max-Age=0`}catch(a){return Promise.reject(a)}}async clearCookies(){try{const t=document.cookie.split(";")||[];for(const a of t)document.cookie=a.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(t){return Promise.reject(t)}}async clearAllCookies(){try{await this.clearCookies()}catch(t){return Promise.reject(t)}}}Z("CapacitorCookies",{web:()=>new rt});const nt=async e=>new Promise((t,a)=>{const s=new FileReader;s.onload=()=>{const r=s.result;t(r.indexOf(",")>=0?r.split(",")[1]:r)},s.onerror=r=>a(r),s.readAsDataURL(e)}),it=(e={})=>{const t=Object.keys(e);return Object.keys(e).map(r=>r.toLocaleLowerCase()).reduce((r,n,o)=>(r[n]=e[t[o]],r),{})},ot=(e,t=!0)=>e?Object.entries(e).reduce((s,r)=>{const[n,o]=r;let i,c;return Array.isArray(o)?(c="",o.forEach(l=>{i=t?encodeURIComponent(l):l,c+=`${n}=${i}&`}),c.slice(0,-1)):(i=t?encodeURIComponent(o):o,c=`${n}=${i}`),`${s}&${c}`},"").substr(1):null,ct=(e,t={})=>{const a=Object.assign({method:e.method||"GET",headers:e.headers},t),r=it(e.headers)["content-type"]||"";if(typeof e.data=="string")a.body=e.data;else if(r.includes("application/x-www-form-urlencoded")){const n=new URLSearchParams;for(const[o,i]of Object.entries(e.data||{}))n.set(o,i);a.body=n.toString()}else if(r.includes("multipart/form-data")||e.data instanceof FormData){const n=new FormData;if(e.data instanceof FormData)e.data.forEach((i,c)=>{n.append(c,i)});else for(const i of Object.keys(e.data))n.append(i,e.data[i]);a.body=n;const o=new Headers(a.headers);o.delete("content-type"),a.headers=o}else(r.includes("application/json")||typeof e.data=="object")&&(a.body=JSON.stringify(e.data));return a};class lt extends Ae{async request(t){const a=ct(t,t.webFetchExtra),s=ot(t.params,t.shouldEncodeUrlParams),r=s?`${t.url}?${s}`:t.url,n=await fetch(r,a),o=n.headers.get("content-type")||"";let{responseType:i="text"}=n.ok?t:{};o.includes("application/json")&&(i="json");let c,l;switch(i){case"arraybuffer":case"blob":l=await n.blob(),c=await nt(l);break;case"json":c=await n.json();break;default:c=await n.text()}const g={};return n.headers.forEach((m,v)=>{g[v]=m}),{data:c,headers:g,status:n.status,url:n.url}}async get(t){return this.request(Object.assign(Object.assign({},t),{method:"GET"}))}async post(t){return this.request(Object.assign(Object.assign({},t),{method:"POST"}))}async put(t){return this.request(Object.assign(Object.assign({},t),{method:"PUT"}))}async patch(t){return this.request(Object.assign(Object.assign({},t),{method:"PATCH"}))}async delete(t){return this.request(Object.assign(Object.assign({},t),{method:"DELETE"}))}}Z("CapacitorHttp",{web:()=>new lt});var Pe;(function(e){e.Dark="DARK",e.Light="LIGHT",e.Default="DEFAULT"})(Pe||(Pe={}));var Ie;(function(e){e.StatusBar="StatusBar",e.NavigationBar="NavigationBar"})(Ie||(Ie={}));class dt extends Ae{async setStyle(){this.unavailable("not available for web")}async setAnimation(){this.unavailable("not available for web")}async show(){this.unavailable("not available for web")}async hide(){this.unavailable("not available for web")}}Z("SystemBars",{web:()=>new dt});const ut="modulepreload",mt=function(e){return"/"+e},qe={},Le=function(t,a,s){let r=Promise.resolve();if(a&&a.length>0){let c=function(l){return Promise.all(l.map(g=>Promise.resolve(g).then(m=>({status:"fulfilled",value:m}),m=>({status:"rejected",reason:m}))))};document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),i=o?.nonce||o?.getAttribute("nonce");r=c(a.map(l=>{if(l=mt(l),l in qe)return;qe[l]=!0;const g=l.endsWith(".css"),m=g?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${m}`))return;const v=document.createElement("link");if(v.rel=g?"stylesheet":ut,g||(v.as="script"),v.crossOrigin="",v.href=l,i&&v.setAttribute("nonce",i),document.head.appendChild(v),g)return new Promise((y,b)=>{v.addEventListener("load",y),v.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${l}`)))})}))}function n(o){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=o,window.dispatchEvent(i),!i.defaultPrevented)throw o}return r.then(o=>{for(const i of o||[])i.status==="rejected"&&n(i.reason);return t().catch(n)})};function vt(e){e.CapacitorUtils.Synapse=new Proxy({},{get(t,a){return new Proxy({},{get(s,r){return(n,o,i)=>{const c=e.Capacitor.Plugins[a];if(c===void 0){i(new Error(`Capacitor plugin ${a} not found`));return}if(typeof c[r]!="function"){i(new Error(`Method ${r} not found in Capacitor plugin ${a}`));return}(async()=>{try{const l=await c[r](n);o(l)}catch(l){i(l)}})()}}})}})}function ft(e){e.CapacitorUtils.Synapse=new Proxy({},{get(t,a){return e.cordova.plugins[a]}})}function ht(e=!1){typeof window>"u"||(window.CapacitorUtils=window.CapacitorUtils||{},window.Capacitor!==void 0&&!e?vt(window):window.cordova!==void 0&&ft(window))}var le;(function(e){e.Documents="DOCUMENTS",e.Data="DATA",e.Library="LIBRARY",e.Cache="CACHE",e.External="EXTERNAL",e.ExternalStorage="EXTERNAL_STORAGE",e.ExternalCache="EXTERNAL_CACHE",e.LibraryNoCloud="LIBRARY_NO_CLOUD",e.Temporary="TEMPORARY"})(le||(le={}));var Se;(function(e){e.UTF8="utf8",e.ASCII="ascii",e.UTF16="utf16"})(Se||(Se={}));const Fe=Z("Filesystem",{web:()=>Le(()=>import("./web-CHkpMdED.js"),[]).then(e=>new e.FilesystemWeb)});ht();const pt=Z("Share",{web:()=>Le(()=>import("./web-C4K0qEaV.js"),[]).then(e=>new e.ShareWeb)});class gt{constructor(t){this.sqlite=t,this._connectionDict=new Map}async initWebStore(){try{return await this.sqlite.initWebStore(),Promise.resolve()}catch(t){return Promise.reject(t)}}async saveToStore(t){try{return await this.sqlite.saveToStore({database:t}),Promise.resolve()}catch(a){return Promise.reject(a)}}async saveToLocalDisk(t){try{return await this.sqlite.saveToLocalDisk({database:t}),Promise.resolve()}catch(a){return Promise.reject(a)}}async getFromLocalDiskToStore(t){const a=t??!0;try{return await this.sqlite.getFromLocalDiskToStore({overwrite:a}),Promise.resolve()}catch(s){return Promise.reject(s)}}async echo(t){try{const a=await this.sqlite.echo({value:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async isSecretStored(){try{const t=await this.sqlite.isSecretStored();return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async setEncryptionSecret(t){try{return await this.sqlite.setEncryptionSecret({passphrase:t}),Promise.resolve()}catch(a){return Promise.reject(a)}}async changeEncryptionSecret(t,a){try{return await this.sqlite.changeEncryptionSecret({passphrase:t,oldpassphrase:a}),Promise.resolve()}catch(s){return Promise.reject(s)}}async clearEncryptionSecret(){try{return await this.sqlite.clearEncryptionSecret(),Promise.resolve()}catch(t){return Promise.reject(t)}}async checkEncryptionSecret(t){try{const a=await this.sqlite.checkEncryptionSecret({passphrase:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async addUpgradeStatement(t,a){try{return t.endsWith(".db")&&(t=t.slice(0,-3)),await this.sqlite.addUpgradeStatement({database:t,upgrade:a}),Promise.resolve()}catch(s){return Promise.reject(s)}}async createConnection(t,a,s,r,n){try{t.endsWith(".db")&&(t=t.slice(0,-3)),await this.sqlite.createConnection({database:t,encrypted:a,mode:s,version:r,readonly:n});const o=new Ue(t,n,this.sqlite),i=n?`RO_${t}`:`RW_${t}`;return this._connectionDict.set(i,o),Promise.resolve(o)}catch(o){return Promise.reject(o)}}async closeConnection(t,a){try{t.endsWith(".db")&&(t=t.slice(0,-3)),await this.sqlite.closeConnection({database:t,readonly:a});const s=a?`RO_${t}`:`RW_${t}`;return this._connectionDict.delete(s),Promise.resolve()}catch(s){return Promise.reject(s)}}async isConnection(t,a){const s={};t.endsWith(".db")&&(t=t.slice(0,-3));const r=a?`RO_${t}`:`RW_${t}`;return s.result=this._connectionDict.has(r),Promise.resolve(s)}async retrieveConnection(t,a){t.endsWith(".db")&&(t=t.slice(0,-3));const s=a?`RO_${t}`:`RW_${t}`;if(this._connectionDict.has(s)){const r=this._connectionDict.get(s);return typeof r<"u"?Promise.resolve(r):Promise.reject(`Connection ${t} is undefined`)}else return Promise.reject(`Connection ${t} does not exist`)}async getNCDatabasePath(t,a){try{const s=await this.sqlite.getNCDatabasePath({path:t,database:a});return Promise.resolve(s)}catch(s){return Promise.reject(s)}}async createNCConnection(t,a){try{await this.sqlite.createNCConnection({databasePath:t,version:a});const s=new Ue(t,!0,this.sqlite),r=`RO_${t})`;return this._connectionDict.set(r,s),Promise.resolve(s)}catch(s){return Promise.reject(s)}}async closeNCConnection(t){try{await this.sqlite.closeNCConnection({databasePath:t});const a=`RO_${t})`;return this._connectionDict.delete(a),Promise.resolve()}catch(a){return Promise.reject(a)}}async isNCConnection(t){const a={},s=`RO_${t})`;return a.result=this._connectionDict.has(s),Promise.resolve(a)}async retrieveNCConnection(t){if(this._connectionDict.has(t)){const a=`RO_${t})`,s=this._connectionDict.get(a);return typeof s<"u"?Promise.resolve(s):Promise.reject(`Connection ${t} is undefined`)}else return Promise.reject(`Connection ${t} does not exist`)}async isNCDatabase(t){try{const a=await this.sqlite.isNCDatabase({databasePath:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async retrieveAllConnections(){return this._connectionDict}async closeAllConnections(){const t=new Map;try{for(const a of this._connectionDict.keys()){const s=a.substring(3),r=a.substring(0,3)==="RO_";await this.sqlite.closeConnection({database:s,readonly:r}),t.set(a,null)}for(const a of t.keys())this._connectionDict.delete(a);return Promise.resolve()}catch(a){return Promise.reject(a)}}async checkConnectionsConsistency(){try{const t=[...this._connectionDict.keys()],a=[],s=[];for(const n of t)a.push(n.substring(0,2)),s.push(n.substring(3));const r=await this.sqlite.checkConnectionsConsistency({dbNames:s,openModes:a});return r.result||(this._connectionDict=new Map),Promise.resolve(r)}catch(t){return this._connectionDict=new Map,Promise.reject(t)}}async importFromJson(t){try{const a=await this.sqlite.importFromJson({jsonstring:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async isJsonValid(t){try{const a=await this.sqlite.isJsonValid({jsonstring:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async copyFromAssets(t){const a=t??!0;try{return await this.sqlite.copyFromAssets({overwrite:a}),Promise.resolve()}catch(s){return Promise.reject(s)}}async getFromHTTPRequest(t,a){const s=a??!0;try{return await this.sqlite.getFromHTTPRequest({url:t,overwrite:s}),Promise.resolve()}catch(r){return Promise.reject(r)}}async isDatabaseEncrypted(t){t.endsWith(".db")&&(t=t.slice(0,-3));try{const a=await this.sqlite.isDatabaseEncrypted({database:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async isInConfigEncryption(){try{const t=await this.sqlite.isInConfigEncryption();return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isInConfigBiometricAuth(){try{const t=await this.sqlite.isInConfigBiometricAuth();return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isDatabase(t){t.endsWith(".db")&&(t=t.slice(0,-3));try{const a=await this.sqlite.isDatabase({database:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async getDatabaseList(){try{const a=(await this.sqlite.getDatabaseList()).values;a.sort();const s={values:a};return Promise.resolve(s)}catch(t){return Promise.reject(t)}}async getMigratableDbList(t){const a=t||"default";try{const s=await this.sqlite.getMigratableDbList({folderPath:a});return Promise.resolve(s)}catch(s){return Promise.reject(s)}}async addSQLiteSuffix(t,a){const s=t||"default",r=a||[];try{const n=await this.sqlite.addSQLiteSuffix({folderPath:s,dbNameList:r});return Promise.resolve(n)}catch(n){return Promise.reject(n)}}async deleteOldDatabases(t,a){const s=t||"default",r=a||[];try{const n=await this.sqlite.deleteOldDatabases({folderPath:s,dbNameList:r});return Promise.resolve(n)}catch(n){return Promise.reject(n)}}async moveDatabasesAndAddSuffix(t,a){const s=t||"default",r=a||[];return this.sqlite.moveDatabasesAndAddSuffix({folderPath:s,dbNameList:r})}}class Ue{constructor(t,a,s){this.dbName=t,this.readonly=a,this.sqlite=s}getConnectionDBName(){return this.dbName}getConnectionReadOnly(){return this.readonly}async open(){try{return await this.sqlite.open({database:this.dbName,readonly:this.readonly}),Promise.resolve()}catch(t){return Promise.reject(t)}}async close(){try{return await this.sqlite.close({database:this.dbName,readonly:this.readonly}),Promise.resolve()}catch(t){return Promise.reject(t)}}async beginTransaction(){try{const t=await this.sqlite.beginTransaction({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async commitTransaction(){try{const t=await this.sqlite.commitTransaction({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async rollbackTransaction(){try{const t=await this.sqlite.rollbackTransaction({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isTransactionActive(){try{const t=await this.sqlite.isTransactionActive({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async loadExtension(t){try{return await this.sqlite.loadExtension({database:this.dbName,path:t,readonly:this.readonly}),Promise.resolve()}catch(a){return Promise.reject(a)}}async enableLoadExtension(t){try{return await this.sqlite.enableLoadExtension({database:this.dbName,toggle:t,readonly:this.readonly}),Promise.resolve()}catch(a){return Promise.reject(a)}}async getUrl(){try{const t=await this.sqlite.getUrl({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async getVersion(){try{const t=await this.sqlite.getVersion({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async getTableList(){try{const t=await this.sqlite.getTableList({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async execute(t,a=!0,s=!0){try{if(this.readonly)return Promise.reject("not allowed in read-only mode");{const r=await this.sqlite.execute({database:this.dbName,statements:t,transaction:a,readonly:!1,isSQL92:s});return Promise.resolve(r)}}catch(r){return Promise.reject(r)}}async query(t,a,s=!0){let r;try{return a&&a.length>0?r=await this.sqlite.query({database:this.dbName,statement:t,values:a,readonly:this.readonly,isSQL92:!0}):r=await this.sqlite.query({database:this.dbName,statement:t,values:[],readonly:this.readonly,isSQL92:s}),r=await this.reorderRows(r),Promise.resolve(r)}catch(n){return Promise.reject(n)}}async run(t,a,s=!0,r="no",n=!0){let o;try{return this.readonly?Promise.reject("not allowed in read-only mode"):(a&&a.length>0?o=await this.sqlite.run({database:this.dbName,statement:t,values:a,transaction:s,readonly:!1,returnMode:r,isSQL92:!0}):o=await this.sqlite.run({database:this.dbName,statement:t,values:[],transaction:s,readonly:!1,returnMode:r,isSQL92:n}),o.changes=await this.reorderRows(o.changes),Promise.resolve(o))}catch(i){return Promise.reject(i)}}async executeSet(t,a=!0,s="no",r=!0){let n;try{return this.readonly?Promise.reject("not allowed in read-only mode"):(n=await this.sqlite.executeSet({database:this.dbName,set:t,transaction:a,readonly:!1,returnMode:s,isSQL92:r}),n.changes=await this.reorderRows(n.changes),Promise.resolve(n))}catch(o){return Promise.reject(o)}}async isExists(){try{const t=await this.sqlite.isDBExists({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isTable(t){try{const a=await this.sqlite.isTableExists({database:this.dbName,table:t,readonly:this.readonly});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async isDBOpen(){try{const t=await this.sqlite.isDBOpen({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async delete(){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.deleteDatabase({database:this.dbName,readonly:!1}),Promise.resolve())}catch(t){return Promise.reject(t)}}async createSyncTable(){try{if(this.readonly)return Promise.reject("not allowed in read-only mode");{const t=await this.sqlite.createSyncTable({database:this.dbName,readonly:!1});return Promise.resolve(t)}}catch(t){return Promise.reject(t)}}async setSyncDate(t){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.setSyncDate({database:this.dbName,syncdate:t,readonly:!1}),Promise.resolve())}catch(a){return Promise.reject(a)}}async getSyncDate(){try{const t=await this.sqlite.getSyncDate({database:this.dbName,readonly:this.readonly});let a="";return t.syncDate>0&&(a=new Date(t.syncDate*1e3).toISOString()),Promise.resolve(a)}catch(t){return Promise.reject(t)}}async exportToJson(t,a=!1){try{const s=await this.sqlite.exportToJson({database:this.dbName,jsonexportmode:t,readonly:this.readonly,encrypted:a});return Promise.resolve(s)}catch(s){return Promise.reject(s)}}async deleteExportedRows(){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.deleteExportedRows({database:this.dbName,readonly:!1}),Promise.resolve())}catch(t){return Promise.reject(t)}}async executeTransaction(t,a=!0){let s=0,r=!1;if(this.readonly)return Promise.reject("not allowed in read-only mode");if(await this.sqlite.beginTransaction({database:this.dbName}),r=await this.sqlite.isTransactionActive({database:this.dbName}),!r)return Promise.reject("After Begin Transaction, no transaction active");try{for(const i of t){if(typeof i!="object"||!("statement"in i))throw new Error("Error a task.statement must be provided");if("values"in i&&i.values&&i.values.length>0){const c=i.statement.toUpperCase().includes("RETURNING")?"all":"no",l=await this.sqlite.run({database:this.dbName,statement:i.statement,values:i.values,transaction:!1,readonly:!1,returnMode:c,isSQL92:a});if(l.changes.changes<0)throw new Error("Error in transaction method run ");s+=l.changes.changes}else{const c=await this.sqlite.execute({database:this.dbName,statements:i.statement,transaction:!1,readonly:!1});if(c.changes.changes<0)throw new Error("Error in transaction method execute ");s+=c.changes.changes}}const n=await this.sqlite.commitTransaction({database:this.dbName});s+=n.changes.changes;const o={changes:{changes:s}};return Promise.resolve(o)}catch(n){const o=n.message?n.message:n;return await this.sqlite.rollbackTransaction({database:this.dbName}),Promise.reject(o)}}async reorderRows(t){const a=t;if(t?.values&&typeof t.values[0]=="object"&&Object.keys(t.values[0]).includes("ios_columns")){const s=t.values[0].ios_columns,r=[];for(let n=1;n<t.values.length;n++){const o=t.values[n],i={};for(const c of s)i[c]=o[c];r.push(i)}a.values=r}return Promise.resolve(a)}}const yt=Z("CapacitorSQLite",{web:()=>Le(()=>import("./web-Bzyjdkqs.js"),[]).then(e=>new e.CapacitorSQLiteWeb),electron:()=>window.CapacitorCustomPlatform.plugins.CapacitorSQLite});function bt(e){return e.replace(/^(add[- ]?on|additional)\s+/i,"").trim()}const Et="laba101_offline",de="fresh_start_reset_v1",wt=new gt(yt);let ne=null;const K=[{id:1,name:"Laba101 Admin",email:"admin@laba101.test",password:"password",role:"admin",branch:"Main Store"}],ue=[],X=[U(1,"Drop-off","Wash, dry and fold.","Drop-Off","order",185,8,40,["Wash","Dry","Fold"],0,24),U(2,"Full Service","Wash, dry, fold, detergent and Fabcon.","Full Service","order",200,8,40,["Wash","Dry","Fold","Detergent","Fabcon"],0,24),U(3,"Self Service Wash","Max of 8kg per load.","Self Service","order",60,8,null,["Wash"],0,1),U(4,"Self Service Dry","Regular time: 40 mins drying time.","Self Service","order",70,8,40,["Dry"],0,1),U(5,"Dry Only","Standard drying rate.","Dry Only","order",70,8,40,["Dry"],0,1),U(6,"Additional Dry 10 mins","Additional drying time.","Dry Only","order",30,8,10,["Dry"],0,1),U(7,"Additional Dry 20 mins","Additional drying time.","Dry Only","order",50,8,20,["Dry"],0,1),U(8,"Additional Dry 40 mins","Additional drying time.","Dry Only","order",70,8,40,["Dry"],0,1),U(9,"Additional Zonrox","Extra Zonrox bleach add-on per load.","Add-on","addon",25,0,null,["Zonrox"],0,0),U(10,"Additional Fabcon","Extra Fabcon fabric conditioner add-on per load.","Add-on","addon",25,0,null,["Fabcon"],0,0),U(11,"Comforter / Bulky Load","Comforter 4kg max per load. Thin blankets, bedsheets, bath towels, pillow cases and curtains: 6kg max per load.","Comforter","order",200,8,40,["Wash","Dry","Fold"],0,24)],H=[{id:1,name:"Regular Clothes",maxKg:8,additionalFee:0,isActive:1},{id:2,name:"Comforter",maxKg:4,additionalFee:0,isActive:1},{id:3,name:"Thin Blankets",maxKg:6,additionalFee:0,isActive:1},{id:4,name:"Bedsheets",maxKg:6,additionalFee:0,isActive:1},{id:5,name:"Bath Towels",maxKg:6,additionalFee:0,isActive:1},{id:6,name:"Curtains",maxKg:6,additionalFee:0,isActive:1}];function ke(e,t){const a=T(e,[]),s=new Map(a.map(n=>[n.id,n])),r=t.map(n=>{const o=s.get(n.id);return o?{...n,...o,isActive:o.isActive??n.isActive}:n});(a.length!==r.length||r.some((n,o)=>n.id!==a[o]?.id||JSON.stringify(n)!==JSON.stringify(a[o])))&&E(e,r)}async function St(){ke("services",X),ke("item_categories",H)}async function he(e){for(const t of X)((await e.query("SELECT id FROM laundry_services WHERE id = ?",[t.id])).values??[]).length>0?await e.run("UPDATE laundry_services SET name = ?, description = ?, category = ?, serviceType = ?, price = ?, maxKg = ?, dryingMinutes = ?, includes = ?, additionalCharge = ?, turnaroundHours = ?, isActive = COALESCE(isActive, ?) WHERE id = ?",[t.name,t.description,t.category,t.serviceType,t.price,t.maxKg,t.dryingMinutes,JSON.stringify(t.includes),t.additionalCharge,t.turnaroundHours,t.isActive,t.id]):await e.run("INSERT INTO laundry_services (id, name, description, category, serviceType, price, maxKg, dryingMinutes, includes, additionalCharge, turnaroundHours, isActive) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",[t.id,t.name,t.description,t.category,t.serviceType,t.price,t.maxKg,t.dryingMinutes,JSON.stringify(t.includes),t.additionalCharge,t.turnaroundHours,t.isActive]);for(const t of H)((await e.query("SELECT id FROM item_categories WHERE id = ?",[t.id])).values??[]).length>0?await e.run("UPDATE item_categories SET name = ?, maxKg = ?, additionalFee = ?, isActive = COALESCE(isActive, ?) WHERE id = ?",[t.name,t.maxKg,t.additionalFee,t.isActive,t.id]):await e.run("INSERT INTO item_categories (id, name, maxKg, additionalFee, isActive) VALUES (?, ?, ?, ?, ?)",[t.id,t.name,t.maxKg,t.additionalFee,t.isActive])}const Q=[],me=[],ve=[],fe=[],B=[...[1,2,3,4].map(e=>({id:e,machineName:`Washer ${e}`,machineType:"washer",status:"available",branch:"Main Store"})),...[1,2,3,4].map(e=>({id:e+4,machineName:`Dryer ${e}`,machineType:"dryer",status:"available",branch:"Main Store"}))],z=[{key:"branch",value:"Main Store"},{key:"fold_rate",value:"5"},{key:"report_email",value:"admin@laba101.test"}];function U(e,t,a,s,r,n,o,i,c,l,g){return{id:e,name:t,description:a,category:s,serviceType:r,price:n,maxKg:o,dryingMinutes:i,includes:c,additionalCharge:l,turnaroundHours:g,isActive:1}}function I(e){return`laba101-mobile-${e}`}function T(e,t){const a=localStorage.getItem(I(e));if(!a)return structuredClone(t);try{return JSON.parse(a)}catch{return structuredClone(t)}}function E(e,t){localStorage.setItem(I(e),JSON.stringify(t))}function k(e){return e.reduce((t,a)=>Math.max(t,a.id),0)+1}function G(){return new Date().toISOString()}function Te(e=new Date){const t=e.getFullYear(),a=String(e.getMonth()+1).padStart(2,"0"),s=String(e.getDate()).padStart(2,"0");return`${t}-${a}-${s}`}function Tt(){return Te().slice(2).replaceAll("-","")}function Y(e,t){if(!e)return t;try{return JSON.parse(e)}catch{return t}}async function A(){return ne||(ne=await wt.createConnection(Et,!1,"no-encryption",1,!1),await ne.open()),ne}async function x(e,t,a,s){((await e.query(`PRAGMA table_info(${t})`)).values??[]).some(o=>o.name===a)||await e.execute(`ALTER TABLE ${t} ADD COLUMN ${a} ${s}`)}async function Nt(){localStorage.getItem(I(de))||(E("staff",K),E("customers",[]),E("orders",[]),E("payments",[]),E("fold_logs",[]),E("expenses",[]),E("sales",[]),localStorage.getItem(I("services"))||E("services",X),localStorage.getItem(I("item_categories"))||E("item_categories",H),localStorage.getItem(I("machines"))||E("machines",B),localStorage.getItem(I("subcleanings"))||E("subcleanings",[]),localStorage.getItem(I("settings"))||E("settings",z),localStorage.removeItem("laba101-mobile-session"),E(de,!0))}async function At(e){const t=K[0];if(((await e.query("SELECT id FROM staff WHERE id = ?",[t.id])).values??[]).length>0){await e.run('UPDATE staff SET name = ?, email = ?, password = COALESCE(NULLIF(password, ""), ?), role = ?, branch = ?, isActive = 1 WHERE id = ?',[t.name,t.email,t.password,t.role,t.branch,t.id]);return}await e.run("INSERT INTO staff (id, name, email, password, role, branch, isActive) VALUES (?, ?, ?, ?, ?, ?, ?)",[t.id,t.name,t.email,t.password,t.role,t.branch,1])}async function Lt(e){if(!(((await e.query("SELECT COUNT(*) as count FROM machines")).values?.[0]?.count??0)>0))for(const a of B)await e.run("INSERT INTO machines (id, machineName, machineType, status, branch) VALUES (?, ?, ?, ?, ?)",[a.id,a.machineName,a.machineType,a.status,a.branch])}async function Ct(e){for(const t of z)await e.run("INSERT OR IGNORE INTO settings (key, value) VALUES (?, ?)",[t.key,t.value])}async function $t(e){((await e.query("SELECT value FROM settings WHERE key = ?",[de])).values??[]).length>0||(await e.execute(`
  ...
  `),await At(e),await Lt(e),await Ct(e),await e.run("INSERT OR REPLACE INTO settings (key, value) VALUES (?, ?)",[de,G()]),localStorage.removeItem("laba101-mobile-session"))}async function Rt(){if(!w.isNativePlatform()){await Nt(),!localStorage.getItem(I("seeded_v4"))&&!localStorage.getItem(I("services"))&&!localStorage.getItem(I("staff"))&&(E("staff",K),E("customers",ue),E("services",X),E("item_categories",H),E("orders",Q),E("payments",me),E("fold_logs",[]),E("expenses",ve),E("sales",fe),E("machines",B),E("subcleanings",[]),E("settings",z),E("seeded_v4",!0)),await St(),localStorage.getItem(I("seeded_v4"))||E("seeded_v4",!0);return}const e=await A();if(await e.execute(`
...
`)||null,foldedBy:null,foldedByName:null,dueAt:new Date(Date.now()+s.turnaroundHours*60*60*1e3).toISOString(),createdAt:G()};if(!w.isNativePlatform()){const b=T("orders",Q),p={...g,id:k(b)};return b.unshift(p),E("orders",b),c>0&&await Ve(p.id,{amount:c,method:e.paymentMethod,reference:e.paymentReference??null}),p}const m=await A(),v=await m.query("SELECT COALESCE(MAX(id), 0) + 1 as id FROM orders"),y={...g,id:Number((v.values?.[0]).id)};return await We(m,y),c>0&&await m.run("INSERT INTO payments (orderId, amount, method, reference, receivedAt, branch) VALUES (?, ?, ?, ?, ?, ?)",[y.id,c,e.paymentMethod,e.paymentReference??null,G(),e.branch]),y}async function Bt(){const e=`LB${Tt()}`,t=await pe(),s=(await ge(t)).filter(n=>n.ticket.startsWith(e)).sort((n,o)=>o.ticket.localeCompare(n.ticket))[0],r=s?Number(s.ticket.slice(-3))+1:1;return`${e}-${String(r).padStart(3,"0")}`}async function _t(e,t){const a=await pe(),[s,r]=await Promise.all([ge(a),$e()]),n=s.find(l=>l.id===e);if(!n)return;const i=Ye(n,r).map(l=>l.key).find(l=>!n.workflowCompleted.includes(l));if(!i)return;if(n.workflowCompleted=[...n.workflowCompleted,i],n.status=Mt(n.workflowCompleted),i==="fold"&&t&&(n.foldedBy=t),!w.isNativePlatform()){const l=T("orders",Q),g=l.find(m=>m.id===n.id);g&&Object.assign(g,n),E("orders",l);return}await(await A()).run("UPDATE orders SET workflowCompleted = ?, status = ?, foldedBy = ? WHERE id = ?",[JSON.stringify(n.workflowCompleted),n.status,n.foldedBy,n.id])}async function Ve(e,t){const a=await pe();if(!(await ge(a)).find(i=>i.id===e))return;const n=Math.max(0,t.amount);if(n<=0)return;if(!w.isNativePlatform()){const i=T("payments",me);i.unshift({id:k(i),orderId:e,amount:n,method:t.method,reference:t.reference??null,receivedAt:G(),branch:a}),E("payments",i);const c=T("orders",Q),l=c.find(g=>g.id===e);l&&(l.paidAmount=Math.min(l.totalAmount,Number((l.paidAmount+n).toFixed(2)))),E("orders",c);return}const o=await A();await o.run("INSERT INTO payments (orderId, amount, method, reference, receivedAt, branch) VALUES (?, ?, ?, ?, ?, ?)",[e,n,t.method,t.reference??null,G(),a]),await o.run("UPDATE orders SET paidAmount = MIN(totalAmount, paidAmount + ?) WHERE id = ?",[n,e])}async function Wt(e){return w.isNativePlatform()?(await(await A()).query("SELECT id, orderId, amount, method, reference, receivedAt, branch FROM payments  ORDER BY receivedAt DESC",[])).values??[]:T("payments",me).filter(s=>!0)}async function Kt(){return w.isNativePlatform()?(await(await A()).query("SELECT id, orderTicket, staffName, foldCount, rate, total, createdAt FROM fold_logs ORDER BY id DESC")).values??[]:T("fold_logs",[])}async function Xt(e){const t=Number((e.foldCount*e.rate).toFixed(2));if(!w.isNativePlatform()){const s=T("fold_logs",[]);s.unshift({id:Date.now(),...e,total:t,createdAt:G()}),E("fold_logs",s);return}await(await A()).run("INSERT INTO fold_logs (orderTicket, staffName, foldCount, rate, total, createdAt) VALUES (?, ?, ?, ?, ?, ?)",[e.orderTicket,e.staffName,e.foldCount,e.rate,t,G()])}async function Ht(){return w.isNativePlatform()?(await(await A()).query("SELECT id, expenseDate, number, name, category, description, amount FROM disbursement_expenses ORDER BY expenseDate DESC, id DESC")).values??[]:T("expenses",ve)}async function Gt(e){if(!w.isNativePlatform()){const r=T("expenses",ve),n=k(r);r.unshift({id:n,expenseDate:e.expenseDate,number:`DISB-${String(n).padStart(2,"0")}`,name:e.name,category:e.category,description:e.description||null,amount:e.amount}),E("expenses",r);return}const t=await A(),a=await t.query("SELECT COALESCE(MAX(id), 0) + 1 as id FROM disbursement_expenses"),s=Number((a.values?.[0]).id);await t.run("INSERT INTO disbursement_expenses (expenseDate, number, name, category, description, amount) VALUES (?, ?, ?, ?, ?, ?)",[e.expenseDate,`DISB-${String(s).padStart(2,"0")}`,e.name,e.category,e.description||null,e.amount])}async function Yt(){return w.isNativePlatform()?(await(await A()).query('SELECT id, saleDate, COALESCE(saleNumber, "") as saleNumber, cashAmount, gcashAmount, totalAmount, notes FROM daily_sales ORDER BY saleDate DESC, id DESC')).values??[]:T("sales",fe)}async function Vt(e){const t=Number((e.cashAmount+e.gcashAmount).toFixed(2));if(!w.isNativePlatform()){const n=T("sales",fe),o=n.find(i=>i.saleDate===e.saleDate);if(o)Object.assign(o,{cashAmount:e.cashAmount,gcashAmount:e.gcashAmount,totalAmount:t,notes:e.notes||null});else{const i=k(n);n.unshift({id:i,saleDate:e.saleDate,saleNumber:`SALE-${String(i).padStart(2,"0")}`,cashAmount:e.cashAmount,gcashAmount:e.gcashAmount,totalAmount:t,notes:e.notes||null})}E("sales",n);return}const a=await A(),r=(await a.query("SELECT id, saleNumber FROM daily_sales WHERE saleDate = ?",[e.saleDate])).values?.[0];if(r)await a.run("UPDATE daily_sales SET cashAmount = ?, gcashAmount = ?, totalAmount = ?, notes = ? WHERE id = ?",[e.cashAmount,e.gcashAmount,t,e.notes||null,r.id]);else{const n=await a.query("SELECT COALESCE(MAX(id), 0) + 1 as id FROM daily_sales"),o=Number((n.values?.[0]).id);await a.run("INSERT INTO daily_sales (saleDate, saleNumber, cashAmount, gcashAmount, totalAmount, notes) VALUES (?, ?, ?, ?, ?, ?)",[e.saleDate,`SALE-${String(o).padStart(2,"0")}`,e.cashAmount,e.gcashAmount,t,e.notes||null])}}async function Je(e){return w.isNativePlatform()?(await(await A()).query("SELECT id, machineName, machineType, status, branch FROM machines WHERE branch = ? ORDER BY machineType, machineName",[e])).values??[]:T("machines",B).filter(s=>s.branch===e)}async function Jt(e){if(!w.isNativePlatform()){const a=T("machines",B);a.unshift({id:k(a),...e}),E("machines",a);return}await(await A()).run("INSERT INTO machines (machineName, machineType, status, branch) VALUES (?, ?, ?, ?)",[e.machineName,e.machineType,e.status,e.branch])}async function Qt(e,t){if(!w.isNativePlatform()){const s=T("machines",B),r=s.find(n=>n.id===e);r&&(r.status=t,E("machines",s));return}await(await A()).run("UPDATE machines SET status = ? WHERE id = ?",[t,e])}async function zt(e){return w.isNativePlatform()?((await(await A()).query("SELECT id, date, machineIds, machineNames, cleaningStatus, notes, branch FROM subcleanings WHERE branch = ? ORDER BY date DESC, id DESC",[e])).values??[]).map(s=>({...s,machineIds:Y(s.machineIds,[])})):T("subcleanings",[]).filter(s=>s.branch===e)}async function Zt(e){const a=(await Je(e.branch)).filter(n=>e.machineIds.includes(n.id)).map(n=>n.machineName).join(", ");if(!w.isNativePlatform()){const n=T("subcleanings",[]);n.unshift({id:k(n),date:e.date,machineIds:e.machineIds,machineNames:a,cleaningStatus:e.cleaningStatus,notes:e.notes||null,branch:e.branch}),E("subcleanings",n);const o=T("machines",B);o.forEach(i=>{e.machineIds.includes(i.id)&&(i.status=e.cleaningStatus==="completed"?"available":"under_cleaning")}),E("machines",o);return}const s=await A();await s.run("INSERT INTO subcleanings (date, machineIds, machineNames, cleaningStatus, notes, branch) VALUES (?, ?, ?, ?, ?, ?)",[e.date,JSON.stringify(e.machineIds),a,e.cleaningStatus,e.notes||null,e.branch]);const r=e.cleaningStatus==="completed"?"available":"under_cleaning";for(const n of e.machineIds)await s.run("UPDATE machines SET status = ? WHERE id = ?",[r,n])}async function ea(e,t){if(!w.isNativePlatform()){const o=T("machines",B),i=o.find(g=>g.id===e);i&&(i.status="available"),E("machines",o);const c=T("subcleanings",[]),l=Te();c.unshift({id:k(c),date:l,machineIds:[e],machineNames:i?.machineName??"",cleaningStatus:"completed",notes:null,branch:t}),E("subcleanings",c);return}const a=await A(),r=(await a.query("SELECT machineName FROM machines WHERE id = ?",[e])).values?.[0]?.machineName??"";await a.run("UPDATE machines SET status = ? WHERE id = ?",["available",e]);const n=Te();await a.run("INSERT INTO subcleanings (date, machineIds, machineNames, cleaningStatus, notes, branch) VALUES (?, ?, ?, ?, ?, ?)",[n,JSON.stringify([e]),r,"completed",null,t])}const Re=document.querySelector("#app");if(!Re)throw new Error("App root not found");let ie;const Oe={dashboard:"Dashboard",orders:"POS / Orders",archived:"Archived Order",customers:"Customers",pricing:"Pricing Services",disbursements:"Daily Report",reports:"Reports",inventory:"Inventory",maintenance:"Maintenance",staff:"Staff",settings:"Settings"},f={tab:"dashboard",receiptOrderId:0,currentUser:null,loginError:"",sidebarOpen:!1,dailyReportTab:"expenses",maintenanceTab:"cleaning",customerSearch:"",orderSearch:"",orderDateFilter:"",archivedOrderSearch:"",reportPreview:null},ta=["Wash","Dry","Fold","Detergent","Fabcon","Zonrox"],ee="laba101-mobile-session";function $(e){return new Intl.NumberFormat("en-PH",{style:"currency",currency:"PHP"}).format(e||0)}function u(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function ye(e){return e.replace(/^(add[- ]?on|additional)\s+/i,"").trim()}function aa(e){const t=new Map;return e.filter(a=>a.workflowCompleted.includes("fold")&&a.foldedByName).forEach(a=>{const s=a.foldedByName,r=t.get(s)??{staffName:s,folds:0};r.folds+=1,t.set(s,r)}),Array.from(t.values())}function te(e=new Date){const t=e.getFullYear(),a=String(e.getMonth()+1).padStart(2,"0"),s=String(e.getDate()).padStart(2,"0");return`${t}-${a}-${s}`}function j(){return te()}function ae(e){return te(new Date(e))}function sa(e){return new Intl.DateTimeFormat("en-PH",{dateStyle:"medium",timeStyle:"short"}).format(new Date(e))}function ra(e=new Date){return{date:new Intl.DateTimeFormat("en-PH",{weekday:"long",month:"long",day:"numeric",year:"numeric"}).format(e),time:new Intl.DateTimeFormat("en-PH",{hour:"numeric",minute:"2-digit",second:"2-digit",hour12:!0}).format(e)}}function oe(){const e=document.querySelector("[data-date-from]"),t=document.querySelector("[data-date-to]"),a=Array.from(document.querySelectorAll('input[name="reportType"]:checked')).map(s=>s.value).filter(s=>s==="sales"||s==="disbursement"||s==="fold_count"||s==="summary");return{from:e?.value||"0000-01-01",to:t?.value||"9999-12-31",types:a.length?a:["summary"]}}function Ee(e,t){return e>=t.from&&e<=t.to}function Qe(e,t,a,s,r){const n=new Set(r.types),o=e.filter(h=>Ee(ae(h.createdAt),r)),i=t.filter(h=>Ee(h.saleDate,r)),c=a.filter(h=>Ee(h.expenseDate,r)),l=aa(o),g=o.reduce((h,O)=>h+O.paidAmount,0),m=i.reduce((h,O)=>h+O.cashAmount,0),v=i.reduce((h,O)=>h+O.gcashAmount,0),y=0,b=g+m,p=y+v,d=b+p,C=c.reduce((h,O)=>h+O.amount,0),N=C,L=d-N,R=()=>({orderCashTotal:g,orderGcashTotal:y,manualCashTotal:m,manualGcashTotal:v,totalCash:b,totalGcash:p,totalSales:d,rows:[["Type","Date","Number","Name","Cash","GCash","Total","Balance"],...o.map(h=>["Order",ae(h.createdAt),h.ticket,h.customer,h.paidAmount,0,h.paidAmount,h.balance]),...i.map(h=>["Manual Sale",h.saleDate,h.saleNumber,h.notes??"",h.cashAmount,h.gcashAmount,h.totalAmount,""]),[],["Sales Summary",r.from,"to",r.to,"","","",""],["Order Cash","","","","","",g,""],["Order GCash","","","","","",y,""],["Manual Cash","","","","","",m,""],["Manual GCash","","","","","",v,""],["Total Cash","","","","","",b,""],["Total GCash","","","","","",p,""],["Total Sales","","","","","",d,""]]}),q=()=>({totalExpenses:C,totalDisbursement:N,rows:[["Type","Date","Number","Name","Cash","GCash","Total","Balance"],...c.map(h=>["Expense",h.expenseDate,h.number,h.name,"","",h.amount,""]),[],["Disbursement Summary",r.from,"to",r.to,"","","",""],["Expenses","","","","","",C,""],["Total Disbursement","","","","","",N,""]]});return{selection:r,selectedTypes:n,salesRows:R,disbursementRows:q,foldCountRows:()=>({rows:[["Staff","Fold Count"],...l.map(h=>[h.staffName,h.folds]),[],["Total Folds",l.reduce((h,O)=>h+O.folds,0)]]}),summaryRows:()=>{const h=R(),O=q();return[["Summary",r.from,"to",r.to,"","","",""],["Order Cash","","","","","",h.orderCashTotal,""],["Order GCash","","","","","",h.orderGcashTotal,""],["Manual Cash","","","","","",h.manualCashTotal,""],["Manual GCash","","","","","",h.manualGcashTotal,""],["Total Cash","","","","","",h.totalCash,""],["Total GCash","","","","","",h.totalGcash,""],["Total Sales","","","","","",h.totalSales,""],["Total Disbursement","","","","","",O.totalDisbursement,""],["Profit","","","","","",L,""]]},profit:L}}function na(e,t){return`<button class="nav-link ${t?"is-active":""}" data-tab="${e}" type="button">
    ...
    <div class="app-frame">
      ...
      <aside class="sidebar ${f.sidebarOpen?"is-open":""}">
        ...
        <nav>${ze().map(a=>na(a,f.tab===a)).join("")}</nav>
      ...
      <main class="workspace">
        ...
        ${f.tab==="dashboard"?da({paidToday:t,orders:e.orders}):""}
        ${f.tab==="orders"?ua(e.orders,e.customers,e.services,e.categories,e.staff,e.payments,e.branch):""}
        ${f.tab==="archived"?ma(e.orders,e.staff,e.services,e.payments):""}
        ${f.tab==="customers"?va(e.customers,e.orders):""}
        ${f.tab==="pricing"?fa(e.allServices,e.categories):""}
        ${f.tab==="disbursements"?ha(e.expenses,e.sales):""}
        ${f.tab==="reports"?pa(e.orders,e.sales,e.expenses,e.foldRate):""}
        ${f.tab==="inventory"?ga(e.services,e.categories):""}
        ${f.tab==="maintenance"?ya(e.machines,e.subcleanings,e.branch):""}
        ${f.tab==="staff"?ba(e.allStaff,e.branch):""}
        ${f.tab==="settings"?Ea(e.branch,e.foldRate,e.reportEmail):""}
      </main>
    </div>
  `,wa(),Na(e),Aa(e.allServices),La(),Ca(e.orders,e.sales,e.expenses,e.foldRate),$a(),Ra(),Oa(),Da(e.allStaff),xa(),Ta()}function ze(){return f.currentUser?.role==="admin"?Object.keys(Oe).filter(e=>e!=="inventory"):["orders","archived","disbursements","reports","maintenance"]}function ca(){Re.innerHTML=`
  ...
  `}function la(){document.querySelectorAll("[data-fill-email]").forEach(e=>{e.addEventListener("click",()=>{const t=document.querySelector('input[name="email"]'),a=document.querySelector('input[name="password"]');t&&(t.value=e.dataset.fillEmail??""),a&&(a.value=e.dataset.fillPassword??"")})})}function da(e){const t=new Date,a=Array.from({length:7},(o,i)=>{const c=new Date(t);return c.setDate(t.getDate()-(6-i)),new Intl.DateTimeFormat("en-PH",{month:"short",day:"numeric"}).format(c)}),s=Array.from({length:7},(o,i)=>{const c=new Date(t);c.setDate(t.getDate()-(6-i));const l=te(c);return e.orders.filter(g=>ae(g.createdAt)===l).reduce((g,m)=>g+m.paidAmount,0)}),r=Math.max(1,...s),n=210;return`
  ...
  `}function ua(e,t,a,s,r,n,o){const i=a.filter(d=>d.serviceType==="order"&&d.isActive),c=a.filter(d=>d.serviceType==="addon"&&d.isActive),l=f.receiptOrderId?e.find(d=>d.id===f.receiptOrderId):null,g=e.filter(d=>d.status!=="claimed"),m=f.orderSearch.trim().toLowerCase(),v=f.orderDateFilter.trim(),y=g.filter(d=>{const C=!m||[d.ticket,d.customer,d.phone,d.service,d.itemCategory,d.status].some(L=>String(L??"").toLowerCase().includes(m)),N=!v||ae(d.createdAt)===v;return C&&N}),b=new Set(e.map(d=>d.customerId)),p=t.filter(d=>b.has(d.id));return`
        ...
        <form id="order-form" class="form">
          ...
          <label>Service
            <select name="serviceId" required>
              ${i.map(d=>`<option value="${d.id}">${u(d.name)} - ${$(d.price)}</option>`).join("")}
            </select>
          </label>
          <label>Item category
          ...
          <fieldset class="check-grid">
            ...
            ${c.length?c.map(d=>`<label class="check"><input type="checkbox" name="addonIds" value="${d.id}" /> ${u(ye(d.name))} ${$(d.price)}</label>`).join(""):'<p class="helper">No extra services configured.</p>'}
          </fieldset>
      ...
      <article class="panel">
        ...
        <form class="queue-filters" id="order-queue-filters">
          <label>
            ...
            <input name="orderSearch" type="search" placeholder="Ticket, name, service, status" value="${u(f.orderSearch)}" autocomplete="off" />
          </label>
          <label>
            <span>Filter date</span>
            <input name="orderDateFilter" type="date" value="${u(f.orderDateFilter)}" />
          </label>
        ...
        <div class="table orders-table">
          ...
          ${y.map(d=>Ze(d,r,a)).join("")||'<div class="helper">No matching active orders.</div>'}
        </div>
      </article>
      ${l?et(l,n.filter(d=>d.orderId===l.id)):""}
    </section>
  `}function ma(e,t,a,s){const r=e.filter(c=>c.status==="claimed"),n=f.archivedOrderSearch.trim().toLowerCase(),o=r.filter(c=>n?[c.ticket,c.customer,c.phone,c.service,c.itemCategory].some(l=>String(l??"").toLowerCase().includes(n)):!0),i=f.receiptOrderId?e.find(c=>c.id===f.receiptOrderId):null;return`
    <section class="grid content full">
      <article class="panel span-2">
        ...
        <form class="queue-filters" id="archived-order-filters">
          <label>
            ...
            <input name="archivedOrderSearch" type="search" placeholder="Ticket, name, service" value="${u(f.archivedOrderSearch)}" autocomplete="off" />
          </label>
          <div class="search-actions queue-actions">
            <button class="primary" type="submit">Apply</button>
        ...
        <div class="table orders-table archived-orders-table">
          <div class="table-head"><div>Ticket</div><div>Customer</div><div>Total</div><div>Status</div><div>Actions</div></div>
          ${o.map(c=>Ze(c,t,a)).join("")||'<div class="helper">No archived orders found.</div>'}
        </div>
      </article>
      ${i?et(i,s.filter(c=>c.orderId===i.id)):""}
    </section>
  `}function Ze(e,t,a){const s=Ye(e,a),r=s.find(i=>!e.workflowCompleted.includes(i.key)),n=r?.key==="fold",o=r?.key==="extras"&&e.extras.length>0;return`
    <div class="table-row">
  ...
  `}function et(e,t){const a=t.reduce((r,n)=>r+Number(n.amount),0),s=Math.max(0,Number((a-e.totalAmount).toFixed(2)));return`
  ...
  `}function va(e,t){const a=f.customerSearch.trim().toLowerCase(),s=e.filter(r=>a?r.name.toLowerCase().includes(a):!1);return`
    <section class="grid content full">
      <article class="panel">
      ...
      <article class="panel">
        ...
        <form id="service-form" class="form">
          ...
          <fieldset class="check-grid">
            ...
            ${ta.map(a=>`<label class="check"><input type="checkbox" name="includes" value="${a}" /> ${a}</label>`).join("")}
          </fieldset>
  ...
  `}function ha(e,t){const a=j(),s=a.slice(0,7),r=e.filter(c=>c.expenseDate===a).reduce((c,l)=>c+l.amount,0),n=e.filter(c=>c.expenseDate.startsWith(s)).reduce((c,l)=>c+l.amount,0),o=t.filter(c=>c.saleDate===a).reduce((c,l)=>c+l.totalAmount,0),i=t.filter(c=>c.saleDate.startsWith(s)).reduce((c,l)=>c+l.totalAmount,0);return`
    ...
    `}
  `}function pa(e,t,a,s,r,n,o){const i=f.reportPreview?Qe(e,t,a,s,f.reportPreview):null;return`
    <section class="page-head">
      <div>
  ...
  `}function wa(){const e=()=>{localStorage.removeItem(ee),f.currentUser=null,f.tab="dashboard",f.receiptOrderId=0,f.sidebarOpen=!1,S()};document.querySelector("#logout-button")?.addEventListener("click",e),document.querySelector("#mobile-logout-button")?.addEventListener("click",e),document.querySelector("#mobile-menu-button")?.addEventListener("click",()=>{f.sidebarOpen=!0,S()}),document.querySelector("#sidebar-close-button")?.addEventListener("click",()=>{f.sidebarOpen=!1,S()}),document.querySelector("#sidebar-backdrop")?.addEventListener("click",()=>{f.sidebarOpen=!1,S()}),document.querySelectorAll("[data-tab]").forEach(t=>{t.addEventListener("click",()=>{f.tab=t.dataset.tab,f.receiptOrderId=0,f.sidebarOpen=!1,S()})}),document.querySelectorAll("[data-quick-tab]").forEach(t=>{t.addEventListener("click",()=>{f.tab=t.dataset.quickTab,S()})}),document.querySelectorAll("[data-receipt]").forEach(t=>{t.addEventListener("click",()=>{f.receiptOrderId=Number(t.dataset.receipt),S()})}),document.querySelector("[data-close-receipt]")?.addEventListener("click",()=>{f.receiptOrderId=0,S()}),document.querySelector("[data-print-receipt]")?.addEventListener("click",()=>{window.print()}),document.querySelectorAll("[data-report-tab]").forEach(t=>{t.addEventListener("click",()=>{f.dailyReportTab=t.dataset.reportTab,S()})}),document.querySelectorAll("[data-maintenance-tab]").forEach(t=>{t.addEventListener("click",()=>{f.maintenanceTab=t.dataset.maintenanceTab,S()})})}function Sa(){la(),document.querySelector("#login-form")?.addEventListener("submit",async e=>{e.preventDefault();const t=new FormData(e.currentTarget),a=document.querySelector("#login-button");a&&(a.disabled=!0,a.textContent="Signing in...");try{const s=await He(String(t.get("email")??""),String(t.get("password")??""));if(!s){f.loginError="Invalid email or password.",await S();return}f.currentUser=s,f.loginError="",await ce("branch",String(s.branch||"Main Store")),t.get("remember")?localStorage.setItem(ee,JSON.stringify({email:s.email,remembered:!0})):localStorage.removeItem(ee),ze().includes(f.tab)||(f.tab="dashboard"),await S()}catch(s){alert("Login Error: "+String(s?.message||s)),a&&(a.disabled=!1,a.textContent="Sign in")}})}function Ta(){ie&&window.clearInterval(ie);const e=document.querySelector("[data-navbar-time]"),t=document.querySelector("[data-navbar-date]");if(!e||!t){ie=void 0;return}const a=()=>{const s=ra();e.textContent=s.time,t.textContent=s.date};a(),ie=window.setInterval(a,1e3)}function Na(e){const t=document.querySelector("#order-form"),a=document.querySelector("#price-preview"),s=t?.querySelector('button[type="submit"]'),r=t?.querySelector('select[name="customerId"]'),n=t?.querySelector('input[name="customerName"]'),o=t?.querySelector('input[name="customerPhone"]'),i=t?.querySelector("[data-category-weight]"),c=t?.querySelector("[data-order-error]"),l=t?.querySelector('select[name="paymentMethod"]'),g=t?.querySelector(".gcash-reference"),m=t?.querySelector('input[name="paymentReference"]'),v=()=>{if(!r||!n||!o)return;const p=r.selectedOptions[0];n.value=p?.dataset.name??"",o.value=p?.dataset.phone??""},y=()=>{const p=l?.value==="gcash";g&&(g.hidden=!p),m&&(m.required=p,p||(m.value=""))},b=()=>{if(!t||!a)return;const p=new FormData(t),d=e.services.find(P=>P.id===Number(p.get("serviceId"))),C=e.categories.find(P=>P.id===Number(p.get("itemCategoryId"))),N=e.services.filter(P=>p.getAll("addonIds").map(Number).includes(P.id));if(!d||!C)return;const L=Ne(d,C,Number(p.get("weightKg")??0),N);i&&(i.textContent=`Allowed item weight: ${C.maxKg} kg`);const R=N.map(P=>ye(P.name)),q=L.extraKg>0;s&&(s.disabled=q),c&&(c.hidden=!q,c.textContent=L.warning??""),a.classList.toggle("has-error",q),a.innerHTML=`
    ...
    `};r?.addEventListener("change",v),l?.addEventListener("change",y),y(),t?.addEventListener("input",b),t?.addEventListener("change",b),b(),t?.addEventListener("submit",async p=>{p.preventDefault();const d=new FormData(t),C=e.services.find(R=>R.id===Number(d.get("serviceId"))),N=e.categories.find(R=>R.id===Number(d.get("itemCategoryId"))),L=e.services.filter(R=>d.getAll("addonIds").map(Number).includes(R.id));if(C&&N){const R=Ne(C,N,Number(d.get("weightKg")??0),L);if(R.extraKg>0){c&&(c.hidden=!1,c.textContent=R.warning??"Weight exceeds the allowed limit.");return}}try{await jt({customerId:Number(d.get("customerId"))||void 0,customerName:String(d.get("customerName")??""),customerPhone:String(d.get("customerPhone")??"")||null,serviceId:Number(d.get("serviceId")),itemCategoryId:Number(d.get("itemCategoryId")),branch:e.branch,weightKg:Number(d.get("weightKg")),addonIds:d.getAll("addonIds").map(Number),paidAmount:Number(d.get("paidAmount")??0),paymentMethod:String(d.get("paymentMethod")??"cash"),paymentReference:String(d.get("paymentReference")??"")||null,notes:String(d.get("notes")??"")||null}),await S()}catch(R){c&&(c.hidden=!1,c.textContent=R instanceof Error?R.message:"Order could not be saved.")}}),document.querySelectorAll(".advance-form").forEach(p=>{p.addEventListener("submit",async d=>{d.preventDefault();const C=new FormData(p);await _t(Number(p.dataset.orderId),Number(C.get("assignedStaffId"))||null),await S()})}),document.querySelectorAll(".payment-form").forEach(p=>{const d=p.querySelector('select[name="method"]'),C=p.querySelector('input[name="reference"]'),N=()=>{const L=d?.value==="gcash";C&&(C.hidden=!L,C.required=L,L||(C.value=""))};d?.addEventListener("change",N),N(),p.addEventListener("submit",async L=>{L.preventDefault();const R=new FormData(p);await Ve(Number(p.dataset.orderId),{amount:Number(R.get("amount")),method:String(R.get("method")),reference:String(R.get("reference")??"")||null}),await S()})})}function Aa(e){document.querySelector("#service-form")?.addEventListener("submit",async t=>{t.preventDefault();const a=new FormData(t.currentTarget),s=a.get("id")?Number(a.get("id")):void 0;await je({id:s,name:String(a.get("name")??""),description:String(a.get("description")??"")||null,category:String(a.get("category")??""),serviceType:String(a.get("serviceType")??"order"),price:Number(a.get("price")??0),maxKg:Number(a.get("maxKg")??0),dryingMinutes:Number(a.get("dryingMinutes"))||null,includes:a.getAll("includes").map(String).filter(Boolean),additionalCharge:0,turnaroundHours:Number(a.get("turnaroundHours")??24),isActive:1}),await S()}),document.querySelectorAll(".edit-service-btn").forEach(t=>{t.addEventListener("click",()=>{const a=Number(t.dataset.id),s=e.find(n=>n.id===a),r=document.querySelector("#service-form");s&&r&&(r.querySelector("[name=id]").value=String(s.id),r.querySelector("[name=name]").value=s.name,r.querySelector("[name=category]").value=s.category,r.querySelector("[name=serviceType]").value=s.serviceType,r.querySelector("[name=price]").value=String(s.price),r.querySelector("[name=maxKg]").value=String(s.maxKg),r.querySelector("[name=dryingMinutes]").value=s.dryingMinutes?String(s.dryingMinutes):"",r.querySelectorAll('input[name="includes"]').forEach(n=>{n.checked=s.includes.includes(n.value)}),r.querySelector("[name=turnaroundHours]").value=String(s.turnaroundHours),r.querySelector("[name=description]").value=s.description??"",window.scrollTo({top:0,behavior:"smooth"}))})}),document.querySelectorAll(".deactivate-service-btn, .activate-service-btn").forEach(t=>{t.addEventListener("click",async()=>{const a=Number(t.dataset.id),s=e.find(r=>r.id===a);if(s){const r=s.isActive?0:1;await je({id:s.id,name:s.name,description:s.description,category:s.category,serviceType:s.serviceType,price:s.price,maxKg:s.maxKg,dryingMinutes:s.dryingMinutes,includes:s.includes,additionalCharge:s.additionalCharge,turnaroundHours:s.turnaroundHours,isActive:r}),await S()}})}),document.querySelector("#category-form")?.addEventListener("submit",async t=>{t.preventDefault();const a=new FormData(t.currentTarget);await kt({name:String(a.get("name")??""),maxKg:Number(a.get("maxKg")??0),additionalFee:Number(a.get("additionalFee")??0),isActive:1}),await S()})}function La(){document.querySelector("#expense-form")?.addEventListener("submit",async e=>{e.preventDefault();const t=new FormData(e.currentTarget);await Gt({expenseDate:String(t.get("expenseDate")??""),name:String(t.get("name")??""),category:String(t.get("category")??""),description:String(t.get("description")??""),amount:Number(t.get("amount")??0)}),await S()}),document.querySelector("#fold-form")?.addEventListener("submit",async e=>{e.preventDefault();const t=new FormData(e.currentTarget);await Xt({orderTicket:String(t.get("orderTicket")??""),staffName:String(t.get("staffName")??""),foldCount:Number(t.get("foldCount")??1),rate:Number(t.get("rate")??5)}),await S()})}function Ca(e,t,a,s){document.querySelector("#generate-report")?.addEventListener("click",()=>{f.reportPreview=oe(),S()}),document.querySelector("#sales-form")?.addEventListener("submit",async m=>{m.preventDefault();const v=new FormData(m.currentTarget);await Vt({saleDate:String(v.get("saleDate")??""),cashAmount:Number(v.get("cashAmount")??0),gcashAmount:Number(v.get("gcashAmount")??0),notes:String(v.get("notes")??"")}),await S()});const r=document.querySelector("[data-date-from]"),n=document.querySelector("[data-date-to]");document.querySelectorAll("[data-date-scope]").forEach(m=>{m.addEventListener("change",()=>{if(!m.checked||!r||!n)return;const v=new Date,y=te(v),b=new Date(v);m.value==="week"&&b.setDate(v.getDate()-6),m.value==="month"&&b.setDate(1),m.value!=="custom"&&(r.value=m.value==="today"?y:te(b),n.value=y)})});const o=m=>{const v=p=>String(p??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&apos;"),y=p=>p==="Sales Report"?[110,125,150,215,95,95,105,105]:p==="Disbursement"?[130,115,165,190,95,105,105,105]:p==="Fold Count"?[220,125]:[155,125,125,125,95,95,115,115];return`<?xml version="1.0"?>
...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 xmlns:html="http://www.w3.org/TR/REC-html40">
  ...
  ${m.map(p=>{const d=y(p.name).map(N=>`<Column ss:Width="${N}" ss:AutoFitWidth="0"/>`).join(""),C=p.rows.map(N=>{if(!N.length)return'<Row ss:Height="10" ss:StyleID="BorderRow"><Cell ss:StyleID="BorderCell"><Data ss:Type="String">&nbsp;</Data></Cell></Row>';const L=N[0]==="Type"||N[0]==="Summary"||N[0]==="Sales Summary"||N[0]==="Disbursement Summary"||N[0]==="Staff",R=L?"HeaderRow":"BorderRow",q=L?"HeaderCell":"BorderCell",P=L?26:22,V=N.map(h=>`<Cell ss:StyleID="${q}"><Data ss:Type="${typeof h=="number"?"Number":"String"}">${v(h)}</Data></Cell>`).join("");return`<Row ss:Height="${P}" ss:StyleID="${R}">${V}</Row>`}).join("");return`
...
</Workbook>`},i=()=>{const m=oe(),v=Qe(e,t,a,s,m),y=[];v.selectedTypes.has("sales")&&y.push({name:"Sales Report",rows:v.salesRows().rows}),v.selectedTypes.has("disbursement")&&y.push({name:"Disbursement",rows:v.disbursementRows().rows}),v.selectedTypes.has("fold_count")&&y.push({name:"Fold Count",rows:v.foldCountRows().rows}),v.selectedTypes.has("summary")&&y.push({name:"Summary",rows:v.summaryRows()});const b=o(y.length?y:[{name:"Summary",rows:v.summaryRows()}]),p=`laba101-report-${m.from}-to-${m.to}.xls`;return new File([b],p,{type:"application/vnd.ms-excel"})},c=async()=>{const m=i();if(!w.isNativePlatform())return{fileName:m.name,uri:""};const v=await m.text(),y=m.name;await Fe.writeFile({path:y,data:v,directory:le.External,encoding:Se.UTF8});const{uri:b}=await Fe.getUri({path:y,directory:le.External});return{fileName:m.name,uri:b}},l=()=>{const m=i(),v=oe(),y=`laba101-report-${v.from}-to-${v.to}.xls`,b=m,p=URL.createObjectURL(b),d=document.createElement("a");return d.href=p,d.download=y,document.body.appendChild(d),d.click(),setTimeout(()=>{d.remove(),URL.revokeObjectURL(p)},1e3),y},g=async m=>{const v=document.querySelector(m==="export"?"#export-report":"#email-report");v&&(v.disabled=!0,v.textContent=m==="export"?"Exporting...":"Sending...");try{if(m==="export")if(w.isNativePlatform()){const y=await c();alert(`Report exported as "${y.fileName}".`)}else{const y=l();alert(`Report saved: ${y}`)}else{const y=await Ke("report_email")||"";if(!y){alert("Please configure a report email in Settings first.");return}const b=oe(),p=`Laba101 report ${b.from} to ${b.to}`;if(w.isNativePlatform()){const d=await c();try{await pt.share({title:p,text:`Please find the attached Laba101 report file: ${d.fileName}`,files:[d.uri],dialogTitle:"Send report via email"}),alert(`Report saved and shared as "${d.fileName}".`)}catch(C){const N=String(C).toLowerCase();if(N.includes("share canceled")||N.includes("canceled"))alert(`Report saved as "${d.fileName}".`);else throw C}}else{const d=l(),C=`Hi,

Please find the attached Laba101 report file: ${d}

Date range: ${b.from} to ${b.to}`,N=`mailto:${y}?subject=${encodeURIComponent(p)}&body=${encodeURIComponent(C)}`;setTimeout(()=>{window.location.href=N},800),alert(`Report downloaded as "${d}".
Your email app will open — please attach the file and send.`)}}}catch(y){alert("Failed: "+String(y))}finally{v&&(v.disabled=!1,v.textContent=m==="export"?"Export Excel":"Send to Email")}};document.querySelector("#export-report")?.addEventListener("click",async()=>{await g("export")}),document.querySelector("#email-report")?.addEventListener("click",async()=>{await g("email")})}function $a(){document.querySelector("#order-queue-filters")?.addEventListener("submit",e=>{e.preventDefault();const t=new FormData(e.currentTarget);f.orderSearch=String(t.get("orderSearch")??"").trim(),f.orderDateFilter=String(t.get("orderDateFilter")??"").trim(),S()}),document.querySelector("#order-queue-clear")?.addEventListener("click",()=>{f.orderSearch="",f.orderDateFilter="",S()}),document.querySelector("#archived-order-filters")?.addEventListener("submit",e=>{e.preventDefault();const t=new FormData(e.currentTarget);f.archivedOrderSearch=String(t.get("archivedOrderSearch")??"").trim(),S()}),document.querySelector("#archived-order-clear")?.addEventListener("click",()=>{f.archivedOrderSearch="",S()})}function Ra(){document.querySelector("#customer-search-form")?.addEventListener("submit",e=>{e.preventDefault();const t=new FormData(e.currentTarget);f.customerSearch=String(t.get("customerSearch")??"").trim(),S()}),document.querySelector("#customer-search-clear")?.addEventListener("click",()=>{f.customerSearch="",S()})}function Oa(){document.querySelector("#machine-form")?.addEventListener("submit",async e=>{e.preventDefault();const t=new FormData(e.currentTarget);await Jt({machineName:String(t.get("machineName")??""),machineType:String(t.get("machineType")),status:String(t.get("status")),branch:String(t.get("branch")??"")}),await S()}),document.querySelector("#subcleaning-form")?.addEventListener("submit",async e=>{e.preventDefault();const t=e.currentTarget.querySelector('button[type="submit"]');t&&(t.disabled=!0,t.textContent="Starting...");const a=new FormData(e.currentTarget),s=a.getAll("machineIds").map(Number);if(!s.length){alert("Please select at least one machine to clean."),t&&(t.disabled=!1,t.textContent="Start Cleaning");return}await Zt({date:String(a.get("date")??""),machineIds:s,cleaningStatus:String(a.get("cleaningStatus")??""),notes:String(a.get("notes")??""),branch:String(a.get("branch")??"")}),await S()}),document.querySelectorAll(".complete-cleaning-btn").forEach(e=>{e.addEventListener("click",async()=>{const t=Number(e.dataset.machineId),a=e.dataset.branch??"";e.disabled=!0,e.textContent="Completing...",await ea(t,a),await S()})}),document.querySelectorAll(".deactivate-machine-btn, .activate-machine-btn").forEach(e=>{e.addEventListener("click",async()=>{const t=Number(e.dataset.id),a=e.classList.contains("deactivate-machine-btn");await Qt(t,a?"inactive":"available"),await S()})})}function Da(e){const t=document.querySelector("#add-staff-modal"),a=document.querySelector("#open-add-staff-modal"),s=document.querySelector("#close-add-staff-modal"),r=document.querySelector("#staff-form"),n=()=>{r?.reset(),r&&(r.querySelector("[name=id]").value="");const i=document.querySelector("#add-staff-title");i&&(i.textContent="Add staff member"),t?.removeAttribute("hidden")},o=()=>{t?.setAttribute("hidden",""),r?.reset()};a?.addEventListener("click",n),s?.addEventListener("click",o),t?.addEventListener("click",i=>{i.target===t&&o()}),document.querySelectorAll(".edit-staff-btn").forEach(i=>{i.addEventListener("click",()=>{const c=Number(i.dataset.id),l=e.find(g=>g.id===c);if(l&&r){r.querySelector("[name=id]").value=String(l.id),r.querySelector("[name=name]").value=l.name,r.querySelector("[name=email]").value=l.email,r.querySelector("[name=password]").value=l.password,r.querySelector("[name=role]").value=l.role,r.querySelector("[name=branch]").value=l.branch;const g=document.querySelector("#add-staff-title");g&&(g.textContent="Edit staff member"),t?.removeAttribute("hidden")}})}),document.querySelectorAll(".deactivate-staff-btn, .activate-staff-btn").forEach(i=>{i.addEventListener("click",async()=>{const c=Number(i.dataset.id),l=e.find(g=>g.id===c);l&&(await Me(c,{isActive:l.isActive!==0?0:1}),await S())})}),r?.addEventListener("submit",async i=>{i.preventDefault();const c=document.querySelector("#staff-save-btn");c&&(c.disabled=!0,c.textContent="Saving...");const l=new FormData(r),g=l.get("id")?Number(l.get("id")):void 0,m=String(l.get("name")??"").trim(),v=String(l.get("email")??"").trim(),y=String(l.get("password")??"password")||"password",b=String(l.get("role")),p=String(l.get("branch")??"");if(!m||!v){alert("Name and email are required."),c&&(c.disabled=!1,c.textContent="Save staff member");return}try{g?await Me(g,{name:m,email:v,password:y,role:b,branch:p}):await It({name:m,email:v,password:y,role:b,branch:p}),o(),await S()}catch{alert("Failed to save staff. The email may already be in use."),c&&(c.disabled=!1,c.textContent="Save staff member")}})}function xa(){document.querySelector("#settings-form")?.addEventListener("submit",async e=>{e.preventDefault();const t=new FormData(e.currentTarget);await ce("branch",String(t.get("branch")??"Main Store")),await ce("fold_rate",String(t.get("foldRate")??"5")),String(t.get("reportEmail")??"")&&await ce("report_email",String(t.get("reportEmail"))),alert("Settings saved successfully!"),await S()})}await Dt();const _e=localStorage.getItem(ee);if(_e)try{const e=JSON.parse(_e);if(e.email&&e.remembered){const t=await He(e.email,"password")??null;f.currentUser=t}}catch{localStorage.removeItem(ee)}await S();export{Se as E,Ae as W,ct as b};
