(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))a(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const i of r.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&a(i)}).observe(document,{childList:!0,subtree:!0});function n(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(s){if(s.ep)return;s.ep=!0;const r=n(s);fetch(s.href,r)}})();var ve;(function(e){e.Unimplemented="UNIMPLEMENTED",e.Unavailable="UNAVAILABLE"})(ve||(ve={}));class Fe extends Error{constructor(t,n,a){super(t),this.message=t,this.code=n,this.data=a}}const _t=e=>{var t,n;return e?.androidBridge?"android":!((n=(t=e?.webkit)===null||t===void 0?void 0:t.messageHandlers)===null||n===void 0)&&n.bridge?"ios":"web"},jt=e=>{const t=e.CapacitorCustomPlatform||null,n=e.Capacitor||{},a=n.Plugins=n.Plugins||{},s=()=>t!==null?t.name:_t(e),r=()=>s()!=="web",i=m=>{const f=c.get(m);return!!(f?.platforms.has(s())||o(m))},o=m=>{var f;return(f=n.PluginHeaders)===null||f===void 0?void 0:f.find(y=>y.name===m)},d=m=>e.console.error(m),c=new Map,u=(m,f={})=>{const y=c.get(m);if(y)return console.warn(`Capacitor plugin "${m}" already registered. Cannot register plugins twice.`),y.proxy;const E=s(),q=o(m);let S;const w=async()=>(!S&&E in f?S=typeof f[E]=="function"?S=await f[E]():S=f[E]:t!==null&&!S&&"web"in f&&(S=typeof f.web=="function"?S=await f.web():S=f.web),S),p=(D,P)=>{var k,M;if(q){const B=q?.methods.find(H=>P===H.name);if(B)return B.rtype==="promise"?H=>n.nativePromise(m,P.toString(),H):(H,Ee)=>n.nativeCallback(m,P.toString(),H,Ee);if(D)return(k=D[P])===null||k===void 0?void 0:k.bind(D)}else{if(D)return(M=D[P])===null||M===void 0?void 0:M.bind(D);throw new Fe(`"${m}" plugin is not implemented on ${E}`,ve.Unimplemented)}},g=D=>{let P;const k=(...M)=>{const B=w().then(H=>{const Ee=p(H,D);if(Ee){const Te=Ee(...M);return P=Te?.remove,Te}else throw new Fe(`"${m}.${D}()" is not implemented on ${E}`,ve.Unimplemented)});return D==="addListener"&&(B.remove=async()=>P()),B};return k.toString=()=>`${D.toString()}() { [capacitor code] }`,Object.defineProperty(k,"name",{value:D,writable:!1,configurable:!1}),k},N=g("addListener"),$=g("removeListener"),x=(D,P)=>{const k=N({eventName:D},P),M=async()=>{const H=await k;$({eventName:D,callbackId:H},P)},B=new Promise(H=>k.then(()=>H({remove:M})));return B.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await M()},B},L=new Proxy({},{get(D,P){switch(P){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return q?x:N;case"removeListener":return $;default:return g(P)}}});return a[m]=L,c.set(m,{name:m,proxy:L,platforms:new Set([...Object.keys(f),...q?[E]:[]])}),L};return n.convertFileSrc||(n.convertFileSrc=m=>m),n.getPlatform=s,n.handleError=d,n.isNativePlatform=r,n.isPluginAvailable=i,n.registerPlugin=u,n.Exception=Fe,n.DEBUG=!!n.DEBUG,n.isLoggingEnabled=!!n.isLoggingEnabled,n},Ht=e=>e.Capacitor=jt(e),R=Ht(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),ce=R.registerPlugin;class He{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(t,n){let a=!1;this.listeners[t]||(this.listeners[t]=[],a=!0),this.listeners[t].push(n);const r=this.windowListeners[t];r&&!r.registered&&this.addWindowListener(r),a&&this.sendRetainedArgumentsForEvent(t);const i=async()=>this.removeListener(t,n);return Promise.resolve({remove:i})}async removeAllListeners(){this.listeners={};for(const t in this.windowListeners)this.removeWindowListener(this.windowListeners[t]);this.windowListeners={}}notifyListeners(t,n,a){const s=this.listeners[t];if(!s){if(a){let r=this.retainedEventArguments[t];r||(r=[]),r.push(n),this.retainedEventArguments[t]=r}return}s.forEach(r=>r(n))}hasListeners(t){var n;return!!(!((n=this.listeners[t])===null||n===void 0)&&n.length)}registerWindowListener(t,n){this.windowListeners[n]={registered:!1,windowEventName:t,pluginEventName:n,handler:a=>{this.notifyListeners(n,a)}}}unimplemented(t="not implemented"){return new R.Exception(t,ve.Unimplemented)}unavailable(t="not available"){return new R.Exception(t,ve.Unavailable)}async removeListener(t,n){const a=this.listeners[t];if(!a)return;const s=a.indexOf(n);this.listeners[t].splice(s,1),this.listeners[t].length||this.removeWindowListener(this.windowListeners[t])}addWindowListener(t){window.addEventListener(t.windowEventName,t.handler),t.registered=!0}removeWindowListener(t){t&&(window.removeEventListener(t.windowEventName,t.handler),t.registered=!1)}sendRetainedArgumentsForEvent(t){const n=this.retainedEventArguments[t];n&&(delete this.retainedEventArguments[t],n.forEach(a=>{this.notifyListeners(t,a)}))}}const Ze=e=>encodeURIComponent(e).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),et=e=>e.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class Wt extends He{async getCookies(){const t=document.cookie,n={};return t.split(";").forEach(a=>{if(a.length<=0)return;let[s,r]=a.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");s=et(s).trim(),r=et(r).trim(),n[s]=r}),n}async setCookie(t){try{const n=Ze(t.key),a=Ze(t.value),s=t.expires?`; expires=${t.expires.replace("expires=","")}`:"",r=(t.path||"/").replace("path=",""),i=t.url!=null&&t.url.length>0?`domain=${t.url}`:"";document.cookie=`${n}=${a||""}${s}; path=${r}; ${i};`}catch(n){return Promise.reject(n)}}async deleteCookie(t){try{document.cookie=`${t.key}=; Max-Age=0`}catch(n){return Promise.reject(n)}}async clearCookies(){try{const t=document.cookie.split(";")||[];for(const n of t)document.cookie=n.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(t){return Promise.reject(t)}}async clearAllCookies(){try{await this.clearCookies()}catch(t){return Promise.reject(t)}}}ce("CapacitorCookies",{web:()=>new Wt});const Xt=async e=>new Promise((t,n)=>{const a=new FileReader;a.onload=()=>{const s=a.result;t(s.indexOf(",")>=0?s.split(",")[1]:s)},a.onerror=s=>n(s),a.readAsDataURL(e)}),Gt=(e={})=>{const t=Object.keys(e);return Object.keys(e).map(s=>s.toLocaleLowerCase()).reduce((s,r,i)=>(s[r]=e[t[i]],s),{})},Kt=(e,t=!0)=>e?Object.entries(e).reduce((a,s)=>{const[r,i]=s;let o,d;return Array.isArray(i)?(d="",i.forEach(c=>{o=t?encodeURIComponent(c):c,d+=`${r}=${o}&`}),d.slice(0,-1)):(o=t?encodeURIComponent(i):i,d=`${r}=${o}`),`${a}&${d}`},"").substr(1):null,Vt=(e,t={})=>{const n=Object.assign({method:e.method||"GET",headers:e.headers},t),s=Gt(e.headers)["content-type"]||"";if(typeof e.data=="string")n.body=e.data;else if(s.includes("application/x-www-form-urlencoded")){const r=new URLSearchParams;for(const[i,o]of Object.entries(e.data||{}))r.set(i,o);n.body=r.toString()}else if(s.includes("multipart/form-data")||e.data instanceof FormData){const r=new FormData;if(e.data instanceof FormData)e.data.forEach((o,d)=>{r.append(d,o)});else for(const o of Object.keys(e.data))r.append(o,e.data[o]);n.body=r;const i=new Headers(n.headers);i.delete("content-type"),n.headers=i}else(s.includes("application/json")||typeof e.data=="object")&&(n.body=JSON.stringify(e.data));return n};class Yt extends He{async request(t){const n=Vt(t,t.webFetchExtra),a=Kt(t.params,t.shouldEncodeUrlParams),s=a?`${t.url}?${a}`:t.url,r=await fetch(s,n),i=r.headers.get("content-type")||"";let{responseType:o="text"}=r.ok?t:{};i.includes("application/json")&&(o="json");let d,c;switch(o){case"arraybuffer":case"blob":c=await r.blob(),d=await Xt(c);break;case"json":d=await r.json();break;default:d=await r.text()}const u={};return r.headers.forEach((m,f)=>{u[f]=m}),{data:d,headers:u,status:r.status,url:r.url}}async get(t){return this.request(Object.assign(Object.assign({},t),{method:"GET"}))}async post(t){return this.request(Object.assign(Object.assign({},t),{method:"POST"}))}async put(t){return this.request(Object.assign(Object.assign({},t),{method:"PUT"}))}async patch(t){return this.request(Object.assign(Object.assign({},t),{method:"PATCH"}))}async delete(t){return this.request(Object.assign(Object.assign({},t),{method:"DELETE"}))}}ce("CapacitorHttp",{web:()=>new Yt});var tt;(function(e){e.Dark="DARK",e.Light="LIGHT",e.Default="DEFAULT"})(tt||(tt={}));var at;(function(e){e.StatusBar="StatusBar",e.NavigationBar="NavigationBar"})(at||(at={}));class Qt extends He{async setStyle(){this.unavailable("not available for web")}async setAnimation(){this.unavailable("not available for web")}async show(){this.unavailable("not available for web")}async hide(){this.unavailable("not available for web")}}ce("SystemBars",{web:()=>new Qt});const Jt="modulepreload",zt=function(e){return"/"+e},nt={},We=function(t,n,a){let s=Promise.resolve();if(n&&n.length>0){let d=function(c){return Promise.all(c.map(u=>Promise.resolve(u).then(m=>({status:"fulfilled",value:m}),m=>({status:"rejected",reason:m}))))};document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),o=i?.nonce||i?.getAttribute("nonce");s=d(n.map(c=>{if(c=zt(c),c in nt)return;nt[c]=!0;const u=c.endsWith(".css"),m=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${m}`))return;const f=document.createElement("link");if(f.rel=u?"stylesheet":Jt,u||(f.as="script"),f.crossOrigin="",f.href=c,o&&f.setAttribute("nonce",o),document.head.appendChild(f),u)return new Promise((y,E)=>{f.addEventListener("load",y),f.addEventListener("error",()=>E(new Error(`Unable to preload CSS for ${c}`)))})}))}function r(i){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=i,window.dispatchEvent(o),!o.defaultPrevented)throw i}return s.then(i=>{for(const o of i||[])o.status==="rejected"&&r(o.reason);return t().catch(r)})};function Zt(e){e.CapacitorUtils.Synapse=new Proxy({},{get(t,n){return new Proxy({},{get(a,s){return(r,i,o)=>{const d=e.Capacitor.Plugins[n];if(d===void 0){o(new Error(`Capacitor plugin ${n} not found`));return}if(typeof d[s]!="function"){o(new Error(`Method ${s} not found in Capacitor plugin ${n}`));return}(async()=>{try{const c=await d[s](r);i(c)}catch(c){o(c)}})()}}})}})}function ea(e){e.CapacitorUtils.Synapse=new Proxy({},{get(t,n){return e.cordova.plugins[n]}})}function ta(e=!1){typeof window>"u"||(window.CapacitorUtils=window.CapacitorUtils||{},window.Capacitor!==void 0&&!e?Zt(window):window.cordova!==void 0&&ea(window))}var $e;(function(e){e.Documents="DOCUMENTS",e.Data="DATA",e.Library="LIBRARY",e.Cache="CACHE",e.External="EXTERNAL",e.ExternalStorage="EXTERNAL_STORAGE",e.ExternalCache="EXTERNAL_CACHE",e.LibraryNoCloud="LIBRARY_NO_CLOUD",e.Temporary="TEMPORARY"})($e||($e={}));var Be;(function(e){e.UTF8="utf8",e.ASCII="ascii",e.UTF16="utf16"})(Be||(Be={}));const st=ce("Filesystem",{web:()=>We(()=>import("./web-D4bVAIz6.js"),[]).then(e=>new e.FilesystemWeb)});ta();const aa=ce("Share",{web:()=>We(()=>import("./web-DALO0EGb.js"),[]).then(e=>new e.ShareWeb)});class na{constructor(t){this.sqlite=t,this._connectionDict=new Map}async initWebStore(){try{return await this.sqlite.initWebStore(),Promise.resolve()}catch(t){return Promise.reject(t)}}async saveToStore(t){try{return await this.sqlite.saveToStore({database:t}),Promise.resolve()}catch(n){return Promise.reject(n)}}async saveToLocalDisk(t){try{return await this.sqlite.saveToLocalDisk({database:t}),Promise.resolve()}catch(n){return Promise.reject(n)}}async getFromLocalDiskToStore(t){const n=t??!0;try{return await this.sqlite.getFromLocalDiskToStore({overwrite:n}),Promise.resolve()}catch(a){return Promise.reject(a)}}async echo(t){try{const n=await this.sqlite.echo({value:t});return Promise.resolve(n)}catch(n){return Promise.reject(n)}}async isSecretStored(){try{const t=await this.sqlite.isSecretStored();return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async setEncryptionSecret(t){try{return await this.sqlite.setEncryptionSecret({passphrase:t}),Promise.resolve()}catch(n){return Promise.reject(n)}}async changeEncryptionSecret(t,n){try{return await this.sqlite.changeEncryptionSecret({passphrase:t,oldpassphrase:n}),Promise.resolve()}catch(a){return Promise.reject(a)}}async clearEncryptionSecret(){try{return await this.sqlite.clearEncryptionSecret(),Promise.resolve()}catch(t){return Promise.reject(t)}}async checkEncryptionSecret(t){try{const n=await this.sqlite.checkEncryptionSecret({passphrase:t});return Promise.resolve(n)}catch(n){return Promise.reject(n)}}async addUpgradeStatement(t,n){try{return t.endsWith(".db")&&(t=t.slice(0,-3)),await this.sqlite.addUpgradeStatement({database:t,upgrade:n}),Promise.resolve()}catch(a){return Promise.reject(a)}}async createConnection(t,n,a,s,r){try{t.endsWith(".db")&&(t=t.slice(0,-3)),await this.sqlite.createConnection({database:t,encrypted:n,mode:a,version:s,readonly:r});const i=new rt(t,r,this.sqlite),o=r?`RO_${t}`:`RW_${t}`;return this._connectionDict.set(o,i),Promise.resolve(i)}catch(i){return Promise.reject(i)}}async closeConnection(t,n){try{t.endsWith(".db")&&(t=t.slice(0,-3)),await this.sqlite.closeConnection({database:t,readonly:n});const a=n?`RO_${t}`:`RW_${t}`;return this._connectionDict.delete(a),Promise.resolve()}catch(a){return Promise.reject(a)}}async isConnection(t,n){const a={};t.endsWith(".db")&&(t=t.slice(0,-3));const s=n?`RO_${t}`:`RW_${t}`;return a.result=this._connectionDict.has(s),Promise.resolve(a)}async retrieveConnection(t,n){t.endsWith(".db")&&(t=t.slice(0,-3));const a=n?`RO_${t}`:`RW_${t}`;if(this._connectionDict.has(a)){const s=this._connectionDict.get(a);return typeof s<"u"?Promise.resolve(s):Promise.reject(`Connection ${t} is undefined`)}else return Promise.reject(`Connection ${t} does not exist`)}async getNCDatabasePath(t,n){try{const a=await this.sqlite.getNCDatabasePath({path:t,database:n});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async createNCConnection(t,n){try{await this.sqlite.createNCConnection({databasePath:t,version:n});const a=new rt(t,!0,this.sqlite),s=`RO_${t})`;return this._connectionDict.set(s,a),Promise.resolve(a)}catch(a){return Promise.reject(a)}}async closeNCConnection(t){try{await this.sqlite.closeNCConnection({databasePath:t});const n=`RO_${t})`;return this._connectionDict.delete(n),Promise.resolve()}catch(n){return Promise.reject(n)}}async isNCConnection(t){const n={},a=`RO_${t})`;return n.result=this._connectionDict.has(a),Promise.resolve(n)}async retrieveNCConnection(t){if(this._connectionDict.has(t)){const n=`RO_${t})`,a=this._connectionDict.get(n);return typeof a<"u"?Promise.resolve(a):Promise.reject(`Connection ${t} is undefined`)}else return Promise.reject(`Connection ${t} does not exist`)}async isNCDatabase(t){try{const n=await this.sqlite.isNCDatabase({databasePath:t});return Promise.resolve(n)}catch(n){return Promise.reject(n)}}async retrieveAllConnections(){return this._connectionDict}async closeAllConnections(){const t=new Map;try{for(const n of this._connectionDict.keys()){const a=n.substring(3),s=n.substring(0,3)==="RO_";await this.sqlite.closeConnection({database:a,readonly:s}),t.set(n,null)}for(const n of t.keys())this._connectionDict.delete(n);return Promise.resolve()}catch(n){return Promise.reject(n)}}async checkConnectionsConsistency(){try{const t=[...this._connectionDict.keys()],n=[],a=[];for(const r of t)n.push(r.substring(0,2)),a.push(r.substring(3));const s=await this.sqlite.checkConnectionsConsistency({dbNames:a,openModes:n});return s.result||(this._connectionDict=new Map),Promise.resolve(s)}catch(t){return this._connectionDict=new Map,Promise.reject(t)}}async importFromJson(t){try{const n=await this.sqlite.importFromJson({jsonstring:t});return Promise.resolve(n)}catch(n){return Promise.reject(n)}}async isJsonValid(t){try{const n=await this.sqlite.isJsonValid({jsonstring:t});return Promise.resolve(n)}catch(n){return Promise.reject(n)}}async copyFromAssets(t){const n=t??!0;try{return await this.sqlite.copyFromAssets({overwrite:n}),Promise.resolve()}catch(a){return Promise.reject(a)}}async getFromHTTPRequest(t,n){const a=n??!0;try{return await this.sqlite.getFromHTTPRequest({url:t,overwrite:a}),Promise.resolve()}catch(s){return Promise.reject(s)}}async isDatabaseEncrypted(t){t.endsWith(".db")&&(t=t.slice(0,-3));try{const n=await this.sqlite.isDatabaseEncrypted({database:t});return Promise.resolve(n)}catch(n){return Promise.reject(n)}}async isInConfigEncryption(){try{const t=await this.sqlite.isInConfigEncryption();return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isInConfigBiometricAuth(){try{const t=await this.sqlite.isInConfigBiometricAuth();return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isDatabase(t){t.endsWith(".db")&&(t=t.slice(0,-3));try{const n=await this.sqlite.isDatabase({database:t});return Promise.resolve(n)}catch(n){return Promise.reject(n)}}async getDatabaseList(){try{const n=(await this.sqlite.getDatabaseList()).values;n.sort();const a={values:n};return Promise.resolve(a)}catch(t){return Promise.reject(t)}}async getMigratableDbList(t){const n=t||"default";try{const a=await this.sqlite.getMigratableDbList({folderPath:n});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async addSQLiteSuffix(t,n){const a=t||"default",s=n||[];try{const r=await this.sqlite.addSQLiteSuffix({folderPath:a,dbNameList:s});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async deleteOldDatabases(t,n){const a=t||"default",s=n||[];try{const r=await this.sqlite.deleteOldDatabases({folderPath:a,dbNameList:s});return Promise.resolve(r)}catch(r){return Promise.reject(r)}}async moveDatabasesAndAddSuffix(t,n){const a=t||"default",s=n||[];return this.sqlite.moveDatabasesAndAddSuffix({folderPath:a,dbNameList:s})}}class rt{constructor(t,n,a){this.dbName=t,this.readonly=n,this.sqlite=a}getConnectionDBName(){return this.dbName}getConnectionReadOnly(){return this.readonly}async open(){try{return await this.sqlite.open({database:this.dbName,readonly:this.readonly}),Promise.resolve()}catch(t){return Promise.reject(t)}}async close(){try{return await this.sqlite.close({database:this.dbName,readonly:this.readonly}),Promise.resolve()}catch(t){return Promise.reject(t)}}async beginTransaction(){try{const t=await this.sqlite.beginTransaction({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async commitTransaction(){try{const t=await this.sqlite.commitTransaction({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async rollbackTransaction(){try{const t=await this.sqlite.rollbackTransaction({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isTransactionActive(){try{const t=await this.sqlite.isTransactionActive({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async loadExtension(t){try{return await this.sqlite.loadExtension({database:this.dbName,path:t,readonly:this.readonly}),Promise.resolve()}catch(n){return Promise.reject(n)}}async enableLoadExtension(t){try{return await this.sqlite.enableLoadExtension({database:this.dbName,toggle:t,readonly:this.readonly}),Promise.resolve()}catch(n){return Promise.reject(n)}}async getUrl(){try{const t=await this.sqlite.getUrl({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async getVersion(){try{const t=await this.sqlite.getVersion({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async getTableList(){try{const t=await this.sqlite.getTableList({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async execute(t,n=!0,a=!0){try{if(this.readonly)return Promise.reject("not allowed in read-only mode");{const s=await this.sqlite.execute({database:this.dbName,statements:t,transaction:n,readonly:!1,isSQL92:a});return Promise.resolve(s)}}catch(s){return Promise.reject(s)}}async query(t,n,a=!0){let s;try{return n&&n.length>0?s=await this.sqlite.query({database:this.dbName,statement:t,values:n,readonly:this.readonly,isSQL92:!0}):s=await this.sqlite.query({database:this.dbName,statement:t,values:[],readonly:this.readonly,isSQL92:a}),s=await this.reorderRows(s),Promise.resolve(s)}catch(r){return Promise.reject(r)}}async run(t,n,a=!0,s="no",r=!0){let i;try{return this.readonly?Promise.reject("not allowed in read-only mode"):(n&&n.length>0?i=await this.sqlite.run({database:this.dbName,statement:t,values:n,transaction:a,readonly:!1,returnMode:s,isSQL92:!0}):i=await this.sqlite.run({database:this.dbName,statement:t,values:[],transaction:a,readonly:!1,returnMode:s,isSQL92:r}),i.changes=await this.reorderRows(i.changes),Promise.resolve(i))}catch(o){return Promise.reject(o)}}async executeSet(t,n=!0,a="no",s=!0){let r;try{return this.readonly?Promise.reject("not allowed in read-only mode"):(r=await this.sqlite.executeSet({database:this.dbName,set:t,transaction:n,readonly:!1,returnMode:a,isSQL92:s}),r.changes=await this.reorderRows(r.changes),Promise.resolve(r))}catch(i){return Promise.reject(i)}}async isExists(){try{const t=await this.sqlite.isDBExists({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isTable(t){try{const n=await this.sqlite.isTableExists({database:this.dbName,table:t,readonly:this.readonly});return Promise.resolve(n)}catch(n){return Promise.reject(n)}}async isDBOpen(){try{const t=await this.sqlite.isDBOpen({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async delete(){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.deleteDatabase({database:this.dbName,readonly:!1}),Promise.resolve())}catch(t){return Promise.reject(t)}}async createSyncTable(){try{if(this.readonly)return Promise.reject("not allowed in read-only mode");{const t=await this.sqlite.createSyncTable({database:this.dbName,readonly:!1});return Promise.resolve(t)}}catch(t){return Promise.reject(t)}}async setSyncDate(t){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.setSyncDate({database:this.dbName,syncdate:t,readonly:!1}),Promise.resolve())}catch(n){return Promise.reject(n)}}async getSyncDate(){try{const t=await this.sqlite.getSyncDate({database:this.dbName,readonly:this.readonly});let n="";return t.syncDate>0&&(n=new Date(t.syncDate*1e3).toISOString()),Promise.resolve(n)}catch(t){return Promise.reject(t)}}async exportToJson(t,n=!1){try{const a=await this.sqlite.exportToJson({database:this.dbName,jsonexportmode:t,readonly:this.readonly,encrypted:n});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async deleteExportedRows(){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.deleteExportedRows({database:this.dbName,readonly:!1}),Promise.resolve())}catch(t){return Promise.reject(t)}}async executeTransaction(t,n=!0){let a=0,s=!1;if(this.readonly)return Promise.reject("not allowed in read-only mode");if(await this.sqlite.beginTransaction({database:this.dbName}),s=await this.sqlite.isTransactionActive({database:this.dbName}),!s)return Promise.reject("After Begin Transaction, no transaction active");try{for(const o of t){if(typeof o!="object"||!("statement"in o))throw new Error("Error a task.statement must be provided");if("values"in o&&o.values&&o.values.length>0){const d=o.statement.toUpperCase().includes("RETURNING")?"all":"no",c=await this.sqlite.run({database:this.dbName,statement:o.statement,values:o.values,transaction:!1,readonly:!1,returnMode:d,isSQL92:n});if(c.changes.changes<0)throw new Error("Error in transaction method run ");a+=c.changes.changes}else{const d=await this.sqlite.execute({database:this.dbName,statements:o.statement,transaction:!1,readonly:!1});if(d.changes.changes<0)throw new Error("Error in transaction method execute ");a+=d.changes.changes}}const r=await this.sqlite.commitTransaction({database:this.dbName});a+=r.changes.changes;const i={changes:{changes:a}};return Promise.resolve(i)}catch(r){const i=r.message?r.message:r;return await this.sqlite.rollbackTransaction({database:this.dbName}),Promise.reject(i)}}async reorderRows(t){const n=t;if(t?.values&&typeof t.values[0]=="object"&&Object.keys(t.values[0]).includes("ios_columns")){const a=t.values[0].ios_columns,s=[];for(let r=1;r<t.values.length;r++){const i=t.values[r],o={};for(const d of a)o[d]=i[d];s.push(o)}n.values=s}return Promise.resolve(n)}}const sa=ce("CapacitorSQLite",{web:()=>We(()=>import("./web-CYIp-blI.js"),[]).then(e=>new e.CapacitorSQLiteWeb),electron:()=>window.CapacitorCustomPlatform.plugins.CapacitorSQLite});function ra(e){return e.replace(/^(add[- ]?on|additional)\s+/i,"").trim()}const ia="laba101_offline",Re="fresh_start_reset_v1",oa=new na(sa);let we=null;const Q=[{id:1,name:"Laba101 Admin",email:"admin@laba101.test",password:"password",role:"admin",branch:"Main Store"},{id:2,name:"Gensan Branch Staff",email:"staff@laba101.gensan",password:"password",role:"staff",branch:"Gensan Branch"}],Oe=[],z=[V(1,"Drop-off","P185. Includes wash, dry, and fold.","Drop-Off","order",185,8,40,["Wash","Dry","Fold"],0,24),V(2,"Full Service","P200. Wash, Fabcon, detergent, dry, and fold.","Full Service","order",200,8,40,["Wash","Dry","Fold","Detergent","Fabcon"],0,24),V(3,"Self Service Wash","P60. Self-service wash (max 8kg per load).","Self Service","order",60,8,null,["Wash"],0,1),V(4,"Self Service Dry","P70. Self-service dry (40 mins).","Self Service","order",70,8,40,["Dry"],0,1),V(6,"Dry 10 mins","Additional drying time (10 mins).","Add-on","addon",30,8,10,["Dry"],0,1),V(7,"Dry 20 mins","Additional drying time (20 mins).","Add-on","addon",50,8,20,["Dry"],0,1),V(8,"Dry 40 mins","Additional drying time (40 mins).","Add-on","addon",70,8,40,["Dry"],0,1),V(9,"Additional Zonrox","Extra Zonrox bleach add-on per load.","Add-on","addon",10,0,null,["Zonrox"],0,0),V(10,"Additional Fabcon","Extra Fabcon fabric conditioner add-on per load.","Add-on","addon",10,0,null,["Fabcon"],0,0),V(11,"Additional Finishing","Extra finishing spray add-on per load.","Add-on","addon",20,0,null,["Finishing"],0,0)],se=[{id:1,name:"Regular Clothes",maxKg:8,additionalFee:0,isActive:1},{id:2,name:"Comforter",maxKg:4,additionalFee:0,isActive:1},{id:3,name:"Thin Blankets",maxKg:6,additionalFee:0,isActive:1},{id:4,name:"Bedsheets",maxKg:6,additionalFee:0,isActive:1},{id:5,name:"Bath Towels",maxKg:6,additionalFee:0,isActive:1},{id:6,name:"Curtains",maxKg:6,additionalFee:0,isActive:1}];function it(e,t){const n=C(e,[]),a=new Map(n.map(r=>[r.id,r])),s=t.map(r=>{const i=a.get(r.id);return i?{...r,...i,isActive:i.isActive??r.isActive}:r});(n.length!==s.length||s.some((r,i)=>r.id!==n[i]?.id||JSON.stringify(r)!==JSON.stringify(n[i])))&&A(e,s)}async function ca(){it("services",z),it("item_categories",se)}async function Ie(e){for(const t of z)((await e.query("SELECT id FROM laundry_services WHERE id = ?",[t.id])).values??[]).length>0?await e.run("UPDATE laundry_services SET name = ?, description = ?, category = ?, serviceType = ?, price = ?, maxKg = ?, dryingMinutes = ?, includes = ?, additionalCharge = ?, turnaroundHours = ?, isActive = COALESCE(isActive, ?) WHERE id = ?",[t.name,t.description,t.category,t.serviceType,t.price,t.maxKg,t.dryingMinutes,JSON.stringify(t.includes),t.additionalCharge,t.turnaroundHours,t.isActive,t.id]):await e.run("INSERT INTO laundry_services (id, name, description, category, serviceType, price, maxKg, dryingMinutes, includes, additionalCharge, turnaroundHours, isActive) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",[t.id,t.name,t.description,t.category,t.serviceType,t.price,t.maxKg,t.dryingMinutes,JSON.stringify(t.includes),t.additionalCharge,t.turnaroundHours,t.isActive]);for(const t of se)((await e.query("SELECT id FROM item_categories WHERE id = ?",[t.id])).values??[]).length>0?await e.run("UPDATE item_categories SET name = ?, maxKg = ?, additionalFee = ?, isActive = COALESCE(isActive, ?) WHERE id = ?",[t.name,t.maxKg,t.additionalFee,t.isActive,t.id]):await e.run("INSERT INTO item_categories (id, name, maxKg, additionalFee, isActive) VALUES (?, ?, ?, ?, ?)",[t.id,t.name,t.maxKg,t.additionalFee,t.isActive])}const re=[],pe=[],ie=[],ye=[],fe=[],Z=[...[1,2,3,4].map(e=>({id:e,machineName:`Washer ${e}`,machineType:"washer",status:"available",branch:"Main Store"})),...[1,2,3,4].map(e=>({id:e+4,machineName:`Dryer ${e}`,machineType:"dryer",status:"available",branch:"Main Store"}))],he=[{key:"branch",value:"Main Store"},{key:"fold_rate",value:"5"},{key:"report_email",value:"admin@laba101.test"}];function V(e,t,n,a,s,r,i,o,d,c,u){return{id:e,name:t,description:n,category:a,serviceType:s,price:r,maxKg:i,dryingMinutes:o,includes:d,additionalCharge:c,turnaroundHours:u,isActive:1}}function X(e){return`laba101-mobile-${e}`}function C(e,t){const n=localStorage.getItem(X(e));if(!n)return structuredClone(t);try{return JSON.parse(n)}catch{return structuredClone(t)}}function A(e,t){localStorage.setItem(X(e),JSON.stringify(t))}function W(e){return e.reduce((t,n)=>Math.max(t,n.id),0)+1}function K(){return new Date().toISOString()}function De(e=new Date){const t=e.getFullYear(),n=String(e.getMonth()+1).padStart(2,"0"),a=String(e.getDate()).padStart(2,"0");return`${t}-${n}-${a}`}function la(){return De().slice(2).replaceAll("-","")}function J(e,t){if(!e)return t;try{return JSON.parse(e)}catch{return t}}async function O(){return we||(we=await oa.createConnection(ia,!1,"no-encryption",1,!1),await we.open()),we}async function U(e,t,n,a){((await e.query(`PRAGMA table_info(${t})`)).values??[]).some(i=>i.name===n)||await e.execute(`ALTER TABLE ${t} ADD COLUMN ${n} ${a}`)}function da(){const e=C("staff",Q),t=new Map(e.map(a=>[a.id,a]));let n=!1;for(const a of Q){const s=t.get(a.id);if(!s){t.set(a.id,{...a,isActive:1}),n=!0;continue}const r={...s,name:a.name,email:a.email,password:a.password,role:a.role,branch:a.branch,isActive:1};JSON.stringify(r)!==JSON.stringify(s)&&(t.set(a.id,r),n=!0)}n&&A("staff",Array.from(t.values()).sort((a,s)=>a.id-s.id))}async function ua(){localStorage.getItem(X(Re))||(A("staff",Q),A("customers",[]),A("orders",[]),A("payments",[]),A("fold_logs",[]),A("expenses",[]),A("sales",[]),localStorage.getItem(X("services"))||A("services",z),localStorage.getItem(X("item_categories"))||A("item_categories",se),localStorage.getItem(X("machines"))||A("machines",Z),localStorage.getItem(X("subcleanings"))||A("subcleanings",[]),localStorage.getItem(X("settings"))||A("settings",he),localStorage.removeItem("laba101-mobile-session"),A(Re,!0))}async function bt(e){for(const t of Q){if(((await e.query("SELECT id FROM staff WHERE id = ?",[t.id])).values??[]).length>0){await e.run("UPDATE staff SET name = ?, email = ?, password = ?, role = ?, branch = ?, isActive = 1 WHERE id = ?",[t.name,t.email,t.password,t.role,t.branch,t.id]);continue}await e.run("INSERT INTO staff (id, name, email, password, role, branch, isActive) VALUES (?, ?, ?, ?, ?, ?, ?)",[t.id,t.name,t.email,t.password,t.role,t.branch,1])}}async function ma(e){if(!(((await e.query("SELECT COUNT(*) as count FROM machines")).values?.[0]?.count??0)>0))for(const n of Z)await e.run("INSERT INTO machines (id, machineName, machineType, status, branch) VALUES (?, ?, ?, ?, ?)",[n.id,n.machineName,n.machineType,n.status,n.branch])}async function va(e){for(const t of he)await e.run("INSERT OR IGNORE INTO settings (key, value) VALUES (?, ?)",[t.key,t.value])}async function Et(e){for(const t of z)((await e.query("SELECT id FROM laundry_services WHERE id = ?",[t.id])).values??[]).length>0||await e.run("INSERT INTO laundry_services (id, name, description, category, serviceType, price, maxKg, dryingMinutes, includes, additionalCharge, turnaroundHours, isActive) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",[t.id,t.name,t.description,t.category,t.serviceType,t.price,t.maxKg,t.dryingMinutes,JSON.stringify(t.includes),t.additionalCharge,t.turnaroundHours,t.isActive]);for(const t of se)((await e.query("SELECT id FROM item_categories WHERE id = ?",[t.id])).values??[]).length>0||await e.run("INSERT INTO item_categories (id, name, maxKg, additionalFee, isActive) VALUES (?, ?, ?, ?, ?)",[t.id,t.name,t.maxKg,t.additionalFee,t.isActive])}async function pa(e){((await e.query("SELECT value FROM settings WHERE key = ?",[Re])).values??[]).length>0||(await e.execute(`
  ...
  `),await bt(e),await Et(e),await ma(e),await va(e),await e.run("INSERT OR REPLACE INTO settings (key, value) VALUES (?, ?)",[Re,K()]),localStorage.removeItem("laba101-mobile-session"))}async function ya(){if(!R.isNativePlatform()){await ua(),!localStorage.getItem(X("seeded_v4"))&&!localStorage.getItem(X("services"))&&!localStorage.getItem(X("staff"))&&(A("staff",Q),A("customers",Oe),A("services",z),A("item_categories",se),A("orders",re),A("payments",pe),A("fold_logs",[]),A("expenses",ie),A("sales",ye),A("revolving_history",fe),A("machines",Z),A("subcleanings",[]),A("settings",he),A("seeded_v4",!0)),await ca(),da(),localStorage.getItem(X("seeded_v4"))||A("seeded_v4",!0);return}const e=await O();await e.execute(`
  ...
  `}function on(e=new Date){return{date:new Intl.DateTimeFormat("en-PH",{weekday:"long",month:"long",day:"numeric",year:"numeric"}).format(e),time:new Intl.DateTimeFormat("en-PH",{hour:"numeric",minute:"2-digit",second:"2-digit",hour12:!0}).format(e)}}function Ae(){const e=document.querySelector("[data-date-from]"),t=document.querySelector("[data-date-to]"),n=Array.from(document.querySelectorAll('input[name="reportType"]:checked')).map(a=>a.value).filter(a=>a==="sales"||a==="disbursement"||a==="fold_count"||a==="revolving_fund"||a==="summary");return{from:e?.value||"0000-01-01",to:t?.value||"9999-12-31",types:n.length?n:["summary"]}}function ue(e,t){return e>=t.from&&e<=t.to}function qt(e,t,n,a,s,r,i,o){const d=new Set(o.types),c=e.filter(h=>ue(G(h.createdAt),o)),u=n.filter(h=>ue(h.saleDate,o)),m=a.filter(h=>ue(h.expenseDate,o)),f=e.filter(h=>h.workflowCompleted.includes("fold")&&ue(an(h),o)),y=tn(f,r),E=new Map;t.filter(h=>ue(G(h.receivedAt),o)).forEach(h=>{const F=E.get(h.orderId)??{cash:0,gcash:0};h.method==="gcash"?F.gcash+=h.amount:F.cash+=h.amount,E.set(h.orderId,F)});const q=c.reduce((h,F)=>{const _=E.get(F.id);if(_){const te=_.cash+_.gcash;if(te>F.totalAmount){const de=F.totalAmount/te;return h+_.cash*de}return h+_.cash}return h+F.paidAmount},0),S=u.reduce((h,F)=>h+F.cashAmount,0),w=u.reduce((h,F)=>h+F.gcashAmount,0),p=c.reduce((h,F)=>{const _=E.get(F.id);if(_){const te=_.cash+_.gcash;if(te>F.totalAmount){const de=F.totalAmount/te;return h+_.gcash*de}return h+_.gcash}return h+0},0),g=q+S,N=p+w,$=g+N,x=m.reduce((h,F)=>h+F.amount,0),L=x,D=$-L,P=()=>({orderCashTotal:q,orderGcashTotal:p,manualCashTotal:S,manualGcashTotal:w,totalCash:g,totalGcash:N,totalSales:$,transactions:c.map(h=>{const F=E.get(h.id)??{cash:h.paidAmount,gcash:0},_=F.cash+F.gcash;let te=F.cash,de=F.gcash,Je=_;if(_>h.totalAmount){const ze=h.totalAmount/_;te=F.cash*ze,de=F.gcash*ze,Je=h.totalAmount}return{ticket:h.ticket,customer:h.customer,cash:te,gcash:de,total:Je}}),manualSales:u.map(h=>({cash:h.cashAmount,gcash:h.gcashAmount,total:h.totalAmount}))}),k=()=>({totalExpenses:x,totalDisbursement:L,rows:[["Date/Month","id#","Type","Name","Category","Description","Amount"],...m.map(h=>[Pt(h),h.number,ne(h),h.name,h.category??"",h.description??"",h.amount]),[],["Total Disbursement","","","","","",L]]}),M=()=>({rows:[["Staff","Fold Count"],...y.map(h=>[h.staffName,h.folds]),[],["Total Folds",y.reduce((h,F)=>h+F.folds,0)]]}),B=s.filter(h=>ue(G(h.createdAt),o));return{selection:o,selectedTypes:d,salesRows:P,disbursementRows:k,foldCountRows:M,revolvingDailySummaryRows:()=>({rows:[["Date of Sales","Cash on Hand","Status","Date Update"],...u.map(h=>{const F=Dt(h.saleDate,e,a,h.cashAmount),_=h.status==="revolving"?"Revolving":h.status==="endorsed"?`Endorsed to ${h.endorsedTo??""}`:"Pending";return[h.saleDate,F,_,h.statusUpdatedAt?G(h.statusUpdatedAt):""]})]}),revolvingHistoryRows:()=>({rows:[["Date","Number","Name","Amount","Category","Description","Type"],...B.map(h=>[G(h.createdAt),h.revolvingNumber,h.name,h.type==="disbursement"?-h.amount:h.amount,h.category,h.description??"",h.type==="add"?"Add Revolving Fund":"Disbursement"])]}),summaryRows:()=>{const h=P(),F=k();return[["Summary",o.from,"to",o.to],[],["Total Cash:","Total GCash:","Total Sales:"],["","",""],[h.totalCash,h.totalGcash,h.totalSales],["","",""],["Total Disbursement:","Total Profit:","Cash on Hand:"],["","",""],[F.totalDisbursement,D,qe(h.totalCash,F.totalDisbursement)]]},profit:D}}function cn(e,t){return`<button class="nav-link ${t?"is-active":""}" data-tab="${e}" type="button">
    <span class="nav-icon">${ln(e)}</span>
    <span>${Ye[e]}</span>
  </button>`}function I(e,t){return`<div class="section-head"><div><h2>${v(e)}</h2><p class="meta">${v(t)}</p></div></div>`}function pt(){return Ye[l.tab]??"Dashboard"}function ke(e){return(e?.name??"Laba101").trim().slice(0,1).toUpperCase()}function ln(e){return{dashboard:"DB",pos:"POS",orders:"PO",archived:"AR",customers:"CU",pricing:"PS",disbursements:"DR",reports:"RP",logs:"LG",inventory:"IN",maintenance:"MT",staff:"ST",revolving:"RV",settings:"SE"}[e]}async function Ft(){const e=await le(),t=await ba(e),n=await Ge(),a=await Ta(),s=await Ke(),r=await wa(),i=await Nt(),o=await be(e),d=await $a(),c=await Da(),u=await qa(),m=await _a(),f=await $t(e),y=await Qa(e),E=await Pa(e),q=await Rt(e),S=await Ga(e),w=await Wa(),p=await ga(),g=await St("report_email");return{branch:e,staff:t,allStaff:n,customers:a,services:s,allServices:r,categories:i,orders:o,payments:d,foldLogs:c,expenses:u,sales:m,machines:f,subcleanings:y,activityLogs:E,inventoryItems:q,inventoryMovements:S,revolvingHistory:w,foldRate:p,reportEmail:g??""}}async function b(){if(!l.currentUser){dn(),xn();return}const e=await Ft();e.orders.filter(d=>d.status!=="claimed").length,e.orders.filter(d=>d.status==="ready").length,e.orders.reduce((d,c)=>d+c.paidAmount,0);const t=j(),n=It(e.payments,e.orders,d=>d.branch===e.branch&&G(d.receivedAt)===t),a=n.gcash+e.sales.filter(d=>d.saleDate===t).reduce((d,c)=>d+c.gcashAmount,0),s=n.cash+e.sales.filter(d=>d.saleDate===t).reduce((d,c)=>d+c.cashAmount,0),r=s+a,i=e.expenses.filter(d=>ne(d)==="daily"&&d.expenseDate===t).reduce((d,c)=>d+c.amount,0),o=qe(s,i);e.sales.reduce((d,c)=>d+c.totalAmount,0),e.expenses.reduce((d,c)=>d+c.amount,0),Ve.innerHTML=`
    <div class="app-frame">
      <header class="topbar">
      ...
      <aside class="sidebar ${l.sidebarOpen?"is-open":""}">
        ...
        <nav>${Ut().map(d=>cn(d,l.tab===d)).join("")}</nav>
      ...
      <main class="workspace">
        ...
        ${l.tab==="dashboard"?mn({paidToday:r,cashPaidToday:s,gcashPaidToday:a,disbursementToday:i,cashOnHandToday:o,orders:e.orders,payments:e.payments,sales:e.sales}):""}
        ${l.tab==="pos"?pn(e.orders,e.customers,e.services,e.categories,e.payments,e.branch):""}
        ${l.tab==="orders"?yn(e.orders,e.staff,e.services,e.payments):""}
        ${l.tab==="archived"?fn(e.orders,e.staff,e.services,e.payments):""}
        ${l.tab==="customers"?Sn(e.customers,e.orders):""}
        ${l.tab==="pricing"?wn(e.allServices,e.categories):""}
        ${l.tab==="disbursements"?Nn(e.expenses,e.sales):""}
        ${l.tab==="reports"?An(e.orders,e.payments,e.sales,e.expenses,e.revolvingHistory,e.allStaff,e.foldRate):""}
        ${l.tab==="logs"?Ln(e.activityLogs):""}
        ${l.tab==="inventory"?Cn(e.inventoryItems,e.inventoryMovements,e.branch):""}
        ${l.tab==="maintenance"?$n(e.machines,e.subcleanings,e.branch):""}
        ${l.tab==="staff"?Rn(e.allStaff,e.branch):""}
        ${l.tab==="revolving"?Xn(e.sales,e.revolvingHistory,e.orders,e.expenses):""}
        ${l.tab==="settings"?On(e.branch,e.foldRate,e.reportEmail):""}
      </main>
    </div>
  `,Dn(),In(e),qn(e.allServices),Fn(e.expenses),Un(e.orders,e.payments,e.sales,e.expenses,e.revolvingHistory,e.allStaff,e.foldRate),kn(),Mn(),Bn(),_n(e.inventoryItems,e.branch),jn(e.allStaff),Gn(),Hn(),Pn()}function Ut(){if(l.currentUser?.role==="admin")return Object.keys(Ye);const e=["dashboard","pos","orders","archived","disbursements","reports","maintenance","revolving"];return nn(l.currentUser)?["dashboard","disbursements","reports","maintenance","revolving"]:sn(l.currentUser)?e.filter(t=>t!=="revolving"):e}function dn(){Ve.innerHTML=`
  ...
  `}function un(){document.querySelectorAll("[data-fill-email]").forEach(e=>{e.addEventListener("click",()=>{const t=document.querySelector('input[name="email"]'),n=document.querySelector('input[name="password"]');t&&(t.value=e.dataset.fillEmail??""),n&&(n.value=e.dataset.fillPassword??"")})})}function mn(e){const t=new Date,n=Array.from({length:7},(i,o)=>{const d=new Date(t);return d.setDate(t.getDate()-(6-o)),new Intl.DateTimeFormat("en-PH",{month:"short",day:"numeric"}).format(d)}),a=Array.from({length:7},(i,o)=>{const d=new Date(t);d.setDate(t.getDate()-(6-o));const c=oe(d),u=It(e.payments,e.orders,f=>G(f.receivedAt)===c).total,m=e.sales.filter(f=>f.saleDate===c).reduce((f,y)=>f+y.totalAmount,0);return u+m}),s=Math.max(1,...a),r=210;return`
    <section class="dashboard-main">
      <article class="panel revenue-panel">
        ${I("Revenue overview","Paid amount for the last 7 days.")}
        ...
        <div class="chart-shell">
          <div class="mini-chart revenue-chart">
            ${a.map((i,o)=>{const d=Math.max(12,Math.round(i/s*r));return`<div class="chart-bar ${o===a.length-1?"is-today":""}"><span style="height:${d}px"></span><strong>${T(i)}</strong></div>`}).join("")}
          </div>
      ...
      ${l.dashboardSummaryModalOpen?vn(e):""}
    </section>
  ...
  `}function pn(e,t,n,a,s,r){const i=n.filter(c=>c.serviceType==="order"&&c.isActive),o=n.filter(c=>c.serviceType==="addon"&&c.isActive),d=l.receiptOrderId?e.find(c=>c.id===l.receiptOrderId):null;return`
    <section class="grid content full">
      <article class="panel span-2">
        ${I("New POS order","Search for a customer or type a new name, pick services and confirm")}
        <form id="order-form" class="form">
          ...
          <fieldset class="check-grid">
            ...
            ${o.length?o.map(c=>`<div class="qty-card addon-quantity" data-qty-card="addonQty-${c.id}">
              <span><strong>${v(ae(c.name))}</strong><small>${T(c.price)} each</small></span>
              <div class="qty-control">
  ...
  `}function yn(e,t,n,a){const s=l.receiptOrderId?e.find(y=>y.id===l.receiptOrderId):null,r=e.filter(y=>y.status!=="claimed"),i=l.orderSearch.trim().toLowerCase(),o=l.orderDateFilter.trim(),d=l.orderPaymentFilter.trim().toLowerCase(),c=r.filter(y=>{const E=!i||[y.ticket,y.customer,y.phone,y.service,y.itemCategory,y.status].some(w=>String(w??"").toLowerCase().includes(i)),q=!o||G(y.createdAt)===o,S=!d||xe(y)===d;return E&&q&&S}),m=c.filter(y=>["unpaid","partial"].includes(xe(y))).reduce((y,E)=>y+Math.max(0,Number(E.balance||0)),0),f=c.length;return`
    <section class="grid content full">
      <article class="panel span-2">
        ${I("Order queue","Workflow, payment, and receipts")}
      ...
      ${l.paymentModalOrderId?hn(e.find(y=>y.id===l.paymentModalOrderId)):""}
    </section>
  `}function fn(e,t,n,a){const s=e.filter(d=>d.status==="claimed"),r=l.archivedOrderSearch.trim().toLowerCase(),i=s.filter(d=>r?[d.ticket,d.customer,d.phone,d.service,d.itemCategory].some(c=>String(c??"").toLowerCase().includes(r)):!0),o=l.receiptOrderId?e.find(d=>d.id===l.receiptOrderId):null;return`
    <section class="grid content full">
      <article class="panel span-2">
        ${I("Archived orders","All claimed orders are listed here")}
  ...
  `}function kt(e,t,n){const a=At(e,n),s=e.workflowCompleted.includes("claimed"),r=a.find(E=>!e.workflowCompleted.includes(E.key)),i=r?.key==="fold",o=xe(e),d=o==="unpaid"?"pending":o,c=e.extras.length?e.extras.map(E=>`${v(ae(E.name))} x${Number(E.quantity??1)}`).join(", "):"",u=l.currentUser?.role==="admin",m=e.status!=="claimed"&&e.paidAmount<=0,f=e.status!=="claimed"&&u&&e.paidAmount>0;let y=1;if(e.serviceLines){let E=0;e.serviceLines.forEach(q=>{const S=n.find(w=>w.id===q.id);S&&Array.isArray(S.includes)&&S.includes.includes("Fold")&&(E+=q.quantity)}),E>0&&(y=E)}return`
    <tr class="order-row-main">
      <td><strong>${v(e.ticket)}</strong><div class="small">${v(me(e.createdAt))}</div></td>
      <td>${v(e.customer)}<div class="small">${v(e.phone??"")}</div></td>
      <td>${v(e.service)}${c?`<div class="small">Extras: ${c}</div>`:""}</td>
      <td class="amount-cell payment-cell status-${o}"><strong>${T(e.totalAmount)}</strong><div class="payment-status">${v(d)}${o==="paid"?"":` &middot; Bal: ${T(e.balance)}`}</div></td>
      <td>
      <div class="row-actions">
        ${r?.key==="fold"?`<form class="inline-form advance-form flex-wrap" data-order-id="${e.id}">
          ${i?Array.from({length:y}).map((E,q)=>`<select name="assignedStaffId" required>
            <option value="">-- Staff ${y>1?`(Fold ${q+1})`:""}--</option>
            ${t.map(S=>`<option value="${S.id}">${v(S.name)}</option>`).join("")}
          </select>`).join(""):""}
    ...
    <div class="modal-backdrop" role="presentation">
      <div class="receipt-modal" role="dialog" aria-modal="true" aria-labelledby="payment-title">
        ...
        <div class="receipt" style="border: 1px solid var(--line); border-style: solid; box-shadow: none;">
          ...
          <p>Please settle the remaining balance of <strong>${T(e.balance)}</strong> for ticket <strong>${v(e.ticket)}</strong> before claiming.</p>
      ...
      <div class="receipt-modal" role="dialog" aria-modal="true" aria-labelledby="receipt-title">
        ...
        <div class="receipt" id="receipt-print-area">
          ...
          <div class="summary-list receipt-lines">
            ...
            ${e.extras.length?`<div><span>Extra services</span><strong>${e.extras.map(i=>`${v(ae(i.name))} x${Number(i.quantity??1)} (${T(Number(i.total??i.price))})`).join(", ")}</strong></div>`:""}
  ...
  `}async function yt(){l.printerLoading=!0,l.printerError="",l.printerStatus="",await b();try{if(!(await ge.requestBluetoothPermissions()).granted)throw new Error("Bluetooth permission was not granted.");const t=await ge.listPairedPrinters();l.pairedPrinters=t.printers??[],l.selectedPrinterAddress=l.selectedPrinterAddress||t.savedAddress||l.pairedPrinters[0]?.address||"",l.printerStatus=l.pairedPrinters.length?"Select a printer, then connect.":"No paired printers found. Pair the printer in Android Bluetooth settings first."}catch(e){l.printerError=e instanceof Error?e.message:"Could not scan paired printers."}finally{l.printerLoading=!1,await b()}}async function bn(){if(!l.selectedPrinterAddress){l.printerError="Select a paired printer first.",await b();return}l.printerLoading=!0,l.printerError="",l.printerStatus="",await b();try{await ge.savePrinter({address:l.selectedPrinterAddress}),await ge.connect({address:l.selectedPrinterAddress}),l.printerStatus="Printer connected and saved."}catch(e){l.printerError=e instanceof Error?e.message:"Printer connection failed."}finally{l.printerLoading=!1,await b()}}function En(e){const t=(e.serviceLines?.length?e.serviceLines:[{id:e.serviceId,name:e.service,price:e.price,quantity:1,total:e.price}]).map(a=>({name:a.name,quantity:Number(a.quantity||1),price:Number(a.price||0)})),n=e.extras.map(a=>({name:ae(a.name),quantity:Number(a.quantity??1),price:Number(a.price||0)}));return[...t,...n]}async function Tn(e,t){const n=t.reduce((s,r)=>s+Number(r.amount),0),a=Math.max(0,Number((n-e.totalAmount).toFixed(2)));l.printerLoading=!0,l.printerError="",l.printerStatus="",await b();try{if(!l.selectedPrinterAddress){const s=await ge.getSavedPrinter();l.selectedPrinterAddress=s.address||""}await ge.printReceipt({address:l.selectedPrinterAddress||void 0,paperWidth:l.printerPaperWidth,storeName:"Laba101",receiptNumber:e.ticket,dateTime:me(e.createdAt),customerName:e.customer,customerPhone:e.phone?.trim()||"No phone",items:En(e),totalAmount:e.totalAmount,paidAmount:e.paidAmount,changeAmount:a,balanceAmount:e.balance,staffName:l.currentUser?.name?.trim()||"Staff"}),l.printerStatus="Receipt sent to printer."}catch(s){l.printerPanelOpen=!0,l.printerError=s instanceof Error?s.message:"Bluetooth thermal print failed."}finally{l.printerLoading=!1,await b()}}function Sn(e,t){const n=l.customerSearch.trim().toLowerCase(),a=e.filter(s=>n?s.name.toLowerCase().includes(n):!1);return`
    <section class="grid content full">
      <article class="panel">
        ${I("Customer Management","Customer records from local offline storage")}
      ...
      <article class="panel">
        ${I("Customer list","Names, phones, addresses, and order history")}
  ...
  `}function wn(e,t){const n=e.filter(s=>s.serviceType==="order"),a=e.filter(s=>s.serviceType==="addon");return`
    <section class="grid content full">
      <article class="panel">
        ${I("Services","Order services and add-ons used by POS pricing")}
        <form id="service-form" class="form">
          ...
          <fieldset class="check-grid">
            ...
            ${Za.map(s=>`<label class="check"><input type="checkbox" name="includes" value="${s}" /> ${s}</label>`).join("")}
          </fieldset>
      ...
      <article class="panel">
        ${I("Item categories","Load limits and extra fees")}
      ...
      <article class="panel span-2">
        ${I("Services Table","Order services")}
        <div class="table-scroll">
        ...
        <div class="table-scroll">
          <div class="table data-table extra-services-table">
            ...
            ${a.map(s=>`<div class="table-row"><div><strong>${v(s.name)}</strong></div><div>${v(s.category)}</div><div>${T(s.price)}</div><div>${v(s.includes.join(", ")||"none")}</div><div>${s.isActive?"Active":"Inactive"}</div><div class="row-actions"><button class="secondary edit-service-btn" data-id="${s.id}">Edit</button>${s.isActive?`<button class="secondary deactivate-service-btn" data-id="${s.id}">Deactivate</button>`:`<button class="secondary activate-service-btn" data-id="${s.id}">Activate</button>`}</div></div>`).join("")||'<div class="helper">No extra services yet.</div>'}
          </div>
        </div>
      </article>
    </section>
  `}function Nn(e,t){const n=j(),a=n.slice(0,7),s=l.currentUser?.role==="admin",r=Array.from(new Set([...en,...e.map(m=>m.category).filter(Boolean)])),i=e.filter(m=>ne(m)==="daily"&&m.expenseDate===n).reduce((m,f)=>m+f.amount,0),o=e.filter(m=>ne(m)==="monthly"&&m.expenseDate.startsWith(a)).reduce((m,f)=>m+f.amount,0),d=t.filter(m=>m.saleDate===n).reduce((m,f)=>m+f.totalAmount,0),c=t.filter(m=>m.saleDate.startsWith(a)).reduce((m,f)=>m+f.totalAmount,0),u=[...e].sort((m,f)=>vt(f.number)-vt(m.number)||f.id-m.id);return`
    ...
    <section class="grid stats compact report-stats">
      ...
      <div class="panel stat"><div class="card-label">Today sales input</div><div class="value">${T(d)}</div></div>
      <div class="panel stat"><div class="card-label">Month sales input</div><div class="value">${T(c)}</div></div>
    </section>
    ${l.dailyReportTab==="expenses"?`
    <section class="grid content full">
      <article class="panel">
        ${I("Input disbursement","Supplies, utilities, and cash disbursements")}
      ...
      <article class="panel">
        ${I("Disbursement list","Expenses only")}
        ${ee(["Date/Month","No.","Type","Name","Category","Amount","Action"],u.map(m=>[`<strong>${v(Pt(m))}</strong>`,v(m.number),v(ne(m)),v(m.name),v(m.category),T(m.amount),`<div class="row-actions"><button class="secondary edit-expense-btn" data-id="${m.id}" type="button">Edit</button>${s?`<button class="secondary delete-expense-btn" data-id="${m.id}" type="button">Delete</button>`:""}</div>`]),"data-table orders-data-table app-record-table disbursement-list-table")}
      </article>
    </section>
    `:`
    <section class="grid content full">
      <article class="panel">
        ${I("Input total sale","Manual cash and GCash totals")}
      ...
      <article class="panel">
        ${I("Daily sales history","Cash, GCash, total sale, notes, and updates")}
        <div class="table-scroll daily-report-scroll">
          <div class="table wide-table daily-report-table">
            ...
            ${t.map(m=>`<div class="table-row"><div>${v(m.saleNumber)}</div><div>${v(m.saleDate)}</div><div>${T(m.cashAmount)}</div><div>${T(m.gcashAmount)}</div><div><strong>${T(m.totalAmount)}</strong></div><div class="row-actions"><button class="secondary edit-sale-btn" data-id="${m.id}" type="button">Edit</button>${s?`<button class="secondary delete-sale-btn" data-id="${m.id}" type="button">Delete</button>`:""}</div></div>`).join("")||'<div class="helper">No daily sales totals yet.</div>'}
          </div>
        </div>
      </article>
    </section>
    `}
  `}function An(e,t,n,a,s,r,i,o,d,c){const u=l.reportPreview?qt(e,t,n,a,s,r,i,l.reportPreview):null;return`
    <section class="page-head">
      <div>
    ...
    ${u?`
      <section class="panel report-preview">
        ${u.selectedTypes.has("sales")?`
          <article>
            ${I("Sales report preview",`${u.selection.from} to ${u.selection.to}`)}
            <div class="table wide-table report-preview-table sales-table">
              ...
              ${u.salesRows().transactions.map(m=>`<div class="table-row report-table-row"><div>${v(m.ticket)}</div><div>${v(m.customer)}</div><div>${T(m.cash)}</div><div>${T(m.gcash)}</div><div>${T(m.total)}</div></div>`).join("")}
            </div>
        ...
        ${u.selectedTypes.has("disbursement")?`
          <article>
            ${I("Disbursement preview",`${u.selection.from} to ${u.selection.to}`)}
            <div class="table wide-table report-preview-table report-disbursement-table">
              ...
              ${u.disbursementRows().rows.slice(1).filter(m=>m.length&&m[0]!=="Total Disbursement").map(m=>`<div class="table-row report-table-row"><div>${v(m[1]??"")}</div><div>${v(m[0]??"")}</div><div>${v(m[2]??"")}</div><div>${v(m[3]??"")}</div><div>${v(m[4]??"")}</div><div>${T(m[6])}</div></div>`).join("")}
            </div>
        ...
        ${u.selectedTypes.has("fold_count")?`
          <article>
            ${I("Fold Count preview",`${u.selection.from} to ${u.selection.to}`)}
        ...
        ${u.selectedTypes.has("revolving_fund")?`
          <article>
            ${I("Revolving Fund — Daily Summary",`${u.selection.from} to ${u.selection.to}`)}
          ...
          <article>
            ${I("Revolving Fund — Table History",`${u.selection.from} to ${u.selection.to}`)}
        ...
        ${u.selectedTypes.has("summary")?`
          <article>
            ${I("Summary preview",`${u.selection.from} to ${u.selection.to}`)}
            <div class="summary-cards-grid summary-single-row">
              ...
              <div class="summary-card"><span class="card-label">Cash on Hand</span><strong>${T(qe(u.salesRows().totalCash,u.disbursementRows().totalDisbursement))}</strong></div>
            </div>
          </article>`:""}
      </section>
    `:""}
  `}function Ln(e){return`
    <section class="grid content full">
      <article class="panel span-2">
        ${I("Activity Logs","Recorded staff actions and timestamps")}
  ...
  `}function Cn(e,t,n){return`
    <section class="grid content full">
      <article class="panel">
        ${I("Inventory Item","Custom stocks and supplies")}
      ...
      <article class="panel span-2">
        ${I("Stock List","Editable branch inventory")}
      ...
      <article class="panel">
        ${I("Stock In / Stock Out","Adjust inventory quantities")}
      ...
      <article class="panel span-2">
        ${I("Stock Movement History","Recent stock-in and stock-out records")}
  ...
  `}function $n(e,t,n){const a=e.filter(u=>u.status!=="under_cleaning"),s=e.filter(u=>u.status==="under_cleaning"),r=new Date,i=new Date(r.getFullYear(),r.getMonth(),1);i.setDate(i.getDate()-i.getDay());const o=Array.from({length:35},(u,m)=>{const f=new Date(i);f.setDate(i.getDate()+m);const y=oe(f),E=t.filter(q=>q.date===y);return{key:y,date:f,records:E,isCurrentMonth:f.getMonth()===r.getMonth(),isToday:y===j()}}),d=new Intl.DateTimeFormat("en-PH",{month:"long",year:"numeric"}).format(r),c=t.some(u=>u.date===j()&&u.cleaningType==="general");return`
    <section class="page-head">
      <div>
    ...
    <section class="grid content full">
      <article class="panel">
        ${I("Available Machines","Select machines to start cleaning.")}
      ...
      <article class="panel">
        ${I("General Cleaning","Confirm general cleaning for today")}
        <div class="summary-list">
      ...
      <article class="panel warning-panel">
        ${I("Under Cleaning","Machines currently being serviced.")}
      ...
      <article class="panel span-2">
        ${I("Tube Cleaning Checklist","Track which machines have been cleaned today.")}
    ...
    <section class="grid content full">
      <article class="panel">
        ${I("Add Machine","Create washer and dryer records")}
      ...
      <article class="panel">
        ${I("Machines","Washer and dryer status")}
        <div class="table">
  ...
  `}function On(e,t,n){return`
    <section class="grid content full">
      <article class="panel">
        ${I("Settings","Device-local configuration")}
  ...
  `}function Dn(){const e=()=>{localStorage.removeItem(Se),l.currentUser=null,l.tab="dashboard",l.receiptOrderId=0,l.sidebarOpen=!1,b()};document.querySelector("#logout-button")?.addEventListener("click",e),document.querySelector("#mobile-logout-button")?.addEventListener("click",e),document.querySelector("#mobile-menu-button")?.addEventListener("click",()=>{l.sidebarOpen=!0,b()}),document.querySelector("#sidebar-close-button")?.addEventListener("click",()=>{l.sidebarOpen=!1,b()}),document.querySelector("#sidebar-backdrop")?.addEventListener("click",()=>{l.sidebarOpen=!1,b()}),document.querySelectorAll("[data-tab]").forEach(t=>{t.addEventListener("click",()=>{l.tab=t.dataset.tab,l.receiptOrderId=0,l.sidebarOpen=!1,b()})}),document.querySelectorAll("[data-quick-tab]").forEach(t=>{t.addEventListener("click",()=>{l.tab=t.dataset.quickTab,b()})}),document.querySelectorAll("[data-receipt]").forEach(t=>{t.addEventListener("click",()=>{l.receiptOrderId=Number(t.dataset.receipt),l.printerPanelOpen=!1,l.printerError="",l.printerStatus="",b()})}),document.querySelector("[data-close-receipt]")?.addEventListener("click",()=>{l.receiptOrderId=0,b()}),document.querySelector("[data-open-printer-panel]")?.addEventListener("click",()=>{l.printerPanelOpen=!l.printerPanelOpen,l.printerPanelOpen&&l.pairedPrinters.length===0?yt():b()}),document.querySelector("[data-refresh-printers]")?.addEventListener("click",()=>{yt()}),document.querySelector("[data-printer-select]")?.addEventListener("change",t=>{l.selectedPrinterAddress=t.currentTarget.value,b()}),document.querySelector("[data-paper-width]")?.addEventListener("change",t=>{l.printerPaperWidth=Number(t.currentTarget.value)===80?80:58,b()}),document.querySelector("[data-connect-printer]")?.addEventListener("click",()=>{bn()}),document.querySelector("[data-thermal-print]")?.addEventListener("click",()=>{(async()=>{const t=await Ft(),n=t.orders.find(s=>s.id===l.receiptOrderId);if(!n)throw new Error("Receipt order not found.");const a=t.payments.filter(s=>s.orderId===n.id);await Tn(n,a)})().catch(t=>{l.printerPanelOpen=!0,l.printerError=t instanceof Error?t.message:"Bluetooth thermal print failed.",b()})}),document.querySelector("[data-open-daily-summary]")?.addEventListener("click",()=>{l.dashboardSummaryModalOpen=!0,b()}),document.querySelector("[data-close-daily-summary]")?.addEventListener("click",()=>{l.dashboardSummaryModalOpen=!1,b()}),document.querySelector("[data-print-modal]")?.addEventListener("click",()=>{window.print()}),document.querySelectorAll("[data-report-tab]").forEach(t=>{t.addEventListener("click",()=>{l.dailyReportTab=t.dataset.reportTab,b()})}),document.querySelectorAll("[data-maintenance-tab]").forEach(t=>{t.addEventListener("click",()=>{l.maintenanceTab=t.dataset.maintenanceTab,b()})})}function xn(){un(),document.querySelector("#login-form")?.addEventListener("submit",async e=>{e.preventDefault();const t=new FormData(e.currentTarget),n=document.querySelector("#login-button");n&&(n.disabled=!0,n.textContent="Signing in...");try{const a=await wt(String(t.get("email")??""),String(t.get("password")??""));if(!a){l.loginError="Invalid email or password.",await b();return}l.currentUser=a,l.loginError="",await Le("branch",String(a.branch||"Main Store")),t.get("remember")?localStorage.setItem(Se,JSON.stringify({email:a.email,remembered:!0})):localStorage.removeItem(Se),Ut().includes(l.tab)||(l.tab="dashboard"),await b()}catch(a){alert("Login Error: "+String(a?.message||a)),n&&(n.disabled=!1,n.textContent="Sign in")}})}function Pn(){Ne&&window.clearInterval(Ne);const e=document.querySelector("[data-navbar-time]"),t=document.querySelector("[data-navbar-date]");if(!e||!t){Ne=void 0;return}const n=()=>{const a=on();e.textContent=a.time,t.textContent=a.date};n(),Ne=window.setInterval(n,1e3)}function ft(e,t){return e?t.find(n=>n.name.toLowerCase()===e.category.toLowerCase())??t.find(n=>n.name==="Regular Clothes")??t[0]??null:null}function Me(e,t){return Math.max(1,Number(t.maxKg||e.maxKg||1))}function Mt(e,t){return Object.fromEntries(t.filter(n=>n.serviceType==="order").map(n=>[n.id,Number(e.querySelector(`input[name="serviceQty-${n.id}"]`)?.value??0)]).filter(([,n])=>Number(n)>0))}function ht(e,t){const n=Mt(e,t);return t.filter(a=>a.serviceType==="order"&&Number(n[a.id]??0)>0).map(a=>({...a,quantity:Number(n[a.id])}))}function Bt(e,t){return Object.fromEntries(t.filter(n=>n.serviceType==="addon").map(n=>[n.id,Number(e.querySelector(`input[name="addonQty-${n.id}"]`)?.value??0)]).filter(([,n])=>Number(n)>0))}function gt(e,t){const n=Bt(e,t);return t.filter(a=>a.serviceType==="addon"&&Number(n[a.id]??0)>0).map(a=>({...a,quantity:Number(n[a.id])}))}function In(e){const t=document.querySelector("#order-form"),n=document.querySelector("#price-preview"),a=t?.querySelector('button[type="submit"]'),s=document.querySelector("#customer-name-input"),r=document.querySelector("#customer-id-input"),i=document.querySelector("#customer-phone-input"),o=document.querySelector("#customer-suggestions"),d=t?.querySelector("[data-order-error]"),c=t?.querySelector('select[name="paymentMethod"]'),u=t?.querySelector(".gcash-reference"),m=t?.querySelector('input[name="paymentReference"]');let f=!1,y;const E=p=>{if(!o||!s)return;const g=p.trim().toLowerCase();if(!g){o.hidden=!0;return}const N=e.customers.filter(L=>L.name.toLowerCase().includes(g)||(L.phone??"").includes(g)).slice(0,8),$=`<div class="ac-item ac-add" data-ac-new="true"><strong>+ Add new: "${v(p.trim())}"</strong></div>`,x=N.map(L=>`<div class="ac-item" data-ac-id="${L.id}" data-ac-name="${v(L.name)}" data-ac-phone="${v(L.phone??"")}"><strong>${v(L.name)}</strong>${L.phone?`<span>${v(L.phone)}</span>`:""}</div>`).join("");o.innerHTML=x+$,o.hidden=!1};s?.addEventListener("input",()=>{r&&(r.value=""),clearTimeout(y),y=window.setTimeout(()=>E(s.value),150)}),s?.addEventListener("focus",()=>{s.value.trim()&&E(s.value)}),o?.addEventListener("click",p=>{const g=p.target.closest(".ac-item");g&&(g.dataset.acNew==="true"?r&&(r.value=""):(s&&(s.value=g.dataset.acName??""),i&&(i.value=g.dataset.acPhone??""),r&&(r.value=g.dataset.acId??"")),o&&(o.hidden=!0))}),document.addEventListener("click",p=>{o&&!o.contains(p.target)&&p.target!==s&&(o.hidden=!0)});const q=()=>{const p=c?.value==="gcash";u&&(u.hidden=!p),m&&(m.required=p,p||(m.value=""))},S=(p,g)=>{if(!t)return;const N=t.querySelector(`input[name="${p}"]`);N&&(N.value=String(Math.max(0,Number(N.value||0)+g)),N.closest(".qty-card")?.classList.toggle("is-selected",Number(N.value)>0),N.dispatchEvent(new Event("input",{bubbles:!0})))};t?.querySelectorAll(".qty-control input").forEach(p=>{p.addEventListener("input",()=>{p.value=String(Math.max(0,Number(p.value||0))),p.closest(".qty-card")?.classList.toggle("is-selected",Number(p.value)>0)})}),t?.querySelectorAll("[data-qty-card]").forEach(p=>{p.addEventListener("click",g=>{const N=g.target;N.closest("input")||N.closest("button")||S(p.dataset.qtyCard??"",1)})}),t?.querySelectorAll("[data-qty-plus]").forEach(p=>{p.addEventListener("click",()=>S(p.dataset.qtyPlus??"",1))}),t?.querySelectorAll("[data-qty-minus]").forEach(p=>{p.addEventListener("click",()=>S(p.dataset.qtyMinus??"",-1))});const w=()=>{if(!t||!n)return;const p=ht(t,e.services),g=p[0],N=ft(g,e.categories),$=gt(t,e.services),x=p.length>0&&g&&N,L=$.length>0;if(!x&&!L){a&&(a.disabled=!0),d&&(d.hidden=!f,d.textContent=f?"Please select at least one service or extra service.":""),n.innerHTML='<div class="preview-total"><span>Total amount</span><strong>PHP 0.00</strong></div>';return}if(x){const D=Ce(p,N,Me(g,N),$),P=D.serviceLines.map(M=>`${M.name} x${M.quantity}`),k=D.extras.map(M=>`${ae(M.name)} x${M.quantity}`);a&&(a.disabled=!1),d&&(d.hidden=!0,d.textContent=""),n.classList.remove("has-error"),n.innerHTML=`
        <div class="preview-line"><span>Services${P.length?` (${v(P.join(", "))})`:""}</span><strong>${T(D.price)}</strong></div>
        ${D.extraServiceAmount>0?`<div class="preview-line"><span>Extra services${k.length?` (${v(k.join(", "))})`:""}</span><strong>${T(D.extraServiceAmount)}</strong></div>`:""}
        <div class="preview-total"><span>Total amount</span><strong>${T(D.totalAmount)}</strong></div>
      `}else{const D=$.reduce((k,M)=>k+M.price*(M.quantity??1),0),P=$.map(k=>`${ae(k.name)} x${k.quantity??1}`);a&&(a.disabled=!1),d&&(d.hidden=!0,d.textContent=""),n.classList.remove("has-error"),n.innerHTML=`
        <div class="preview-line"><span>Extra services (${v(P.join(", "))})</span><strong>${T(D)}</strong></div>
        <div class="preview-total"><span>Total amount</span><strong>${T(D)}</strong></div>
      `}};c?.addEventListener("change",q),q(),t?.addEventListener("input",w),t?.addEventListener("change",w),w(),t?.addEventListener("submit",async p=>{p.preventDefault(),f=!0;const g=new FormData(t),N=ht(t,e.services),$=N[0],x=ft($,e.categories),L=gt(t,e.services),D=N.length>0&&$&&x,P=L.length>0;if(!D&&!P){d&&(d.hidden=!1,d.textContent="Please select at least one service or extra service.");return}const k=N.map(B=>`${B.name} x${B.quantity}`).join(", "),M=D?Ce(N,x,Me($,x),L):Ce([],e.categories[0],1,L);if(confirm(`Save this order?

Services: ${k}
Total: ${T(M.totalAmount)}`))try{const B=await La({customerId:Number(g.get("customerId"))||void 0,customerName:String(g.get("customerName")??""),customerPhone:String(g.get("customerPhone")??"")||null,serviceQuantities:Mt(t,e.services),branch:e.branch,itemCategoryId:x?.id??e.categories[0].id,weightKg:$&&x?Me($,x):1,addonQuantities:Bt(t,e.services),paidAmount:Number(g.get("paidAmount")??0),paymentMethod:String(g.get("paymentMethod")??"cash"),paymentReference:String(g.get("paymentReference")??"")||null,notes:String(g.get("notes")??"")||null});await Y("Create order",`${B.ticket} ${T(B.totalAmount)}`),l.receiptOrderId=B.id,await b()}catch(B){d&&(d.hidden=!1,d.textContent=B instanceof Error?B.message:"Order could not be saved.")}}),document.querySelectorAll(".advance-form").forEach(p=>{p.addEventListener("submit",async g=>{g.preventDefault();const N=Number(p.dataset.orderId),$=p.dataset.action==="claim",x=Number(p.dataset.balance||0);if($&&x>0){alert("Please complete the balance before claiming this order.");return}const L=new FormData(p),D=L.getAll("assignedStaffId").map(Number).filter(M=>M>0),P=Number(L.get("releasedBy")||0),k=D.length>0?D:P>0?P:null;await lt(N,k),await Y($?"Claim order":"Advance order",`Order ID ${N}`),await b()})}),document.querySelectorAll(".claim-payment-form").forEach(p=>{const g=p.querySelector('select[name="method"]'),N=p.querySelector('input[name="reference"]'),$=()=>{const x=g?.value==="gcash";N&&(N.closest("label").hidden=!x,N.required=x,x||(N.value=""))};g?.addEventListener("change",$),$(),p.addEventListener("submit",async x=>{x.preventDefault();const L=new FormData(p),D=Number(L.get("amount"));if(D<=0)return;const P=Number(p.dataset.orderId);await _e(P,{amount:D,method:String(L.get("method")),reference:String(L.get("reference")??"")||null}),await lt(P,null),l.paymentModalOrderId=0,await b()})}),document.querySelectorAll("[data-close-payment-modal]").forEach(p=>{p.addEventListener("click",async()=>{l.paymentModalOrderId=0,await b()})}),document.querySelectorAll(".payment-form").forEach(p=>{const g=p.querySelector('select[name="method"]'),N=p.querySelector('input[name="reference"]'),$=()=>{const x=g?.value==="gcash";N&&(N.hidden=!x,N.required=x,x||(N.value=""))};g?.addEventListener("change",$),$(),p.addEventListener("submit",async x=>{x.preventDefault();const L=new FormData(p),D=Number(L.get("amount")),P=String(L.get("method")),k=String(L.get("reference")??"")||null;confirm(`Confirm payment of ${T(D)} via ${P.toUpperCase()}?`)&&(await _e(Number(p.dataset.orderId),{amount:D,method:P,reference:k}),await Y("Record payment",`${T(D)} ${P.toUpperCase()} for order ID ${p.dataset.orderId}`),await b())})}),document.querySelectorAll("[data-cancel-order]").forEach(p=>{p.addEventListener("click",async()=>{const g=Number(p.dataset.cancelOrder);if(Number.isFinite(g)&&confirm("Cancel this order? (No payment will be refunded.)"))try{l.receiptOrderId===g&&(l.receiptOrderId=0),await Ra(g),await Y("Cancel order",`Order ID ${g}`),await b()}catch(N){alert(N instanceof Error?N.message:"Cancel failed.")}})}),document.querySelectorAll("[data-delete-order]").forEach(p=>{p.addEventListener("click",async()=>{const g=Number(p.dataset.deleteOrder);if(Number.isFinite(g)&&confirm("Delete this paid order and update sales?"))try{l.receiptOrderId===g&&(l.receiptOrderId=0),await Oa(g),await b()}catch(N){alert(N instanceof Error?N.message:"Delete failed.")}})})}function qn(e){document.querySelector("#service-form")?.addEventListener("submit",async t=>{t.preventDefault();const n=new FormData(t.currentTarget),a=n.get("id")?Number(n.get("id")):void 0;await ct({id:a,name:String(n.get("name")??""),description:String(n.get("description")??"")||null,category:String(n.get("category")??""),serviceType:String(n.get("serviceType")??"order"),price:Number(n.get("price")??0),maxKg:Number(n.get("maxKg")??0),dryingMinutes:Number(n.get("dryingMinutes"))||null,includes:n.getAll("includes").map(String).filter(Boolean),additionalCharge:0,turnaroundHours:Number(n.get("turnaroundHours")??24),isActive:1}),await b()}),document.querySelectorAll(".edit-service-btn").forEach(t=>{t.addEventListener("click",()=>{const n=Number(t.dataset.id),a=e.find(r=>r.id===n),s=document.querySelector("#service-form");a&&s&&(s.querySelector("[name=id]").value=String(a.id),s.querySelector("[name=name]").value=a.name,s.querySelector("[name=category]").value=a.category,s.querySelector("[name=serviceType]").value=a.serviceType,s.querySelector("[name=price]").value=String(a.price),s.querySelector("[name=maxKg]").value=String(a.maxKg),s.querySelector("[name=dryingMinutes]").value=a.dryingMinutes?String(a.dryingMinutes):"",s.querySelectorAll('input[name="includes"]').forEach(r=>{r.checked=a.includes.includes(r.value)}),s.querySelector("[name=turnaroundHours]").value=String(a.turnaroundHours),s.querySelector("[name=description]").value=a.description??"",window.scrollTo({top:0,behavior:"smooth"}))})}),document.querySelectorAll(".deactivate-service-btn, .activate-service-btn").forEach(t=>{t.addEventListener("click",async()=>{const n=Number(t.dataset.id),a=e.find(s=>s.id===n);if(a){const s=a.isActive?0:1;await ct({id:a.id,name:a.name,description:a.description,category:a.category,serviceType:a.serviceType,price:a.price,maxKg:a.maxKg,dryingMinutes:a.dryingMinutes,includes:a.includes,additionalCharge:a.additionalCharge,turnaroundHours:a.turnaroundHours,isActive:s}),await b()}})}),document.querySelector("#category-form")?.addEventListener("submit",async t=>{t.preventDefault();const n=new FormData(t.currentTarget);await Na({name:String(n.get("name")??""),maxKg:Number(n.get("maxKg")??0),additionalFee:Number(n.get("additionalFee")??0),isActive:1}),await b()})}function Fn(e){const t=document.querySelector("#expense-form"),n=t?.querySelector('input[name="disbursementType"]'),a=t?.querySelector(".expense-date-field"),s=t?.querySelector(".expense-month-field"),r=t?.querySelector('input[name="expenseDate"]'),i=t?.querySelector('input[name="expenseMonth"]'),o=d=>{!t||!n||!r||!i||(n.value=d,t.querySelectorAll("[data-expense-type]").forEach(c=>{c.classList.toggle("is-active",c.dataset.expenseType===d)}),a&&(a.hidden=d==="monthly"),s&&(s.hidden=d!=="monthly"),r.required=d==="daily",i.required=d==="monthly",d==="monthly"&&!i.value&&(i.value=je()),d==="daily"&&!r.value&&(r.value=j()))};t?.querySelectorAll("[data-expense-type]").forEach(d=>{d.addEventListener("click",()=>o(d.dataset.expenseType==="monthly"?"monthly":"daily"))}),o("daily"),t?.addEventListener("submit",async d=>{d.preventDefault();const c=new FormData(d.currentTarget),u=Number(c.get("id")||0),m=String(c.get("disbursementType")??"daily")==="monthly"?"monthly":"daily",f=String(c.get("expenseMonth")??je()),y={expenseDate:m==="monthly"?`${f}-01`:String(c.get("expenseDate")??""),disbursementType:m,name:String(c.get("name")??""),category:String(c.get("category")??""),description:String(c.get("description")??""),amount:Number(c.get("amount")??0)};if(m==="daily"&&y.expenseDate!==j()){const E=prompt("Admin password is required for non-today disbursement dates.");if(!E||!await rn(E)){alert("Admin password is incorrect. Disbursement was not saved.");return}}u?await Ma(u,y):await ka(y),await Y(u?"Update disbursement":"Create disbursement",`${y.expenseDate} ${y.name} ${T(y.amount)}`),await b()}),document.querySelectorAll(".edit-expense-btn").forEach(d=>{d.addEventListener("click",()=>{const c=e.find(m=>m.id===Number(d.dataset.id));if(!c||!t)return;t.querySelector("[name=id]").value=String(c.id),t.querySelector("[name=expenseDate]").value=c.expenseDate,t.querySelector("[name=expenseMonth]").value=xt(c.expenseDate),o(ne(c)),t.querySelector("[name=amount]").value=String(c.amount),t.querySelector("[name=name]").value=c.name,t.querySelector("[name=category]").value=c.category,t.querySelector("[name=description]").value=c.description??"";const u=t.querySelector('button[type="submit"]');u&&(u.textContent="Update expense"),t.scrollIntoView({behavior:"smooth",block:"start"})})}),document.querySelectorAll(".delete-expense-btn").forEach(d=>{d.addEventListener("click",async()=>{if(l.currentUser?.role!=="admin")return;const c=Number(d.dataset.id);!Number.isFinite(c)||!confirm("Delete this disbursement?")||(await Ba(c),await b())})}),document.querySelector("#fold-form")?.addEventListener("submit",async d=>{d.preventDefault();const c=new FormData(d.currentTarget);await xa({orderTicket:String(c.get("orderTicket")??""),staffName:String(c.get("staffName")??""),foldCount:Number(c.get("foldCount")??1),rate:Number(c.get("rate")??5)}),await b()})}function Un(e,t,n,a,s,r,i){document.querySelector("#generate-report")?.addEventListener("click",()=>{l.reportPreview=Ae(),b()});const o=document.querySelector("#sales-form");o?.addEventListener("submit",async S=>{S.preventDefault();const w=new FormData(S.currentTarget);await ja({id:Number(w.get("id")||0)||void 0,saleDate:String(w.get("saleDate")??""),cashAmount:Number(w.get("cashAmount")??0),gcashAmount:Number(w.get("gcashAmount")??0),notes:String(w.get("notes")??"")}),await b()}),document.querySelectorAll(".edit-sale-btn").forEach(S=>{S.addEventListener("click",()=>{const w=n.find(g=>g.id===Number(S.dataset.id));if(!w||!o)return;o.querySelector("[name=id]").value=String(w.id),o.querySelector("[name=saleDate]").value=w.saleDate,o.querySelector("[name=cashAmount]").value=String(w.cashAmount),o.querySelector("[name=gcashAmount]").value=String(w.gcashAmount),o.querySelector("[name=notes]").value=w.notes??"";const p=o.querySelector('button[type="submit"]');p&&(p.textContent="Update daily sale"),o.scrollIntoView({behavior:"smooth",block:"start"})})}),document.querySelectorAll(".delete-sale-btn").forEach(S=>{S.addEventListener("click",async()=>{if(l.currentUser?.role!=="admin")return;const w=Number(S.dataset.id);!Number.isFinite(w)||!confirm("Delete this daily sale?")||(await Ha(w),await b())})});const d=document.querySelector("[data-date-from]"),c=document.querySelector("[data-date-to]"),u=document.querySelector('[data-date-scope][value="custom"]');d&&u&&d.addEventListener("change",()=>u.checked=!0),c&&u&&c.addEventListener("change",()=>u.checked=!0),document.querySelectorAll("[data-date-scope]").forEach(S=>{S.addEventListener("change",()=>{if(!S.checked||!d||!c)return;const w=new Date,p=oe(w),g=new Date(w);S.value==="week"&&g.setDate(w.getDate()-6),S.value==="month"&&g.setDate(1),S.value!=="custom"&&(d.value=S.value==="today"?p:oe(g),c.value=p)})});const m=S=>{const w=N=>String(N??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&apos;"),p=N=>N==="Sales Report"?[110,125,150,215,95,95,105,105]:N==="Disbursement"?[115,115,90,150,150,220,105]:N==="Fold Count"?[220,125]:N==="Revolving Daily Summary"?[115,105,120,115]:N==="Revolving History"?[115,96,140,96,110,180,120]:[155,125,125,125,95,95,115,115];return`<?xml version="1.0"?>
...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 xmlns:html="http://www.w3.org/TR/REC-html40">
  ...
  ${S.map(N=>{const $=p(N.name).map(L=>`<Column ss:Width="${L}" ss:AutoFitWidth="0"/>`).join(""),x=N.rows.map(L=>{if(!L.length)return'<Row ss:Height="10" ss:StyleID="BorderRow"><Cell ss:StyleID="BorderCell"><Data ss:Type="String">&nbsp;</Data></Cell></Row>';const D=L[0]==="Type"||L[0]==="Summary"||L[0]==="Sales Summary"||L[0]==="Disbursement Summary"||L[0]==="Staff"||L[0]==="Date of Sales"||L[0]==="Date"||L[0]==="Date/Month",P=D?"HeaderRow":"BorderRow",k=D?"HeaderCell":"BorderCell",M=D?26:22,B=L.map(H=>`<Cell ss:StyleID="${k}"><Data ss:Type="${typeof H=="number"?"Number":"String"}">${w(H)}</Data></Cell>`).join("");return`<Row ss:Height="${M}" ss:StyleID="${P}">${B}</Row>`}).join("");return`
        <Worksheet ss:Name="${w(N.name)}">
          <Table>
            ${$}
            ${x}
          </Table>
        </Worksheet>`}).join("")}
</Workbook>`},f=()=>{const S=Ae(),w=qt(e,t,n,a,s,r,i,S),p=[];if(w.selectedTypes.has("sales")){const $=w.salesRows(),x=[["Ticket","Customer","Cash","GCash","Total Payment"],...$.transactions.map(L=>[L.ticket,L.customer,L.cash,L.gcash,L.total]),[],["Cash from Orders","GCash from Orders","Sales from Orders"],[$.orderCashTotal,$.orderGcashTotal,$.orderCashTotal+$.orderGcashTotal],[],["Cash Whole Sale","GCash Whole Sale","Whole Sale of Day"],[$.manualCashTotal,$.manualGcashTotal,$.manualCashTotal+$.manualGcashTotal],[],["Total Cash","Total GCash","Total Sales"],[$.totalCash,$.totalGcash,$.totalSales]];p.push({name:"Sales Report",rows:x})}w.selectedTypes.has("disbursement")&&p.push({name:"Disbursement",rows:w.disbursementRows().rows}),w.selectedTypes.has("fold_count")&&p.push({name:"Fold Count",rows:w.foldCountRows().rows}),w.selectedTypes.has("revolving_fund")&&(p.push({name:"Revolving Daily Summary",rows:w.revolvingDailySummaryRows().rows}),p.push({name:"Revolving History",rows:w.revolvingHistoryRows().rows})),w.selectedTypes.has("summary")&&p.push({name:"Summary",rows:w.summaryRows()});const g=m(p.length?p:[{name:"Summary",rows:w.summaryRows()}]),N=`laba101-report-${S.from}-to-${S.to}.xls`;return new File([g],N,{type:"application/vnd.ms-excel"})},y=async()=>{const S=f();if(!R.isNativePlatform())return{fileName:S.name,uri:""};const w=await S.text(),p=S.name;await st.writeFile({path:p,data:w,directory:$e.External,encoding:Be.UTF8});const{uri:g}=await st.getUri({path:p,directory:$e.External});return{fileName:S.name,uri:g}},E=()=>{const S=f(),w=Ae(),p=`laba101-report-${w.from}-to-${w.to}.xls`,g=S,N=URL.createObjectURL(g),$=document.createElement("a");return $.href=N,$.download=p,document.body.appendChild($),$.click(),setTimeout(()=>{$.remove(),URL.revokeObjectURL(N)},1e3),p},q=async S=>{const w=document.querySelector(S==="export"?"#export-report":"#email-report");w&&(w.disabled=!0,w.textContent=S==="export"?"Exporting...":"Sending...");try{if(S==="export")if(R.isNativePlatform()){const p=await y();alert(`Report exported as "${p.fileName}".`)}else{const p=E();alert(`Report saved: ${p}`)}else{const p=await St("report_email")||"";if(!p){alert("Please configure a report email in Settings first.");return}const g=Ae(),N=`Laba101 report ${g.from} to ${g.to}`;if(R.isNativePlatform()){const $=await y();try{await aa.share({title:N,text:`Please find the attached Laba101 report file: ${$.fileName}`,files:[$.uri],dialogTitle:"Send report via email"}),alert(`Report saved and shared as "${$.fileName}".`)}catch(x){const L=String(x).toLowerCase();if(L.includes("share canceled")||L.includes("canceled"))alert(`Report saved as "${$.fileName}".`);else throw x}}else{const $=E(),x=`Hi,

Please find the attached Laba101 report file: ${$}

Date range: ${g.from} to ${g.to}`,L=`mailto:${p}?subject=${encodeURIComponent(N)}&body=${encodeURIComponent(x)}`;setTimeout(()=>{window.location.href=L},800),alert(`Report downloaded as "${$}".
Your email app will open — please attach the file and send.`)}}}catch(p){alert("Failed: "+String(p))}finally{w&&(w.disabled=!1,w.textContent=S==="export"?"Export Excel":"Send to Email")}};document.querySelector("#export-report")?.addEventListener("click",async()=>{await q("export")}),document.querySelector("#email-report")?.addEventListener("click",async()=>{await q("email")})}function kn(){document.querySelector("#order-queue-filters")?.addEventListener("submit",e=>{e.preventDefault();const t=new FormData(e.currentTarget);l.orderSearch=String(t.get("orderSearch")??"").trim(),l.orderDateFilter=String(t.get("orderDateFilter")??"").trim(),l.orderPaymentFilter=String(t.get("orderPaymentFilter")??"").trim(),b()}),document.querySelector("#order-queue-clear")?.addEventListener("click",()=>{l.orderSearch="",l.orderDateFilter="",l.orderPaymentFilter="",b()}),document.querySelector("#archived-order-filters")?.addEventListener("submit",e=>{e.preventDefault();const t=new FormData(e.currentTarget);l.archivedOrderSearch=String(t.get("archivedOrderSearch")??"").trim(),b()}),document.querySelector("#archived-order-clear")?.addEventListener("click",()=>{l.archivedOrderSearch="",b()})}function Mn(){document.querySelector("#customer-search-form")?.addEventListener("submit",e=>{e.preventDefault();const t=new FormData(e.currentTarget);l.customerSearch=String(t.get("customerSearch")??"").trim(),b()}),document.querySelector("#customer-search-clear")?.addEventListener("click",()=>{l.customerSearch="",b()})}function Bn(){document.querySelector("#machine-form")?.addEventListener("submit",async e=>{e.preventDefault();const t=new FormData(e.currentTarget);await Va({machineName:String(t.get("machineName")??""),machineType:String(t.get("machineType")),status:String(t.get("status")),branch:String(t.get("branch")??"")}),await b()}),document.querySelector("#subcleaning-form")?.addEventListener("submit",async e=>{e.preventDefault();const t=e.currentTarget.querySelector('button[type="submit"]');t&&(t.disabled=!0,t.textContent="Starting...");const n=new FormData(e.currentTarget),a=n.getAll("machineIds").map(Number);if(!a.length){alert("Please select at least one machine to clean."),t&&(t.disabled=!1,t.textContent="Start Cleaning");return}await Ot({date:String(n.get("date")??""),machineIds:a,cleaningStatus:String(n.get("cleaningStatus")??""),cleaningType:"tube",notes:String(n.get("notes")??""),branch:String(n.get("branch")??"")}),await Y("Start tube cleaning",`${a.length} machine(s)`),await b()}),document.querySelector("#confirm-general-cleaning")?.addEventListener("click",async()=>{await za(document.querySelector('input[name="branch"]')?.value||l.currentUser?.branch||"Main Store",l.currentUser?.name??"Unknown"),await Y("Confirm general cleaning",j()),await b()}),document.querySelectorAll(".complete-cleaning-btn").forEach(e=>{e.addEventListener("click",async()=>{const t=Number(e.dataset.machineId),n=e.dataset.branch??"";e.disabled=!0,e.textContent="Completing...",await Ja(t,n),await Y("Complete tube cleaning",`Machine ID ${t}`),await b()})}),document.querySelectorAll(".deactivate-machine-btn, .activate-machine-btn").forEach(e=>{e.addEventListener("click",async()=>{const t=Number(e.dataset.id),n=e.classList.contains("deactivate-machine-btn");await Ya(t,n?"inactive":"available"),await b()})})}function _n(e,t){const n=document.querySelector("#inventory-form");n?.addEventListener("submit",async a=>{a.preventDefault();const s=new FormData(a.currentTarget),r=Number(s.get("id")||0);await Xa({id:r||void 0,name:String(s.get("name")??""),unit:String(s.get("unit")??""),quantity:Number(s.get("quantity")??0),reorderLevel:Number(s.get("reorderLevel")??0),notes:String(s.get("notes")??""),branch:t}),await Y(r?"Update inventory item":"Create inventory item",String(s.get("name")??"")),await b()}),document.querySelectorAll(".edit-inventory-btn").forEach(a=>{a.addEventListener("click",()=>{const s=e.find(r=>r.id===Number(a.dataset.id));!s||!n||(n.querySelector("[name=id]").value=String(s.id),n.querySelector("[name=name]").value=s.name,n.querySelector("[name=unit]").value=s.unit,n.querySelector("[name=quantity]").value=String(s.quantity),n.querySelector("[name=reorderLevel]").value=String(s.reorderLevel),n.querySelector("[name=notes]").value=s.notes??"",n.scrollIntoView({behavior:"smooth",block:"start"}))})}),document.querySelector("#inventory-movement-form")?.addEventListener("submit",async a=>{a.preventDefault();const s=new FormData(a.currentTarget),r=String(s.get("movementType")??"in")==="out"?"out":"in";try{await Ka({itemId:Number(s.get("itemId")??0),movementType:r,quantity:Number(s.get("quantity")??0),notes:String(s.get("notes")??""),staffName:l.currentUser?.name??"Unknown",branch:t}),await Y(r==="in"?"Stock-in":"Stock-out",`Item ID ${s.get("itemId")} qty ${s.get("quantity")}`),await b()}catch(i){alert(i instanceof Error?i.message:"Stock movement failed.")}})}function jn(e){const t=document.querySelector("#add-staff-modal"),n=document.querySelector("#open-add-staff-modal"),a=document.querySelector("#close-add-staff-modal"),s=document.querySelector("#staff-form"),r=()=>{s?.reset(),s&&(s.querySelector("[name=id]").value="");const o=document.querySelector("#add-staff-title");o&&(o.textContent="Add staff member"),t?.removeAttribute("hidden")},i=()=>{t?.setAttribute("hidden",""),s?.reset()};n?.addEventListener("click",r),a?.addEventListener("click",i),t?.addEventListener("click",o=>{o.target===t&&i()}),document.querySelectorAll(".edit-staff-btn").forEach(o=>{o.addEventListener("click",()=>{const d=Number(o.dataset.id),c=e.find(u=>u.id===d);if(c&&s){s.querySelector("[name=id]").value=String(c.id),s.querySelector("[name=name]").value=c.name,s.querySelector("[name=email]").value=c.email,s.querySelector("[name=password]").value=c.password,s.querySelector("[name=role]").value=c.role,s.querySelector("[name=branch]").value=c.branch;const u=document.querySelector("#add-staff-title");u&&(u.textContent="Edit staff member"),t?.removeAttribute("hidden")}})}),document.querySelectorAll(".deactivate-staff-btn, .activate-staff-btn").forEach(o=>{o.addEventListener("click",async()=>{const d=Number(o.dataset.id),c=e.find(u=>u.id===d);c&&(await ot(d,{isActive:c.isActive!==0?0:1}),await b())})}),s?.addEventListener("submit",async o=>{o.preventDefault();const d=document.querySelector("#staff-save-btn");d&&(d.disabled=!0,d.textContent="Saving...");const c=new FormData(s),u=c.get("id")?Number(c.get("id")):void 0,m=String(c.get("name")??"").trim(),f=String(c.get("email")??"").trim(),y=String(c.get("password")??"password")||"password",E=String(c.get("role")),q=String(c.get("branch")??"");if(!m||!f){alert("Name and email are required."),d&&(d.disabled=!1,d.textContent="Save staff member");return}try{u?await ot(u,{name:m,email:f,password:y,role:E,branch:q}):await Ea({name:m,email:f,password:y,role:E,branch:q}),i(),await b()}catch{alert("Failed to save staff. The email may already be in use."),d&&(d.disabled=!1,d.textContent="Save staff member")}})}function Hn(){document.querySelector("#settings-form")?.addEventListener("submit",async e=>{e.preventDefault();const t=new FormData(e.currentTarget);await Le("branch",String(t.get("branch")??"Main Store")),await Le("fold_rate",String(t.get("foldRate")??"5")),String(t.get("reportEmail")??"")&&await Le("report_email",String(t.get("reportEmail"))),alert("Settings saved successfully!")})}async function Wn(){await ha();const e=localStorage.getItem(Se);if(e)try{const t=JSON.parse(e);if(t.email&&t.remembered){const n=await wt(t.email,"password")??null;l.currentUser=n}}catch{localStorage.removeItem(Se)}await b()}function Xn(e,t,n,a){const s=e.filter(y=>y.status==="revolving").reduce((y,E)=>y+E.cashAmount,0),r=t.filter(y=>y.type==="add").reduce((y,E)=>y+E.amount,0),i=t.filter(y=>y.type==="disbursement").reduce((y,E)=>y+E.amount,0),o=s+r-i,d=l.revolvingHistoryFrom||"0000-01-01",c=l.revolvingHistoryTo||"9999-12-31",u=t.filter(y=>{const E=G(y.createdAt);return E>=d&&E<=c}),m=e.map(y=>{const E=Dt(y.saleDate,n,a,y.cashAmount),q=y.status==="revolving"?'<span class="ok">Revolving</span>':y.status==="endorsed"?`<span class="warn">Endorsed to ${v(y.endorsedTo)}</span>`:'<span class="meta">Pending</span>',S=y.status!=="revolving"&&y.status!=="endorsed"?`<div class="row-actions">
          <button class="primary revolving-btn" data-id="${y.id}">Revolving</button>
          <button class="secondary endorsed-btn" data-id="${y.id}" data-date="${me(y.saleDate)}">Endorsed</button>
        </div>`:"";return[`<strong>${v(me(y.saleDate))}</strong>`,`<strong class="ok">${T(E)}</strong>`,q,y.statusUpdatedAt?v(me(y.statusUpdatedAt)):"-",S]}),f=u.map(y=>[Pe(y.createdAt),`<strong>${v(y.revolvingNumber)}</strong>`,v(y.name),`<strong class="${y.type==="disbursement"?"warn":"ok"}">${y.type==="disbursement"?"-":"+"}${T(y.amount)}</strong>`,v(y.category),v(y.description||"-"),`<span class="${y.type==="add"?"ok":"warn"}">${y.type==="add"?"Add Revolving Fund":"Disbursement"}</span>`]);return`
    <section class="grid content full">
      ...
      <article class="panel">
        ...
        ${I("Daily Summary","Cash on hand per day (order cash + manual cash − disbursements)")}
        ${ee(["Date of Sales","Cash on Hand","Status","Date Update","Action"],m,"data-table revolving-summary-datatable")}
      </article>

      <article class="panel">
        ${I("Revolving Table History","Filter by date — DISB numbers shared with Daily Report expenses")}
