(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))n(r);new MutationObserver(r=>{for(const s of r)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function a(r){const s={};return r.integrity&&(s.integrity=r.integrity),r.referrerPolicy&&(s.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?s.credentials="include":r.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function n(r){if(r.ep)return;r.ep=!0;const s=a(r);fetch(r.href,s)}})();const Ve="modulepreload",Je=function(e){return"/"+e},Ce={},we=function(t,a,n){let r=Promise.resolve();if(a&&a.length>0){let c=function(l){return Promise.all(l.map(p=>Promise.resolve(p).then(h=>({status:"fulfilled",value:h}),h=>({status:"rejected",reason:h}))))};document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),i=o?.nonce||o?.getAttribute("nonce");r=c(a.map(l=>{if(l=Je(l),l in Ce)return;Ce[l]=!0;const p=l.endsWith(".css"),h=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${h}`))return;const u=document.createElement("link");if(u.rel=p?"stylesheet":Ve,p||(u.as="script"),u.crossOrigin="",u.href=l,i&&u.setAttribute("nonce",i),document.head.appendChild(u),p)return new Promise((R,T)=>{u.addEventListener("load",R),u.addEventListener("error",()=>T(new Error(`Unable to preload CSS for ${l}`)))})}))}function s(o){const i=new Event("vite:preloadError",{cancelable:!0});if(i.payload=o,window.dispatchEvent(i),!i.defaultPrevented)throw o}return r.then(o=>{for(const i of o||[])i.status==="rejected"&&s(i.reason);return t().catch(s)})};var X;(function(e){e.Unimplemented="UNIMPLEMENTED",e.Unavailable="UNAVAILABLE"})(X||(X={}));class pe extends Error{constructor(t,a,n){super(t),this.message=t,this.code=a,this.data=n}}const Qe=e=>{var t,a;return e?.androidBridge?"android":!((a=(t=e?.webkit)===null||t===void 0?void 0:t.messageHandlers)===null||a===void 0)&&a.bridge?"ios":"web"},ze=e=>{const t=e.CapacitorCustomPlatform||null,a=e.Capacitor||{},n=a.Plugins=a.Plugins||{},r=()=>t!==null?t.name:Qe(e),s=()=>r()!=="web",o=h=>{const u=l.get(h);return!!(u?.platforms.has(r())||i(h))},i=h=>{var u;return(u=a.PluginHeaders)===null||u===void 0?void 0:u.find(R=>R.name===h)},c=h=>e.console.error(h),l=new Map,p=(h,u={})=>{const R=l.get(h);if(R)return console.warn(`Capacitor plugin "${h}" already registered. Cannot register plugins twice.`),R.proxy;const T=r(),m=i(h);let v;const y=async()=>(!v&&T in u?v=typeof u[T]=="function"?v=await u[T]():v=u[T]:t!==null&&!v&&"web"in u&&(v=typeof u.web=="function"?v=await u.web():v=u.web),v),C=(O,I)=>{var F,_;if(m){const B=m?.methods.find(U=>I===U.name);if(B)return B.rtype==="promise"?U=>a.nativePromise(h,I.toString(),U):(U,J)=>a.nativeCallback(h,I.toString(),U,J);if(O)return(F=O[I])===null||F===void 0?void 0:F.bind(O)}else{if(O)return(_=O[I])===null||_===void 0?void 0:_.bind(O);throw new pe(`"${h}" plugin is not implemented on ${T}`,X.Unimplemented)}},A=O=>{let I;const F=(..._)=>{const B=y().then(U=>{const J=C(U,O);if(J){const Q=J(..._);return I=Q?.remove,Q}else throw new pe(`"${h}.${O}()" is not implemented on ${T}`,X.Unimplemented)});return O==="addListener"&&(B.remove=async()=>I()),B};return F.toString=()=>`${O.toString()}() { [capacitor code] }`,Object.defineProperty(F,"name",{value:O,writable:!1,configurable:!1}),F},g=A("addListener"),q=A("removeListener"),P=(O,I)=>{const F=g({eventName:O},I),_=async()=>{const U=await F;q({eventName:O,callbackId:U},I)},B=new Promise(U=>F.then(()=>U({remove:_})));return B.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await _()},B},b=new Proxy({},{get(O,I){switch(I){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return m?P:g;case"removeListener":return q;default:return A(I)}}});return n[h]=b,l.set(h,{name:h,proxy:b,platforms:new Set([...Object.keys(u),...m?[T]:[]])}),b};return a.convertFileSrc||(a.convertFileSrc=h=>h),a.getPlatform=r,a.handleError=c,a.isNativePlatform=s,a.isPluginAvailable=o,a.registerPlugin=p,a.Exception=pe,a.DEBUG=!!a.DEBUG,a.isLoggingEnabled=!!a.isLoggingEnabled,a},Ze=e=>e.Capacitor=ze(e),E=Ze(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),Y=E.registerPlugin;class Ee{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(t,a){let n=!1;this.listeners[t]||(this.listeners[t]=[],n=!0),this.listeners[t].push(a);const s=this.windowListeners[t];s&&!s.registered&&this.addWindowListener(s),n&&this.sendRetainedArgumentsForEvent(t);const o=async()=>this.removeListener(t,a);return Promise.resolve({remove:o})}async removeAllListeners(){this.listeners={};for(const t in this.windowListeners)this.removeWindowListener(this.windowListeners[t]);this.windowListeners={}}notifyListeners(t,a,n){const r=this.listeners[t];if(!r){if(n){let s=this.retainedEventArguments[t];s||(s=[]),s.push(a),this.retainedEventArguments[t]=s}return}r.forEach(s=>s(a))}hasListeners(t){var a;return!!(!((a=this.listeners[t])===null||a===void 0)&&a.length)}registerWindowListener(t,a){this.windowListeners[a]={registered:!1,windowEventName:t,pluginEventName:a,handler:n=>{this.notifyListeners(a,n)}}}unimplemented(t="not implemented"){return new E.Exception(t,X.Unimplemented)}unavailable(t="not available"){return new E.Exception(t,X.Unavailable)}async removeListener(t,a){const n=this.listeners[t];if(!n)return;const r=n.indexOf(a);this.listeners[t].splice(r,1),this.listeners[t].length||this.removeWindowListener(this.windowListeners[t])}addWindowListener(t){window.addEventListener(t.windowEventName,t.handler),t.registered=!0}removeWindowListener(t){t&&(window.removeEventListener(t.windowEventName,t.handler),t.registered=!1)}sendRetainedArgumentsForEvent(t){const a=this.retainedEventArguments[t];a&&(delete this.retainedEventArguments[t],a.forEach(n=>{this.notifyListeners(t,n)}))}}const $e=e=>encodeURIComponent(e).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),Oe=e=>e.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class et extends Ee{async getCookies(){const t=document.cookie,a={};return t.split(";").forEach(n=>{if(n.length<=0)return;let[r,s]=n.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");r=Oe(r).trim(),s=Oe(s).trim(),a[r]=s}),a}async setCookie(t){try{const a=$e(t.key),n=$e(t.value),r=t.expires?`; expires=${t.expires.replace("expires=","")}`:"",s=(t.path||"/").replace("path=",""),o=t.url!=null&&t.url.length>0?`domain=${t.url}`:"";document.cookie=`${a}=${n||""}${r}; path=${s}; ${o};`}catch(a){return Promise.reject(a)}}async deleteCookie(t){try{document.cookie=`${t.key}=; Max-Age=0`}catch(a){return Promise.reject(a)}}async clearCookies(){try{const t=document.cookie.split(";")||[];for(const a of t)document.cookie=a.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(t){return Promise.reject(t)}}async clearAllCookies(){try{await this.clearCookies()}catch(t){return Promise.reject(t)}}}Y("CapacitorCookies",{web:()=>new et});const tt=async e=>new Promise((t,a)=>{const n=new FileReader;n.onload=()=>{const r=n.result;t(r.indexOf(",")>=0?r.split(",")[1]:r)},n.onerror=r=>a(r),n.readAsDataURL(e)}),at=(e={})=>{const t=Object.keys(e);return Object.keys(e).map(r=>r.toLocaleLowerCase()).reduce((r,s,o)=>(r[s]=e[t[o]],r),{})},nt=(e,t=!0)=>e?Object.entries(e).reduce((n,r)=>{const[s,o]=r;let i,c;return Array.isArray(o)?(c="",o.forEach(l=>{i=t?encodeURIComponent(l):l,c+=`${s}=${i}&`}),c.slice(0,-1)):(i=t?encodeURIComponent(o):o,c=`${s}=${i}`),`${n}&${c}`},"").substr(1):null,st=(e,t={})=>{const a=Object.assign({method:e.method||"GET",headers:e.headers},t),r=at(e.headers)["content-type"]||"";if(typeof e.data=="string")a.body=e.data;else if(r.includes("application/x-www-form-urlencoded")){const s=new URLSearchParams;for(const[o,i]of Object.entries(e.data||{}))s.set(o,i);a.body=s.toString()}else if(r.includes("multipart/form-data")||e.data instanceof FormData){const s=new FormData;if(e.data instanceof FormData)e.data.forEach((i,c)=>{s.append(c,i)});else for(const i of Object.keys(e.data))s.append(i,e.data[i]);a.body=s;const o=new Headers(a.headers);o.delete("content-type"),a.headers=o}else(r.includes("application/json")||typeof e.data=="object")&&(a.body=JSON.stringify(e.data));return a};class rt extends Ee{async request(t){const a=st(t,t.webFetchExtra),n=nt(t.params,t.shouldEncodeUrlParams),r=n?`${t.url}?${n}`:t.url,s=await fetch(r,a),o=s.headers.get("content-type")||"";let{responseType:i="text"}=s.ok?t:{};o.includes("application/json")&&(i="json");let c,l;switch(i){case"arraybuffer":case"blob":l=await s.blob(),c=await tt(l);break;case"json":c=await s.json();break;default:c=await s.text()}const p={};return s.headers.forEach((h,u)=>{p[u]=h}),{data:c,headers:p,status:s.status,url:s.url}}async get(t){return this.request(Object.assign(Object.assign({},t),{method:"GET"}))}async post(t){return this.request(Object.assign(Object.assign({},t),{method:"POST"}))}async put(t){return this.request(Object.assign(Object.assign({},t),{method:"PUT"}))}async patch(t){return this.request(Object.assign(Object.assign({},t),{method:"PATCH"}))}async delete(t){return this.request(Object.assign(Object.assign({},t),{method:"DELETE"}))}}Y("CapacitorHttp",{web:()=>new rt});var Pe;(function(e){e.Dark="DARK",e.Light="LIGHT",e.Default="DEFAULT"})(Pe||(Pe={}));var Re;(function(e){e.StatusBar="StatusBar",e.NavigationBar="NavigationBar"})(Re||(Re={}));class it extends Ee{async setStyle(){this.unavailable("not available for web")}async setAnimation(){this.unavailable("not available for web")}async show(){this.unavailable("not available for web")}async hide(){this.unavailable("not available for web")}}Y("SystemBars",{web:()=>new it});function ot(e){e.CapacitorUtils.Synapse=new Proxy({},{get(t,a){return new Proxy({},{get(n,r){return(s,o,i)=>{const c=e.Capacitor.Plugins[a];if(c===void 0){i(new Error(`Capacitor plugin ${a} not found`));return}if(typeof c[r]!="function"){i(new Error(`Method ${r} not found in Capacitor plugin ${a}`));return}(async()=>{try{const l=await c[r](s);o(l)}catch(l){i(l)}})()}}})}})}function ct(e){e.CapacitorUtils.Synapse=new Proxy({},{get(t,a){return e.cordova.plugins[a]}})}function lt(e=!1){typeof window>"u"||(window.CapacitorUtils=window.CapacitorUtils||{},window.Capacitor!==void 0&&!e?ot(window):window.cordova!==void 0&&ct(window))}var ae;(function(e){e.Documents="DOCUMENTS",e.Data="DATA",e.Library="LIBRARY",e.Cache="CACHE",e.External="EXTERNAL",e.ExternalStorage="EXTERNAL_STORAGE",e.ExternalCache="EXTERNAL_CACHE",e.LibraryNoCloud="LIBRARY_NO_CLOUD",e.Temporary="TEMPORARY"})(ae||(ae={}));var be;(function(e){e.UTF8="utf8",e.ASCII="ascii",e.UTF16="utf16"})(be||(be={}));const De=Y("Filesystem",{web:()=>we(()=>import("./web-CzlyDowh.js"),[]).then(e=>new e.FilesystemWeb)});lt();const dt=Y("Share",{web:()=>we(()=>import("./web-CKGKa2lT.js"),[]).then(e=>new e.ShareWeb)});class ut{constructor(t){this.sqlite=t,this._connectionDict=new Map}async initWebStore(){try{return await this.sqlite.initWebStore(),Promise.resolve()}catch(t){return Promise.reject(t)}}async saveToStore(t){try{return await this.sqlite.saveToStore({database:t}),Promise.resolve()}catch(a){return Promise.reject(a)}}async saveToLocalDisk(t){try{return await this.sqlite.saveToLocalDisk({database:t}),Promise.resolve()}catch(a){return Promise.reject(a)}}async getFromLocalDiskToStore(t){const a=t??!0;try{return await this.sqlite.getFromLocalDiskToStore({overwrite:a}),Promise.resolve()}catch(n){return Promise.reject(n)}}async echo(t){try{const a=await this.sqlite.echo({value:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async isSecretStored(){try{const t=await this.sqlite.isSecretStored();return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async setEncryptionSecret(t){try{return await this.sqlite.setEncryptionSecret({passphrase:t}),Promise.resolve()}catch(a){return Promise.reject(a)}}async changeEncryptionSecret(t,a){try{return await this.sqlite.changeEncryptionSecret({passphrase:t,oldpassphrase:a}),Promise.resolve()}catch(n){return Promise.reject(n)}}async clearEncryptionSecret(){try{return await this.sqlite.clearEncryptionSecret(),Promise.resolve()}catch(t){return Promise.reject(t)}}async checkEncryptionSecret(t){try{const a=await this.sqlite.checkEncryptionSecret({passphrase:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async addUpgradeStatement(t,a){try{return t.endsWith(".db")&&(t=t.slice(0,-3)),await this.sqlite.addUpgradeStatement({database:t,upgrade:a}),Promise.resolve()}catch(n){return Promise.reject(n)}}async createConnection(t,a,n,r,s){try{t.endsWith(".db")&&(t=t.slice(0,-3)),await this.sqlite.createConnection({database:t,encrypted:a,mode:n,version:r,readonly:s});const o=new xe(t,s,this.sqlite),i=s?`RO_${t}`:`RW_${t}`;return this._connectionDict.set(i,o),Promise.resolve(o)}catch(o){return Promise.reject(o)}}async closeConnection(t,a){try{t.endsWith(".db")&&(t=t.slice(0,-3)),await this.sqlite.closeConnection({database:t,readonly:a});const n=a?`RO_${t}`:`RW_${t}`;return this._connectionDict.delete(n),Promise.resolve()}catch(n){return Promise.reject(n)}}async isConnection(t,a){const n={};t.endsWith(".db")&&(t=t.slice(0,-3));const r=a?`RO_${t}`:`RW_${t}`;return n.result=this._connectionDict.has(r),Promise.resolve(n)}async retrieveConnection(t,a){t.endsWith(".db")&&(t=t.slice(0,-3));const n=a?`RO_${t}`:`RW_${t}`;if(this._connectionDict.has(n)){const r=this._connectionDict.get(n);return typeof r<"u"?Promise.resolve(r):Promise.reject(`Connection ${t} is undefined`)}else return Promise.reject(`Connection ${t} does not exist`)}async getNCDatabasePath(t,a){try{const n=await this.sqlite.getNCDatabasePath({path:t,database:a});return Promise.resolve(n)}catch(n){return Promise.reject(n)}}async createNCConnection(t,a){try{await this.sqlite.createNCConnection({databasePath:t,version:a});const n=new xe(t,!0,this.sqlite),r=`RO_${t})`;return this._connectionDict.set(r,n),Promise.resolve(n)}catch(n){return Promise.reject(n)}}async closeNCConnection(t){try{await this.sqlite.closeNCConnection({databasePath:t});const a=`RO_${t})`;return this._connectionDict.delete(a),Promise.resolve()}catch(a){return Promise.reject(a)}}async isNCConnection(t){const a={},n=`RO_${t})`;return a.result=this._connectionDict.has(n),Promise.resolve(a)}async retrieveNCConnection(t){if(this._connectionDict.has(t)){const a=`RO_${t})`,n=this._connectionDict.get(a);return typeof n<"u"?Promise.resolve(n):Promise.reject(`Connection ${t} is undefined`)}else return Promise.reject(`Connection ${t} does not exist`)}async isNCDatabase(t){try{const a=await this.sqlite.isNCDatabase({databasePath:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async retrieveAllConnections(){return this._connectionDict}async closeAllConnections(){const t=new Map;try{for(const a of this._connectionDict.keys()){const n=a.substring(3),r=a.substring(0,3)==="RO_";await this.sqlite.closeConnection({database:n,readonly:r}),t.set(a,null)}for(const a of t.keys())this._connectionDict.delete(a);return Promise.resolve()}catch(a){return Promise.reject(a)}}async checkConnectionsConsistency(){try{const t=[...this._connectionDict.keys()],a=[],n=[];for(const s of t)a.push(s.substring(0,2)),n.push(s.substring(3));const r=await this.sqlite.checkConnectionsConsistency({dbNames:n,openModes:a});return r.result||(this._connectionDict=new Map),Promise.resolve(r)}catch(t){return this._connectionDict=new Map,Promise.reject(t)}}async importFromJson(t){try{const a=await this.sqlite.importFromJson({jsonstring:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async isJsonValid(t){try{const a=await this.sqlite.isJsonValid({jsonstring:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async copyFromAssets(t){const a=t??!0;try{return await this.sqlite.copyFromAssets({overwrite:a}),Promise.resolve()}catch(n){return Promise.reject(n)}}async getFromHTTPRequest(t,a){const n=a??!0;try{return await this.sqlite.getFromHTTPRequest({url:t,overwrite:n}),Promise.resolve()}catch(r){return Promise.reject(r)}}async isDatabaseEncrypted(t){t.endsWith(".db")&&(t=t.slice(0,-3));try{const a=await this.sqlite.isDatabaseEncrypted({database:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async isInConfigEncryption(){try{const t=await this.sqlite.isInConfigEncryption();return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isInConfigBiometricAuth(){try{const t=await this.sqlite.isInConfigBiometricAuth();return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isDatabase(t){t.endsWith(".db")&&(t=t.slice(0,-3));try{const a=await this.sqlite.isDatabase({database:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async getDatabaseList(){try{const a=(await this.sqlite.getDatabaseList()).values;a.sort();const n={values:a};return Promise.resolve(n)}catch(t){return Promise.reject(t)}}async getMigratableDbList(t){const a=t||"default";try{const n=await this.sqlite.getMigratableDbList({folderPath:a});return Promise.resolve(n)}catch(n){return Promise.reject(n)}}async addSQLiteSuffix(t,a){const n=t||"default",r=a||[];try{const s=await this.sqlite.addSQLiteSuffix({folderPath:n,dbNameList:r});return Promise.resolve(s)}catch(s){return Promise.reject(s)}}async deleteOldDatabases(t,a){const n=t||"default",r=a||[];try{const s=await this.sqlite.deleteOldDatabases({folderPath:n,dbNameList:r});return Promise.resolve(s)}catch(s){return Promise.reject(s)}}async moveDatabasesAndAddSuffix(t,a){const n=t||"default",r=a||[];return this.sqlite.moveDatabasesAndAddSuffix({folderPath:n,dbNameList:r})}}class xe{constructor(t,a,n){this.dbName=t,this.readonly=a,this.sqlite=n}getConnectionDBName(){return this.dbName}getConnectionReadOnly(){return this.readonly}async open(){try{return await this.sqlite.open({database:this.dbName,readonly:this.readonly}),Promise.resolve()}catch(t){return Promise.reject(t)}}async close(){try{return await this.sqlite.close({database:this.dbName,readonly:this.readonly}),Promise.resolve()}catch(t){return Promise.reject(t)}}async beginTransaction(){try{const t=await this.sqlite.beginTransaction({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async commitTransaction(){try{const t=await this.sqlite.commitTransaction({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async rollbackTransaction(){try{const t=await this.sqlite.rollbackTransaction({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isTransactionActive(){try{const t=await this.sqlite.isTransactionActive({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async loadExtension(t){try{return await this.sqlite.loadExtension({database:this.dbName,path:t,readonly:this.readonly}),Promise.resolve()}catch(a){return Promise.reject(a)}}async enableLoadExtension(t){try{return await this.sqlite.enableLoadExtension({database:this.dbName,toggle:t,readonly:this.readonly}),Promise.resolve()}catch(a){return Promise.reject(a)}}async getUrl(){try{const t=await this.sqlite.getUrl({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async getVersion(){try{const t=await this.sqlite.getVersion({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async getTableList(){try{const t=await this.sqlite.getTableList({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async execute(t,a=!0,n=!0){try{if(this.readonly)return Promise.reject("not allowed in read-only mode");{const r=await this.sqlite.execute({database:this.dbName,statements:t,transaction:a,readonly:!1,isSQL92:n});return Promise.resolve(r)}}catch(r){return Promise.reject(r)}}async query(t,a,n=!0){let r;try{return a&&a.length>0?r=await this.sqlite.query({database:this.dbName,statement:t,values:a,readonly:this.readonly,isSQL92:!0}):r=await this.sqlite.query({database:this.dbName,statement:t,values:[],readonly:this.readonly,isSQL92:n}),r=await this.reorderRows(r),Promise.resolve(r)}catch(s){return Promise.reject(s)}}async run(t,a,n=!0,r="no",s=!0){let o;try{return this.readonly?Promise.reject("not allowed in read-only mode"):(a&&a.length>0?o=await this.sqlite.run({database:this.dbName,statement:t,values:a,transaction:n,readonly:!1,returnMode:r,isSQL92:!0}):o=await this.sqlite.run({database:this.dbName,statement:t,values:[],transaction:n,readonly:!1,returnMode:r,isSQL92:s}),o.changes=await this.reorderRows(o.changes),Promise.resolve(o))}catch(i){return Promise.reject(i)}}async executeSet(t,a=!0,n="no",r=!0){let s;try{return this.readonly?Promise.reject("not allowed in read-only mode"):(s=await this.sqlite.executeSet({database:this.dbName,set:t,transaction:a,readonly:!1,returnMode:n,isSQL92:r}),s.changes=await this.reorderRows(s.changes),Promise.resolve(s))}catch(o){return Promise.reject(o)}}async isExists(){try{const t=await this.sqlite.isDBExists({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isTable(t){try{const a=await this.sqlite.isTableExists({database:this.dbName,table:t,readonly:this.readonly});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async isDBOpen(){try{const t=await this.sqlite.isDBOpen({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async delete(){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.deleteDatabase({database:this.dbName,readonly:!1}),Promise.resolve())}catch(t){return Promise.reject(t)}}async createSyncTable(){try{if(this.readonly)return Promise.reject("not allowed in read-only mode");{const t=await this.sqlite.createSyncTable({database:this.dbName,readonly:!1});return Promise.resolve(t)}}catch(t){return Promise.reject(t)}}async setSyncDate(t){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.setSyncDate({database:this.dbName,syncdate:t,readonly:!1}),Promise.resolve())}catch(a){return Promise.reject(a)}}async getSyncDate(){try{const t=await this.sqlite.getSyncDate({database:this.dbName,readonly:this.readonly});let a="";return t.syncDate>0&&(a=new Date(t.syncDate*1e3).toISOString()),Promise.resolve(a)}catch(t){return Promise.reject(t)}}async exportToJson(t,a=!1){try{const n=await this.sqlite.exportToJson({database:this.dbName,jsonexportmode:t,readonly:this.readonly,encrypted:a});return Promise.resolve(n)}catch(n){return Promise.reject(n)}}async deleteExportedRows(){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.deleteExportedRows({database:this.dbName,readonly:!1}),Promise.resolve())}catch(t){return Promise.reject(t)}}async executeTransaction(t,a=!0){let n=0,r=!1;if(this.readonly)return Promise.reject("not allowed in read-only mode");if(await this.sqlite.beginTransaction({database:this.dbName}),r=await this.sqlite.isTransactionActive({database:this.dbName}),!r)return Promise.reject("After Begin Transaction, no transaction active");try{for(const i of t){if(typeof i!="object"||!("statement"in i))throw new Error("Error a task.statement must be provided");if("values"in i&&i.values&&i.values.length>0){const c=i.statement.toUpperCase().includes("RETURNING")?"all":"no",l=await this.sqlite.run({database:this.dbName,statement:i.statement,values:i.values,transaction:!1,readonly:!1,returnMode:c,isSQL92:a});if(l.changes.changes<0)throw new Error("Error in transaction method run ");n+=l.changes.changes}else{const c=await this.sqlite.execute({database:this.dbName,statements:i.statement,transaction:!1,readonly:!1});if(c.changes.changes<0)throw new Error("Error in transaction method execute ");n+=c.changes.changes}}const s=await this.sqlite.commitTransaction({database:this.dbName});n+=s.changes.changes;const o={changes:{changes:n}};return Promise.resolve(o)}catch(s){const o=s.message?s.message:s;return await this.sqlite.rollbackTransaction({database:this.dbName}),Promise.reject(o)}}async reorderRows(t){const a=t;if(t?.values&&typeof t.values[0]=="object"&&Object.keys(t.values[0]).includes("ios_columns")){const n=t.values[0].ios_columns,r=[];for(let s=1;s<t.values.length;s++){const o=t.values[s],i={};for(const c of n)i[c]=o[c];r.push(i)}a.values=r}return Promise.resolve(a)}}const mt=Y("CapacitorSQLite",{web:()=>we(()=>import("./web-BCCRar0y.js"),[]).then(e=>new e.CapacitorSQLiteWeb),electron:()=>window.CapacitorCustomPlatform.plugins.CapacitorSQLite});function vt(e){return e.replace(/^(add[- ]?on|additional)\s+/i,"").trim()}const ft="laba101_offline",pt=new ut(mt);let z=null;const W=[{id:1,name:"Laba101 Admin",email:"admin@laba101.test",password:"password",role:"admin",branch:"Main Store"},{id:2,name:"Laba101 Staff",email:"staff@laba101.test",password:"password",role:"staff",branch:"Main Store"},{id:3,name:"Mintal Staff",email:"mintal@laba101.test",password:"password",role:"staff",branch:"Mintal Branch"},{id:4,name:"Gensan Staff",email:"gensan@laba101.test",password:"password",role:"staff",branch:"Gensan Branch"}],ne=[{id:1,name:"Mara Santos",phone:"0917 482 1101",address:"Bajada, Davao City"},{id:2,name:"Jun Rivera",phone:"0928 314 7720",address:"Lanang, Davao City"},{id:3,name:"Ana Cruz",phone:"0935 901 2234",address:"Matina, Davao City"}],se=[k(1,"Drop-off","Wash, dry and fold.","Drop-Off","order",185,8,40,["Wash","Dry","Fold"],0,24),k(2,"Full Service","Wash, dry, fold, detergent and Fabcon.","Full Service","order",200,8,40,["Wash","Dry","Fold","Detergent","Fabcon"],0,24),k(3,"Self Service Wash","Max of 8kg per load.","Self Service","order",60,8,null,["Wash"],0,1),k(4,"Self Service Dry","Regular 40 mins drying time.","Self Service","order",70,8,40,["Dry"],0,1),k(5,"Dry Only","Standard drying rate.","Dry Only","order",70,8,40,["Dry"],0,1),k(6,"Additional Dry 10 mins","Additional drying time.","Dry Only","order",30,8,10,["Dry"],0,1),k(7,"Additional Dry 20 mins","Additional drying time.","Dry Only","order",50,8,20,["Dry"],0,1),k(8,"Additional Dry 40 mins","Additional drying time.","Dry Only","order",70,8,40,["Dry"],0,1),k(9,"Additional Zonrox","Extra bleach add-on per load.","Add-on","addon",25,0,null,["Zonrox"],0,0),k(10,"Additional Fabcon","Extra fabric conditioner add-on per load.","Add-on","addon",25,0,null,["Fabcon"],0,0),k(11,"Comforter / Bulky Load","Comforter and bulky item service.","Comforter","order",200,8,40,["Wash","Dry","Fold"],0,24)],re=[{id:1,name:"Regular Clothes",maxKg:8,additionalFee:0,isActive:1},{id:2,name:"Comforter",maxKg:4,additionalFee:0,isActive:1},{id:3,name:"Thin Blankets",maxKg:6,additionalFee:0,isActive:1},{id:4,name:"Bedsheets",maxKg:6,additionalFee:0,isActive:1},{id:5,name:"Bath Towels",maxKg:6,additionalFee:0,isActive:1},{id:6,name:"Curtains",maxKg:6,additionalFee:0,isActive:1}],H=[{id:1,ticket:"LB260527-001",customerId:1,customer:"Mara Santos",phone:"0917 482 1101",serviceId:1,service:"Drop-off",itemCategoryId:1,itemCategory:"Regular Clothes",branch:"Main Store",status:"washing",workflowCompleted:["received","wash"],weightKg:5.75,price:185,additionalCharge:0,extraServiceAmount:0,totalAmount:185,paidAmount:185,balance:0,extras:[],notes:"Separate white uniforms.",foldedBy:null,foldedByName:null,dueAt:new Date(Date.now()+1080*60*1e3).toISOString(),createdAt:new Date().toISOString()}],ie=[{id:1,orderId:1,amount:185,method:"cash",reference:null,receivedAt:new Date().toISOString(),branch:"Main Store"}],oe=[{id:1,expenseDate:"2026-05-27",number:"DISB-01",name:"Water refill",category:"Supplies",description:"Weekly supply",amount:250},{id:2,expenseDate:"2026-05-27",number:"DISB-02",name:"Detergent",category:"Supplies",description:"Laundry detergent",amount:500}],ce=[{id:1,saleDate:"2026-05-27",saleNumber:"SALE-01",cashAmount:1200,gcashAmount:500,totalAmount:1700,notes:"Seed day total"}],K=[...[1,2,3,4].map(e=>({id:e,machineName:`Washer ${e}`,machineType:"washer",status:"available",branch:"Main Store"})),...[1,2,3,4].map(e=>({id:e+4,machineName:`Dryer ${e}`,machineType:"dryer",status:"available",branch:"Main Store"}))],le=[{key:"branch",value:"Main Store"},{key:"fold_rate",value:"5"},{key:"report_email",value:"admin@laba101.test"}];function k(e,t,a,n,r,s,o,i,c,l,p){return{id:e,name:t,description:a,category:n,serviceType:r,price:s,maxKg:o,dryingMinutes:i,includes:c,additionalCharge:l,turnaroundHours:p,isActive:1}}function Se(e){return`laba101-mobile-${e}`}function S(e,t){const a=localStorage.getItem(Se(e));if(!a)return structuredClone(t);try{return JSON.parse(a)}catch{return structuredClone(t)}}function w(e,t){localStorage.setItem(Se(e),JSON.stringify(t))}function M(e){return e.reduce((t,a)=>Math.max(t,a.id),0)+1}function G(){return new Date().toISOString()}function ye(e=new Date){const t=e.getFullYear(),a=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0");return`${t}-${a}-${n}`}function ht(){return ye().slice(2).replaceAll("-","")}function de(e,t){if(!e)return t;try{return JSON.parse(e)}catch{return t}}async function N(){return z||(z=await pt.createConnection(ft,!1,"no-encryption",1,!1),await z.open()),z}async function D(e,t,a,n){((await e.query(`PRAGMA table_info(${t})`)).values??[]).some(o=>o.name===a)||await e.execute(`ALTER TABLE ${t} ADD COLUMN ${a} ${n}`)}async function bt(){if(!E.isNativePlatform()){localStorage.getItem(Se("seeded_v3"))||(w("staff",W),w("customers",ne),w("services",se),w("item_categories",re),w("orders",H),w("payments",ie),w("fold_logs",[]),w("expenses",oe),w("sales",ce),w("machines",K),w("subcleanings",[]),w("settings",le),w("seeded_v3",!0));return}const e=await N();if(await e.execute(`
  ...
  `),await D(e,"staff","email","TEXT"),await D(e,"staff","password","TEXT"),await D(e,"staff","role","TEXT"),await D(e,"staff","isActive","INTEGER NOT NULL DEFAULT 1"),await e.run('UPDATE staff SET password = ? WHERE password IS NULL OR password = ""',["password"]),await e.run('UPDATE staff SET role = ? WHERE role IS NULL OR role = ""',["staff"]),await D(e,"orders","customerId","INTEGER NOT NULL DEFAULT 0"),await D(e,"orders","phone","TEXT"),await D(e,"orders","serviceId","INTEGER NOT NULL DEFAULT 0"),await D(e,"orders","itemCategoryId","INTEGER NOT NULL DEFAULT 0"),await D(e,"orders","itemCategory",'TEXT NOT NULL DEFAULT "Regular Clothes"'),await D(e,"orders","workflowCompleted","TEXT"),await D(e,"orders","weightKg","REAL NOT NULL DEFAULT 0"),await D(e,"orders","price","REAL NOT NULL DEFAULT 0"),await D(e,"orders","additionalCharge","REAL NOT NULL DEFAULT 0"),await D(e,"orders","extraServiceAmount","REAL NOT NULL DEFAULT 0"),await D(e,"orders","totalAmount","REAL NOT NULL DEFAULT 0"),await D(e,"orders","paidAmount","REAL NOT NULL DEFAULT 0"),await D(e,"orders","extras","TEXT"),await D(e,"orders","notes","TEXT"),await D(e,"orders","dueAt","TEXT"),await D(e,"orders","createdAt",'TEXT NOT NULL DEFAULT ""'),await D(e,"daily_sales","saleNumber","TEXT"),((await e.query("SELECT COUNT(*) as count FROM staff")).values?.[0]?.count??0)===0){for(const a of W)await e.run("INSERT INTO staff (id, name, email, password, role, branch, isActive) VALUES (?, ?, ?, ?, ?, ?, ?)",[a.id,a.name,a.email,a.password,a.role,a.branch,1]);for(const a of ne)await e.run("INSERT INTO customers (id, name, phone, address) VALUES (?, ?, ?, ?)",[a.id,a.name,a.phone,a.address]);for(const a of se)await e.run("INSERT INTO laundry_services (id, name, description, category, serviceType, price, maxKg, dryingMinutes, includes, additionalCharge, turnaroundHours, isActive) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",[a.id,a.name,a.description,a.category,a.serviceType,a.price,a.maxKg,a.dryingMinutes,JSON.stringify(a.includes),a.additionalCharge,a.turnaroundHours,a.isActive]);for(const a of re)await e.run("INSERT INTO item_categories (id, name, maxKg, additionalFee, isActive) VALUES (?, ?, ?, ?, ?)",[a.id,a.name,a.maxKg,a.additionalFee,a.isActive]);for(const a of H)await Me(e,a);for(const a of ie)await e.run("INSERT INTO payments (id, orderId, amount, method, reference, receivedAt, branch) VALUES (?, ?, ?, ?, ?, ?, ?)",[a.id,a.orderId,a.amount,a.method,a.reference,a.receivedAt,a.branch]);for(const a of oe)await e.run("INSERT INTO disbursement_expenses (id, expenseDate, number, name, category, description, amount) VALUES (?, ?, ?, ?, ?, ?, ?)",[a.id,a.expenseDate,a.number,a.name,a.category,a.description,a.amount]);for(const a of ce)await e.run("INSERT INTO daily_sales (id, saleDate, saleNumber, cashAmount, gcashAmount, totalAmount, notes) VALUES (?, ?, ?, ?, ?, ?, ?)",[a.id,a.saleDate,a.saleNumber,a.cashAmount,a.gcashAmount,a.totalAmount,a.notes]);for(const a of K)await e.run("INSERT INTO machines (id, machineName, machineType, status, branch) VALUES (?, ?, ?, ?, ?)",[a.id,a.machineName,a.machineType,a.status,a.branch]);for(const a of le)await e.run("INSERT INTO settings (key, value) VALUES (?, ?)",[a.key,a.value])}}async function Me(e,t){await e.run("INSERT INTO orders (id, ticket, customerId, customer, phone, serviceId, service, itemCategoryId, itemCategory, branch, status, workflowCompleted, weightKg, price, additionalCharge, extraServiceAmount, totalAmount, paidAmount, extras, notes, foldedBy, dueAt, createdAt) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",[t.id,t.ticket,t.customerId,t.customer,t.phone,t.serviceId,t.service,t.itemCategoryId,t.itemCategory,t.branch,t.status,JSON.stringify(t.workflowCompleted),t.weightKg,t.price,t.additionalCharge,t.extraServiceAmount,t.totalAmount,t.paidAmount,JSON.stringify(t.extras),t.notes,t.foldedBy,t.dueAt,t.createdAt])}function yt(e){const t=Number(e.paidAmount??0),a=Number(e.totalAmount??0),n=Number(e.foldedBy);return{id:Number(e.id),ticket:String(e.ticket),customerId:Number(e.customerId),customer:String(e.customer),phone:e.phone?String(e.phone):null,serviceId:Number(e.serviceId),service:String(e.service),itemCategoryId:Number(e.itemCategoryId),itemCategory:String(e.itemCategory),branch:String(e.branch),status:String(e.status),workflowCompleted:de(e.workflowCompleted,[]),weightKg:Number(e.weightKg),price:Number(e.price),additionalCharge:Number(e.additionalCharge),extraServiceAmount:Number(e.extraServiceAmount),totalAmount:a,paidAmount:t,balance:Number((a-t).toFixed(2)),extras:de(e.extras,[]),notes:e.notes?String(e.notes):null,foldedBy:Number.isFinite(n)&&n>0?n:null,foldedByName:e.foldedByName?String(e.foldedByName):null,dueAt:String(e.dueAt),createdAt:String(e.createdAt)}}async function gt(){await bt()}async function me(){return(await Te()).find(t=>t.key==="branch")?.value??"Main Store"}async function wt(){const e=await Te();return Number(e.find(t=>t.key==="fold_rate")?.value??"5")}async function Fe(e){return(await Te()).find(a=>a.key===e)?.value}async function Te(){return E.isNativePlatform()?(await(await N()).query("SELECT key, value FROM settings ORDER BY key")).values??[]:S("settings",le)}async function ee(e,t){if(!E.isNativePlatform()){const n=S("settings",le).filter(r=>r.key!==e);n.push({key:e,value:t}),w("settings",n);return}await(await N()).run("REPLACE INTO settings (key, value) VALUES (?, ?)",[e,t])}async function Et(e){return E.isNativePlatform()?(await(await N()).query('SELECT id, name, COALESCE(email, "") as email, COALESCE(password, "password") as password, COALESCE(role, "staff") as role, branch, COALESCE(isActive, 1) as isActive FROM staff WHERE branch = ? ORDER BY name ASC',[e])).values??[]:S("staff",W).filter(n=>n.branch===e)}async function je(){return E.isNativePlatform()?(await(await N()).query('SELECT id, name, COALESCE(email, "") as email, COALESCE(password, "password") as password, COALESCE(role, "staff") as role, branch, COALESCE(isActive, 1) as isActive FROM staff ORDER BY name ASC')).values??[]:S("staff",W)}async function _e(e,t){const a=e.trim().toLowerCase();return(await je()).find(r=>r.email.toLowerCase()===a&&r.password===t&&r.isActive!==0)??null}async function St(e){if(!E.isNativePlatform()){const a=S("staff",W);a.unshift({id:M(a),...e,isActive:1}),w("staff",a);return}await(await N()).run("INSERT INTO staff (name, email, password, role, branch, isActive) VALUES (?, ?, ?, ?, ?, ?)",[e.name,e.email,e.password,e.role,e.branch,1])}async function Ie(e,t){if(!E.isNativePlatform()){const s=S("staff",W),o=s.find(i=>i.id===e);o&&(Object.assign(o,t),w("staff",s));return}const a=await N(),n=[],r=[];for(const[s,o]of Object.entries(t))s!=="id"&&(n.push(`${s} = ?`),r.push(o));n.length&&(r.push(e),await a.run(`UPDATE staff SET ${n.join(", ")} WHERE id = ?`,r))}async function Tt(){return E.isNativePlatform()?(await(await N()).query("SELECT id, name, phone, address FROM customers ORDER BY name ASC")).values??[]:S("customers",ne).sort((a,n)=>a.name.localeCompare(n.name))}async function Nt(e){if(!E.isNativePlatform()){const r=S("customers",ne),s=e.id?r.find(i=>i.id===e.id):r.find(i=>i.name.toLowerCase()===e.name.toLowerCase()&&(e.phone?i.phone===e.phone:!0));if(s)return s.name=e.name,s.phone=e.phone??s.phone,s.address=e.address??s.address,w("customers",r),s;const o={id:M(r),name:e.name,phone:e.phone??null,address:e.address??null};return r.push(o),w("customers",r),o}const t=await N();if(e.id)return await t.run("UPDATE customers SET name = ?, phone = ?, address = ? WHERE id = ?",[e.name,e.phone??null,e.address??null,e.id]),{id:e.id,name:e.name,phone:e.phone??null,address:e.address??null};const a=await t.query("SELECT COALESCE(MAX(id), 0) + 1 as id FROM customers"),n=Number((a.values?.[0]).id);return await t.run("INSERT INTO customers (id, name, phone, address) VALUES (?, ?, ?, ?)",[n,e.name,e.phone??null,e.address??null]),{id:n,name:e.name,phone:e.phone??null,address:e.address??null}}async function Ne(e){return E.isNativePlatform()?((await(await N()).query("SELECT id, name, description, category, serviceType, price, maxKg, dryingMinutes, includes, additionalCharge, turnaroundHours, isActive FROM laundry_services  ORDER BY name ASC",[])).values??[]).map(n=>({...n,includes:de(n.includes,[])})):S("services",se).filter(n=>!0)}async function qe(e){if(!E.isNativePlatform()){const a=S("services",se),n=e.id?a.find(r=>r.id===e.id):null;n?Object.assign(n,e):a.unshift({...e,id:M(a)}),w("services",a);return}const t=await N();e.id?await t.run("UPDATE laundry_services SET name = ?, description = ?, category = ?, serviceType = ?, price = ?, maxKg = ?, dryingMinutes = ?, includes = ?, additionalCharge = ?, turnaroundHours = ?, isActive = ? WHERE id = ?",[e.name,e.description,e.category,e.serviceType,e.price,e.maxKg,e.dryingMinutes,JSON.stringify(e.includes),e.additionalCharge,e.turnaroundHours,e.isActive,e.id]):await t.run("INSERT INTO laundry_services (name, description, category, serviceType, price, maxKg, dryingMinutes, includes, additionalCharge, turnaroundHours, isActive) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",[e.name,e.description,e.category,e.serviceType,e.price,e.maxKg,e.dryingMinutes,JSON.stringify(e.includes),e.additionalCharge,e.turnaroundHours,e.isActive])}async function Be(){return E.isNativePlatform()?(await(await N()).query("SELECT id, name, maxKg, additionalFee, isActive FROM item_categories WHERE isActive = 1 ORDER BY name ASC")).values??[]:S("item_categories",re).filter(a=>a.isActive)}async function At(e){if(!E.isNativePlatform()){const a=S("item_categories",re),n=e.id?a.find(r=>r.id===e.id):null;n?Object.assign(n,e):a.unshift({...e,id:M(a)}),w("item_categories",a);return}const t=await N();e.id?await t.run("UPDATE item_categories SET name = ?, maxKg = ?, additionalFee = ?, isActive = ? WHERE id = ?",[e.name,e.maxKg,e.additionalFee,e.isActive,e.id]):await t.run("INSERT INTO item_categories (name, maxKg, additionalFee, isActive) VALUES (?, ?, ?, ?)",[e.name,e.maxKg,e.additionalFee,e.isActive])}function ge(e,t,a,n){const r=Number(t.maxKg),s=Math.max(0,a-r),o=0,i=n.reduce((p,h)=>p+Number(h.price),0),c=n.map(p=>({id:p.id,name:vt(p.name),price:Number(p.price)})),l=Number((Number(e.price)+o+i).toFixed(2));return{price:Number(e.price),additionalCharge:Number(o.toFixed(2)),extraServiceAmount:Number(i.toFixed(2)),totalAmount:l,allowedKg:r,extraKg:Number(s.toFixed(2)),warning:s>0?`Weight exceeds the ${t.name} load limit of ${r.toFixed(2)} kg.`:null,extras:c}}function Ke(e,t){const a=t.find(s=>s.id===e.serviceId),n=a?.includes??[],r=[{key:"received",label:"Received"}];return n.includes("Wash")&&r.push({key:"wash",label:"Wash"}),e.extras.length&&r.push({key:"extras",label:"Extra services"}),(n.includes("Dry")||(a?.dryingMinutes??0)>0)&&r.push({key:"dry",label:"Dry"}),n.includes("Fold")&&r.push({key:"fold",label:"Fold"}),r.push({key:"ready",label:"Ready"},{key:"claimed",label:"Claimed"}),r}function Lt(e){return e.includes("claimed")?"claimed":e.includes("ready")?"ready":e.includes("dry")?"drying":e.includes("extras")||e.includes("wash")?"washing":"received"}async function ve(e){return E.isNativePlatform()?((await(await N()).query("SELECT o.*, s.name as foldedByName FROM orders o LEFT JOIN staff s ON s.id = o.foldedBy WHERE o.branch = ? ORDER BY o.id DESC",[e])).values??[]).map(n=>yt(n)):S("orders",H).filter(n=>n.branch===e).map(n=>({...n,balance:Number((n.totalAmount-n.paidAmount).toFixed(2))}))}async function Ct(e){const[t,a]=await Promise.all([Ne(),Be()]),n=t.find(T=>T.id===e.serviceId),r=a.find(T=>T.id===e.itemCategoryId);if(!n||!r)throw new Error("Service or item category is missing.");const s=t.filter(T=>e.addonIds.includes(T.id)),o=ge(n,r,e.weightKg,s);if(o.extraKg>0)throw new Error(o.warning??"Weight exceeds the allowed limit.");const i=await Nt({id:e.customerId||void 0,name:e.customerName,phone:e.customerPhone??null}),c=Math.max(0,e.paidAmount),l=Math.min(o.totalAmount,c),p={ticket:await $t(),customerId:i.id,customer:i.name,phone:i.phone,serviceId:n.id,service:n.name,itemCategoryId:r.id,itemCategory:r.name,branch:e.branch,status:"received",workflowCompleted:["received"],weightKg:e.weightKg,price:o.price,additionalCharge:o.additionalCharge,extraServiceAmount:o.extraServiceAmount,totalAmount:o.totalAmount,paidAmount:l,balance:Number((o.totalAmount-l).toFixed(2)),extras:o.extras,notes:[e.notes,o.warning].filter(Boolean).join(`
`)||null,foldedBy:null,foldedByName:null,dueAt:new Date(Date.now()+n.turnaroundHours*60*60*1e3).toISOString(),createdAt:G()};if(!E.isNativePlatform()){const T=S("orders",H),m={...p,id:M(T)};return T.unshift(m),w("orders",T),c>0&&await Xe(m.id,{amount:c,method:e.paymentMethod,reference:e.paymentReference??null}),m}const h=await N(),u=await h.query("SELECT COALESCE(MAX(id), 0) + 1 as id FROM orders"),R={...p,id:Number((u.values?.[0]).id)};return await Me(h,R),c>0&&await h.run("INSERT INTO payments (orderId, amount, method, reference, receivedAt, branch) VALUES (?, ?, ?, ?, ?, ?)",[R.id,c,e.paymentMethod,e.paymentReference??null,G(),e.branch]),R}async function $t(){const e=`LB${ht()}`,t=await me(),n=(await ve(t)).filter(s=>s.ticket.startsWith(e)).sort((s,o)=>o.ticket.localeCompare(s.ticket))[0],r=n?Number(n.ticket.slice(-3))+1:1;return`${e}-${String(r).padStart(3,"0")}`}async function Ot(e,t){const a=await me(),[n,r]=await Promise.all([ve(a),Ne()]),s=n.find(l=>l.id===e);if(!s)return;const i=Ke(s,r).map(l=>l.key).find(l=>!s.workflowCompleted.includes(l));if(!i)return;if(s.workflowCompleted=[...s.workflowCompleted,i],s.status=Lt(s.workflowCompleted),i==="fold"&&t&&(s.foldedBy=t),!E.isNativePlatform()){const l=S("orders",H),p=l.find(h=>h.id===s.id);p&&Object.assign(p,s),w("orders",l);return}await(await N()).run("UPDATE orders SET workflowCompleted = ?, status = ?, foldedBy = ? WHERE id = ?",[JSON.stringify(s.workflowCompleted),s.status,s.foldedBy,s.id])}async function Xe(e,t){const a=await me();if(!(await ve(a)).find(i=>i.id===e))return;const s=Math.max(0,t.amount);if(s<=0)return;if(!E.isNativePlatform()){const i=S("payments",ie);i.unshift({id:M(i),orderId:e,amount:s,method:t.method,reference:t.reference??null,receivedAt:G(),branch:a}),w("payments",i);const c=S("orders",H),l=c.find(p=>p.id===e);l&&(l.paidAmount=Math.min(l.totalAmount,Number((l.paidAmount+s).toFixed(2)))),w("orders",c);return}const o=await N();await o.run("INSERT INTO payments (orderId, amount, method, reference, receivedAt, branch) VALUES (?, ?, ?, ?, ?, ?)",[e,s,t.method,t.reference??null,G(),a]),await o.run("UPDATE orders SET paidAmount = MIN(totalAmount, paidAmount + ?) WHERE id = ?",[s,e])}async function Pt(e){return E.isNativePlatform()?(await(await N()).query("SELECT id, orderId, amount, method, reference, receivedAt, branch FROM payments  ORDER BY receivedAt DESC",[])).values??[]:S("payments",ie).filter(n=>!0)}async function Rt(){return E.isNativePlatform()?(await(await N()).query("SELECT id, orderTicket, staffName, foldCount, rate, total, createdAt FROM fold_logs ORDER BY id DESC")).values??[]:S("fold_logs",[])}async function Dt(e){const t=Number((e.foldCount*e.rate).toFixed(2));if(!E.isNativePlatform()){const n=S("fold_logs",[]);n.unshift({id:Date.now(),...e,total:t,createdAt:G()}),w("fold_logs",n);return}await(await N()).run("INSERT INTO fold_logs (orderTicket, staffName, foldCount, rate, total, createdAt) VALUES (?, ?, ?, ?, ?, ?)",[e.orderTicket,e.staffName,e.foldCount,e.rate,t,G()])}async function xt(){return E.isNativePlatform()?(await(await N()).query("SELECT id, expenseDate, number, name, category, description, amount FROM disbursement_expenses ORDER BY expenseDate DESC, id DESC")).values??[]:S("expenses",oe)}async function It(e){if(!E.isNativePlatform()){const r=S("expenses",oe),s=M(r);r.unshift({id:s,expenseDate:e.expenseDate,number:`DISB-${String(s).padStart(2,"0")}`,name:e.name,category:e.category,description:e.description||null,amount:e.amount}),w("expenses",r);return}const t=await N(),a=await t.query("SELECT COALESCE(MAX(id), 0) + 1 as id FROM disbursement_expenses"),n=Number((a.values?.[0]).id);await t.run("INSERT INTO disbursement_expenses (expenseDate, number, name, category, description, amount) VALUES (?, ?, ?, ?, ?, ?)",[e.expenseDate,`DISB-${String(n).padStart(2,"0")}`,e.name,e.category,e.description||null,e.amount])}async function qt(){return E.isNativePlatform()?(await(await N()).query('SELECT id, saleDate, COALESCE(saleNumber, "") as saleNumber, cashAmount, gcashAmount, totalAmount, notes FROM daily_sales ORDER BY saleDate DESC, id DESC')).values??[]:S("sales",ce)}async function Ut(e){const t=Number((e.cashAmount+e.gcashAmount).toFixed(2));if(!E.isNativePlatform()){const s=S("sales",ce),o=s.find(i=>i.saleDate===e.saleDate);if(o)Object.assign(o,{cashAmount:e.cashAmount,gcashAmount:e.gcashAmount,totalAmount:t,notes:e.notes||null});else{const i=M(s);s.unshift({id:i,saleDate:e.saleDate,saleNumber:`SALE-${String(i).padStart(2,"0")}`,cashAmount:e.cashAmount,gcashAmount:e.gcashAmount,totalAmount:t,notes:e.notes||null})}w("sales",s);return}const a=await N(),r=(await a.query("SELECT id, saleNumber FROM daily_sales WHERE saleDate = ?",[e.saleDate])).values?.[0];if(r)await a.run("UPDATE daily_sales SET cashAmount = ?, gcashAmount = ?, totalAmount = ?, notes = ? WHERE id = ?",[e.cashAmount,e.gcashAmount,t,e.notes||null,r.id]);else{const s=await a.query("SELECT COALESCE(MAX(id), 0) + 1 as id FROM daily_sales"),o=Number((s.values?.[0]).id);await a.run("INSERT INTO daily_sales (saleDate, saleNumber, cashAmount, gcashAmount, totalAmount, notes) VALUES (?, ?, ?, ?, ?, ?)",[e.saleDate,`SALE-${String(o).padStart(2,"0")}`,e.cashAmount,e.gcashAmount,t,e.notes||null])}}async function We(e){return E.isNativePlatform()?(await(await N()).query("SELECT id, machineName, machineType, status, branch FROM machines WHERE branch = ? ORDER BY machineType, machineName",[e])).values??[]:S("machines",K).filter(n=>n.branch===e)}async function kt(e){if(!E.isNativePlatform()){const a=S("machines",K);a.unshift({id:M(a),...e}),w("machines",a);return}await(await N()).run("INSERT INTO machines (machineName, machineType, status, branch) VALUES (?, ?, ?, ?)",[e.machineName,e.machineType,e.status,e.branch])}async function Mt(e,t){if(!E.isNativePlatform()){const n=S("machines",K),r=n.find(s=>s.id===e);r&&(r.status=t,w("machines",n));return}await(await N()).run("UPDATE machines SET status = ? WHERE id = ?",[t,e])}async function Ft(e){return E.isNativePlatform()?((await(await N()).query("SELECT id, date, machineIds, machineNames, cleaningStatus, notes, branch FROM subcleanings WHERE branch = ? ORDER BY date DESC, id DESC",[e])).values??[]).map(n=>({...n,machineIds:de(n.machineIds,[])})):S("subcleanings",[]).filter(n=>n.branch===e)}async function jt(e){const a=(await We(e.branch)).filter(s=>e.machineIds.includes(s.id)).map(s=>s.machineName).join(", ");if(!E.isNativePlatform()){const s=S("subcleanings",[]);s.unshift({id:M(s),date:e.date,machineIds:e.machineIds,machineNames:a,cleaningStatus:e.cleaningStatus,notes:e.notes||null,branch:e.branch}),w("subcleanings",s);const o=S("machines",K);o.forEach(i=>{e.machineIds.includes(i.id)&&(i.status=e.cleaningStatus==="completed"?"available":"under_cleaning")}),w("machines",o);return}const n=await N();await n.run("INSERT INTO subcleanings (date, machineIds, machineNames, cleaningStatus, notes, branch) VALUES (?, ?, ?, ?, ?, ?)",[e.date,JSON.stringify(e.machineIds),a,e.cleaningStatus,e.notes||null,e.branch]);const r=e.cleaningStatus==="completed"?"available":"under_cleaning";for(const s of e.machineIds)await n.run("UPDATE machines SET status = ? WHERE id = ?",[r,s])}async function _t(e,t){if(!E.isNativePlatform()){const o=S("machines",K),i=o.find(p=>p.id===e);i&&(i.status="available"),w("machines",o);const c=S("subcleanings",[]),l=ye();c.unshift({id:M(c),date:l,machineIds:[e],machineNames:i?.machineName??"",cleaningStatus:"completed",notes:null,branch:t}),w("subcleanings",c);return}const a=await N(),r=(await a.query("SELECT machineName FROM machines WHERE id = ?",[e])).values?.[0]?.machineName??"";await a.run("UPDATE machines SET status = ? WHERE id = ?",["available",e]);const s=ye();await a.run("INSERT INTO subcleanings (date, machineIds, machineNames, cleaningStatus, notes, branch) VALUES (?, ?, ?, ?, ?, ?)",[s,JSON.stringify([e]),r,"completed",null,t])}const Ae=document.querySelector("#app");if(!Ae)throw new Error("App root not found");let Z;const Le={dashboard:"Dashboard",orders:"POS / Orders",customers:"Customers",pricing:"Pricing Services",disbursements:"Daily Report",reports:"Reports",inventory:"Inventory",maintenance:"Maintenance",staff:"Staff",settings:"Settings"},f={tab:"dashboard",receiptOrderId:0,currentUser:null,loginError:"",sidebarOpen:!1,dailyReportTab:"expenses",maintenanceTab:"cleaning"},V="laba101-mobile-session";function $(e){return new Intl.NumberFormat("en-PH",{style:"currency",currency:"PHP"}).format(e||0)}function d(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function fe(e){return e.replace(/^(add[- ]?on|additional)\s+/i,"").trim()}function He(e,t){const a=new Map;return e.filter(n=>n.workflowCompleted.includes("fold")&&n.foldedByName).forEach(n=>{const r=n.foldedByName,s=a.get(r)??{staffName:r,folds:0,rate:t,total:0};s.folds+=1,s.total=Number((s.folds*s.rate).toFixed(2)),a.set(r,s)}),Array.from(a.values())}function ue(e=new Date){const t=e.getFullYear(),a=String(e.getMonth()+1).padStart(2,"0"),n=String(e.getDate()).padStart(2,"0");return`${t}-${a}-${n}`}function j(){return ue()}function te(e){return ue(new Date(e))}function Bt(e){return new Intl.DateTimeFormat("en-PH",{dateStyle:"medium",timeStyle:"short"}).format(new Date(e))}function Ge(e=new Date){return{date:new Intl.DateTimeFormat("en-PH",{weekday:"long",month:"long",day:"numeric",year:"numeric"}).format(e),time:new Intl.DateTimeFormat("en-PH",{hour:"numeric",minute:"2-digit",second:"2-digit",hour12:!0}).format(e)}}function Kt(e,t){return`<button class="nav-link ${t?"is-active":""}" data-tab="${e}" type="button">
    <span class="nav-icon">${Xt(e)}</span>
    <span>${Le[e]}</span>
  </button>`}function x(e,t){return`<div class="section-head"><div><h2>${d(e)}</h2><p class="meta">${d(t)}</p></div></div>`}function Ue(){return Le[f.tab]??"Dashboard"}function he(e){return(e?.name??"Laba101").trim().slice(0,1).toUpperCase()}function Xt(e){return{dashboard:"DB",orders:"PO",customers:"CU",pricing:"PS",disbursements:"DR",reports:"RP",inventory:"IN",maintenance:"MT",staff:"ST",settings:"SE"}[e]}async function Wt(){const e=await me(),t=await Et(e),a=await je(),n=await Tt(),r=await Ne(),s=await Be(),o=await ve(e),i=await Pt(),c=await Rt(),l=await xt(),p=await qt(),h=await We(e),u=await Ft(e),R=await wt(),T=await Fe("report_email");return{branch:e,staff:t,allStaff:a,customers:n,services:r,categories:s,orders:o,payments:i,foldLogs:c,expenses:l,sales:p,machines:h,subcleanings:u,foldRate:R,reportEmail:T??""}}async function L(){if(!f.currentUser){Ht(),oa();return}const e=await Wt(),t=e.orders.filter(s=>s.status!=="claimed").length,a=e.orders.filter(s=>s.status==="ready").length;e.orders.reduce((s,o)=>s+o.paidAmount,0);const n=e.orders.filter(s=>te(s.createdAt)===j()).reduce((s,o)=>s+o.paidAmount,0);e.sales.reduce((s,o)=>s+o.totalAmount,0);const r=He(e.orders,e.foldRate).reduce((s,o)=>s+o.total,0);e.expenses.reduce((s,o)=>s+o.amount,0)+r,Ae.innerHTML=`
    <div class="app-frame">
      <header class="topbar">
      ...
      <aside class="sidebar ${f.sidebarOpen?"is-open":""}">
        ...
        <nav>${Ye().map(s=>Kt(s,f.tab===s)).join("")}</nav>
      ...
      <main class="workspace">
        ...
        ${f.tab==="dashboard"?Yt({openQueue:t,readyPickup:a,customerCount:e.customers.length,paidToday:n,orders:e.orders}):""}
        ${f.tab==="orders"?Vt(e.orders,e.customers,e.services,e.categories,e.staff,e.payments,e.branch):""}
        ${f.tab==="customers"?zt(e.customers,e.orders):""}
        ${f.tab==="pricing"?Zt(e.services,e.categories):""}
        ${f.tab==="disbursements"?ea(e.expenses,e.sales):""}
        ${f.tab==="reports"?ta(e.orders,e.sales,e.expenses,e.foldRate):""}
        ${f.tab==="inventory"?aa(e.services,e.categories):""}
        ${f.tab==="maintenance"?na(e.machines,e.subcleanings,e.branch):""}
        ${f.tab==="staff"?sa(e.allStaff,e.branch):""}
        ${f.tab==="settings"?ra(e.branch,e.foldRate,e.reportEmail):""}
      </main>
    </div>
  `,ia(),la(e),da(e.services),ua(),ma(e.orders,e.sales,e.expenses,e.foldRate),va(),fa(e.allStaff),pa(),ca()}function Ye(){return f.currentUser?.role==="admin"?Object.keys(Le).filter(e=>e!=="inventory"):["orders","disbursements","reports","maintenance"]}function Ht(){Ae.innerHTML=`
  ...
  `}function Gt(){document.querySelectorAll("[data-fill-email]").forEach(e=>{e.addEventListener("click",()=>{const t=document.querySelector('input[name="email"]'),a=document.querySelector('input[name="password"]');t&&(t.value=e.dataset.fillEmail??""),a&&(a.value=e.dataset.fillPassword??"")})})}function Yt(e){const t=e.orders.slice(0,3),a=new Date,n=Ge(a),r=Array.from({length:7},(s,o)=>{const i=new Date(a);return i.setDate(a.getDate()-(6-o)),new Intl.DateTimeFormat("en-PH",{month:"short",day:"numeric"}).format(i)});return`
    ...
    <section class="dashboard-main">
      ...
      <article class="panel recent-panel">
        ${x("Recent activities","Latest tickets and workflow movements.")}
  ...
  `}function Vt(e,t,a,n,r,s,o){const i=a.filter(u=>u.serviceType==="order"&&u.isActive),c=a.filter(u=>u.serviceType==="addon"&&u.isActive),l=f.receiptOrderId?e.find(u=>u.id===f.receiptOrderId):null,p=new Set(e.map(u=>u.customerId)),h=t.filter(u=>p.has(u.id));return`
    <section class="grid content full">
      <article class="panel">
        ...
        <form id="order-form" class="form">
          ...
          <fieldset class="check-grid">
            ...
            ${c.length?c.map(u=>`<label class="check"><input type="checkbox" name="addonIds" value="${u.id}" /> ${d(fe(u.name))} ${$(u.price)}</label>`).join(""):'<p class="helper">No extra services configured.</p>'}
          </fieldset>
      ...
      <article class="panel">
        ...
        <div class="table orders-table">
          ...
          ${e.map(u=>Jt(u,r,a)).join("")||'<div class="helper">No orders yet.</div>'}
        </div>
      </article>
      ${l?Qt(l,s.filter(u=>u.orderId===l.id)):""}
    </section>
  `}function Jt(e,t,a){const n=Ke(e,a),r=n.find(i=>!e.workflowCompleted.includes(i.key)),s=r?.key==="fold",o=r?.key==="extras"&&e.extras.length>0;return`
    <div class="table-row">
      ...
      <div class="row-actions">
        ${r?`<form class="inline-form advance-form" data-order-id="${e.id}">
          ${o?`<div class="extra-confirmation">Confirm extra service: <strong>${e.extras.map(i=>d(fe(i.name))).join(", ")}</strong></div>`:""}
  ...
  `}function Qt(e,t){const a=t.reduce((r,s)=>r+Number(s.amount),0),n=Math.max(0,Number((a-e.totalAmount).toFixed(2)));return`
      ...
      <div class="receipt-modal" role="dialog" aria-modal="true" aria-labelledby="receipt-title">
        ...
        <div class="receipt" id="receipt-print-area">
          <div class="receipt-head">
            ...
            <p>${d(e.ticket)}<br>${d(Bt(e.createdAt))}</p>
          </div>
          ...
          <div class="summary-list receipt-lines">
            ...
            ${e.extras.length?`<div><span>Extra services</span><strong>${e.extras.map(r=>d(fe(r.name))).join(", ")}</strong></div>`:""}
  ...
  `}function zt(e,t){return`
    <section class="grid content full">
      ...
      <article class="panel">
        ${x("Customer list","Names, phones, and addresses")}
        <div class="table">
  ...
  `}function ea(e,t){const a=j(),n=a.slice(0,7),r=e.filter(c=>c.expenseDate===a).reduce((c,l)=>c+l.amount,0),s=e.filter(c=>c.expenseDate.startsWith(n)).reduce((c,l)=>c+l.amount,0),o=t.filter(c=>c.saleDate===a).reduce((c,l)=>c+l.totalAmount,0),i=t.filter(c=>c.saleDate.startsWith(n)).reduce((c,l)=>c+l.totalAmount,0);return`
    ...
    `}
  `}function ta(e,t,a,n,r,s,o){return`
    <section class="page-head">
      <div>
  ...
  `}function na(e,t,a){const n=e.filter(s=>s.status!=="under_cleaning"),r=e.filter(s=>s.status==="under_cleaning");return`
    <section class="page-head">
      <div>
  ...
  `}function ia(){const e=()=>{localStorage.removeItem(V),f.currentUser=null,f.tab="dashboard",f.receiptOrderId=0,f.sidebarOpen=!1,L()};document.querySelector("#logout-button")?.addEventListener("click",e),document.querySelector("#mobile-logout-button")?.addEventListener("click",e),document.querySelector("#mobile-menu-button")?.addEventListener("click",()=>{f.sidebarOpen=!0,L()}),document.querySelector("#sidebar-close-button")?.addEventListener("click",()=>{f.sidebarOpen=!1,L()}),document.querySelector("#sidebar-backdrop")?.addEventListener("click",()=>{f.sidebarOpen=!1,L()}),document.querySelectorAll("[data-tab]").forEach(t=>{t.addEventListener("click",()=>{f.tab=t.dataset.tab,f.receiptOrderId=0,f.sidebarOpen=!1,L()})}),document.querySelectorAll("[data-quick-tab]").forEach(t=>{t.addEventListener("click",()=>{f.tab=t.dataset.quickTab,L()})}),document.querySelectorAll("[data-receipt]").forEach(t=>{t.addEventListener("click",()=>{f.receiptOrderId=Number(t.dataset.receipt),L()})}),document.querySelector("[data-close-receipt]")?.addEventListener("click",()=>{f.receiptOrderId=0,L()}),document.querySelector("[data-print-receipt]")?.addEventListener("click",()=>{window.print()}),document.querySelectorAll("[data-report-tab]").forEach(t=>{t.addEventListener("click",()=>{f.dailyReportTab=t.dataset.reportTab,L()})}),document.querySelectorAll("[data-maintenance-tab]").forEach(t=>{t.addEventListener("click",()=>{f.maintenanceTab=t.dataset.maintenanceTab,L()})})}function oa(){Gt(),document.querySelector("#login-form")?.addEventListener("submit",async e=>{e.preventDefault();const t=new FormData(e.currentTarget),a=document.querySelector("#login-button");a&&(a.disabled=!0,a.textContent="Signing in...");try{const n=await _e(String(t.get("email")??""),String(t.get("password")??""));if(!n){f.loginError="Invalid email or password.",await L();return}f.currentUser=n,f.loginError="",await ee("branch",String(n.branch||"Main Store")),t.get("remember")?localStorage.setItem(V,JSON.stringify({email:n.email,remembered:!0})):localStorage.removeItem(V),Ye().includes(f.tab)||(f.tab="dashboard"),await L()}catch(n){alert("Login Error: "+String(n?.message||n)),a&&(a.disabled=!1,a.textContent="Sign in")}})}function ca(){Z&&window.clearInterval(Z);const e=document.querySelector("[data-dashboard-time]"),t=document.querySelector("[data-dashboard-date]");if(!e||!t){Z=void 0;return}const a=()=>{const n=Ge();e.textContent=n.time,t.textContent=n.date};a(),Z=window.setInterval(a,1e3)}function la(e){const t=document.querySelector("#order-form"),a=document.querySelector("#price-preview"),n=t?.querySelector('button[type="submit"]'),r=t?.querySelector('select[name="customerId"]'),s=t?.querySelector('input[name="customerName"]'),o=t?.querySelector('input[name="customerPhone"]'),i=t?.querySelector("[data-category-weight]"),c=t?.querySelector("[data-order-error]"),l=t?.querySelector('select[name="paymentMethod"]'),p=t?.querySelector(".gcash-reference"),h=t?.querySelector('input[name="paymentReference"]'),u=()=>{if(!r||!s||!o)return;const m=r.selectedOptions[0];s.value=m?.dataset.name??"",o.value=m?.dataset.phone??""},R=()=>{const m=l?.value==="gcash";p&&(p.hidden=!m),h&&(h.required=m,m||(h.value=""))},T=()=>{if(!t||!a)return;const m=new FormData(t),v=e.services.find(P=>P.id===Number(m.get("serviceId"))),y=e.categories.find(P=>P.id===Number(m.get("itemCategoryId"))),C=e.services.filter(P=>m.getAll("addonIds").map(Number).includes(P.id));if(!v||!y)return;const A=ge(v,y,Number(m.get("weightKg")??0),C);i&&(i.textContent=`Allowed item weight: ${y.maxKg} kg`);const g=C.map(P=>fe(P.name)),q=A.extraKg>0;n&&(n.disabled=q),c&&(c.hidden=!q,c.textContent=A.warning??""),a.classList.toggle("has-error",q),a.innerHTML=`
      <div class="preview-line"><span>Base price</span><strong>${$(A.price)}</strong></div>
      ${A.extraServiceAmount>0?`<div class="preview-line"><span>Extra services${g.length?` (${d(g.join(", "))})`:""}</span><strong>${$(A.extraServiceAmount)}</strong></div>`:""}
      <div class="preview-total"><span>Total amount</span><strong>${$(A.totalAmount)}</strong></div>
      ${A.warning?`<span class="warn">${d(A.warning)}</span>`:""}
    `};r?.addEventListener("change",u),l?.addEventListener("change",R),R(),t?.addEventListener("input",T),t?.addEventListener("change",T),T(),t?.addEventListener("submit",async m=>{m.preventDefault();const v=new FormData(t),y=e.services.find(g=>g.id===Number(v.get("serviceId"))),C=e.categories.find(g=>g.id===Number(v.get("itemCategoryId"))),A=e.services.filter(g=>v.getAll("addonIds").map(Number).includes(g.id));if(y&&C){const g=ge(y,C,Number(v.get("weightKg")??0),A);if(g.extraKg>0){c&&(c.hidden=!1,c.textContent=g.warning??"Weight exceeds the allowed limit.");return}}try{await Ct({customerId:Number(v.get("customerId"))||void 0,customerName:String(v.get("customerName")??""),customerPhone:String(v.get("customerPhone")??"")||null,serviceId:Number(v.get("serviceId")),itemCategoryId:Number(v.get("itemCategoryId")),branch:e.branch,weightKg:Number(v.get("weightKg")),addonIds:v.getAll("addonIds").map(Number),paidAmount:Number(v.get("paidAmount")??0),paymentMethod:String(v.get("paymentMethod")??"cash"),paymentReference:String(v.get("paymentReference")??"")||null,notes:String(v.get("notes")??"")||null}),await L()}catch(g){c&&(c.hidden=!1,c.textContent=g instanceof Error?g.message:"Order could not be saved.")}}),document.querySelectorAll(".advance-form").forEach(m=>{m.addEventListener("submit",async v=>{v.preventDefault();const y=new FormData(m);await Ot(Number(m.dataset.orderId),Number(y.get("assignedStaffId"))||null),await L()})}),document.querySelectorAll(".payment-form").forEach(m=>{const v=m.querySelector('select[name="method"]'),y=m.querySelector('input[name="reference"]'),C=()=>{const A=v?.value==="gcash";y&&(y.hidden=!A,y.required=A,A||(y.value=""))};v?.addEventListener("change",C),C(),m.addEventListener("submit",async A=>{A.preventDefault();const g=new FormData(m);await Xe(Number(m.dataset.orderId),{amount:Number(g.get("amount")),method:String(g.get("method")),reference:String(g.get("reference")??"")||null}),await L()})})}function da(e){document.querySelector("#service-form")?.addEventListener("submit",async t=>{t.preventDefault();const a=new FormData(t.currentTarget),n=a.get("id")?Number(a.get("id")):void 0;await qe({id:n,name:String(a.get("name")??""),description:String(a.get("description")??"")||null,category:String(a.get("category")??""),serviceType:String(a.get("serviceType")??"order"),price:Number(a.get("price")??0),maxKg:Number(a.get("maxKg")??0),dryingMinutes:Number(a.get("dryingMinutes"))||null,includes:String(a.get("includes")??"").split(",").map(r=>r.trim()).filter(Boolean),additionalCharge:0,turnaroundHours:Number(a.get("turnaroundHours")??24),isActive:1}),await L()}),document.querySelectorAll(".edit-service-btn").forEach(t=>{t.addEventListener("click",()=>{const a=Number(t.dataset.id),n=e.find(s=>s.id===a),r=document.querySelector("#service-form");n&&r&&(r.querySelector("[name=id]").value=String(n.id),r.querySelector("[name=name]").value=n.name,r.querySelector("[name=category]").value=n.category,r.querySelector("[name=serviceType]").value=n.serviceType,r.querySelector("[name=price]").value=String(n.price),r.querySelector("[name=maxKg]").value=String(n.maxKg),r.querySelector("[name=dryingMinutes]").value=n.dryingMinutes?String(n.dryingMinutes):"",r.querySelector("[name=includes]").value=n.includes.join(", "),r.querySelector("[name=turnaroundHours]").value=String(n.turnaroundHours),r.querySelector("[name=description]").value=n.description??"",window.scrollTo({top:0,behavior:"smooth"}))})}),document.querySelectorAll(".deactivate-service-btn, .activate-service-btn").forEach(t=>{t.addEventListener("click",async()=>{const a=Number(t.dataset.id),n=e.find(r=>r.id===a);if(n){const r=n.isActive?0:1;await qe({id:n.id,name:n.name,description:n.description,category:n.category,serviceType:n.serviceType,price:n.price,maxKg:n.maxKg,dryingMinutes:n.dryingMinutes,includes:n.includes,additionalCharge:n.additionalCharge,turnaroundHours:n.turnaroundHours,isActive:r}),await L()}})}),document.querySelector("#category-form")?.addEventListener("submit",async t=>{t.preventDefault();const a=new FormData(t.currentTarget);await At({name:String(a.get("name")??""),maxKg:Number(a.get("maxKg")??0),additionalFee:Number(a.get("additionalFee")??0),isActive:1}),await L()})}function ua(){document.querySelector("#expense-form")?.addEventListener("submit",async e=>{e.preventDefault();const t=new FormData(e.currentTarget);await It({expenseDate:String(t.get("expenseDate")??""),name:String(t.get("name")??""),category:String(t.get("category")??""),description:String(t.get("description")??""),amount:Number(t.get("amount")??0)}),await L()}),document.querySelector("#fold-form")?.addEventListener("submit",async e=>{e.preventDefault();const t=new FormData(e.currentTarget);await Dt({orderTicket:String(t.get("orderTicket")??""),staffName:String(t.get("staffName")??""),foldCount:Number(t.get("foldCount")??1),rate:Number(t.get("rate")??5)}),await L()})}function ma(e,t,a,n){document.querySelector("#sales-form")?.addEventListener("submit",async m=>{m.preventDefault();const v=new FormData(m.currentTarget);await Ut({saleDate:String(v.get("saleDate")??""),cashAmount:Number(v.get("cashAmount")??0),gcashAmount:Number(v.get("gcashAmount")??0),notes:String(v.get("notes")??"")}),await L()});const r=document.querySelector("[data-date-from]"),s=document.querySelector("[data-date-to]");document.querySelectorAll("[data-date-scope]").forEach(m=>{m.addEventListener("change",()=>{if(!m.checked||!r||!s)return;const v=new Date,y=ue(v),C=new Date(v);m.value==="week"&&C.setDate(v.getDate()-6),m.value==="month"&&C.setDate(1),m.value!=="custom"&&(r.value=m.value==="today"?y:ue(C),s.value=y)})});const o=()=>new Set(Array.from(document.querySelectorAll('input[name="reportType"]:checked')).map(m=>m.value)),i=()=>({from:r?.value||"0000-01-01",to:s?.value||"9999-12-31"}),c=m=>{const v=i();return m>=v.from&&m<=v.to},l=()=>{const m=o(),v=e.filter(b=>c(te(b.createdAt))),y=t.filter(b=>c(b.saleDate)),C=a.filter(b=>c(b.expenseDate)),A=He(e.filter(b=>c(te(b.createdAt))),n),g=v.reduce((b,O)=>b+O.paidAmount,0)+y.reduce((b,O)=>b+O.totalAmount,0),q=C.reduce((b,O)=>b+O.amount,0)+A.reduce((b,O)=>b+O.total,0),P=[["Type","Date","Number","Name","Cash","GCash","Total","Balance"]];return m.has("sales")&&(P.push(...v.map(b=>["Order",te(b.createdAt),b.ticket,b.customer,"","",b.paidAmount,b.balance])),P.push(...y.map(b=>["Manual Sale",b.saleDate,b.saleNumber,b.notes??"",b.cashAmount,b.gcashAmount,b.totalAmount,""]))),m.has("disbursement")&&(P.push(...C.map(b=>["Expense",b.expenseDate,b.number,b.name,"","",b.amount,""])),P.push(...A.map(b=>["Fold Payout",i().from,`${b.folds} fold(s)`,b.staffName,"","",b.total,""]))),m.has("summary")&&(P.push([]),P.push(["Summary",i().from,"to",i().to,"","","",""]),P.push(["Total Sales","","","","","",g,""]),P.push(["Total Disbursement","","","","","",q,""]),P.push(["Profit","","","","","",g-q,""])),P},p=m=>{const v=m.map(y=>y.length?`<tr>${y.map(C=>`<td>${d(String(C??""))}</td>`).join("")}</tr>`:'<tr><td colspan="8">&nbsp;</td></tr>').join("");return`<!doctype html>
<html>
<head>
  <meta charset="utf-8">
  <style>
...
</html>`},h=()=>{const m=i(),v=p(l()),y=`laba101-report-${m.from}-to-${m.to}.xls`;return new File([v],y,{type:"application/vnd.ms-excel"})},u=async()=>{const m=h();if(!Capacitor.isNativePlatform())return{fileName:m.name,uri:""};const v=await m.text();await De.writeFile({path:m.name,data:v,directory:ae.Documents,encoding:be.UTF8});const{uri:y}=await De.getUri({path:m.name,directory:ae.Documents});return{fileName:m.name,uri:y}},R=()=>{const m=p(l()),v=i(),y=`laba101-report-${v.from}-to-${v.to}.xls`,C=new Blob([m],{type:"application/vnd.ms-excel"}),A=URL.createObjectURL(C),g=document.createElement("a");return g.href=A,g.download=y,document.body.appendChild(g),g.click(),setTimeout(()=>{g.remove(),URL.revokeObjectURL(A)},1e3),y},T=async m=>{const v=document.querySelector(m==="export"?"#export-report":"#email-report");v&&(v.disabled=!0,v.textContent=m==="export"?"Exporting...":"Sending...");try{if(m==="export")if(Capacitor.isNativePlatform()){const y=await u();alert(`Report saved to device storage: ${y.fileName}`)}else{const y=R();alert(`Report saved: ${y}`)}else{const y=await Fe("report_email")||"";if(!y){alert("Please configure a report email in Settings first.");return}const C=i(),A=`Laba101 report ${C.from} to ${C.to}`;if(Capacitor.isNativePlatform()){const g=await u();await dt.share({title:A,text:`Please find the attached Laba101 report file: ${g.fileName}`,files:[g.uri],dialogTitle:"Send report via email"}),alert(`Report saved and shared as "${g.fileName}".`)}else{const g=R(),q=`Hi,

Please find the attached Laba101 report file: ${g}

Date range: ${C.from} to ${C.to}`,P=`mailto:${y}?subject=${encodeURIComponent(A)}&body=${encodeURIComponent(q)}`;setTimeout(()=>{window.location.href=P},800),alert(`Report downloaded as "${g}".
Your email app will open — please attach the file and send.`)}}}catch(y){alert("Failed: "+String(y))}finally{v&&(v.disabled=!1,v.textContent=m==="export"?"Export Excel":"Send to Email")}};document.querySelector("#export-report")?.addEventListener("click",async()=>{await T("export")}),document.querySelector("#email-report")?.addEventListener("click",async()=>{await T("email")})}function va(){document.querySelector("#machine-form")?.addEventListener("submit",async e=>{e.preventDefault();const t=new FormData(e.currentTarget);await kt({machineName:String(t.get("machineName")??""),machineType:String(t.get("machineType")),status:String(t.get("status")),branch:String(t.get("branch")??"")}),await L()}),document.querySelector("#subcleaning-form")?.addEventListener("submit",async e=>{e.preventDefault();const t=e.currentTarget.querySelector('button[type="submit"]');t&&(t.disabled=!0,t.textContent="Starting...");const a=new FormData(e.currentTarget),n=a.getAll("machineIds").map(Number);if(!n.length){alert("Please select at least one machine to clean."),t&&(t.disabled=!1,t.textContent="Start Cleaning");return}await jt({date:String(a.get("date")??""),machineIds:n,cleaningStatus:String(a.get("cleaningStatus")??""),notes:String(a.get("notes")??""),branch:String(a.get("branch")??"")}),await L()}),document.querySelectorAll(".complete-cleaning-btn").forEach(e=>{e.addEventListener("click",async()=>{const t=Number(e.dataset.machineId),a=e.dataset.branch??"";e.disabled=!0,e.textContent="Completing...",await _t(t,a),await L()})}),document.querySelectorAll(".deactivate-machine-btn, .activate-machine-btn").forEach(e=>{e.addEventListener("click",async()=>{const t=Number(e.dataset.id),a=e.classList.contains("deactivate-machine-btn");await Mt(t,a?"inactive":"available"),await L()})})}function fa(e){const t=document.querySelector("#add-staff-modal"),a=document.querySelector("#open-add-staff-modal"),n=document.querySelector("#close-add-staff-modal"),r=document.querySelector("#staff-form"),s=()=>{r?.reset(),r&&(r.querySelector("[name=id]").value="");const i=document.querySelector("#add-staff-title");i&&(i.textContent="Add staff member"),t?.removeAttribute("hidden")},o=()=>{t?.setAttribute("hidden",""),r?.reset()};a?.addEventListener("click",s),n?.addEventListener("click",o),t?.addEventListener("click",i=>{i.target===t&&o()}),document.querySelectorAll(".edit-staff-btn").forEach(i=>{i.addEventListener("click",()=>{const c=Number(i.dataset.id),l=e.find(p=>p.id===c);if(l&&r){r.querySelector("[name=id]").value=String(l.id),r.querySelector("[name=name]").value=l.name,r.querySelector("[name=email]").value=l.email,r.querySelector("[name=password]").value=l.password,r.querySelector("[name=role]").value=l.role,r.querySelector("[name=branch]").value=l.branch;const p=document.querySelector("#add-staff-title");p&&(p.textContent="Edit staff member"),t?.removeAttribute("hidden")}})}),document.querySelectorAll(".deactivate-staff-btn, .activate-staff-btn").forEach(i=>{i.addEventListener("click",async()=>{const c=Number(i.dataset.id),l=e.find(p=>p.id===c);l&&(await Ie(c,{isActive:l.isActive!==0?0:1}),await L())})}),r?.addEventListener("submit",async i=>{i.preventDefault();const c=document.querySelector("#staff-save-btn");c&&(c.disabled=!0,c.textContent="Saving...");const l=new FormData(r),p=l.get("id")?Number(l.get("id")):void 0,h=String(l.get("name")??"").trim(),u=String(l.get("email")??"").trim(),R=String(l.get("password")??"password")||"password",T=String(l.get("role")),m=String(l.get("branch")??"");if(!h||!u){alert("Name and email are required."),c&&(c.disabled=!1,c.textContent="Save staff member");return}try{p?await Ie(p,{name:h,email:u,password:R,role:T,branch:m}):await St({name:h,email:u,password:R,role:T,branch:m}),o(),await L()}catch{alert("Failed to save staff. The email may already be in use."),c&&(c.disabled=!1,c.textContent="Save staff member")}})}function pa(){document.querySelector("#settings-form")?.addEventListener("submit",async e=>{e.preventDefault();const t=new FormData(e.currentTarget);await ee("branch",String(t.get("branch")??"Main Store")),await ee("fold_rate",String(t.get("foldRate")??"5")),String(t.get("reportEmail")??"")&&await ee("report_email",String(t.get("reportEmail"))),alert("Settings saved successfully!"),await L()})}await gt();const ke=localStorage.getItem(V);if(ke)try{const e=JSON.parse(ke);if(e.email&&e.remembered){const t=await _e(e.email,"password")??null;f.currentUser=t}}catch{localStorage.removeItem(V)}await L();export{be as E,Ee as W,st as b};
