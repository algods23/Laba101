          ...
          <article>
            ...
            <div class="sales-summary-section">
              ...
              <div class="table sales-summary-table">
                ...
                <div class="table-row"><div>Orders</div><div>${T(l.salesRows().orderCashTotal)}</div><div>${T(l.salesRows().orderGcashTotal)}</div><div>${T(l.salesRows().orderCashTotal+l.salesRows().orderGcashTotal)}</div></div>
                <div class="table-row"><div>Whole Sale Day</div><div>${T(l.salesRows().manualCashTotal)}</div><div>${T(l.salesRows().manualGcashTotal)}</div><div>${T(l.salesRows().manualCashTotal+l.salesRows().manualGcashTotal)}</div></div>
                <div class="table-row total-row"><div>Total</div><div>${T(l.salesRows().totalCash)}</div><div>${T(l.salesRows().totalGcash)}</div><div>${T(l.salesRows().totalSales)}</div></div>
              </div>
            </div>
          </article>`:""}
        ${l.selectedTypes.has("disbursement")?`
          <article>
            ...
            <div class="table wide-table report-preview-table report-disbursement-table">
              ...
              ${l.disbursementRows().rows.slice(1).filter(d=>d.length&&d[0]!=="Total Disbursement").map(d=>`<div class="table-row report-table-row"><div>${v(d[1]??"")}</div><div>${v(d[0]??"")}</div><div>${v(d[2]??"")}</div><div>${v(d[3]??"")}</div><div>${T(d[5])}</div></div>`).join("")}
            </div>
            <div class="disbursement-total">
              <strong>Total Disbursement: ${T(l.disbursementRows().totalDisbursement)}</strong>
            </div>
          </article>`:""}
