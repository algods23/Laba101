(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const i of n.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function a(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(r){if(r.ep)return;r.ep=!0;const n=a(r);fetch(r.href,n)}})();var re;(function(e){e.Unimplemented="UNIMPLEMENTED",e.Unavailable="UNAVAILABLE"})(re||(re={}));class Ae extends Error{constructor(t,a,s){super(t),this.message=t,this.code=a,this.data=s}}const At=e=>{var t,a;return e?.androidBridge?"android":!((a=(t=e?.webkit)===null||t===void 0?void 0:t.messageHandlers)===null||a===void 0)&&a.bridge?"ios":"web"},Lt=e=>{const t=e.CapacitorCustomPlatform||null,a=e.Capacitor||{},s=a.Plugins=a.Plugins||{},r=()=>t!==null?t.name:At(e),n=()=>r()!=="web",i=m=>{const y=l.get(m);return!!(y?.platforms.has(r())||o(m))},o=m=>{var y;return(y=a.PluginHeaders)===null||y===void 0?void 0:y.find(f=>f.name===m)},u=m=>e.console.error(m),l=new Map,d=(m,y={})=>{const f=l.get(m);if(f)return console.warn(`Capacitor plugin "${m}" already registered. Cannot register plugins twice.`),f.proxy;const g=r(),E=o(m);let p;const N=async()=>(!p&&g in y?p=typeof y[g]=="function"?p=await y[g]():p=y[g]:t!==null&&!p&&"web"in y&&(p=typeof y.web=="function"?p=await y.web():p=y.web),p),h=(P,F)=>{var U,M;if(E){const K=E?.methods.find(_=>F===_.name);if(K)return K.rtype==="promise"?_=>a.nativePromise(m,F.toString(),_):(_,b)=>a.nativeCallback(m,F.toString(),_,b);if(P)return(U=P[F])===null||U===void 0?void 0:U.bind(P)}else{if(P)return(M=P[F])===null||M===void 0?void 0:M.bind(P);throw new Ae(`"${m}" plugin is not implemented on ${g}`,re.Unimplemented)}},A=P=>{let F;const U=(...M)=>{const K=N().then(_=>{const b=h(_,P);if(b){const O=b(...M);return F=O?.remove,O}else throw new Ae(`"${m}.${P}()" is not implemented on ${g}`,re.Unimplemented)});return P==="addListener"&&(K.remove=async()=>F()),K};return U.toString=()=>`${P.toString()}() { [capacitor code] }`,Object.defineProperty(U,"name",{value:P,writable:!1,configurable:!1}),U},D=A("addListener"),R=A("removeListener"),k=(P,F)=>{const U=D({eventName:P},F),M=async()=>{const _=await U;R({eventName:P,callbackId:_},F)},K=new Promise(_=>U.then(()=>_({remove:M})));return K.remove=async()=>{console.warn("Using addListener() without 'await' is deprecated."),await M()},K},q=new Proxy({},{get(P,F){switch(F){case"$$typeof":return;case"toJSON":return()=>({});case"addListener":return E?k:D;case"removeListener":return R;default:return A(F)}}});return s[m]=q,l.set(m,{name:m,proxy:q,platforms:new Set([...Object.keys(y),...E?[g]:[]])}),q};return a.convertFileSrc||(a.convertFileSrc=m=>m),a.getPlatform=r,a.handleError=u,a.isNativePlatform=n,a.isPluginAvailable=i,a.registerPlugin=d,a.Exception=Ae,a.DEBUG=!!a.DEBUG,a.isLoggingEnabled=!!a.isLoggingEnabled,a},Ct=e=>e.Capacitor=Lt(e),C=Ct(typeof globalThis<"u"?globalThis:typeof self<"u"?self:typeof window<"u"?window:typeof global<"u"?global:{}),ae=C.registerPlugin;class Pe{constructor(){this.listeners={},this.retainedEventArguments={},this.windowListeners={}}addListener(t,a){let s=!1;this.listeners[t]||(this.listeners[t]=[],s=!0),this.listeners[t].push(a);const n=this.windowListeners[t];n&&!n.registered&&this.addWindowListener(n),s&&this.sendRetainedArgumentsForEvent(t);const i=async()=>this.removeListener(t,a);return Promise.resolve({remove:i})}async removeAllListeners(){this.listeners={};for(const t in this.windowListeners)this.removeWindowListener(this.windowListeners[t]);this.windowListeners={}}notifyListeners(t,a,s){const r=this.listeners[t];if(!r){if(s){let n=this.retainedEventArguments[t];n||(n=[]),n.push(a),this.retainedEventArguments[t]=n}return}r.forEach(n=>n(a))}hasListeners(t){var a;return!!(!((a=this.listeners[t])===null||a===void 0)&&a.length)}registerWindowListener(t,a){this.windowListeners[a]={registered:!1,windowEventName:t,pluginEventName:a,handler:s=>{this.notifyListeners(a,s)}}}unimplemented(t="not implemented"){return new C.Exception(t,re.Unimplemented)}unavailable(t="not available"){return new C.Exception(t,re.Unavailable)}async removeListener(t,a){const s=this.listeners[t];if(!s)return;const r=s.indexOf(a);this.listeners[t].splice(r,1),this.listeners[t].length||this.removeWindowListener(this.windowListeners[t])}addWindowListener(t){window.addEventListener(t.windowEventName,t.handler),t.registered=!0}removeWindowListener(t){t&&(window.removeEventListener(t.windowEventName,t.handler),t.registered=!1)}sendRetainedArgumentsForEvent(t){const a=this.retainedEventArguments[t];a&&(delete this.retainedEventArguments[t],a.forEach(s=>{this.notifyListeners(t,s)}))}}const _e=e=>encodeURIComponent(e).replace(/%(2[346B]|5E|60|7C)/g,decodeURIComponent).replace(/[()]/g,escape),Be=e=>e.replace(/(%[\dA-F]{2})+/gi,decodeURIComponent);class $t extends Pe{async getCookies(){const t=document.cookie,a={};return t.split(";").forEach(s=>{if(s.length<=0)return;let[r,n]=s.replace(/=/,"CAP_COOKIE").split("CAP_COOKIE");r=Be(r).trim(),n=Be(n).trim(),a[r]=n}),a}async setCookie(t){try{const a=_e(t.key),s=_e(t.value),r=t.expires?`; expires=${t.expires.replace("expires=","")}`:"",n=(t.path||"/").replace("path=",""),i=t.url!=null&&t.url.length>0?`domain=${t.url}`:"";document.cookie=`${a}=${s||""}${r}; path=${n}; ${i};`}catch(a){return Promise.reject(a)}}async deleteCookie(t){try{document.cookie=`${t.key}=; Max-Age=0`}catch(a){return Promise.reject(a)}}async clearCookies(){try{const t=document.cookie.split(";")||[];for(const a of t)document.cookie=a.replace(/^ +/,"").replace(/=.*/,`=;expires=${new Date().toUTCString()};path=/`)}catch(t){return Promise.reject(t)}}async clearAllCookies(){try{await this.clearCookies()}catch(t){return Promise.reject(t)}}}ae("CapacitorCookies",{web:()=>new $t});const Rt=async e=>new Promise((t,a)=>{const s=new FileReader;s.onload=()=>{const r=s.result;t(r.indexOf(",")>=0?r.split(",")[1]:r)},s.onerror=r=>a(r),s.readAsDataURL(e)}),Dt=(e={})=>{const t=Object.keys(e);return Object.keys(e).map(r=>r.toLocaleLowerCase()).reduce((r,n,i)=>(r[n]=e[t[i]],r),{})},Ot=(e,t=!0)=>e?Object.entries(e).reduce((s,r)=>{const[n,i]=r;let o,u;return Array.isArray(i)?(u="",i.forEach(l=>{o=t?encodeURIComponent(l):l,u+=`${n}=${o}&`}),u.slice(0,-1)):(o=t?encodeURIComponent(i):i,u=`${n}=${o}`),`${s}&${u}`},"").substr(1):null,Pt=(e,t={})=>{const a=Object.assign({method:e.method||"GET",headers:e.headers},t),r=Dt(e.headers)["content-type"]||"";if(typeof e.data=="string")a.body=e.data;else if(r.includes("application/x-www-form-urlencoded")){const n=new URLSearchParams;for(const[i,o]of Object.entries(e.data||{}))n.set(i,o);a.body=n.toString()}else if(r.includes("multipart/form-data")||e.data instanceof FormData){const n=new FormData;if(e.data instanceof FormData)e.data.forEach((o,u)=>{n.append(u,o)});else for(const o of Object.keys(e.data))n.append(o,e.data[o]);a.body=n;const i=new Headers(a.headers);i.delete("content-type"),a.headers=i}else(r.includes("application/json")||typeof e.data=="object")&&(a.body=JSON.stringify(e.data));return a};class xt extends Pe{async request(t){const a=Pt(t,t.webFetchExtra),s=Ot(t.params,t.shouldEncodeUrlParams),r=s?`${t.url}?${s}`:t.url,n=await fetch(r,a),i=n.headers.get("content-type")||"";let{responseType:o="text"}=n.ok?t:{};i.includes("application/json")&&(o="json");let u,l;switch(o){case"arraybuffer":case"blob":l=await n.blob(),u=await Rt(l);break;case"json":u=await n.json();break;default:u=await n.text()}const d={};return n.headers.forEach((m,y)=>{d[y]=m}),{data:u,headers:d,status:n.status,url:n.url}}async get(t){return this.request(Object.assign(Object.assign({},t),{method:"GET"}))}async post(t){return this.request(Object.assign(Object.assign({},t),{method:"POST"}))}async put(t){return this.request(Object.assign(Object.assign({},t),{method:"PUT"}))}async patch(t){return this.request(Object.assign(Object.assign({},t),{method:"PATCH"}))}async delete(t){return this.request(Object.assign(Object.assign({},t),{method:"DELETE"}))}}ae("CapacitorHttp",{web:()=>new xt});var je;(function(e){e.Dark="DARK",e.Light="LIGHT",e.Default="DEFAULT"})(je||(je={}));var He;(function(e){e.StatusBar="StatusBar",e.NavigationBar="NavigationBar"})(He||(He={}));class It extends Pe{async setStyle(){this.unavailable("not available for web")}async setAnimation(){this.unavailable("not available for web")}async show(){this.unavailable("not available for web")}async hide(){this.unavailable("not available for web")}}ae("SystemBars",{web:()=>new It});const qt="modulepreload",Ft=function(e){return"/"+e},We={},xe=function(t,a,s){let r=Promise.resolve();if(a&&a.length>0){let u=function(l){return Promise.all(l.map(d=>Promise.resolve(d).then(m=>({status:"fulfilled",value:m}),m=>({status:"rejected",reason:m}))))};document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),o=i?.nonce||i?.getAttribute("nonce");r=u(a.map(l=>{if(l=Ft(l),l in We)return;We[l]=!0;const d=l.endsWith(".css"),m=d?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${l}"]${m}`))return;const y=document.createElement("link");if(y.rel=d?"stylesheet":qt,d||(y.as="script"),y.crossOrigin="",y.href=l,o&&y.setAttribute("nonce",o),document.head.appendChild(y),d)return new Promise((f,g)=>{y.addEventListener("load",f),y.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${l}`)))})}))}function n(i){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=i,window.dispatchEvent(o),!o.defaultPrevented)throw i}return r.then(i=>{for(const o of i||[])o.status==="rejected"&&n(o.reason);return t().catch(n)})};function kt(e){e.CapacitorUtils.Synapse=new Proxy({},{get(t,a){return new Proxy({},{get(s,r){return(n,i,o)=>{const u=e.Capacitor.Plugins[a];if(u===void 0){o(new Error(`Capacitor plugin ${a} not found`));return}if(typeof u[r]!="function"){o(new Error(`Method ${r} not found in Capacitor plugin ${a}`));return}(async()=>{try{const l=await u[r](n);i(l)}catch(l){o(l)}})()}}})}})}function Ut(e){e.CapacitorUtils.Synapse=new Proxy({},{get(t,a){return e.cordova.plugins[a]}})}function Mt(e=!1){typeof window>"u"||(window.CapacitorUtils=window.CapacitorUtils||{},window.Capacitor!==void 0&&!e?kt(window):window.cordova!==void 0&&Ut(window))}var be;(function(e){e.Documents="DOCUMENTS",e.Data="DATA",e.Library="LIBRARY",e.Cache="CACHE",e.External="EXTERNAL",e.ExternalStorage="EXTERNAL_STORAGE",e.ExternalCache="EXTERNAL_CACHE",e.LibraryNoCloud="LIBRARY_NO_CLOUD",e.Temporary="TEMPORARY"})(be||(be={}));var Re;(function(e){e.UTF8="utf8",e.ASCII="ascii",e.UTF16="utf16"})(Re||(Re={}));const Xe=ae("Filesystem",{web:()=>xe(()=>import("./web-BqX-uuk-.js"),[]).then(e=>new e.FilesystemWeb)});Mt();const _t=ae("Share",{web:()=>xe(()=>import("./web-DLhfibrV.js"),[]).then(e=>new e.ShareWeb)});class Bt{constructor(t){this.sqlite=t,this._connectionDict=new Map}async initWebStore(){try{return await this.sqlite.initWebStore(),Promise.resolve()}catch(t){return Promise.reject(t)}}async saveToStore(t){try{return await this.sqlite.saveToStore({database:t}),Promise.resolve()}catch(a){return Promise.reject(a)}}async saveToLocalDisk(t){try{return await this.sqlite.saveToLocalDisk({database:t}),Promise.resolve()}catch(a){return Promise.reject(a)}}async getFromLocalDiskToStore(t){const a=t??!0;try{return await this.sqlite.getFromLocalDiskToStore({overwrite:a}),Promise.resolve()}catch(s){return Promise.reject(s)}}async echo(t){try{const a=await this.sqlite.echo({value:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async isSecretStored(){try{const t=await this.sqlite.isSecretStored();return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async setEncryptionSecret(t){try{return await this.sqlite.setEncryptionSecret({passphrase:t}),Promise.resolve()}catch(a){return Promise.reject(a)}}async changeEncryptionSecret(t,a){try{return await this.sqlite.changeEncryptionSecret({passphrase:t,oldpassphrase:a}),Promise.resolve()}catch(s){return Promise.reject(s)}}async clearEncryptionSecret(){try{return await this.sqlite.clearEncryptionSecret(),Promise.resolve()}catch(t){return Promise.reject(t)}}async checkEncryptionSecret(t){try{const a=await this.sqlite.checkEncryptionSecret({passphrase:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async addUpgradeStatement(t,a){try{return t.endsWith(".db")&&(t=t.slice(0,-3)),await this.sqlite.addUpgradeStatement({database:t,upgrade:a}),Promise.resolve()}catch(s){return Promise.reject(s)}}async createConnection(t,a,s,r,n){try{t.endsWith(".db")&&(t=t.slice(0,-3)),await this.sqlite.createConnection({database:t,encrypted:a,mode:s,version:r,readonly:n});const i=new Ke(t,n,this.sqlite),o=n?`RO_${t}`:`RW_${t}`;return this._connectionDict.set(o,i),Promise.resolve(i)}catch(i){return Promise.reject(i)}}async closeConnection(t,a){try{t.endsWith(".db")&&(t=t.slice(0,-3)),await this.sqlite.closeConnection({database:t,readonly:a});const s=a?`RO_${t}`:`RW_${t}`;return this._connectionDict.delete(s),Promise.resolve()}catch(s){return Promise.reject(s)}}async isConnection(t,a){const s={};t.endsWith(".db")&&(t=t.slice(0,-3));const r=a?`RO_${t}`:`RW_${t}`;return s.result=this._connectionDict.has(r),Promise.resolve(s)}async retrieveConnection(t,a){t.endsWith(".db")&&(t=t.slice(0,-3));const s=a?`RO_${t}`:`RW_${t}`;if(this._connectionDict.has(s)){const r=this._connectionDict.get(s);return typeof r<"u"?Promise.resolve(r):Promise.reject(`Connection ${t} is undefined`)}else return Promise.reject(`Connection ${t} does not exist`)}async getNCDatabasePath(t,a){try{const s=await this.sqlite.getNCDatabasePath({path:t,database:a});return Promise.resolve(s)}catch(s){return Promise.reject(s)}}async createNCConnection(t,a){try{await this.sqlite.createNCConnection({databasePath:t,version:a});const s=new Ke(t,!0,this.sqlite),r=`RO_${t})`;return this._connectionDict.set(r,s),Promise.resolve(s)}catch(s){return Promise.reject(s)}}async closeNCConnection(t){try{await this.sqlite.closeNCConnection({databasePath:t});const a=`RO_${t})`;return this._connectionDict.delete(a),Promise.resolve()}catch(a){return Promise.reject(a)}}async isNCConnection(t){const a={},s=`RO_${t})`;return a.result=this._connectionDict.has(s),Promise.resolve(a)}async retrieveNCConnection(t){if(this._connectionDict.has(t)){const a=`RO_${t})`,s=this._connectionDict.get(a);return typeof s<"u"?Promise.resolve(s):Promise.reject(`Connection ${t} is undefined`)}else return Promise.reject(`Connection ${t} does not exist`)}async isNCDatabase(t){try{const a=await this.sqlite.isNCDatabase({databasePath:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async retrieveAllConnections(){return this._connectionDict}async closeAllConnections(){const t=new Map;try{for(const a of this._connectionDict.keys()){const s=a.substring(3),r=a.substring(0,3)==="RO_";await this.sqlite.closeConnection({database:s,readonly:r}),t.set(a,null)}for(const a of t.keys())this._connectionDict.delete(a);return Promise.resolve()}catch(a){return Promise.reject(a)}}async checkConnectionsConsistency(){try{const t=[...this._connectionDict.keys()],a=[],s=[];for(const n of t)a.push(n.substring(0,2)),s.push(n.substring(3));const r=await this.sqlite.checkConnectionsConsistency({dbNames:s,openModes:a});return r.result||(this._connectionDict=new Map),Promise.resolve(r)}catch(t){return this._connectionDict=new Map,Promise.reject(t)}}async importFromJson(t){try{const a=await this.sqlite.importFromJson({jsonstring:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async isJsonValid(t){try{const a=await this.sqlite.isJsonValid({jsonstring:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async copyFromAssets(t){const a=t??!0;try{return await this.sqlite.copyFromAssets({overwrite:a}),Promise.resolve()}catch(s){return Promise.reject(s)}}async getFromHTTPRequest(t,a){const s=a??!0;try{return await this.sqlite.getFromHTTPRequest({url:t,overwrite:s}),Promise.resolve()}catch(r){return Promise.reject(r)}}async isDatabaseEncrypted(t){t.endsWith(".db")&&(t=t.slice(0,-3));try{const a=await this.sqlite.isDatabaseEncrypted({database:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async isInConfigEncryption(){try{const t=await this.sqlite.isInConfigEncryption();return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isInConfigBiometricAuth(){try{const t=await this.sqlite.isInConfigBiometricAuth();return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isDatabase(t){t.endsWith(".db")&&(t=t.slice(0,-3));try{const a=await this.sqlite.isDatabase({database:t});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async getDatabaseList(){try{const a=(await this.sqlite.getDatabaseList()).values;a.sort();const s={values:a};return Promise.resolve(s)}catch(t){return Promise.reject(t)}}async getMigratableDbList(t){const a=t||"default";try{const s=await this.sqlite.getMigratableDbList({folderPath:a});return Promise.resolve(s)}catch(s){return Promise.reject(s)}}async addSQLiteSuffix(t,a){const s=t||"default",r=a||[];try{const n=await this.sqlite.addSQLiteSuffix({folderPath:s,dbNameList:r});return Promise.resolve(n)}catch(n){return Promise.reject(n)}}async deleteOldDatabases(t,a){const s=t||"default",r=a||[];try{const n=await this.sqlite.deleteOldDatabases({folderPath:s,dbNameList:r});return Promise.resolve(n)}catch(n){return Promise.reject(n)}}async moveDatabasesAndAddSuffix(t,a){const s=t||"default",r=a||[];return this.sqlite.moveDatabasesAndAddSuffix({folderPath:s,dbNameList:r})}}class Ke{constructor(t,a,s){this.dbName=t,this.readonly=a,this.sqlite=s}getConnectionDBName(){return this.dbName}getConnectionReadOnly(){return this.readonly}async open(){try{return await this.sqlite.open({database:this.dbName,readonly:this.readonly}),Promise.resolve()}catch(t){return Promise.reject(t)}}async close(){try{return await this.sqlite.close({database:this.dbName,readonly:this.readonly}),Promise.resolve()}catch(t){return Promise.reject(t)}}async beginTransaction(){try{const t=await this.sqlite.beginTransaction({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async commitTransaction(){try{const t=await this.sqlite.commitTransaction({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async rollbackTransaction(){try{const t=await this.sqlite.rollbackTransaction({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isTransactionActive(){try{const t=await this.sqlite.isTransactionActive({database:this.dbName});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async loadExtension(t){try{return await this.sqlite.loadExtension({database:this.dbName,path:t,readonly:this.readonly}),Promise.resolve()}catch(a){return Promise.reject(a)}}async enableLoadExtension(t){try{return await this.sqlite.enableLoadExtension({database:this.dbName,toggle:t,readonly:this.readonly}),Promise.resolve()}catch(a){return Promise.reject(a)}}async getUrl(){try{const t=await this.sqlite.getUrl({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async getVersion(){try{const t=await this.sqlite.getVersion({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async getTableList(){try{const t=await this.sqlite.getTableList({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async execute(t,a=!0,s=!0){try{if(this.readonly)return Promise.reject("not allowed in read-only mode");{const r=await this.sqlite.execute({database:this.dbName,statements:t,transaction:a,readonly:!1,isSQL92:s});return Promise.resolve(r)}}catch(r){return Promise.reject(r)}}async query(t,a,s=!0){let r;try{return a&&a.length>0?r=await this.sqlite.query({database:this.dbName,statement:t,values:a,readonly:this.readonly,isSQL92:!0}):r=await this.sqlite.query({database:this.dbName,statement:t,values:[],readonly:this.readonly,isSQL92:s}),r=await this.reorderRows(r),Promise.resolve(r)}catch(n){return Promise.reject(n)}}async run(t,a,s=!0,r="no",n=!0){let i;try{return this.readonly?Promise.reject("not allowed in read-only mode"):(a&&a.length>0?i=await this.sqlite.run({database:this.dbName,statement:t,values:a,transaction:s,readonly:!1,returnMode:r,isSQL92:!0}):i=await this.sqlite.run({database:this.dbName,statement:t,values:[],transaction:s,readonly:!1,returnMode:r,isSQL92:n}),i.changes=await this.reorderRows(i.changes),Promise.resolve(i))}catch(o){return Promise.reject(o)}}async executeSet(t,a=!0,s="no",r=!0){let n;try{return this.readonly?Promise.reject("not allowed in read-only mode"):(n=await this.sqlite.executeSet({database:this.dbName,set:t,transaction:a,readonly:!1,returnMode:s,isSQL92:r}),n.changes=await this.reorderRows(n.changes),Promise.resolve(n))}catch(i){return Promise.reject(i)}}async isExists(){try{const t=await this.sqlite.isDBExists({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async isTable(t){try{const a=await this.sqlite.isTableExists({database:this.dbName,table:t,readonly:this.readonly});return Promise.resolve(a)}catch(a){return Promise.reject(a)}}async isDBOpen(){try{const t=await this.sqlite.isDBOpen({database:this.dbName,readonly:this.readonly});return Promise.resolve(t)}catch(t){return Promise.reject(t)}}async delete(){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.deleteDatabase({database:this.dbName,readonly:!1}),Promise.resolve())}catch(t){return Promise.reject(t)}}async createSyncTable(){try{if(this.readonly)return Promise.reject("not allowed in read-only mode");{const t=await this.sqlite.createSyncTable({database:this.dbName,readonly:!1});return Promise.resolve(t)}}catch(t){return Promise.reject(t)}}async setSyncDate(t){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.setSyncDate({database:this.dbName,syncdate:t,readonly:!1}),Promise.resolve())}catch(a){return Promise.reject(a)}}async getSyncDate(){try{const t=await this.sqlite.getSyncDate({database:this.dbName,readonly:this.readonly});let a="";return t.syncDate>0&&(a=new Date(t.syncDate*1e3).toISOString()),Promise.resolve(a)}catch(t){return Promise.reject(t)}}async exportToJson(t,a=!1){try{const s=await this.sqlite.exportToJson({database:this.dbName,jsonexportmode:t,readonly:this.readonly,encrypted:a});return Promise.resolve(s)}catch(s){return Promise.reject(s)}}async deleteExportedRows(){try{return this.readonly?Promise.reject("not allowed in read-only mode"):(await this.sqlite.deleteExportedRows({database:this.dbName,readonly:!1}),Promise.resolve())}catch(t){return Promise.reject(t)}}async executeTransaction(t,a=!0){let s=0,r=!1;if(this.readonly)return Promise.reject("not allowed in read-only mode");if(await this.sqlite.beginTransaction({database:this.dbName}),r=await this.sqlite.isTransactionActive({database:this.dbName}),!r)return Promise.reject("After Begin Transaction, no transaction active");try{for(const o of t){if(typeof o!="object"||!("statement"in o))throw new Error("Error a task.statement must be provided");if("values"in o&&o.values&&o.values.length>0){const u=o.statement.toUpperCase().includes("RETURNING")?"all":"no",l=await this.sqlite.run({database:this.dbName,statement:o.statement,values:o.values,transaction:!1,readonly:!1,returnMode:u,isSQL92:a});if(l.changes.changes<0)throw new Error("Error in transaction method run ");s+=l.changes.changes}else{const u=await this.sqlite.execute({database:this.dbName,statements:o.statement,transaction:!1,readonly:!1});if(u.changes.changes<0)throw new Error("Error in transaction method execute ");s+=u.changes.changes}}const n=await this.sqlite.commitTransaction({database:this.dbName});s+=n.changes.changes;const i={changes:{changes:s}};return Promise.resolve(i)}catch(n){const i=n.message?n.message:n;return await this.sqlite.rollbackTransaction({database:this.dbName}),Promise.reject(i)}}async reorderRows(t){const a=t;if(t?.values&&typeof t.values[0]=="object"&&Object.keys(t.values[0]).includes("ios_columns")){const s=t.values[0].ios_columns,r=[];for(let n=1;n<t.values.length;n++){const i=t.values[n],o={};for(const u of s)o[u]=i[u];r.push(o)}a.values=r}return Promise.resolve(a)}}const jt=ae("CapacitorSQLite",{web:()=>xe(()=>import("./web-Dh9iFrFh.js"),[]).then(e=>new e.CapacitorSQLiteWeb),electron:()=>window.CapacitorCustomPlatform.plugins.CapacitorSQLite});function Ht(e){return e.replace(/^(add[- ]?on|additional)\s+/i,"").trim()}const Wt="laba101_offline",Ee="fresh_start_reset_v1",Xt=new Bt(jt);let fe=null;const X=[{id:1,name:"Laba101 Admin",email:"admin@laba101.test",password:"password",role:"admin",branch:"Main Store"},{id:2,name:"Gensan Branch Staff",email:"staff@laba101.gensan",password:"password",role:"staff",branch:"Gensan Branch"}],Se=[],V=[G(1,"Drop-off","P185. Includes wash, dry, and fold.","Drop-Off","order",185,8,40,["Wash","Dry","Fold"],0,24),G(2,"Full Service","P200. Wash, Fabcon, detergent, dry, and fold.","Full Service","order",200,8,40,["Wash","Dry","Fold","Detergent","Fabcon"],0,24),G(3,"Self Service Wash","P60. Self-service wash (max 8kg per load).","Self Service","order",60,8,null,["Wash"],0,1),G(4,"Self Service Dry","P70. Self-service dry (40 mins).","Self Service","order",70,8,40,["Dry"],0,1),G(6,"Dry 10 mins","Additional drying time (10 mins).","Add-on","addon",30,8,10,["Dry"],0,1),G(7,"Dry 20 mins","Additional drying time (20 mins).","Add-on","addon",50,8,20,["Dry"],0,1),G(8,"Dry 40 mins","Additional drying time (40 mins).","Add-on","addon",70,8,40,["Dry"],0,1),G(9,"Additional Zonrox","Extra Zonrox bleach add-on per load.","Add-on","addon",25,0,null,["Zonrox"],0,0),G(10,"Additional Fabcon","Extra Fabcon fabric conditioner add-on per load.","Add-on","addon",25,0,null,["Fabcon"],0,0)],z=[{id:1,name:"Regular Clothes",maxKg:8,additionalFee:0,isActive:1},{id:2,name:"Comforter",maxKg:4,additionalFee:0,isActive:1},{id:3,name:"Thin Blankets",maxKg:6,additionalFee:0,isActive:1},{id:4,name:"Bedsheets",maxKg:6,additionalFee:0,isActive:1},{id:5,name:"Bath Towels",maxKg:6,additionalFee:0,isActive:1},{id:6,name:"Curtains",maxKg:6,additionalFee:0,isActive:1}];function Ge(e,t){const a=L(e,[]),s=new Map(a.map(n=>[n.id,n])),r=t.map(n=>{const i=s.get(n.id);return i?{...n,...i,isActive:i.isActive??n.isActive}:n});(a.length!==r.length||r.some((n,i)=>n.id!==a[i]?.id||JSON.stringify(n)!==JSON.stringify(a[i])))&&w(e,r)}async function Kt(){Ge("services",V),Ge("item_categories",z)}async function Te(e){for(const t of V)((await e.query("SELECT id FROM laundry_services WHERE id = ?",[t.id])).values??[]).length>0?await e.run("UPDATE laundry_services SET name = ?, description = ?, category = ?, serviceType = ?, price = ?, maxKg = ?, dryingMinutes = ?, includes = ?, additionalCharge = ?, turnaroundHours = ?, isActive = COALESCE(isActive, ?) WHERE id = ?",[t.name,t.description,t.category,t.serviceType,t.price,t.maxKg,t.dryingMinutes,JSON.stringify(t.includes),t.additionalCharge,t.turnaroundHours,t.isActive,t.id]):await e.run("INSERT INTO laundry_services (id, name, description, category, serviceType, price, maxKg, dryingMinutes, includes, additionalCharge, turnaroundHours, isActive) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",[t.id,t.name,t.description,t.category,t.serviceType,t.price,t.maxKg,t.dryingMinutes,JSON.stringify(t.includes),t.additionalCharge,t.turnaroundHours,t.isActive]);for(const t of z)((await e.query("SELECT id FROM item_categories WHERE id = ?",[t.id])).values??[]).length>0?await e.run("UPDATE item_categories SET name = ?, maxKg = ?, additionalFee = ?, isActive = COALESCE(isActive, ?) WHERE id = ?",[t.name,t.maxKg,t.additionalFee,t.isActive,t.id]):await e.run("INSERT INTO item_categories (id, name, maxKg, additionalFee, isActive) VALUES (?, ?, ?, ?, ?)",[t.id,t.name,t.maxKg,t.additionalFee,t.isActive])}const Z=[],ne=[],te=[],ie=[],oe=[],Y=[...[1,2,3,4].map(e=>({id:e,machineName:`Washer ${e}`,machineType:"washer",status:"available",branch:"Main Store"})),...[1,2,3,4].map(e=>({id:e+4,machineName:`Dryer ${e}`,machineType:"dryer",status:"available",branch:"Main Store"}))],ce=[{key:"branch",value:"Main Store"},{key:"fold_rate",value:"5"},{key:"report_email",value:"admin@laba101.test"}];function G(e,t,a,s,r,n,i,o,u,l,d){return{id:e,name:t,description:a,category:s,serviceType:r,price:n,maxKg:i,dryingMinutes:o,includes:u,additionalCharge:l,turnaroundHours:d,isActive:1}}function B(e){return`laba101-mobile-${e}`}function L(e,t){const a=localStorage.getItem(B(e));if(!a)return structuredClone(t);try{return JSON.parse(a)}catch{return structuredClone(t)}}function w(e,t){localStorage.setItem(B(e),JSON.stringify(t))}function j(e){return e.reduce((t,a)=>Math.max(t,a.id),0)+1}function ee(){return new Date().toISOString()}function De(e=new Date){const t=e.getFullYear(),a=String(e.getMonth()+1).padStart(2,"0"),s=String(e.getDate()).padStart(2,"0");return`${t}-${a}-${s}`}function Gt(){return De().slice(2).replaceAll("-","")}function Q(e,t){if(!e)return t;try{return JSON.parse(e)}catch{return t}}async function $(){return fe||(fe=await Xt.createConnection(Wt,!1,"no-encryption",1,!1),await fe.open()),fe}async function I(e,t,a,s){((await e.query(`PRAGMA table_info(${t})`)).values??[]).some(i=>i.name===a)||await e.execute(`ALTER TABLE ${t} ADD COLUMN ${a} ${s}`)}function Vt(){const e=L("staff",X),t=new Map(e.map(s=>[s.id,s]));let a=!1;for(const s of X){const r=t.get(s.id);if(!r){t.set(s.id,{...s,isActive:1}),a=!0;continue}const n={...r,name:s.name,email:s.email,password:s.password,role:s.role,branch:s.branch,isActive:1};JSON.stringify(n)!==JSON.stringify(r)&&(t.set(s.id,n),a=!0)}a&&w("staff",Array.from(t.values()).sort((s,r)=>s.id-r.id))}async function Yt(){localStorage.getItem(B(Ee))||(w("staff",X),w("customers",[]),w("orders",[]),w("payments",[]),w("fold_logs",[]),w("expenses",[]),w("sales",[]),localStorage.getItem(B("services"))||w("services",V),localStorage.getItem(B("item_categories"))||w("item_categories",z),localStorage.getItem(B("machines"))||w("machines",Y),localStorage.getItem(B("subcleanings"))||w("subcleanings",[]),localStorage.getItem(B("settings"))||w("settings",ce),localStorage.removeItem("laba101-mobile-session"),w(Ee,!0))}async function nt(e){for(const t of X){if(((await e.query("SELECT id FROM staff WHERE id = ?",[t.id])).values??[]).length>0){await e.run("UPDATE staff SET name = ?, email = ?, password = ?, role = ?, branch = ?, isActive = 1 WHERE id = ?",[t.name,t.email,t.password,t.role,t.branch,t.id]);continue}await e.run("INSERT INTO staff (id, name, email, password, role, branch, isActive) VALUES (?, ?, ?, ?, ?, ?, ?)",[t.id,t.name,t.email,t.password,t.role,t.branch,1])}}async function Qt(e){if(!(((await e.query("SELECT COUNT(*) as count FROM machines")).values?.[0]?.count??0)>0))for(const a of Y)await e.run("INSERT INTO machines (id, machineName, machineType, status, branch) VALUES (?, ?, ?, ?, ?)",[a.id,a.machineName,a.machineType,a.status,a.branch])}async function Jt(e){for(const t of ce)await e.run("INSERT OR IGNORE INTO settings (key, value) VALUES (?, ?)",[t.key,t.value])}async function it(e){for(const t of V)((await e.query("SELECT id FROM laundry_services WHERE id = ?",[t.id])).values??[]).length>0||await e.run("INSERT INTO laundry_services (id, name, description, category, serviceType, price, maxKg, dryingMinutes, includes, additionalCharge, turnaroundHours, isActive) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",[t.id,t.name,t.description,t.category,t.serviceType,t.price,t.maxKg,t.dryingMinutes,JSON.stringify(t.includes),t.additionalCharge,t.turnaroundHours,t.isActive]);for(const t of z)((await e.query("SELECT id FROM item_categories WHERE id = ?",[t.id])).values??[]).length>0||await e.run("INSERT INTO item_categories (id, name, maxKg, additionalFee, isActive) VALUES (?, ?, ?, ?, ?)",[t.id,t.name,t.maxKg,t.additionalFee,t.isActive])}async function zt(e){((await e.query("SELECT value FROM settings WHERE key = ?",[Ee])).values??[]).length>0||(await e.execute(`
  ...
  `),await nt(e),await it(e),await Qt(e),await Jt(e),await e.run("INSERT OR REPLACE INTO settings (key, value) VALUES (?, ?)",[Ee,ee()]),localStorage.removeItem("laba101-mobile-session"))}async function Zt(){if(!C.isNativePlatform()){await Yt(),!localStorage.getItem(B("seeded_v4"))&&!localStorage.getItem(B("services"))&&!localStorage.getItem(B("staff"))&&(w("staff",X),w("customers",Se),w("services",V),w("item_categories",z),w("orders",Z),w("payments",ne),w("fold_logs",[]),w("expenses",te),w("sales",ie),w("revolving_history",oe),w("machines",Y),w("subcleanings",[]),w("settings",ce),w("seeded_v4",!0)),await Kt(),Vt(),localStorage.getItem(B("seeded_v4"))||w("seeded_v4",!0);return}const e=await $();await e.execute(`
  ...
  `),await I(e,"staff","email","TEXT"),await I(e,"staff","password","TEXT"),await I(e,"staff","role","TEXT"),await I(e,"staff","isActive","INTEGER NOT NULL DEFAULT 1"),await e.run('UPDATE staff SET password = ? WHERE password IS NULL OR password = ""',["password"]),await e.run('UPDATE staff SET role = ? WHERE role IS NULL OR role = ""',["staff"]),await I(e,"orders","customerId","INTEGER NOT NULL DEFAULT 0"),await I(e,"orders","phone","TEXT"),await I(e,"orders","serviceId","INTEGER NOT NULL DEFAULT 0"),await I(e,"orders","serviceLines","TEXT"),await I(e,"orders","itemCategoryId","INTEGER NOT NULL DEFAULT 0"),await I(e,"orders","itemCategory",'TEXT NOT NULL DEFAULT "Regular Clothes"'),await I(e,"orders","workflowCompleted","TEXT"),await I(e,"orders","weightKg","REAL NOT NULL DEFAULT 0"),await I(e,"orders","price","REAL NOT NULL DEFAULT 0"),await I(e,"orders","additionalCharge","REAL NOT NULL DEFAULT 0"),await I(e,"orders","extraServiceAmount","REAL NOT NULL DEFAULT 0"),await I(e,"orders","totalAmount","REAL NOT NULL DEFAULT 0"),await I(e,"orders","paidAmount","REAL NOT NULL DEFAULT 0"),await I(e,"orders","extras","TEXT"),await I(e,"orders","notes","TEXT"),await I(e,"orders","dueAt","TEXT"),await I(e,"orders","createdAt",'TEXT NOT NULL DEFAULT ""'),await I(e,"daily_sales","saleNumber","TEXT"),await I(e,"daily_sales","status","TEXT"),await I(e,"daily_sales","endorsedTo","TEXT"),await I(e,"daily_sales","statusUpdatedAt","TEXT");const a=((await e.query("SELECT COUNT(*) as count FROM staff")).values?.[0]?.count??0)===0;if(a){for(const s of X)await e.run("INSERT INTO staff (id, name, email, password, role, branch, isActive) VALUES (?, ?, ?, ?, ?, ?, ?)",[s.id,s.name,s.email,s.password,s.role,s.branch,1]);for(const s of Se)await e.run("INSERT INTO customers (id, name, phone, address) VALUES (?, ?, ?, ?)",[s.id,s.name,s.phone,s.address]);for(const s of V)await e.run("INSERT INTO laundry_services (id, name, description, category, serviceType, price, maxKg, dryingMinutes, includes, additionalCharge, turnaroundHours, isActive) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",[s.id,s.name,s.description,s.category,s.serviceType,s.price,s.maxKg,s.dryingMinutes,JSON.stringify(s.includes),s.additionalCharge,s.turnaroundHours,s.isActive]);for(const s of z)await e.run("INSERT INTO item_categories (id, name, maxKg, additionalFee, isActive) VALUES (?, ?, ?, ?, ?)",[s.id,s.name,s.maxKg,s.additionalFee,s.isActive]);for(const s of Z)await ot(e,s);for(const s of ne)await e.run("INSERT INTO payments (id, orderId, amount, method, reference, receivedAt, branch) VALUES (?, ?, ?, ?, ?, ?, ?)",[s.id,s.orderId,s.amount,s.method,s.reference,s.receivedAt,s.branch]);for(const s of te)await e.run("INSERT INTO disbursement_expenses (id, expenseDate, number, name, category, description, amount) VALUES (?, ?, ?, ?, ?, ?, ?)",[s.id,s.expenseDate,s.number,s.name,s.category,s.description,s.amount]);for(const s of ie)await e.run("INSERT INTO daily_sales (id, saleDate, saleNumber, cashAmount, gcashAmount, totalAmount, notes) VALUES (?, ?, ?, ?, ?, ?, ?)",[s.id,s.saleDate,s.saleNumber,s.cashAmount,s.gcashAmount,s.totalAmount,s.notes]);for(const s of oe)await e.run("INSERT INTO revolving_history (id, revolvingNumber, name, amount, category, description, type, createdAt) VALUES (?, ?, ?, ?, ?, ?, ?, ?)",[s.id,s.revolvingNumber,s.name,s.amount,s.category,s.description,s.type,s.createdAt]);for(const s of Y)await e.run("INSERT INTO machines (id, machineName, machineType, status, branch) VALUES (?, ?, ?, ?, ?)",[s.id,s.machineName,s.machineType,s.status,s.branch]);for(const s of ce)await e.run("INSERT INTO settings (key, value) VALUES (?, ?)",[s.key,s.value]);await e.run("INSERT OR REPLACE INTO settings (key, value) VALUES (?, ?)",["fresh_install_defaults",ee()])}await Te(e),await nt(e),a||await it(e),await zt(e)}async function ot(e,t){await e.run("INSERT INTO orders (id, ticket, customerId, customer, phone, serviceId, service, serviceLines, itemCategoryId, itemCategory, branch, status, workflowCompleted, weightKg, price, additionalCharge, extraServiceAmount, totalAmount, paidAmount, extras, notes, foldedBy, dueAt, createdAt) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",[t.id,t.ticket,t.customerId,t.customer,t.phone,t.serviceId,t.service,JSON.stringify(t.serviceLines??[]),t.itemCategoryId,t.itemCategory,t.branch,t.status,JSON.stringify(t.workflowCompleted),t.weightKg,t.price,t.additionalCharge,t.extraServiceAmount,t.totalAmount,t.paidAmount,JSON.stringify(t.extras),t.notes,t.foldedBy,t.dueAt,t.createdAt])}function ea(e){const t=Number(e.paidAmount??0),a=Number(e.totalAmount??0),s=Number(e.foldedBy),r=Q(e.serviceLines,[]),n=Number(e.serviceId),i=String(e.service),o=Number(e.price);return{id:Number(e.id),ticket:String(e.ticket),customerId:Number(e.customerId),customer:String(e.customer),phone:e.phone?String(e.phone):null,serviceId:n,service:i,serviceLines:r.length?r:[{id:n,name:i,price:o,quantity:1,total:o}],itemCategoryId:Number(e.itemCategoryId),itemCategory:String(e.itemCategory),branch:String(e.branch),status:String(e.status),workflowCompleted:Q(e.workflowCompleted,[]),weightKg:Number(e.weightKg),price:o,additionalCharge:Number(e.additionalCharge),extraServiceAmount:Number(e.extraServiceAmount),totalAmount:a,paidAmount:t,balance:Number((a-t).toFixed(2)),extras:Q(e.extras,[]),notes:e.notes?String(e.notes):null,foldedBy:Number.isFinite(s)&&s>0?s:null,foldedByName:e.foldedByName?String(e.foldedByName):null,dueAt:String(e.dueAt),createdAt:String(e.createdAt)}}async function ta(){await Zt()}async function de(){return(await Ie()).find(t=>t.key==="branch")?.value??"Main Store"}async function aa(){const e=await Ie();return Number(e.find(t=>t.key==="fold_rate")?.value??"5")}async function ct(e){return(await Ie()).find(a=>a.key===e)?.value}async function Ie(){return C.isNativePlatform()?(await(await $()).query("SELECT key, value FROM settings ORDER BY key")).values??[]:L("settings",ce)}async function ge(e,t){if(!C.isNativePlatform()){const s=L("settings",ce).filter(r=>r.key!==e);s.push({key:e,value:t}),w("settings",s);return}await(await $()).run("REPLACE INTO settings (key, value) VALUES (?, ?)",[e,t])}async function sa(e){return C.isNativePlatform()?(await(await $()).query('SELECT id, name, COALESCE(email, "") as email, COALESCE(password, "password") as password, COALESCE(role, "staff") as role, branch, COALESCE(isActive, 1) as isActive FROM staff WHERE branch = ? ORDER BY name ASC',[e])).values??[]:L("staff",X).filter(s=>s.branch===e)}async function lt(){return C.isNativePlatform()?(await(await $()).query('SELECT id, name, COALESCE(email, "") as email, COALESCE(password, "password") as password, COALESCE(role, "staff") as role, branch, COALESCE(isActive, 1) as isActive FROM staff ORDER BY name ASC')).values??[]:L("staff",X)}async function dt(e,t){const a=e.trim().toLowerCase();return(await lt()).find(r=>r.email.toLowerCase()===a&&r.password===t&&r.isActive!==0)??null}async function ra(e){if(!C.isNativePlatform()){const a=L("staff",X);a.unshift({id:j(a),...e,isActive:1}),w("staff",a);return}await(await $()).run("INSERT INTO staff (name, email, password, role, branch, isActive) VALUES (?, ?, ?, ?, ?, ?)",[e.name,e.email,e.password,e.role,e.branch,1])}async function Ve(e,t){if(!C.isNativePlatform()){const n=L("staff",X),i=n.find(o=>o.id===e);i&&(Object.assign(i,t),w("staff",n));return}const a=await $(),s=[],r=[];for(const[n,i]of Object.entries(t))n!=="id"&&(s.push(`${n} = ?`),r.push(i));s.length&&(r.push(e),await a.run(`UPDATE staff SET ${s.join(", ")} WHERE id = ?`,r))}async function na(){return C.isNativePlatform()?(await(await $()).query("SELECT id, name, phone, address FROM customers ORDER BY name ASC")).values??[]:L("customers",Se).sort((a,s)=>a.name.localeCompare(s.name))}async function ia(e){if(!C.isNativePlatform()){const r=L("customers",Se),n=e.id?r.find(o=>o.id===e.id):r.find(o=>o.name.toLowerCase()===e.name.toLowerCase()&&(e.phone?o.phone===e.phone:!0));if(n)return n.name=e.name,n.phone=e.phone??n.phone,n.address=e.address??n.address,w("customers",r),n;const i={id:j(r),name:e.name,phone:e.phone??null,address:e.address??null};return r.push(i),w("customers",r),i}const t=await $();if(e.id)return await t.run("UPDATE customers SET name = ?, phone = ?, address = ? WHERE id = ?",[e.name,e.phone??null,e.address??null,e.id]),{id:e.id,name:e.name,phone:e.phone??null,address:e.address??null};const a=await t.query("SELECT COALESCE(MAX(id), 0) + 1 as id FROM customers"),s=Number((a.values?.[0]).id);return await t.run("INSERT INTO customers (id, name, phone, address) VALUES (?, ?, ?, ?)",[s,e.name,e.phone??null,e.address??null]),{id:s,name:e.name,phone:e.phone??null,address:e.address??null}}async function qe(e){if(!C.isNativePlatform())return L("services",V).filter(s=>!0);const t=await $(),a=await t.query("SELECT id, name, description, category, serviceType, price, maxKg, dryingMinutes, includes, additionalCharge, turnaroundHours, isActive FROM laundry_services  ORDER BY name ASC",[]);return(a.values??[]).length===0?(await Te(t),((await t.query("SELECT id, name, description, category, serviceType, price, maxKg, dryingMinutes, includes, additionalCharge, turnaroundHours, isActive FROM laundry_services  ORDER BY name ASC",[])).values??[]).map(r=>({...r,includes:Q(r.includes,[])}))):(a.values??[]).map(s=>({...s,includes:Q(s.includes,[])}))}async function oa(){if(!C.isNativePlatform())return L("services",V);const e=await $(),t=await e.query("SELECT id, name, description, category, serviceType, price, maxKg, dryingMinutes, includes, additionalCharge, turnaroundHours, isActive FROM laundry_services ORDER BY name ASC");return(t.values??[]).length===0?(await Te(e),((await e.query("SELECT id, name, description, category, serviceType, price, maxKg, dryingMinutes, includes, additionalCharge, turnaroundHours, isActive FROM laundry_services ORDER BY name ASC")).values??[]).map(s=>({...s,includes:Q(s.includes,[])}))):(t.values??[]).map(a=>({...a,includes:Q(a.includes,[])}))}async function Ye(e){if(!C.isNativePlatform()){const a=L("services",V),s=e.id?a.find(r=>r.id===e.id):null;s?Object.assign(s,e):a.unshift({...e,id:j(a)}),w("services",a);return}const t=await $();e.id?await t.run("UPDATE laundry_services SET name = ?, description = ?, category = ?, serviceType = ?, price = ?, maxKg = ?, dryingMinutes = ?, includes = ?, additionalCharge = ?, turnaroundHours = ?, isActive = ? WHERE id = ?",[e.name,e.description,e.category,e.serviceType,e.price,e.maxKg,e.dryingMinutes,JSON.stringify(e.includes),e.additionalCharge,e.turnaroundHours,e.isActive,e.id]):await t.run("INSERT INTO laundry_services (name, description, category, serviceType, price, maxKg, dryingMinutes, includes, additionalCharge, turnaroundHours, isActive) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)",[e.name,e.description,e.category,e.serviceType,e.price,e.maxKg,e.dryingMinutes,JSON.stringify(e.includes),e.additionalCharge,e.turnaroundHours,e.isActive])}async function ut(){if(!C.isNativePlatform())return L("item_categories",z).filter(a=>a.isActive);const e=await $(),t=await e.query("SELECT id, name, maxKg, additionalFee, isActive FROM item_categories WHERE isActive = 1 ORDER BY name ASC");return(t.values??[]).length===0?(await Te(e),(await e.query("SELECT id, name, maxKg, additionalFee, isActive FROM item_categories WHERE isActive = 1 ORDER BY name ASC")).values??[]):t.values??[]}async function ca(e){if(!C.isNativePlatform()){const a=L("item_categories",z),s=e.id?a.find(r=>r.id===e.id):null;s?Object.assign(s,e):a.unshift({...e,id:j(a)}),w("item_categories",a);return}const t=await $();e.id?await t.run("UPDATE item_categories SET name = ?, maxKg = ?, additionalFee = ?, isActive = ? WHERE id = ?",[e.name,e.maxKg,e.additionalFee,e.isActive,e.id]):await t.run("INSERT INTO item_categories (name, maxKg, additionalFee, isActive) VALUES (?, ?, ?, ?)",[e.name,e.maxKg,e.additionalFee,e.isActive])}function Oe(e,t,a,s){const r=(Array.isArray(e)?e:[e]).map(y=>{const f=Math.max(0,Number(y.quantity??1)),g=Number(y.price);return{id:y.id,name:y.name,price:g,quantity:f,total:Number((g*f).toFixed(2))}}).filter(y=>y.quantity>0),n=Number(t.maxKg),i=0,o=0,u=s.map(y=>{const f=Math.max(0,Number(y.quantity??1)),g=Number(y.price);return{id:y.id,name:Ht(y.name),price:g,quantity:f,total:Number((g*f).toFixed(2))}}).filter(y=>y.quantity>0),l=r.reduce((y,f)=>y+f.total,0),d=u.reduce((y,f)=>y+f.total,0),m=Number((l+o+d).toFixed(2));return{price:Number(l.toFixed(2)),additionalCharge:Number(o.toFixed(2)),extraServiceAmount:Number(d.toFixed(2)),totalAmount:m,allowedKg:n,extraKg:Number(i.toFixed(2)),warning:null,serviceLines:r,extras:u}}function mt(e,t){const a=e.serviceLines?.length?e.serviceLines.map(i=>i.id):[e.serviceId],s=t.filter(i=>a.includes(i.id)),r=Array.from(new Set(s.flatMap(i=>i.includes??[]))),n=[{key:"received",label:"Received"}];return r.includes("Wash")&&n.push({key:"wash",label:"Wash"}),e.extras.length&&n.push({key:"extras",label:"Extra services"}),(r.includes("Dry")||s.some(i=>(i.dryingMinutes??0)>0))&&n.push({key:"dry",label:"Dry"}),r.includes("Fold")&&n.push({key:"fold",label:"Fold"}),n.push({key:"ready",label:"Ready"},{key:"claimed",label:"Claimed"}),n}function la(e){return e.includes("claimed")?"claimed":e.includes("ready")?"ready":e.includes("dry")?"drying":e.includes("extras")||e.includes("wash")?"washing":"received"}async function ue(e){return C.isNativePlatform()?((await(await $()).query("SELECT o.*, s.name as foldedByName FROM orders o LEFT JOIN staff s ON s.id = o.foldedBy WHERE o.branch = ? ORDER BY o.id DESC",[e])).values??[]).map(s=>ea(s)):L("orders",Z).filter(s=>s.branch===e).map(s=>({...s,serviceLines:s.serviceLines??[{id:s.serviceId,name:s.service,price:Number(s.price),quantity:1,total:Number(s.price)}],balance:Number((s.totalAmount-s.paidAmount).toFixed(2))}))}async function da(e){const[t,a]=await Promise.all([qe(),ut()]),s=e.serviceQuantities??(e.serviceId?{[e.serviceId]:1}:{}),r=t.filter(h=>h.serviceType==="order"&&Number(s[h.id]??0)>0).map(h=>({...h,quantity:Number(s[h.id]??0)})),n=r[0],i=a.find(h=>h.id===e.itemCategoryId)??a.find(h=>h.name.toLowerCase()===(n?.category??"").toLowerCase())??a.find(h=>h.name==="Regular Clothes")??a[0];if(!r.length||!n||!i)throw new Error("Please select at least one service.");const o=e.addonQuantities??Object.fromEntries((e.addonIds??[]).map(h=>[h,1])),u=t.filter(h=>h.serviceType==="addon"&&Number(o[h.id]??0)>0).map(h=>({...h,quantity:Number(o[h.id]??0)})),l=e.weightKg??Math.max(1,Number(i.maxKg||n.maxKg||1)),d=Oe(r,i,l,u),m=await ia({id:e.customerId||void 0,name:e.customerName,phone:e.customerPhone??null}),y=Math.max(0,e.paidAmount),f=Math.min(d.totalAmount,y),g={ticket:await ua(),customerId:m.id,customer:m.name,phone:m.phone,serviceId:n.id,service:d.serviceLines.map(h=>`${h.name} x${h.quantity}`).join(", "),serviceLines:d.serviceLines,itemCategoryId:i.id,itemCategory:i.name,branch:e.branch,status:"received",workflowCompleted:["received"],weightKg:l,price:d.price,additionalCharge:d.additionalCharge,extraServiceAmount:d.extraServiceAmount,totalAmount:d.totalAmount,paidAmount:f,balance:Number((d.totalAmount-f).toFixed(2)),extras:d.extras,notes:e.notes||null,foldedBy:null,foldedByName:null,dueAt:new Date(Date.now()+Math.max(...r.map(h=>h.turnaroundHours))*60*60*1e3).toISOString(),createdAt:ee()};if(!C.isNativePlatform()){const h=L("orders",Z),A={...g,id:j(h)};return h.unshift(A),w("orders",h),y>0&&await vt(A.id,{amount:y,method:e.paymentMethod,reference:e.paymentReference??null}),A}const E=await $(),p=await E.query("SELECT COALESCE(MAX(id), 0) + 1 as id FROM orders"),N={...g,id:Number((p.values?.[0]).id)};return await ot(E,N),y>0&&await E.run("INSERT INTO payments (orderId, amount, method, reference, receivedAt, branch) VALUES (?, ?, ?, ?, ?, ?)",[N.id,y,e.paymentMethod,e.paymentReference??null,ee(),e.branch]),N}async function ua(){const e=`LB${Gt()}`,t=await de(),s=(await ue(t)).filter(n=>n.ticket.startsWith(e)).sort((n,i)=>i.ticket.localeCompare(n.ticket))[0],r=s?Number(s.ticket.slice(-3))+1:1;return`${e}-${String(r).padStart(3,"0")}`}async function ma(e,t){const a=await de(),[s,r]=await Promise.all([ue(a),qe()]),n=s.find(l=>l.id===e);if(!n)return;const o=mt(n,r).map(l=>l.key).find(l=>!n.workflowCompleted.includes(l));if(!o)return;if(n.workflowCompleted=[...n.workflowCompleted,o],n.status=la(n.workflowCompleted),o==="fold"&&t&&(n.foldedBy=t),!C.isNativePlatform()){const l=L("orders",Z),d=l.find(m=>m.id===n.id);d&&Object.assign(d,n),w("orders",l);return}await(await $()).run("UPDATE orders SET workflowCompleted = ?, status = ?, foldedBy = ? WHERE id = ?",[JSON.stringify(n.workflowCompleted),n.status,n.foldedBy,n.id])}async function vt(e,t){const a=await de();if(!(await ue(a)).find(o=>o.id===e))return;const n=Math.max(0,t.amount);if(n<=0)return;if(!C.isNativePlatform()){const o=L("payments",ne);o.unshift({id:j(o),orderId:e,amount:n,method:t.method,reference:t.reference??null,receivedAt:ee(),branch:a}),w("payments",o);const u=L("orders",Z),l=u.find(d=>d.id===e);l&&(l.paidAmount=Math.min(l.totalAmount,Number((l.paidAmount+n).toFixed(2)))),w("orders",u);return}const i=await $();await i.run("INSERT INTO payments (orderId, amount, method, reference, receivedAt, branch) VALUES (?, ?, ?, ?, ?, ?)",[e,n,t.method,t.reference??null,ee(),a]),await i.run("UPDATE orders SET paidAmount = MIN(totalAmount, paidAmount + ?) WHERE id = ?",[n,e])}async function va(e){return C.isNativePlatform()?(await(await $()).query("SELECT id, orderId, amount, method, reference, receivedAt, branch FROM payments  ORDER BY receivedAt DESC",[])).values??[]:L("payments",ne).filter(s=>!0)}async function pa(e){const t=await de(),s=(await ue(t)).find(n=>n.id===e);if(!s)return;if(s.paidAmount>0)throw new Error("Cancel is only allowed for unpaid orders. Use Delete (admin) to refund paid orders.");if(!C.isNativePlatform()){const n=L("orders",Z),i=L("payments",ne),o=L("fold_logs",[]),u=n.filter(m=>m.id!==e),l=i.filter(m=>m.orderId!==e),d=o.filter(m=>m.orderTicket!==s.ticket);w("orders",u),w("payments",l),w("fold_logs",d);return}const r=await $();await r.run("DELETE FROM payments WHERE orderId = ?",[e]),await r.run("DELETE FROM fold_logs WHERE orderTicket = ?",[s.ticket]),await r.run("DELETE FROM orders WHERE id = ?",[e])}async function fa(e){const t=await de(),s=(await ue(t)).find(n=>n.id===e);if(!s)return;if(s.paidAmount<=0)throw new Error("Delete (refund) is only allowed for paid orders.");if(!C.isNativePlatform()){const n=L("orders",Z),i=L("payments",ne),o=L("fold_logs",[]),u=n.filter(m=>m.id!==e),l=i.filter(m=>m.orderId!==e),d=o.filter(m=>m.orderTicket!==s.ticket);w("orders",u),w("payments",l),w("fold_logs",d);return}const r=await $();await r.run("DELETE FROM payments WHERE orderId = ?",[e]),await r.run("DELETE FROM fold_logs WHERE orderTicket = ?",[s.ticket]),await r.run("DELETE FROM orders WHERE id = ?",[e])}async function ya(){return C.isNativePlatform()?(await(await $()).query("SELECT id, orderTicket, staffName, foldCount, rate, total, createdAt FROM fold_logs ORDER BY id DESC")).values??[]:L("fold_logs",[])}async function ha(e){const t=Number((e.foldCount*e.rate).toFixed(2));if(!C.isNativePlatform()){const s=L("fold_logs",[]);s.unshift({id:Date.now(),...e,total:t,createdAt:ee()}),w("fold_logs",s);return}await(await $()).run("INSERT INTO fold_logs (orderTicket, staffName, foldCount, rate, total, createdAt) VALUES (?, ?, ?, ?, ?, ?)",[e.orderTicket,e.staffName,e.foldCount,e.rate,t,ee()])}async function ga(){return C.isNativePlatform()?(await(await $()).query("SELECT id, expenseDate, number, name, category, description, amount FROM disbursement_expenses ORDER BY expenseDate DESC, id DESC")).values??[]:L("expenses",te)}function Le(e){const t=/^DISB-(\d+)$/i.exec(String(e??"").trim());return t?Number(t[1]):0}function Qe(e){const t=/^REV-(\d+)$/i.exec(String(e??"").trim());return t?Number(t[1]):0}async function ba(){let e=0;if(!C.isNativePlatform()){const r=L("expenses",te),n=L("revolving_history",oe);for(const i of r)e=Math.max(e,Le(i.number));for(const i of n)i.type==="disbursement"&&(e=Math.max(e,Le(i.revolvingNumber)));return e}const t=await $(),a=await t.query("SELECT number FROM disbursement_expenses"),s=await t.query("SELECT revolvingNumber as number FROM revolving_history WHERE type = 'disbursement'");for(const r of[...a.values??[],...s.values??[]])e=Math.max(e,Le(String(r.number)));return e}async function pt(){const e=await ba()+1;return`DISB-${String(e).padStart(2,"0")}`}async function Ea(){let e=0;if(!C.isNativePlatform()){const s=L("revolving_history",oe);for(const r of s)r.type==="add"&&(e=Math.max(e,Qe(r.revolvingNumber)));return`REV-${String(e+1).padStart(2,"0")}`}const a=await(await $()).query("SELECT revolvingNumber FROM revolving_history WHERE type = 'add'");for(const s of a.values??[])e=Math.max(e,Qe(String(s.revolvingNumber)));return`REV-${String(e+1).padStart(2,"0")}`}async function ft(e){if(!C.isNativePlatform()){const a=L("expenses",te),s=j(a);a.unshift({id:s,expenseDate:e.expenseDate,number:e.number,name:e.name,category:e.category,description:e.description||null,amount:e.amount}),w("expenses",a);return}await(await $()).run("INSERT INTO disbursement_expenses (expenseDate, number, name, category, description, amount) VALUES (?, ?, ?, ?, ?, ?)",[e.expenseDate,e.number,e.name,e.category,e.description||null,e.amount])}async function Sa(e){const t=await pt();await ft({expenseDate:e.expenseDate,number:t,name:e.name,category:e.category,description:e.description,amount:e.amount})}async function wa(e,t){if(!C.isNativePlatform()){const s=L("expenses",te),r=s.find(n=>n.id===e);r&&(Object.assign(r,{expenseDate:t.expenseDate,name:t.name,category:t.category,description:t.description||null,amount:t.amount}),w("expenses",s));return}await(await $()).run("UPDATE disbursement_expenses SET expenseDate = ?, name = ?, category = ?, description = ?, amount = ? WHERE id = ?",[t.expenseDate,t.name,t.category,t.description||null,t.amount,e])}async function Ta(e){if(!C.isNativePlatform()){const a=L("expenses",te);w("expenses",a.filter(s=>s.id!==e));return}await(await $()).run("DELETE FROM disbursement_expenses WHERE id = ?",[e])}async function Na(){return C.isNativePlatform()?(await(await $()).query('SELECT id, saleDate, COALESCE(saleNumber, "") as saleNumber, cashAmount, gcashAmount, totalAmount, notes, status, endorsedTo, statusUpdatedAt FROM daily_sales ORDER BY saleDate DESC, id DESC')).values??[]:L("sales",ie)}async function Aa(e){const t=Number((e.cashAmount+e.gcashAmount).toFixed(2));if(!C.isNativePlatform()){const n=L("sales",ie),i=e.id?n.find(o=>o.id===e.id):n.find(o=>o.saleDate===e.saleDate);if(i)Object.assign(i,{saleDate:e.saleDate,cashAmount:e.cashAmount,gcashAmount:e.gcashAmount,totalAmount:t,notes:e.notes||null});else{const o=j(n);n.unshift({id:o,saleDate:e.saleDate,saleNumber:`SALE-${String(o).padStart(2,"0")}`,cashAmount:e.cashAmount,gcashAmount:e.gcashAmount,totalAmount:t,notes:e.notes||null})}w("sales",n);return}const a=await $(),r=(e.id?await a.query("SELECT id, saleNumber FROM daily_sales WHERE id = ?",[e.id]):await a.query("SELECT id, saleNumber FROM daily_sales WHERE saleDate = ?",[e.saleDate])).values?.[0];if(r)await a.run("UPDATE daily_sales SET saleDate = ?, cashAmount = ?, gcashAmount = ?, totalAmount = ?, notes = ? WHERE id = ?",[e.saleDate,e.cashAmount,e.gcashAmount,t,e.notes||null,r.id]);else{const n=await a.query("SELECT COALESCE(MAX(id), 0) + 1 as id FROM daily_sales"),i=Number((n.values?.[0]).id);await a.run("INSERT INTO daily_sales (saleDate, saleNumber, cashAmount, gcashAmount, totalAmount, notes) VALUES (?, ?, ?, ?, ?, ?)",[e.saleDate,`SALE-${String(i).padStart(2,"0")}`,e.cashAmount,e.gcashAmount,t,e.notes||null])}}async function La(e){if(!C.isNativePlatform()){const a=L("sales",ie);w("sales",a.filter(s=>s.id!==e));return}await(await $()).run("DELETE FROM daily_sales WHERE id = ?",[e])}async function Je(e,t,a=null,s){if(!C.isNativePlatform()){const n=L("sales",ie),i=n.find(o=>o.id===e);i&&(i.status=t,i.endorsedTo=a,i.statusUpdatedAt=s,w("sales",n));return}await(await $()).run("UPDATE daily_sales SET status = ?, endorsedTo = ?, statusUpdatedAt = ? WHERE id = ?",[t,a,s,e])}async function Ca(){return C.isNativePlatform()?(await(await $()).query("SELECT id, revolvingNumber, name, amount, category, description, type, createdAt FROM revolving_history ORDER BY createdAt DESC, id DESC")).values??[]:L("revolving_history",oe).sort((a,s)=>s.createdAt.localeCompare(a.createdAt))}async function ze(e){const t=e.type==="disbursement"?await pt():await Ea();if(e.type==="disbursement"){const s=e.expenseDate??e.createdAt.slice(0,10);await ft({expenseDate:s,number:t,name:e.name,category:e.category,description:e.description??"",amount:e.amount})}if(!C.isNativePlatform()){const s=L("revolving_history",oe),r=j(s);s.unshift({id:r,revolvingNumber:t,...e}),w("revolving_history",s);return}await(await $()).run("INSERT INTO revolving_history (revolvingNumber, name, amount, category, description, type, createdAt) VALUES (?, ?, ?, ?, ?, ?, ?)",[t,e.name,e.amount,e.category,e.description||null,e.type,e.createdAt])}async function yt(e){return C.isNativePlatform()?(await(await $()).query("SELECT id, machineName, machineType, status, branch FROM machines WHERE branch = ? ORDER BY machineType, machineName",[e])).values??[]:L("machines",Y).filter(s=>s.branch===e)}async function $a(e){if(!C.isNativePlatform()){const a=L("machines",Y);a.unshift({id:j(a),...e}),w("machines",a);return}await(await $()).run("INSERT INTO machines (machineName, machineType, status, branch) VALUES (?, ?, ?, ?)",[e.machineName,e.machineType,e.status,e.branch])}async function Ra(e,t){if(!C.isNativePlatform()){const s=L("machines",Y),r=s.find(n=>n.id===e);r&&(r.status=t,w("machines",s));return}await(await $()).run("UPDATE machines SET status = ? WHERE id = ?",[t,e])}async function Da(e){return C.isNativePlatform()?((await(await $()).query("SELECT id, date, machineIds, machineNames, cleaningStatus, notes, branch FROM subcleanings WHERE branch = ? ORDER BY date DESC, id DESC",[e])).values??[]).map(s=>({...s,machineIds:Q(s.machineIds,[])})):L("subcleanings",[]).filter(s=>s.branch===e)}async function Oa(e){const a=(await yt(e.branch)).filter(n=>e.machineIds.includes(n.id)).map(n=>n.machineName).join(", ");if(!C.isNativePlatform()){const n=L("subcleanings",[]);n.unshift({id:j(n),date:e.date,machineIds:e.machineIds,machineNames:a,cleaningStatus:e.cleaningStatus,notes:e.notes||null,branch:e.branch}),w("subcleanings",n);const i=L("machines",Y);i.forEach(o=>{e.machineIds.includes(o.id)&&(o.status=e.cleaningStatus==="completed"?"available":"under_cleaning")}),w("machines",i);return}const s=await $();await s.run("INSERT INTO subcleanings (date, machineIds, machineNames, cleaningStatus, notes, branch) VALUES (?, ?, ?, ?, ?, ?)",[e.date,JSON.stringify(e.machineIds),a,e.cleaningStatus,e.notes||null,e.branch]);const r=e.cleaningStatus==="completed"?"available":"under_cleaning";for(const n of e.machineIds)await s.run("UPDATE machines SET status = ? WHERE id = ?",[r,n])}async function Pa(e,t){if(!C.isNativePlatform()){const i=L("machines",Y),o=i.find(d=>d.id===e);o&&(o.status="available"),w("machines",i);const u=L("subcleanings",[]),l=De();u.unshift({id:j(u),date:l,machineIds:[e],machineNames:o?.machineName??"",cleaningStatus:"completed",notes:null,branch:t}),w("subcleanings",u);return}const a=await $(),r=(await a.query("SELECT machineName FROM machines WHERE id = ?",[e])).values?.[0]?.machineName??"";await a.run("UPDATE machines SET status = ? WHERE id = ?",["available",e]);const n=De();await a.run("INSERT INTO subcleanings (date, machineIds, machineNames, cleaningStatus, notes, branch) VALUES (?, ?, ?, ?, ?, ?)",[n,JSON.stringify([e]),r,"completed",null,t])}const Fe=document.querySelector("#app");if(!Fe)throw new Error("App root not found");let ye;const le=ae("BluetoothThermalPrinter"),ke={dashboard:"Dashboard",pos:"POS",orders:"Orders",archived:"Archived Order",customers:"Customers",pricing:"Pricing Services",disbursements:"Daily Report",reports:"Reports",inventory:"Inventory",maintenance:"Maintenance",staff:"Staff",revolving:"Revolving Fund",settings:"Settings"},c={tab:"dashboard",receiptOrderId:0,currentUser:null,loginError:"",sidebarOpen:!1,dailyReportTab:"expenses",maintenanceTab:"cleaning",customerSearch:"",orderSearch:"",orderDateFilter:"",orderPaymentFilter:"",printerPanelOpen:!1,printerLoading:!1,printerError:"",printerStatus:"",printerPaperWidth:58,pairedPrinters:[],selectedPrinterAddress:"",archivedOrderSearch:"",reportPreview:null,endorseModalOpen:!1,endorseSaleId:0,endorseSaleDate:"",revolvingModalOpen:!1,revolvingSaleId:0,addFundModalOpen:!1,disbursementModalOpen:!1,revolvingHistoryFrom:"",revolvingHistoryTo:""},xa=["Wash","Dry","Fold","Detergent","Fabcon","Zonrox"],ve="laba101-mobile-session";function T(e){return new Intl.NumberFormat("en-PH",{style:"currency",currency:"PHP"}).format(e||0)}function v(e){return String(e??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&#39;")}function J(e){return e.replace(/^(add[- ]?on|additional)\s+/i,"").trim()}function Ne(e,t){return Number((e-t).toFixed(2))}function ht(e,t,a,s=0){const r=t.filter(i=>H(i.createdAt)===e).reduce((i,o)=>i+o.paidAmount,0),n=a.filter(i=>i.expenseDate===e).reduce((i,o)=>i+o.amount,0);return Ne(r+s,n)}function Ia(e){const t=new Map;return e.filter(a=>a.workflowCompleted.includes("fold")&&a.foldedByName).forEach(a=>{const s=a.foldedByName,r=t.get(s)??{staffName:s,folds:0};r.folds+=1,t.set(s,r)}),Array.from(t.values())}function pe(e=new Date){const t=e.getFullYear(),a=String(e.getMonth()+1).padStart(2,"0"),s=String(e.getDate()).padStart(2,"0");return`${t}-${a}-${s}`}function W(){return pe()}function H(e){return pe(new Date(e))}function Ue(e){return e.paidAmount<=0?"unpaid":e.balance>0?"partial":"paid"}function se(e){return new Intl.DateTimeFormat("en-PH",{dateStyle:"medium",timeStyle:"short"}).format(new Date(e))}function qa(e){const t=new Date(e),a=new Intl.DateTimeFormat("en-PH",{month:"short",day:"numeric",year:"numeric"}).format(t),s=new Intl.DateTimeFormat("en-PH",{hour:"numeric",minute:"2-digit",hour12:!0}).format(t);return`<div class="datetime-stack"><strong>${v(a)}</strong><span class="meta">${v(s)}</span></div>`}function Fa(e){return e?.role==="staff"&&e.branch==="Gensan Branch"}function ka(e){return e?.role==="staff"&&e.branch.toLowerCase().includes("mintal")}function we(e,t,a="data-table"){return`
  ...
  `}function Ua(e=new Date){return{date:new Intl.DateTimeFormat("en-PH",{weekday:"long",month:"long",day:"numeric",year:"numeric"}).format(e),time:new Intl.DateTimeFormat("en-PH",{hour:"numeric",minute:"2-digit",second:"2-digit",hour12:!0}).format(e)}}function he(){const e=document.querySelector("[data-date-from]"),t=document.querySelector("[data-date-to]"),a=Array.from(document.querySelectorAll('input[name="reportType"]:checked')).map(s=>s.value).filter(s=>s==="sales"||s==="disbursement"||s==="fold_count"||s==="revolving_fund"||s==="summary");return{from:e?.value||"0000-01-01",to:t?.value||"9999-12-31",types:a.length?a:["summary"]}}function me(e,t){return e>=t.from&&e<=t.to}function gt(e,t,a,s,r,n,i){const o=new Set(i.types),u=e.filter(b=>me(H(b.createdAt),i)),l=a.filter(b=>me(b.saleDate,i)),d=s.filter(b=>me(b.expenseDate,i)),m=Ia(u),y=new Map;t.filter(b=>me(H(b.receivedAt),i)).forEach(b=>{const O=y.get(b.orderId)??{cash:0,gcash:0};b.method==="gcash"?O.gcash+=b.amount:O.cash+=b.amount,y.set(b.orderId,O)});const f=u.reduce((b,O)=>b+(y.get(O.id)?.cash??O.paidAmount),0),g=l.reduce((b,O)=>b+O.cashAmount,0),E=l.reduce((b,O)=>b+O.gcashAmount,0),p=u.reduce((b,O)=>b+(y.get(O.id)?.gcash??0),0),N=f+g,h=p+E,A=N+h,D=d.reduce((b,O)=>b+O.amount,0),R=D,k=A-R,q=()=>({orderCashTotal:f,orderGcashTotal:p,manualCashTotal:g,manualGcashTotal:E,totalCash:N,totalGcash:h,totalSales:A,transactions:u.map(b=>{const O=y.get(b.id)??{cash:b.paidAmount,gcash:0};return{ticket:b.ticket,customer:b.customer,cash:O.cash,gcash:O.gcash,total:O.cash+O.gcash}}),manualSales:l.map(b=>({cash:b.cashAmount,gcash:b.gcashAmount,total:b.totalAmount}))}),P=()=>({totalExpenses:D,totalDisbursement:R,rows:[["Date","id#","Name","Category","Description","Amount"],...d.map(b=>[b.expenseDate,b.number,b.name,b.category??"",b.description??"",b.amount]),[],["Total Disbursement","","","","",R]]}),F=()=>({rows:[["Staff","Fold Count"],...m.map(b=>[b.staffName,b.folds]),[],["Total Folds",m.reduce((b,O)=>b+O.folds,0)]]}),U=r.filter(b=>me(H(b.createdAt),i));return{selection:i,selectedTypes:o,salesRows:q,disbursementRows:P,foldCountRows:F,revolvingDailySummaryRows:()=>({rows:[["Date of Sales","Cash on Hand","Status","Date Update"],...l.map(b=>{const O=ht(b.saleDate,e,s,b.cashAmount),Nt=b.status==="revolving"?"Revolving":b.status==="endorsed"?`Endorsed to ${b.endorsedTo??""}`:"Pending";return[b.saleDate,O,Nt,b.statusUpdatedAt?H(b.statusUpdatedAt):""]})]}),revolvingHistoryRows:()=>({rows:[["Date","Number","Name","Amount","Category","Description","Type"],...U.map(b=>[H(b.createdAt),b.revolvingNumber,b.name,b.type==="disbursement"?-b.amount:b.amount,b.category,b.description??"",b.type==="add"?"Add Revolving Fund":"Disbursement"])]}),summaryRows:()=>{const b=q(),O=P();return[["Summary",i.from,"to",i.to],[],["Total Cash:","Total GCash:","Total Sales:"],["","",""],[b.totalCash,b.totalGcash,b.totalSales],["","",""],["Total Disbursement:","Total Profit:","Cash on Hand:"],["","",""],[O.totalDisbursement,k,Ne(b.totalCash,O.totalDisbursement)]]},profit:k}}function Ma(e,t){return`<button class="nav-link ${t?"is-active":""}" data-tab="${e}" type="button">
    <span class="nav-icon">${_a(e)}</span>
    <span>${ke[e]}</span>
  </button>`}function x(e,t){return`<div class="section-head"><div><h2>${v(e)}</h2><p class="meta">${v(t)}</p></div></div>`}function Ze(){return ke[c.tab]??"Dashboard"}function Ce(e){return(e?.name??"Laba101").trim().slice(0,1).toUpperCase()}function _a(e){return{dashboard:"DB",pos:"POS",orders:"PO",archived:"AR",customers:"CU",pricing:"PS",disbursements:"DR",reports:"RP",inventory:"IN",maintenance:"MT",staff:"ST",revolving:"RV",settings:"SE"}[e]}async function bt(){const e=await de(),t=await sa(e),a=await lt(),s=await na(),r=await qe(),n=await oa(),i=await ut(),o=await ue(e),u=await va(),l=await ya(),d=await ga(),m=await Na(),y=await yt(e),f=await Da(e),g=await Ca(),E=await aa(),p=await ct("report_email");return{branch:e,staff:t,allStaff:a,customers:s,services:r,allServices:n,categories:i,orders:o,payments:u,foldLogs:l,expenses:d,sales:m,machines:y,subcleanings:f,revolvingHistory:g,foldRate:E,reportEmail:p??""}}async function S(){if(!c.currentUser){Ba(),is();return}const e=await bt();e.orders.filter(o=>o.status!=="claimed").length,e.orders.filter(o=>o.status==="ready").length,e.orders.reduce((o,u)=>o+u.paidAmount,0);const t=W(),a=e.payments.filter(o=>o.branch===e.branch&&o.method==="gcash"&&H(o.receivedAt)===t).reduce((o,u)=>o+u.amount,0)+e.sales.filter(o=>o.saleDate===t).reduce((o,u)=>o+u.gcashAmount,0),s=e.payments.filter(o=>o.branch===e.branch&&o.method==="cash"&&H(o.receivedAt)===t).reduce((o,u)=>o+u.amount,0)+e.sales.filter(o=>o.saleDate===t).reduce((o,u)=>o+u.cashAmount,0),r=s+a,n=e.expenses.filter(o=>o.expenseDate===t).reduce((o,u)=>o+u.amount,0),i=Ne(s,n);e.sales.reduce((o,u)=>o+u.totalAmount,0),e.expenses.reduce((o,u)=>o+u.amount,0),Fe.innerHTML=`
    <div class="app-frame">
      <header class="topbar">
      ...
      <aside class="sidebar ${c.sidebarOpen?"is-open":""}">
        ...
        <div class="sidebar-user">
          <span class="avatar">${Ce(c.currentUser)}</span>
          <div>
            <strong>${v(c.currentUser.name)}</strong>
      ...
      <main class="workspace">
        <header class="mobile-topbar">
          ...
          <button class="mobile-avatar" type="button">${Ce(c.currentUser)}</button>
        </header>

        ${c.tab==="dashboard"?Ha({paidToday:r,cashPaidToday:s,gcashPaidToday:a,disbursementToday:n,cashOnHandToday:i,orders:e.orders,payments:e.payments,sales:e.sales}):""}
        ...
        ${c.tab==="reports"?es(e.orders,e.payments,e.sales,e.expenses,e.revolvingHistory,e.foldRate):""}
        ${c.tab==="inventory"?ts(e.services,e.categories):""}
        ${c.tab==="maintenance"?as(e.machines,e.subcleanings,e.branch):""}
        ${c.tab==="staff"?ss(e.allStaff,e.branch):""}
        ${c.tab==="revolving"?hs(e.sales,e.revolvingHistory,e.orders,e.expenses):""}
        ${c.tab==="settings"?rs(e.branch,e.foldRate,e.reportEmail):""}
      </main>
    </div>
  `,ns(),cs(e),ls(e.allServices),ds(e.expenses),us(e.orders,e.payments,e.sales,e.expenses,e.revolvingHistory,e.foldRate),ms(),vs(),ps(),fs(e.allStaff),gs(),ys(),os()}function Et(){if(c.currentUser?.role==="admin")return Object.keys(ke).filter(t=>t!=="inventory");const e=["dashboard","pos","orders","archived","disbursements","reports","maintenance","revolving"];return Fa(c.currentUser)?["dashboard","disbursements","reports","maintenance","revolving"]:ka(c.currentUser)?e.filter(t=>t!=="revolving"):e}function Ba(){Fe.innerHTML=`
  ...
  `}function ja(){document.querySelectorAll("[data-fill-email]").forEach(e=>{e.addEventListener("click",()=>{const t=document.querySelector('input[name="email"]'),a=document.querySelector('input[name="password"]');t&&(t.value=e.dataset.fillEmail??""),a&&(a.value=e.dataset.fillPassword??"")})})}function Ha(e){const t=new Date,a=Array.from({length:7},(i,o)=>{const u=new Date(t);return u.setDate(t.getDate()-(6-o)),new Intl.DateTimeFormat("en-PH",{month:"short",day:"numeric"}).format(u)}),s=Array.from({length:7},(i,o)=>{const u=new Date(t);u.setDate(t.getDate()-(6-o));const l=pe(u),d=e.orders.filter(y=>H(y.createdAt)===l).reduce((y,f)=>y+f.paidAmount,0),m=e.sales.filter(y=>y.saleDate===l).reduce((y,f)=>y+f.totalAmount,0);return d+m}),r=Math.max(1,...s),n=210;return`
      ...
      <article class="panel revenue-panel">
        ...
        <div class="chart-shell">
          <div class="mini-chart revenue-chart">
            ${s.map((i,o)=>{const u=Math.max(12,Math.round(i/r*n));return`<div class="chart-bar ${o===s.length-1?"is-today":""}"><span style="height:${u}px"></span><strong>${T(i)}</strong></div>`}).join("")}
          </div>
  ...
  `}function Wa(e,t,a,s,r,n){const i=a.filter(m=>m.serviceType==="order"&&m.isActive),o=a.filter(m=>m.serviceType==="addon"&&m.isActive),u=c.receiptOrderId?e.find(m=>m.id===c.receiptOrderId):null,l=new Set(e.map(m=>m.customerId)),d=t.filter(m=>l.has(m.id));return`
    <section class="grid content full">
        ...
        <form id="order-form" class="form">
          ...
          <fieldset class="check-grid">
            ...
            ${o.length?o.map(m=>`<div class="qty-card addon-quantity" data-qty-card="addonQty-${m.id}">
              <span><strong>${v(J(m.name))}</strong><small>${T(m.price)} each</small></span>
              <div class="qty-control">
                <button type="button" data-qty-minus="addonQty-${m.id}" aria-label="Decrease ${v(J(m.name))}">-</button>
                <input type="number" name="addonQty-${m.id}" min="0" step="1" value="0" inputmode="numeric" />
                <button type="button" data-qty-plus="addonQty-${m.id}" aria-label="Increase ${v(J(m.name))}">+</button>
              </div>
      ...
      ${u?Me(u,r.filter(m=>m.orderId===u.id)):""}
    </section>
  `}function Xa(e,t,a,s){const r=c.receiptOrderId?e.find(d=>d.id===c.receiptOrderId):null,n=e.filter(d=>d.status!=="claimed"),i=c.orderSearch.trim().toLowerCase(),o=c.orderDateFilter.trim(),u=c.orderPaymentFilter.trim().toLowerCase(),l=n.filter(d=>{const m=!i||[d.ticket,d.customer,d.phone,d.service,d.itemCategory,d.status].some(g=>String(g??"").toLowerCase().includes(i)),y=!o||H(d.createdAt)===o,f=!u||Ue(d)===u;return m&&y&&f});return`
    <section class="grid content full">
      <article class="panel span-2">
      ...
      ${r?Me(r,s.filter(d=>d.orderId===r.id)):""}
    </section>
  `}function Ka(e,t,a,s){const r=e.filter(u=>u.status==="claimed"),n=c.archivedOrderSearch.trim().toLowerCase(),i=r.filter(u=>n?[u.ticket,u.customer,u.phone,u.service,u.itemCategory].some(l=>String(l??"").toLowerCase().includes(n)):!0),o=c.receiptOrderId?e.find(u=>u.id===c.receiptOrderId):null;return`
    <section class="grid content full">
      <article class="panel span-2">
        ...
        <table class="data-table orders-data-table archived-orders-table">
          ...
          <tbody>
            ${i.map(u=>St(u,t,a)).join("")||'<tr><td colspan="5" class="table-empty">No archived orders found.</td></tr>'}
          </tbody>
        </table>
      </article>
      ${o?Me(o,s.filter(u=>u.orderId===o.id)):""}
    </section>
  `}function St(e,t,a){const s=mt(e,a),r=s.find(f=>!e.workflowCompleted.includes(f.key)),n=r?.key==="fold",i=r?.key==="extras"&&e.extras.length>0,o=Ue(e),u=o.charAt(0).toUpperCase()+o.slice(1),l=e.extras.length?e.extras.map(f=>`${v(J(f.name))} x${Number(f.quantity??1)}`).join(", "):"",d=c.currentUser?.role==="admin",m=e.status!=="claimed"&&e.paidAmount<=0,y=e.status!=="claimed"&&d&&e.paidAmount>0;return`
    <tr class="order-row-main">
      <td><strong>${v(e.ticket)}</strong><div class="small">${v(se(e.createdAt))}</div></td>
      <td>${v(e.customer)}<div class="small">${v(e.phone??"")}</div></td>
      <td>${v(e.service)}${l?`<div class="small">Extras: ${l}</div>`:""}</td>
      <td class="amount-cell"><strong>${T(e.totalAmount)}</strong><div class="small">${v(u)} · Paid ${T(e.paidAmount)} · Bal PHP ***</div></td>
      <td>
  ...
  `}function Me(e,t){const a=t.reduce((i,o)=>i+Number(o.amount),0),s=Math.max(0,Number((a-e.totalAmount).toFixed(2))),r=Ue(e),n=r.charAt(0).toUpperCase()+r.slice(1);return`
      ...
      <div class="receipt-modal" role="dialog" aria-modal="true" aria-labelledby="receipt-title">
        ...
        <div class="receipt" id="receipt-print-area">
          <div class="receipt-head">
            ...
            <p>${v(e.ticket)}<br>${v(se(e.createdAt))}</p>
          </div>
          ...
          <div class="summary-list receipt-lines">
            ...
            ${e.extras.length?`<div><span>Extra services</span><strong>${e.extras.map(i=>`${v(J(i.name))} x${Number(i.quantity??1)} (${T(Number(i.total??i.price))})`).join(", ")}</strong></div>`:""}
          ...
          ${e.map(a=>`
            <article class="service-card">
              ...
              <div class="service-fields">
                <div><span>price:</span><strong>${T(a.price)}</strong></div>
  ...
  `}function Za(e,t){const a=W(),s=a.slice(0,7),r=c.currentUser?.role==="admin",n=e.filter(l=>l.expenseDate===a).reduce((l,d)=>l+d.amount,0),i=e.filter(l=>l.expenseDate.startsWith(s)).reduce((l,d)=>l+d.amount,0),o=t.filter(l=>l.saleDate===a).reduce((l,d)=>l+d.totalAmount,0),u=t.filter(l=>l.saleDate.startsWith(s)).reduce((l,d)=>l+d.totalAmount,0);return`
    ...
    <section class="grid stats compact report-stats">
      ...
      <div class="panel stat"><div class="card-label">Today sales input</div><div class="value">${T(o)}</div></div>
      <div class="panel stat"><div class="card-label">Month sales input</div><div class="value">${T(u)}</div></div>
    </section>
      ...
      <article class="panel">
        ...
        <div class="table-scroll daily-report-scroll">
          <div class="table wide-table daily-report-table">
            ...
            ${t.map(l=>`<div class="table-row"><div>${v(l.saleNumber)}</div><div>${v(l.saleDate)}</div><div>${T(l.cashAmount)}</div><div>${T(l.gcashAmount)}</div><div><strong>${T(l.totalAmount)}</strong></div><div class="row-actions"><button class="secondary edit-sale-btn" data-id="${l.id}" type="button">Edit</button>${r?`<button class="secondary delete-sale-btn" data-id="${l.id}" type="button">Delete</button>`:""}</div></div>`).join("")||'<div class="helper">No daily sales totals yet.</div>'}
          </div>
        </div>
      </article>
    </section>
    `}
  `}function es(e,t,a,s,r,n,i,o,u){const l=c.reportPreview?gt(e,t,a,s,r,n,c.reportPreview):null;return`
    <section class="page-head">
      <div>
        ...
        ${l.selectedTypes.has("sales")?`
          <article>
            ...
            <div class="table wide-table report-preview-table">
              ...
              ${l.salesRows().transactions.map(d=>`<div class="table-row report-table-row"><div>${v(d.ticket)}</div><div>${v(d.customer)}</div><div>${T(d.cash)}</div><div>${T(d.gcash)}</div><div>${T(d.total)}</div></div>`).join("")}
            </div>
            <div class="sales-summary-table">
              <div class="summary-row">
                <div class="summary-cell"><span class="summary-label">Cash from Orders</span><strong>${T(l.salesRows().orderCashTotal)}</strong></div>
                <div class="summary-cell"><span class="summary-label">GCash from Orders</span><strong>${T(l.salesRows().orderGcashTotal)}</strong></div>
                <div class="summary-cell"><span class="summary-label">Sales from Orders</span><strong>${T(l.salesRows().orderCashTotal+l.salesRows().orderGcashTotal)}</strong></div>
              </div>
              <div class="summary-row">
                <div class="summary-cell"><span class="summary-label">Cash Whole Sale</span><strong>${T(l.salesRows().manualCashTotal)}</strong></div>
                <div class="summary-cell"><span class="summary-label">GCash Whole Sale</span><strong>${T(l.salesRows().manualGcashTotal)}</strong></div>
                <div class="summary-cell"><span class="summary-label">Whole Sale of Day</span><strong>${T(l.salesRows().manualCashTotal+l.salesRows().manualGcashTotal)}</strong></div>
              </div>
              <div class="summary-row total-row">
                <div class="summary-cell"><span class="summary-label">Total Cash</span><strong>${T(l.salesRows().totalCash)}</strong></div>
                <div class="summary-cell"><span class="summary-label">Total GCash</span><strong>${T(l.salesRows().totalGcash)}</strong></div>
                <div class="summary-cell"><span class="summary-label">Total Sales</span><strong>${T(l.salesRows().totalSales)}</strong></div>
              </div>
            </div>
          </article>`:""}
        ${l.selectedTypes.has("disbursement")?`
          <article>
            ...
            <div class="table wide-table report-preview-table report-disbursement-table">
              ...
              ${l.disbursementRows().rows.slice(1).filter(d=>d.length&&d[0]!=="Total Disbursement").map(d=>`<div class="table-row report-table-row"><div>${v(d[1]??"")}</div><div>${v(d[2]??"")}</div><div>${v(d[3]??"")}</div><div>${T(d[5])}</div><div>${v(d[0]??"")}</div></div>`).join("")}
              <div class="table-row report-table-row total-row"><div></div><div></div><div>Total Disbursement</div><div>${T(l.disbursementRows().totalDisbursement)}</div><div></div></div>
            </div>
          </article>`:""}
        ...
        ${l.selectedTypes.has("summary")?`
          <article>
            ...
            <div class="summary-cards-grid">
              <div class="summary-card"><span class="card-label">Total Cash</span><strong>${T(l.salesRows().totalCash)}</strong></div>
              <div class="summary-card"><span class="card-label">Total GCash</span><strong>${T(l.salesRows().totalGcash)}</strong></div>
              <div class="summary-card"><span class="card-label">Total Sales</span><strong>${T(l.salesRows().totalSales)}</strong></div>
              <div class="summary-card"><span class="card-label">Total Disbursement</span><strong>${T(l.disbursementRows().totalDisbursement)}</strong></div>
              <div class="summary-card"><span class="card-label">Total Profit</span><strong>${T(l.profit)}</strong></div>
              <div class="summary-card"><span class="card-label">Cash on Hand</span><strong>${T(Ne(l.salesRows().totalCash,l.disbursementRows().totalDisbursement))}</strong></div>
            </div>
          </article>`:""}
      </section>
    `:""}
  ...
  `}function as(e,t,a){const s=e.filter(n=>n.status!=="under_cleaning"),r=e.filter(n=>n.status==="under_cleaning");return`
    <section class="page-head">
      <div>
    ...
    <section class="grid content full">
      ...
      <article class="panel span-2">
        ...
        <div class="table">
          ...
          ${e.map(n=>{const i=t.find(o=>o.machineIds.includes(n.id)&&o.date===W());return`<div class="table-row"><div><strong>${v(n.machineName)}</strong></div><div>${v(n.machineType)}</div><div>${i?v(i.cleaningStatus.replace("_"," ")):"Not Cleaned"}</div><div>${v(i?.notes??"-")}</div><div>${W()}</div></div>`}).join("")}
        </div>
      </article>
    </section>
    `:`
  ...
  `}function ns(){const e=()=>{localStorage.removeItem(ve),c.currentUser=null,c.tab="dashboard",c.receiptOrderId=0,c.sidebarOpen=!1,S()};document.querySelector("#logout-button")?.addEventListener("click",e),document.querySelector("#mobile-logout-button")?.addEventListener("click",e),document.querySelector("#mobile-menu-button")?.addEventListener("click",()=>{c.sidebarOpen=!0,S()}),document.querySelector("#sidebar-close-button")?.addEventListener("click",()=>{c.sidebarOpen=!1,S()}),document.querySelector("#sidebar-backdrop")?.addEventListener("click",()=>{c.sidebarOpen=!1,S()}),document.querySelectorAll("[data-tab]").forEach(t=>{t.addEventListener("click",()=>{c.tab=t.dataset.tab,c.receiptOrderId=0,c.sidebarOpen=!1,S()})}),document.querySelectorAll("[data-quick-tab]").forEach(t=>{t.addEventListener("click",()=>{c.tab=t.dataset.quickTab,S()})}),document.querySelectorAll("[data-receipt]").forEach(t=>{t.addEventListener("click",()=>{c.receiptOrderId=Number(t.dataset.receipt),c.printerPanelOpen=!1,c.printerError="",c.printerStatus="",S()})}),document.querySelector("[data-close-receipt]")?.addEventListener("click",()=>{c.receiptOrderId=0,S()}),document.querySelector("[data-open-printer-panel]")?.addEventListener("click",()=>{c.printerPanelOpen=!c.printerPanelOpen,c.printerPanelOpen&&c.pairedPrinters.length===0?et():S()}),document.querySelector("[data-refresh-printers]")?.addEventListener("click",()=>{et()}),document.querySelector("[data-printer-select]")?.addEventListener("change",t=>{c.selectedPrinterAddress=t.currentTarget.value,S()}),document.querySelector("[data-paper-width]")?.addEventListener("change",t=>{c.printerPaperWidth=Number(t.currentTarget.value)===80?80:58,S()}),document.querySelector("[data-connect-printer]")?.addEventListener("click",()=>{Va()}),document.querySelector("[data-thermal-print]")?.addEventListener("click",()=>{(async()=>{const t=await bt(),a=t.orders.find(r=>r.id===c.receiptOrderId);if(!a)throw new Error("Receipt order not found.");const s=t.payments.filter(r=>r.orderId===a.id);await Qa(a,s)})().catch(t=>{c.printerPanelOpen=!0,c.printerError=t instanceof Error?t.message:"Bluetooth thermal print failed.",S()})}),document.querySelectorAll("[data-report-tab]").forEach(t=>{t.addEventListener("click",()=>{c.dailyReportTab=t.dataset.reportTab,S()})}),document.querySelectorAll("[data-maintenance-tab]").forEach(t=>{t.addEventListener("click",()=>{c.maintenanceTab=t.dataset.maintenanceTab,S()})})}function is(){ja(),document.querySelector("#login-form")?.addEventListener("submit",async e=>{e.preventDefault();const t=new FormData(e.currentTarget),a=document.querySelector("#login-button");a&&(a.disabled=!0,a.textContent="Signing in...");try{const s=await dt(String(t.get("email")??""),String(t.get("password")??""));if(!s){c.loginError="Invalid email or password.",await S();return}c.currentUser=s,c.loginError="",await ge("branch",String(s.branch||"Main Store")),t.get("remember")?localStorage.setItem(ve,JSON.stringify({email:s.email,remembered:!0})):localStorage.removeItem(ve),Et().includes(c.tab)||(c.tab="dashboard"),await S()}catch(s){alert("Login Error: "+String(s?.message||s)),a&&(a.disabled=!1,a.textContent="Sign in")}})}function os(){ye&&window.clearInterval(ye);const e=document.querySelector("[data-navbar-time]"),t=document.querySelector("[data-navbar-date]");if(!e||!t){ye=void 0;return}const a=()=>{const s=Ua();e.textContent=s.time,t.textContent=s.date};a(),ye=window.setInterval(a,1e3)}function tt(e,t){return e?t.find(a=>a.name.toLowerCase()===e.category.toLowerCase())??t.find(a=>a.name==="Regular Clothes")??t[0]??null:null}function $e(e,t){return Math.max(1,Number(t.maxKg||e.maxKg||1))}function wt(e,t){return Object.fromEntries(t.filter(a=>a.serviceType==="order").map(a=>[a.id,Number(e.querySelector(`input[name="serviceQty-${a.id}"]`)?.value??0)]).filter(([,a])=>Number(a)>0))}function at(e,t){const a=wt(e,t);return t.filter(s=>s.serviceType==="order"&&Number(a[s.id]??0)>0).map(s=>({...s,quantity:Number(a[s.id])}))}function Tt(e,t){return Object.fromEntries(t.filter(a=>a.serviceType==="addon").map(a=>[a.id,Number(e.querySelector(`input[name="addonQty-${a.id}"]`)?.value??0)]).filter(([,a])=>Number(a)>0))}function st(e,t){const a=Tt(e,t);return t.filter(s=>s.serviceType==="addon"&&Number(a[s.id]??0)>0).map(s=>({...s,quantity:Number(a[s.id])}))}function cs(e){const t=document.querySelector("#order-form"),a=document.querySelector("#price-preview"),s=t?.querySelector('button[type="submit"]'),r=t?.querySelector('select[name="customerId"]'),n=t?.querySelector('input[name="customerName"]'),i=t?.querySelector('input[name="customerPhone"]'),o=t?.querySelector("[data-order-error]"),u=t?.querySelector('select[name="paymentMethod"]'),l=t?.querySelector(".gcash-reference"),d=t?.querySelector('input[name="paymentReference"]');let m=!1;const y=()=>{if(!r||!n||!i)return;const p=r.selectedOptions[0];n.value=p?.dataset.name??"",i.value=p?.dataset.phone??""},f=()=>{const p=u?.value==="gcash";l&&(l.hidden=!p),d&&(d.required=p,p||(d.value=""))},g=(p,N)=>{if(!t)return;const h=t.querySelector(`input[name="${p}"]`);h&&(h.value=String(Math.max(0,Number(h.value||0)+N)),h.closest(".qty-card")?.classList.toggle("is-selected",Number(h.value)>0),h.dispatchEvent(new Event("input",{bubbles:!0})))};t?.querySelectorAll(".qty-control input").forEach(p=>{p.addEventListener("input",()=>{p.value=String(Math.max(0,Number(p.value||0))),p.closest(".qty-card")?.classList.toggle("is-selected",Number(p.value)>0)})}),t?.querySelectorAll("[data-qty-card]").forEach(p=>{p.addEventListener("click",N=>{const h=N.target;h.closest("input")||h.closest("button")||g(p.dataset.qtyCard??"",1)})}),t?.querySelectorAll("[data-qty-plus]").forEach(p=>{p.addEventListener("click",()=>g(p.dataset.qtyPlus??"",1))}),t?.querySelectorAll("[data-qty-minus]").forEach(p=>{p.addEventListener("click",()=>g(p.dataset.qtyMinus??"",-1))});const E=()=>{if(!t||!a)return;const p=at(t,e.services),N=p[0],h=tt(N,e.categories),A=st(t,e.services);if(!p.length||!N||!h){s&&(s.disabled=!0),o&&(o.hidden=!m,o.textContent=m?"Please select at least one service quantity.":""),a.innerHTML='<div class="preview-total"><span>Total amount</span><strong>PHP 0.00</strong></div>';return}const D=Oe(p,h,$e(N,h),A),R=D.serviceLines.map(q=>`${q.name} x${q.quantity}`),k=D.extras.map(q=>`${J(q.name)} x${q.quantity}`);s&&(s.disabled=!1),o&&(o.hidden=!0,o.textContent=""),a.classList.remove("has-error"),a.innerHTML=`
      <div class="preview-line"><span>Services${R.length?` (${v(R.join(", "))})`:""}</span><strong>${T(D.price)}</strong></div>
    ...
    `};r?.addEventListener("change",y),u?.addEventListener("change",f),f(),t?.addEventListener("input",E),t?.addEventListener("change",E),E(),t?.addEventListener("submit",async p=>{p.preventDefault(),m=!0;const N=new FormData(t),h=at(t,e.services),A=h[0],D=tt(A,e.categories),R=st(t,e.services);if(!h.length||!A||!D){o&&(o.hidden=!1,o.textContent="Please select at least one service quantity.");return}const k=h.map(P=>`${P.name} x${P.quantity}`).join(", "),q=Oe(h,D,$e(A,D),R);if(confirm(`Save this order?

Services: ${k}
Total: ${T(q.totalAmount)}`))try{await da({customerId:Number(N.get("customerId"))||void 0,customerName:String(N.get("customerName")??""),customerPhone:String(N.get("customerPhone")??"")||null,serviceQuantities:wt(t,e.services),branch:e.branch,itemCategoryId:D?.id,weightKg:A&&D?$e(A,D):void 0,addonQuantities:Tt(t,e.services),paidAmount:Number(N.get("paidAmount")??0),paymentMethod:String(N.get("paymentMethod")??"cash"),paymentReference:String(N.get("paymentReference")??"")||null,notes:String(N.get("notes")??"")||null}),await S()}catch(P){o&&(o.hidden=!1,o.textContent=P instanceof Error?P.message:"Order could not be saved.")}}),document.querySelectorAll(".advance-form").forEach(p=>{p.addEventListener("submit",async N=>{N.preventDefault();const h=new FormData(p);await ma(Number(p.dataset.orderId),Number(h.get("assignedStaffId"))||null),await S()})}),document.querySelectorAll(".payment-form").forEach(p=>{const N=p.querySelector('select[name="method"]'),h=p.querySelector('input[name="reference"]'),A=()=>{const D=N?.value==="gcash";h&&(h.hidden=!D,h.required=D,D||(h.value=""))};N?.addEventListener("change",A),A(),p.addEventListener("submit",async D=>{D.preventDefault();const R=new FormData(p),k=Number(R.get("amount")),q=String(R.get("method")),P=String(R.get("reference")??"")||null;confirm(`Confirm payment of ${T(k)} via ${q.toUpperCase()}?`)&&(await vt(Number(p.dataset.orderId),{amount:k,method:q,reference:P}),await S())})}),document.querySelectorAll("[data-cancel-order]").forEach(p=>{p.addEventListener("click",async()=>{const N=Number(p.dataset.cancelOrder);if(Number.isFinite(N)&&confirm("Cancel this order? (No payment will be refunded.)"))try{c.receiptOrderId===N&&(c.receiptOrderId=0),await pa(N),await S()}catch(h){alert(h instanceof Error?h.message:"Cancel failed.")}})}),document.querySelectorAll("[data-delete-order]").forEach(p=>{p.addEventListener("click",async()=>{const N=Number(p.dataset.deleteOrder);if(Number.isFinite(N)&&confirm("Delete this paid order and update sales?"))try{c.receiptOrderId===N&&(c.receiptOrderId=0),await fa(N),await S()}catch(h){alert(h instanceof Error?h.message:"Delete failed.")}})})}function ls(e){document.querySelector("#service-form")?.addEventListener("submit",async t=>{t.preventDefault();const a=new FormData(t.currentTarget),s=a.get("id")?Number(a.get("id")):void 0;await Ye({id:s,name:String(a.get("name")??""),description:String(a.get("description")??"")||null,category:String(a.get("category")??""),serviceType:String(a.get("serviceType")??"order"),price:Number(a.get("price")??0),maxKg:Number(a.get("maxKg")??0),dryingMinutes:Number(a.get("dryingMinutes"))||null,includes:a.getAll("includes").map(String).filter(Boolean),additionalCharge:0,turnaroundHours:Number(a.get("turnaroundHours")??24),isActive:1}),await S()}),document.querySelectorAll(".edit-service-btn").forEach(t=>{t.addEventListener("click",()=>{const a=Number(t.dataset.id),s=e.find(n=>n.id===a),r=document.querySelector("#service-form");s&&r&&(r.querySelector("[name=id]").value=String(s.id),r.querySelector("[name=name]").value=s.name,r.querySelector("[name=category]").value=s.category,r.querySelector("[name=serviceType]").value=s.serviceType,r.querySelector("[name=price]").value=String(s.price),r.querySelector("[name=maxKg]").value=String(s.maxKg),r.querySelector("[name=dryingMinutes]").value=s.dryingMinutes?String(s.dryingMinutes):"",r.querySelectorAll('input[name="includes"]').forEach(n=>{n.checked=s.includes.includes(n.value)}),r.querySelector("[name=turnaroundHours]").value=String(s.turnaroundHours),r.querySelector("[name=description]").value=s.description??"",window.scrollTo({top:0,behavior:"smooth"}))})}),document.querySelectorAll(".deactivate-service-btn, .activate-service-btn").forEach(t=>{t.addEventListener("click",async()=>{const a=Number(t.dataset.id),s=e.find(r=>r.id===a);if(s){const r=s.isActive?0:1;await Ye({id:s.id,name:s.name,description:s.description,category:s.category,serviceType:s.serviceType,price:s.price,maxKg:s.maxKg,dryingMinutes:s.dryingMinutes,includes:s.includes,additionalCharge:s.additionalCharge,turnaroundHours:s.turnaroundHours,isActive:r}),await S()}})}),document.querySelector("#category-form")?.addEventListener("submit",async t=>{t.preventDefault();const a=new FormData(t.currentTarget);await ca({name:String(a.get("name")??""),maxKg:Number(a.get("maxKg")??0),additionalFee:Number(a.get("additionalFee")??0),isActive:1}),await S()})}function ds(e){const t=document.querySelector("#expense-form");t?.addEventListener("submit",async a=>{a.preventDefault();const s=new FormData(a.currentTarget),r=Number(s.get("id")||0),n={expenseDate:String(s.get("expenseDate")??""),name:String(s.get("name")??""),category:String(s.get("category")??""),description:String(s.get("description")??""),amount:Number(s.get("amount")??0)};r?await wa(r,n):await Sa(n),await S()}),document.querySelectorAll(".edit-expense-btn").forEach(a=>{a.addEventListener("click",()=>{const s=e.find(n=>n.id===Number(a.dataset.id));if(!s||!t)return;t.querySelector("[name=id]").value=String(s.id),t.querySelector("[name=expenseDate]").value=s.expenseDate,t.querySelector("[name=amount]").value=String(s.amount),t.querySelector("[name=name]").value=s.name,t.querySelector("[name=category]").value=s.category,t.querySelector("[name=description]").value=s.description??"";const r=t.querySelector('button[type="submit"]');r&&(r.textContent="Update expense"),t.scrollIntoView({behavior:"smooth",block:"start"})})}),document.querySelectorAll(".delete-expense-btn").forEach(a=>{a.addEventListener("click",async()=>{if(c.currentUser?.role!=="admin")return;const s=Number(a.dataset.id);!Number.isFinite(s)||!confirm("Delete this disbursement?")||(await Ta(s),await S())})}),document.querySelector("#fold-form")?.addEventListener("submit",async a=>{a.preventDefault();const s=new FormData(a.currentTarget);await ha({orderTicket:String(s.get("orderTicket")??""),staffName:String(s.get("staffName")??""),foldCount:Number(s.get("foldCount")??1),rate:Number(s.get("rate")??5)}),await S()})}function us(e,t,a,s,r,n){document.querySelector("#generate-report")?.addEventListener("click",()=>{c.reportPreview=he(),S()});const i=document.querySelector("#sales-form");i?.addEventListener("submit",async g=>{g.preventDefault();const E=new FormData(g.currentTarget);await Aa({id:Number(E.get("id")||0)||void 0,saleDate:String(E.get("saleDate")??""),cashAmount:Number(E.get("cashAmount")??0),gcashAmount:Number(E.get("gcashAmount")??0),notes:String(E.get("notes")??"")}),await S()}),document.querySelectorAll(".edit-sale-btn").forEach(g=>{g.addEventListener("click",()=>{const E=a.find(N=>N.id===Number(g.dataset.id));if(!E||!i)return;i.querySelector("[name=id]").value=String(E.id),i.querySelector("[name=saleDate]").value=E.saleDate,i.querySelector("[name=cashAmount]").value=String(E.cashAmount),i.querySelector("[name=gcashAmount]").value=String(E.gcashAmount),i.querySelector("[name=notes]").value=E.notes??"";const p=i.querySelector('button[type="submit"]');p&&(p.textContent="Update daily sale"),i.scrollIntoView({behavior:"smooth",block:"start"})})}),document.querySelectorAll(".delete-sale-btn").forEach(g=>{g.addEventListener("click",async()=>{if(c.currentUser?.role!=="admin")return;const E=Number(g.dataset.id);!Number.isFinite(E)||!confirm("Delete this daily sale?")||(await La(E),await S())})});const o=document.querySelector("[data-date-from]"),u=document.querySelector("[data-date-to]");document.querySelectorAll("[data-date-scope]").forEach(g=>{g.addEventListener("change",()=>{if(!g.checked||!o||!u)return;const E=new Date,p=pe(E),N=new Date(E);g.value==="week"&&N.setDate(E.getDate()-6),g.value==="month"&&N.setDate(1),g.value!=="custom"&&(o.value=g.value==="today"?p:pe(N),u.value=p)})});const l=g=>{const E=h=>String(h??"").replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;").replaceAll("'","&apos;"),p=h=>h==="Sales Report"?[110,125,150,215,95,95,105,105]:h==="Disbursement"?[110,115,150,220,105]:h==="Fold Count"?[220,125]:h==="Revolving Daily Summary"?[115,105,120,115]:h==="Revolving History"?[115,96,140,96,110,180,120]:[155,125,125,125,95,95,115,115];return`<?xml version="1.0"?>
...
<Workbook xmlns="urn:schemas-microsoft-com:office:spreadsheet"
 ...
 xmlns:html="http://www.w3.org/TR/REC-html40">
  ...
  ${g.map(h=>{const A=p(h.name).map(R=>`<Column ss:Width="${R}" ss:AutoFitWidth="0"/>`).join(""),D=h.rows.map(R=>{if(!R.length)return'<Row ss:Height="10" ss:StyleID="BorderRow"><Cell ss:StyleID="BorderCell"><Data ss:Type="String">&nbsp;</Data></Cell></Row>';const k=R[0]==="Type"||R[0]==="Summary"||R[0]==="Sales Summary"||R[0]==="Disbursement Summary"||R[0]==="Staff"||R[0]==="Date of Sales"||R[0]==="Date",q=k?"HeaderRow":"BorderRow",P=k?"HeaderCell":"BorderCell",F=k?26:22,U=R.map(M=>`<Cell ss:StyleID="${P}"><Data ss:Type="${typeof M=="number"?"Number":"String"}">${E(M)}</Data></Cell>`).join("");return`<Row ss:Height="${F}" ss:StyleID="${q}">${U}</Row>`}).join("");return`
...
</Workbook>`},d=()=>{const g=he(),E=gt(e,t,a,s,r,n,g),p=[];if(E.selectedTypes.has("sales")){const A=E.salesRows(),D=[["Ticket","Customer","Cash","GCash","Total Payment"],...A.transactions.map(R=>[R.ticket,R.customer,R.cash,R.gcash,R.total]),[],["Cash from Orders","GCash from Orders","Sales from Orders"],[A.orderCashTotal,A.orderGcashTotal,A.orderCashTotal+A.orderGcashTotal],[],["Cash Whole Sale","GCash Whole Sale","Whole Sale of Day"],[A.manualCashTotal,A.manualGcashTotal,A.manualCashTotal+A.manualGcashTotal],[],["Total Cash","Total GCash","Total Sales"],[A.totalCash,A.totalGcash,A.totalSales]];p.push({name:"Sales Report",rows:D})}E.selectedTypes.has("disbursement")&&p.push({name:"Disbursement",rows:E.disbursementRows().rows}),E.selectedTypes.has("fold_count")&&p.push({name:"Fold Count",rows:E.foldCountRows().rows}),E.selectedTypes.has("revolving_fund")&&(p.push({name:"Revolving Daily Summary",rows:E.revolvingDailySummaryRows().rows}),p.push({name:"Revolving History",rows:E.revolvingHistoryRows().rows})),E.selectedTypes.has("summary")&&p.push({name:"Summary",rows:E.summaryRows()});const N=l(p.length?p:[{name:"Summary",rows:E.summaryRows()}]),h=`laba101-report-${g.from}-to-${g.to}.xls`;return new File([N],h,{type:"application/vnd.ms-excel"})},m=async()=>{const g=d();if(!C.isNativePlatform())return{fileName:g.name,uri:""};const E=await g.text(),p=g.name;await Xe.writeFile({path:p,data:E,directory:be.External,encoding:Re.UTF8});const{uri:N}=await Xe.getUri({path:p,directory:be.External});return{fileName:g.name,uri:N}},y=()=>{const g=d(),E=he(),p=`laba101-report-${E.from}-to-${E.to}.xls`,N=g,h=URL.createObjectURL(N),A=document.createElement("a");return A.href=h,A.download=p,document.body.appendChild(A),A.click(),setTimeout(()=>{A.remove(),URL.revokeObjectURL(h)},1e3),p},f=async g=>{const E=document.querySelector(g==="export"?"#export-report":"#email-report");E&&(E.disabled=!0,E.textContent=g==="export"?"Exporting...":"Sending...");try{if(g==="export")if(C.isNativePlatform()){const p=await m();alert(`Report exported as "${p.fileName}".`)}else{const p=y();alert(`Report saved: ${p}`)}else{const p=await ct("report_email")||"";if(!p){alert("Please configure a report email in Settings first.");return}const N=he(),h=`Laba101 report ${N.from} to ${N.to}`;if(C.isNativePlatform()){const A=await m();try{await _t.share({title:h,text:`Please find the attached Laba101 report file: ${A.fileName}`,files:[A.uri],dialogTitle:"Send report via email"}),alert(`Report saved and shared as "${A.fileName}".`)}catch(D){const R=String(D).toLowerCase();if(R.includes("share canceled")||R.includes("canceled"))alert(`Report saved as "${A.fileName}".`);else throw D}}else{const A=y(),D=`Hi,

Please find the attached Laba101 report file: ${A}

Date range: ${N.from} to ${N.to}`,R=`mailto:${p}?subject=${encodeURIComponent(h)}&body=${encodeURIComponent(D)}`;setTimeout(()=>{window.location.href=R},800),alert(`Report downloaded as "${A}".
Your email app will open — please attach the file and send.`)}}}catch(p){alert("Failed: "+String(p))}finally{E&&(E.disabled=!1,E.textContent=g==="export"?"Export Excel":"Send to Email")}};document.querySelector("#export-report")?.addEventListener("click",async()=>{await f("export")}),document.querySelector("#email-report")?.addEventListener("click",async()=>{await f("email")})}function ms(){document.querySelector("#order-queue-filters")?.addEventListener("submit",e=>{e.preventDefault();const t=new FormData(e.currentTarget);c.orderSearch=String(t.get("orderSearch")??"").trim(),c.orderDateFilter=String(t.get("orderDateFilter")??"").trim(),c.orderPaymentFilter=String(t.get("orderPaymentFilter")??"").trim(),S()}),document.querySelector("#order-queue-clear")?.addEventListener("click",()=>{c.orderSearch="",c.orderDateFilter="",c.orderPaymentFilter="",S()}),document.querySelector("#archived-order-filters")?.addEventListener("submit",e=>{e.preventDefault();const t=new FormData(e.currentTarget);c.archivedOrderSearch=String(t.get("archivedOrderSearch")??"").trim(),S()}),document.querySelector("#archived-order-clear")?.addEventListener("click",()=>{c.archivedOrderSearch="",S()})}function vs(){document.querySelector("#customer-search-form")?.addEventListener("submit",e=>{e.preventDefault();const t=new FormData(e.currentTarget);c.customerSearch=String(t.get("customerSearch")??"").trim(),S()}),document.querySelector("#customer-search-clear")?.addEventListener("click",()=>{c.customerSearch="",S()})}function ps(){document.querySelector("#machine-form")?.addEventListener("submit",async e=>{e.preventDefault();const t=new FormData(e.currentTarget);await $a({machineName:String(t.get("machineName")??""),machineType:String(t.get("machineType")),status:String(t.get("status")),branch:String(t.get("branch")??"")}),await S()}),document.querySelector("#subcleaning-form")?.addEventListener("submit",async e=>{e.preventDefault();const t=e.currentTarget.querySelector('button[type="submit"]');t&&(t.disabled=!0,t.textContent="Starting...");const a=new FormData(e.currentTarget),s=a.getAll("machineIds").map(Number);if(!s.length){alert("Please select at least one machine to clean."),t&&(t.disabled=!1,t.textContent="Start Cleaning");return}await Oa({date:String(a.get("date")??""),machineIds:s,cleaningStatus:String(a.get("cleaningStatus")??""),notes:String(a.get("notes")??""),branch:String(a.get("branch")??"")}),await S()}),document.querySelectorAll(".complete-cleaning-btn").forEach(e=>{e.addEventListener("click",async()=>{const t=Number(e.dataset.machineId),a=e.dataset.branch??"";e.disabled=!0,e.textContent="Completing...",await Pa(t,a),await S()})}),document.querySelectorAll(".deactivate-machine-btn, .activate-machine-btn").forEach(e=>{e.addEventListener("click",async()=>{const t=Number(e.dataset.id),a=e.classList.contains("deactivate-machine-btn");await Ra(t,a?"inactive":"available"),await S()})})}function fs(e){const t=document.querySelector("#add-staff-modal"),a=document.querySelector("#open-add-staff-modal"),s=document.querySelector("#close-add-staff-modal"),r=document.querySelector("#staff-form"),n=()=>{r?.reset(),r&&(r.querySelector("[name=id]").value="");const o=document.querySelector("#add-staff-title");o&&(o.textContent="Add staff member"),t?.removeAttribute("hidden")},i=()=>{t?.setAttribute("hidden",""),r?.reset()};a?.addEventListener("click",n),s?.addEventListener("click",i),t?.addEventListener("click",o=>{o.target===t&&i()}),document.querySelectorAll(".edit-staff-btn").forEach(o=>{o.addEventListener("click",()=>{const u=Number(o.dataset.id),l=e.find(d=>d.id===u);if(l&&r){r.querySelector("[name=id]").value=String(l.id),r.querySelector("[name=name]").value=l.name,r.querySelector("[name=email]").value=l.email,r.querySelector("[name=password]").value=l.password,r.querySelector("[name=role]").value=l.role,r.querySelector("[name=branch]").value=l.branch;const d=document.querySelector("#add-staff-title");d&&(d.textContent="Edit staff member"),t?.removeAttribute("hidden")}})}),document.querySelectorAll(".deactivate-staff-btn, .activate-staff-btn").forEach(o=>{o.addEventListener("click",async()=>{const u=Number(o.dataset.id),l=e.find(d=>d.id===u);l&&(await Ve(u,{isActive:l.isActive!==0?0:1}),await S())})}),r?.addEventListener("submit",async o=>{o.preventDefault();const u=document.querySelector("#staff-save-btn");u&&(u.disabled=!0,u.textContent="Saving...");const l=new FormData(r),d=l.get("id")?Number(l.get("id")):void 0,m=String(l.get("name")??"").trim(),y=String(l.get("email")??"").trim(),f=String(l.get("password")??"password")||"password",g=String(l.get("role")),E=String(l.get("branch")??"");if(!m||!y){alert("Name and email are required."),u&&(u.disabled=!1,u.textContent="Save staff member");return}try{d?await Ve(d,{name:m,email:y,password:f,role:g,branch:E}):await ra({name:m,email:y,password:f,role:g,branch:E}),i(),await S()}catch{alert("Failed to save staff. The email may already be in use."),u&&(u.disabled=!1,u.textContent="Save staff member")}})}function ys(){document.querySelector("#settings-form")?.addEventListener("submit",async e=>{e.preventDefault();const t=new FormData(e.currentTarget);await ge("branch",String(t.get("branch")??"Main Store")),await ge("fold_rate",String(t.get("foldRate")??"5")),String(t.get("reportEmail")??"")&&await ge("report_email",String(t.get("reportEmail"))),alert("Settings saved successfully!"),await S()})}await ta();const rt=localStorage.getItem(ve);if(rt)try{const e=JSON.parse(rt);if(e.email&&e.remembered){const t=await dt(e.email,"password")??null;c.currentUser=t}}catch{localStorage.removeItem(ve)}function hs(e,t,a,s){const r=e.filter(f=>f.status==="revolving").reduce((f,g)=>f+g.cashAmount,0),n=t.filter(f=>f.type==="add").reduce((f,g)=>f+g.amount,0),i=t.filter(f=>f.type==="disbursement").reduce((f,g)=>f+g.amount,0),o=r+n-i,u=c.revolvingHistoryFrom||"0000-01-01",l=c.revolvingHistoryTo||"9999-12-31",d=t.filter(f=>{const g=H(f.createdAt);return g>=u&&g<=l}),m=e.map(f=>{const g=ht(f.saleDate,a,s,f.cashAmount),E=f.status==="revolving"?'<span class="ok">Revolving</span>':f.status==="endorsed"?`<span class="warn">Endorsed to ${v(f.endorsedTo)}</span>`:'<span class="meta">Pending</span>',p=f.status!=="revolving"&&f.status!=="endorsed"?`<div class="row-actions">
          <button class="primary revolving-btn" data-id="${f.id}">Revolving</button>
          <button class="secondary endorsed-btn" data-id="${f.id}" data-date="${se(f.saleDate)}">Endorsed</button>
        </div>`:"";return[`<strong>${v(se(f.saleDate))}</strong>`,`<strong class="ok">${T(g)}</strong>`,E,f.statusUpdatedAt?v(se(f.statusUpdatedAt)):"-",p]}),y=d.map(f=>[qa(f.createdAt),`<strong>${v(f.revolvingNumber)}</strong>`,v(f.name),`<strong class="${f.type==="disbursement"?"warn":"ok"}">${f.type==="disbursement"?"-":"+"}${T(f.amount)}</strong>`,v(f.category),v(f.description||"-"),`<span class="${f.type==="add"?"ok":"warn"}">${f.type==="add"?"Add Revolving Fund":"Disbursement"}</span>`]);return`
    <section class="grid content full">
      ...
      <article class="panel">
        ...
        ${we(["Date of Sales","Cash on Hand","Status","Date Update","Action"],m,"data-table revolving-summary-datatable")}
      </article>
  ...
  `}function gs(){document.querySelector("#revolving-history-filters")?.addEventListener("submit",async d=>{d.preventDefault();const m=new FormData(d.currentTarget);c.revolvingHistoryFrom=String(m.get("revolvingHistoryFrom")??"").trim(),c.revolvingHistoryTo=String(m.get("revolvingHistoryTo")??"").trim(),await S()}),document.querySelector("#revolving-history-clear")?.addEventListener("click",async()=>{c.revolvingHistoryFrom="",c.revolvingHistoryTo="",await S()}),document.querySelectorAll(".revolving-btn").forEach(d=>{d.addEventListener("click",async()=>{c.revolvingModalOpen=!0,c.revolvingSaleId=Number(d.dataset.id),await S()})});const e=document.getElementById("confirm-revolving-btn");e&&e.addEventListener("click",async()=>{await Je(c.revolvingSaleId,"revolving",null,new Date().toISOString()),c.revolvingModalOpen=!1,await S()});const t=document.getElementById("close-revolving-modal");t&&t.addEventListener("click",async()=>{c.revolvingModalOpen=!1,await S()}),document.querySelectorAll(".endorsed-btn").forEach(d=>{d.addEventListener("click",async()=>{c.endorseModalOpen=!0,c.endorseSaleId=Number(d.dataset.id),c.endorseSaleDate=d.dataset.date??"",await S()})});const a=document.getElementById("close-endorse-modal");a&&a.addEventListener("click",async()=>{c.endorseModalOpen=!1,await S()});const s=document.getElementById("endorse-form");s&&s.addEventListener("submit",async d=>{d.preventDefault();const m=new FormData(s),y=String(m.get("endorsedTo")??"").trim();y&&(await Je(c.endorseSaleId,"endorsed",y,new Date().toISOString()),c.endorseModalOpen=!1,await S())});const r=document.getElementById("add-revolving-fund-btn");r&&r.addEventListener("click",async()=>{c.addFundModalOpen=!0,await S()});const n=document.getElementById("close-add-fund-modal");n&&n.addEventListener("click",async()=>{c.addFundModalOpen=!1,await S()});const i=document.getElementById("add-fund-form");i&&i.addEventListener("submit",async d=>{d.preventDefault();const m=new FormData(i);await ze({name:String(m.get("name")??"").trim(),amount:Number(m.get("amount")??0),category:"Add Revolving Fund",description:null,type:"add",createdAt:new Date().toISOString()}),c.addFundModalOpen=!1,await S()});const o=document.getElementById("revolving-disbursement-btn");o&&o.addEventListener("click",async()=>{c.disbursementModalOpen=!0,await S()});const u=document.getElementById("close-disbursement-modal");u&&u.addEventListener("click",async()=>{c.disbursementModalOpen=!1,await S()});const l=document.getElementById("disbursement-form");l&&l.addEventListener("submit",async d=>{d.preventDefault();const m=new FormData(l);await ze({name:String(m.get("name")??"").trim(),amount:Number(m.get("amount")??0),category:String(m.get("category")??"").trim(),description:String(m.get("description")??"").trim(),type:"disbursement",expenseDate:W(),createdAt:new Date().toISOString()}),c.disbursementModalOpen=!1,await S()})}await S();export{Re as E,Pe as W,Pt as b};
