        ...
        <article class="rounded-3xl border border-white/70 bg-white/90 p-6 shadow-lg">
            <div class="flex items-start gap-4">
                ...
                <div class="flex-1">
                    ...
                    <p class="mt-1 text-sm text-[#5c6a86]">Set the default email address where exported reports will be sent. Staff can still type a different recipient on the Reports page before sending.</p>
                </div>
            </div>
